...
class RequiredCreateVacancyDetailParameter(TypedDict):
...
class OptionalCreateVacancyDetailParameter(TypedDict, total=False):
...
class CreateVacancyDetailParameter(RequiredCreateVacancyDetailParameter, OptionalCreateVacancyDetailParameter):
    pass
