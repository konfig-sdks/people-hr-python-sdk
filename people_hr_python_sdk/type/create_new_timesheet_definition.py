...
class RequiredCreateNewTimesheetDefinition(TypedDict):
...
class OptionalCreateNewTimesheetDefinition(TypedDict, total=False):
    TimeIn1: str
...
class CreateNewTimesheetDefinition(RequiredCreateNewTimesheetDefinition, OptionalCreateNewTimesheetDefinition):
    pass
