...
RequiredCreateEmployeeDetailParameter = TypedDict("RequiredCreateEmployeeDetailParameter", {
...
OptionalCreateEmployeeDetailParameter = TypedDict("OptionalCreateEmployeeDetailParameter", {
    ...
    "EntitlementThisYear": str,

    # Entitlement next year default value 
    "EntitlementNextYear": str,
...
class CreateEmployeeDetailParameter(RequiredCreateEmployeeDetailParameter, OptionalCreateEmployeeDetailParameter):
    pass
