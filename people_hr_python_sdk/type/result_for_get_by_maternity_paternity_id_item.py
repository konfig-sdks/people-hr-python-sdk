...
from people_hr_python_sdk.type.commentss_array_for_get_detail import CommentssArrayForGetDetail
from people_hr_python_sdk.type.files_array_for_maternity_paternity import FilesArrayForMaternityPaternity

class RequiredResultForGetByMaternityPaternityIdItem(TypedDict):
    pass

class OptionalResultForGetByMaternityPaternityIdItem(TypedDict, total=False):
    #  CPDId Value
    MaternityPaternityTxnId: int

    #  ExpectedDate value
    ExpectedDate: date

    #  DueWeekStartDate value
    DueWeekStartDate: date

    #  DueWeekEndDate value
    DueWeekEndDate: date

    #  EarliestStartDate value
    EarliestStartDate: date

    #  ContinousWeeksService value
    ContinousWeeksService: str

    #  OrdinaryLeaveStartDate value
    OrdinaryLeaveStartDate: date

    #  OrdinaryLeaveEndDate value
    OrdinaryLeaveEndDate: date

    #  AdditionalLeaveStartDate value
    AdditionalLeaveStartDate: date

    #  AdditionalLeaveEndDate value
    AdditionalLeaveEndDate: date
    ...
    # Comments for get details
    Comments: CommentssArrayForGetDetail

    # Files for get details
    Files: FilesArrayForMaternityPaternity

    # ReferenceId value
    ReferenceId: str

class ResultForGetByMaternityPaternityIdItem(RequiredResultForGetByMaternityPaternityIdItem, OptionalResultForGetByMaternityPaternityIdItem):
    pass
