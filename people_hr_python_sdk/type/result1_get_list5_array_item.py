...
from people_hr_python_sdk.type.result1_get_list5_array_item_company_effective_date import Result1GetList5ArrayItemCompanyEffectiveDate
from people_hr_python_sdk.type.result1_get_list5_array_item_department_effective_date import Result1GetList5ArrayItemDepartmentEffectiveDate
from people_hr_python_sdk.type.result1_get_list5_array_item_employee_status import Result1GetList5ArrayItemEmployeeStatus
from people_hr_python_sdk.type.result1_get_list5_array_item_employment_type_effective_date import Result1GetList5ArrayItemEmploymentTypeEffectiveDate
from people_hr_python_sdk.type.result1_get_list5_array_item_holiday_allowance_days import Result1GetList5ArrayItemHolidayAllowanceDays
from people_hr_python_sdk.type.result1_get_list5_array_item_holiday_allowance_mins import Result1GetList5ArrayItemHolidayAllowanceMins
from people_hr_python_sdk.type.result1_get_list5_array_item_job_role_change_date import Result1GetList5ArrayItemJobRoleChangeDate
from people_hr_python_sdk.type.result1_get_list5_array_item_location_effective_date import Result1GetList5ArrayItemLocationEffectiveDate
from people_hr_python_sdk.type.result1_get_list5_array_item_reports_to_effective_date import Result1GetList5ArrayItemReportsToEffectiveDate
from people_hr_python_sdk.type.result1_get_list5_array_item_reports_to_email_address import Result1GetList5ArrayItemReportsToEmailAddress
from people_hr_python_sdk.type.result1_get_list5_array_item_reports_to_employee_id import Result1GetList5ArrayItemReportsToEmployeeId
...
class RequiredResult1GetList5ArrayItem(TypedDict):
    pass

class OptionalResult1GetList5ArrayItem(TypedDict, total=False):
    ...
    CompanyEffectiveDate: Result1GetList5ArrayItemCompanyEffectiveDate

    # Location name of employee
    Location: LocationObject

    LocationEffectiveDate: Result1GetList5ArrayItemLocationEffectiveDate

    # Department name of employee
    Department: DepartmentObject

    DepartmentEffectiveDate: Result1GetList5ArrayItemDepartmentEffectiveDate

    JobRoleChangeDate: Result1GetList5ArrayItemJobRoleChangeDate

    # Reports to value
    ReportsTo: ReportsToObject

    ReportsToEffectiveDate: Result1GetList5ArrayItemReportsToEffectiveDate

    ReportsToEmployeeId: Result1GetList5ArrayItemReportsToEmployeeId

    ReportsToEmailAddress: Result1GetList5ArrayItemReportsToEmailAddress
    ...
    EmploymentTypeEffectiveDate: Result1GetList5ArrayItemEmploymentTypeEffectiveDate

    EmployeeStatus: Result1GetList5ArrayItemEmployeeStatus

    HolidayAllowanceDays: Result1GetList5ArrayItemHolidayAllowanceDays

    HolidayAllowanceMins: Result1GetList5ArrayItemHolidayAllowanceMins
...
class Result1GetList5ArrayItem(RequiredResult1GetList5ArrayItem, OptionalResult1GetList5ArrayItem):
    pass
