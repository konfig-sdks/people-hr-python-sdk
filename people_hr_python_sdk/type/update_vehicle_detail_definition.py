...
class RequiredUpdateVehicleDetailDefinition(TypedDict):
...
class OptionalUpdateVehicleDetailDefinition(TypedDict, total=False):
    # Make default value 
    Make: str
    ...
    CustomColumns: CustomColumnsForEmployeeVehicleUpdateArray

    # AddFiles to update employee's vehicle detail
    AddFiles: AddFilesForEmployeeVehicleUpdateArray

class UpdateVehicleDetailDefinition(RequiredUpdateVehicleDetailDefinition, OptionalUpdateVehicleDetailDefinition):
    pass
