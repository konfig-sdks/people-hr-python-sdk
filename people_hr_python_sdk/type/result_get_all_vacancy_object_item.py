...
from people_hr_python_sdk.type.result_additional_questions_arrayobject import ResultAdditionalQuestionsArrayobject
from people_hr_python_sdk.type.result_internal_questions_arrayobject import ResultInternalQuestionsArrayobject

class RequiredResultGetAllVacancyObjectItem(TypedDict):
    pass

class OptionalResultGetAllVacancyObjectItem(TypedDict, total=False):
    # Vacancy name value
    VacancyName: str
    ...
    AdditionalQuestions: ResultAdditionalQuestionsArrayobject

    # Internal questions array list
    InternalQuestions: ResultInternalQuestionsArrayobject

class ResultGetAllVacancyObjectItem(RequiredResultGetAllVacancyObjectItem, OptionalResultGetAllVacancyObjectItem):
    pass
