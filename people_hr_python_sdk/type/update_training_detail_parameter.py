...
class RequiredUpdateTrainingDetailParameter(TypedDict):
...
class OptionalUpdateTrainingDetailParameter(TypedDict, total=False):
    ...
    CustomColumns: CustomColumnsForEmployeeTraining

    # Add files for update training detail
    AddFiles: AddFilesForEmployeeTraining

class UpdateTrainingDetailParameter(RequiredUpdateTrainingDetailParameter, OptionalUpdateTrainingDetailParameter):
    pass
