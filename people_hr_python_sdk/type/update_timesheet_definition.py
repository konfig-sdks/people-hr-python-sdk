...
class RequiredUpdateTimesheetDefinition(TypedDict):
...
class OptionalUpdateTimesheetDefinition(TypedDict, total=False):
    TimeIn1: str
...
class UpdateTimesheetDefinition(RequiredUpdateTimesheetDefinition, OptionalUpdateTimesheetDefinition):
    pass
