...
class RequiredResultGetVacancyObject(TypedDict):
    pass

class OptionalResultGetVacancyObject(TypedDict, total=False):
    # Vacancy name value
    VacancyName: str
...
class ResultGetVacancyObject(RequiredResultGetVacancyObject, OptionalResultGetVacancyObject):
    pass
