...
from people_hr_python_sdk.type.timespan import Timespan

class RequiredResult1ForgetothereventdetailItem(TypedDict):
    pass

class OptionalResult1ForgetothereventdetailItem(TypedDict, total=False):
    # OtherLeaveTxnId Value
    OtherLeaveTxnId: int
    ...
    # Duration In Days This Period value
    DurationInDaysThisPeriod: int

    # Duration In Minutes This Period value
    DurationInMinutesThisPeriod: int

    # Requester Comments value
    RequesterComments: str

    # Approver Comments value
    ApproverComments: str
    ...
    # Last Action DateTime value
    LastActionDateTime: str

class Result1ForgetothereventdetailItem(RequiredResult1ForgetothereventdetailItem, OptionalResult1ForgetothereventdetailItem):
    pass
