...
RequiredUpdateEmployeeDetail3 = TypedDict("RequiredUpdateEmployeeDetail3", {
    ...
    "DepartmentEffectiveDate": date,

    # EmploymentTypeEffectiveDate default value 
    "EmploymentTypeEffectiveDate": date,
    })

OptionalUpdateEmployeeDetail3 = TypedDict("OptionalUpdateEmployeeDetail3", {
...
class UpdateEmployeeDetail3(RequiredUpdateEmployeeDetail3, OptionalUpdateEmployeeDetail3):
    pass
