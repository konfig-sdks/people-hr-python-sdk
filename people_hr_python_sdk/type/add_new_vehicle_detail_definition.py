...
class RequiredAddNewVehicleDetailDefinition(TypedDict):
...
class OptionalAddNewVehicleDetailDefinition(TypedDict, total=False):
    # Make default value 
    Make: str
    ...
    CustomColumns: CustomColumnsForEmployeeVehicleAddArray

    # AddFiles to add employee's new vehicle detail
    AddFiles: AddFilesForEmployeeVehicleAddArray

class AddNewVehicleDetailDefinition(RequiredAddNewVehicleDetailDefinition, OptionalAddNewVehicleDetailDefinition):
    pass
