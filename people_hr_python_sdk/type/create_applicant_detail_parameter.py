...
class RequiredCreateApplicantDetailParameter(TypedDict):
...
class OptionalCreateApplicantDetailParameter(TypedDict, total=False):
    # VacancyReference default value 
    VacancyReference: str
    ...
    OtherContactDetails: str

    # Source default value
    Source: str

    # Source for create new applicant
    AdditionalQuestions: AdditionalQuestionsForCreatenewApplicantArray

    # Internal questions for create new applicant
    InternalQuestions: InternalQuestionsForCreateNewApplicantArray
...
class CreateApplicantDetailParameter(RequiredCreateApplicantDetailParameter, OptionalCreateApplicantDetailParameter):
    pass
