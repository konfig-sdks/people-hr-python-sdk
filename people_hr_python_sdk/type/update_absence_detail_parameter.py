...
class RequiredUpdateAbsenceDetailParameter(TypedDict):
...
class OptionalUpdateAbsenceDetailParameter(TypedDict, total=False):
    # PartOfDay for update absence
    PartOfDay: PartOfDayForUpdateAbsence

    # AddComments array list
    AddComments: AddCommentsArrayForAbsence

    # AddFiles array list
    AddFiles: AddFilesArrayForAbsence

class UpdateAbsenceDetailParameter(RequiredUpdateAbsenceDetailParameter, OptionalUpdateAbsenceDetailParameter):
    pass
