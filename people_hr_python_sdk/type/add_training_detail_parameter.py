...
class RequiredAddTrainingDetailParameter(TypedDict):
...
class OptionalAddTrainingDetailParameter(TypedDict, total=False):
...
class AddTrainingDetailParameter(RequiredAddTrainingDetailParameter, OptionalAddTrainingDetailParameter):
    pass
