...
class RequiredResult1GetTimesheetArrayItem(TypedDict):
    pass

class OptionalResult1GetTimesheetArrayItem(TypedDict, total=False):
...
class Result1GetTimesheetArrayItem(RequiredResult1GetTimesheetArrayItem, OptionalResult1GetTimesheetArrayItem):
    pass
