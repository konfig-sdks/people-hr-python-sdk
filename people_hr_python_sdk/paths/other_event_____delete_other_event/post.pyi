...
from people_hr_python_sdk.model.error_for_delete_other_event import ErrorForDeleteOtherEvent as ErrorForDeleteOtherEventSchema
from people_hr_python_sdk.model.delete_other_event_parameter import DeleteOtherEventParameter as DeleteOtherEventParameterSchema

from people_hr_python_sdk.type.error_for_delete_other_event import ErrorForDeleteOtherEvent
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.delete_other_event_parameter import DeleteOtherEventParameter

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_delete_other_event import ErrorForDeleteOtherEvent as ErrorForDeleteOtherEventPydantic
from people_hr_python_sdk.pydantic.delete_other_event_parameter import DeleteOtherEventParameter as DeleteOtherEventParameterPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DeleteOtherEventParameterSchema


request_body_delete_other_event_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForDeleteOtherEventSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForDeleteOtherEvent
...
class BaseApi(api_client.Api):
    ...
    def _delete_event_mapped_args(
        ...
        if other_leave_txn_id is not None:
            _body["OtherLeaveTxnId"] = other_leave_txn_id
        args.body = _body
        return args

    async def _adelete_event_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Other Event  -  DeleteOtherEvent',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_delete_other_event_parameter.serialize(body, content_type)
...
class DeleteEventRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_event(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._delete_event_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            other_leave_txn_id=other_leave_txn_id,
        )
        return await self._adelete_event_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def delete_event(
        ...
        return self._delete_event_oapg(
            body=args.body,
        )

class DeleteEvent(BaseApi):
    ...
    async def adelete_event(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForDeleteOtherEventPydantic:
        raw_response = await self.raw.adelete_event(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            other_leave_txn_id=other_leave_txn_id,
        ...
        if validate:
            return ErrorForDeleteOtherEventPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForDeleteOtherEventPydantic, raw_response.body)
    ...
    def delete_event(
        ...
        raw_response = self.raw.delete_event(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            other_leave_txn_id=other_leave_txn_id,
