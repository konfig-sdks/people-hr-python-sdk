...
from people_hr_python_sdk.model.add_files_for_employee_vehicle_add_array import AddFilesForEmployeeVehicleAddArray as AddFilesForEmployeeVehicleAddArraySchema
from people_hr_python_sdk.model.error_for_add_new_vehicle_detail import ErrorForAddNewVehicleDetail as ErrorForAddNewVehicleDetailSchema
from people_hr_python_sdk.model.add_new_vehicle_detail_definition import AddNewVehicleDetailDefinition as AddNewVehicleDetailDefinitionSchema
from people_hr_python_sdk.model.custom_columns_for_employee_vehicle_add_array import CustomColumnsForEmployeeVehicleAddArray as CustomColumnsForEmployeeVehicleAddArraySchema

from people_hr_python_sdk.type.add_files_for_employee_vehicle_add_array import AddFilesForEmployeeVehicleAddArray
from people_hr_python_sdk.type.error_for_add_new_vehicle_detail import ErrorForAddNewVehicleDetail
from people_hr_python_sdk.type.add_new_vehicle_detail_definition import AddNewVehicleDetailDefinition
from people_hr_python_sdk.type.custom_columns_for_employee_vehicle_add_array import CustomColumnsForEmployeeVehicleAddArray
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.add_files_for_employee_vehicle_add_array import AddFilesForEmployeeVehicleAddArray as AddFilesForEmployeeVehicleAddArrayPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_add_new_vehicle_detail import ErrorForAddNewVehicleDetail as ErrorForAddNewVehicleDetailPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic
from people_hr_python_sdk.pydantic.custom_columns_for_employee_vehicle_add_array import CustomColumnsForEmployeeVehicleAddArray as CustomColumnsForEmployeeVehicleAddArrayPydantic
from people_hr_python_sdk.pydantic.add_new_vehicle_detail_definition import AddNewVehicleDetailDefinition as AddNewVehicleDetailDefinitionPydantic

# body param
SchemaForRequestBodyApplicationJson = AddNewVehicleDetailDefinitionSchema


request_body_add_new_vehicle_detail_definition = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForAddNewVehicleDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForAddNewVehicleDetail
...
class BaseApi(api_client.Api):
    ...
    def _create_new_vehicle_detail_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        engine_size: typing.Optional[str] = None,
        fuel_type: typing.Optional[str] = None,
        insurance_company: typing.Optional[str] = None,
        policy_number: typing.Optional[str] = None,
        mot_expiry_date: typing.Optional[date] = None,
        insurance_expiry_date: typing.Optional[date] = None,
        comments: typing.Optional[str] = None,
        custom_columns: typing.Optional[CustomColumnsForEmployeeVehicleAddArray] = None,
        add_files: typing.Optional[AddFilesForEmployeeVehicleAddArray] = None,
        ...
        if registration is not None:
            _body["Registration"] = registration
        if make is not None:
            _body["Make"] = make
        ...
        if engine_size is not None:
            _body["EngineSize"] = engine_size
        if fuel_type is not None:
            _body["FuelType"] = fuel_type
        if insurance_company is not None:
            _body["InsuranceCompany"] = insurance_company
        if policy_number is not None:
            _body["PolicyNumber"] = policy_number
        if mot_expiry_date is not None:
            _body["MOTExpiryDate"] = mot_expiry_date
        if insurance_expiry_date is not None:
            _body["InsuranceExpiryDate"] = insurance_expiry_date
    ...
    async def _acreate_new_vehicle_detail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Vehicle  -  AddNewVehicleDetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_add_new_vehicle_detail_definition.serialize(body, content_type)
    ...
    def _create_new_vehicle_detail_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateNewVehicleDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_vehicle_detail(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._create_new_vehicle_detail_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._acreate_new_vehicle_detail_oapg(
            body=args.body,
            **kwargs,
        )
    
    def create_new_vehicle_detail(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._create_new_vehicle_detail_oapg(
            body=args.body,
        )

class CreateNewVehicleDetail(BaseApi):
    ...
    async def acreate_new_vehicle_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForAddNewVehicleDetailPydantic:
        raw_response = await self.raw.acreate_new_vehicle_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            registration=registration,
        ...
        if validate:
            return ErrorForAddNewVehicleDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForAddNewVehicleDetailPydantic, raw_response.body)
    ...
    def create_new_vehicle_detail(
        ...
        raw_response = self.raw.create_new_vehicle_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            registration=registration,
