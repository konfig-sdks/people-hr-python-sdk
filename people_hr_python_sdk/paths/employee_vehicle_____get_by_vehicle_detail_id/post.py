...
from people_hr_python_sdk.model.error_for_get_vehicle_detail_by_vehicle_id import ErrorForGetVehicleDetailByVehicleId as ErrorForGetVehicleDetailByVehicleIdSchema
from people_hr_python_sdk.model.get_vehicle_detail_by_vehicle_id_definition import GetVehicleDetailByVehicleIdDefinition as GetVehicleDetailByVehicleIdDefinitionSchema

from people_hr_python_sdk.type.error_for_get_vehicle_detail_by_vehicle_id import ErrorForGetVehicleDetailByVehicleId
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.get_vehicle_detail_by_vehicle_id_definition import GetVehicleDetailByVehicleIdDefinition
...
from people_hr_python_sdk.pydantic.get_vehicle_detail_by_vehicle_id_definition import GetVehicleDetailByVehicleIdDefinition as GetVehicleDetailByVehicleIdDefinitionPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic
from people_hr_python_sdk.pydantic.error_for_get_vehicle_detail_by_vehicle_id import ErrorForGetVehicleDetailByVehicleId as ErrorForGetVehicleDetailByVehicleIdPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = GetVehicleDetailByVehicleIdDefinitionSchema


request_body_get_vehicle_detail_by_vehicle_id_definition = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetVehicleDetailByVehicleIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetVehicleDetailByVehicleId
...
class BaseApi(api_client.Api):
    ...
    def _get_by_vehicle_detail_id_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        if vehicle_id is not None:
            _body["VehicleId"] = vehicle_id
        args.body = _body
        return args

    async def _aget_by_vehicle_detail_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Vehicle  -  GetByVehicleDetailId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_vehicle_detail_by_vehicle_id_definition.serialize(body, content_type)
    ...
    def _get_by_vehicle_detail_id_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetByVehicleDetailIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_vehicle_detail_id(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._get_by_vehicle_detail_id_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            vehicle_id=vehicle_id,
        )
        return await self._aget_by_vehicle_detail_id_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_by_vehicle_detail_id(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._get_by_vehicle_detail_id_oapg(
            body=args.body,
        )

class GetByVehicleDetailId(BaseApi):
    ...
    async def aget_by_vehicle_detail_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetVehicleDetailByVehicleIdPydantic:
        raw_response = await self.raw.aget_by_vehicle_detail_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            vehicle_id=vehicle_id,
        ...
        if validate:
            return ErrorForGetVehicleDetailByVehicleIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetVehicleDetailByVehicleIdPydantic, raw_response.body)
    ...
    def get_by_vehicle_detail_id(
        ...
        raw_response = self.raw.get_by_vehicle_detail_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            vehicle_id=vehicle_id,
