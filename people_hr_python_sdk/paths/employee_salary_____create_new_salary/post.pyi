...
from people_hr_python_sdk.model.deductions_array import DeductionsArray as DeductionsArraySchema
from people_hr_python_sdk.model.entitlements_array import EntitlementsArray as EntitlementsArraySchema
...
from people_hr_python_sdk.model.payment_frequency import PaymentFrequency as PaymentFrequencySchema
from people_hr_python_sdk.model.error_for_create_new_salary1 import ErrorForCreateNewSalary1 as ErrorForCreateNewSalary1Schema
from people_hr_python_sdk.model.salary_type import SalaryType as SalaryTypeSchema
from people_hr_python_sdk.model.create_new_salary_parameter import CreateNewSalaryParameter as CreateNewSalaryParameterSchema

from people_hr_python_sdk.type.create_new_salary_parameter import CreateNewSalaryParameter
from people_hr_python_sdk.type.salary_type import SalaryType
from people_hr_python_sdk.type.entitlements_array import EntitlementsArray
from people_hr_python_sdk.type.deductions_array import DeductionsArray
from people_hr_python_sdk.type.payment_frequency import PaymentFrequency
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.error_for_create_new_salary1 import ErrorForCreateNewSalary1

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.create_new_salary_parameter import CreateNewSalaryParameter as CreateNewSalaryParameterPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_create_new_salary1 import ErrorForCreateNewSalary1 as ErrorForCreateNewSalary1Pydantic
from people_hr_python_sdk.pydantic.entitlements_array import EntitlementsArray as EntitlementsArrayPydantic
from people_hr_python_sdk.pydantic.salary_type import SalaryType as SalaryTypePydantic
from people_hr_python_sdk.pydantic.payment_frequency import PaymentFrequency as PaymentFrequencyPydantic
from people_hr_python_sdk.pydantic.deductions_array import DeductionsArray as DeductionsArrayPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = CreateNewSalaryParameterSchema


request_body_create_new_salary_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForCreateNewSalary1Schema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForCreateNewSalary1
...
class BaseApi(api_client.Api):
    ...
    def _add_new_salary_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        if salary_type is not None:
            _body["SalaryType"] = salary_type
        if payment_frequency is not None:
            _body["PaymentFrequency"] = payment_frequency
        if salary_amount is not None:
            _body["SalaryAmount"] = salary_amount
    ...
    async def _aadd_new_salary_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeSalary  -  CreateNewSalary',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_create_new_salary_parameter.serialize(body, content_type)
...
class AddNewSalaryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_new_salary(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._add_new_salary_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aadd_new_salary_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def add_new_salary(
        ...
        return self._add_new_salary_oapg(
            body=args.body,
        )

class AddNewSalary(BaseApi):
    ...
    async def aadd_new_salary(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForCreateNewSalary1Pydantic:
        raw_response = await self.raw.aadd_new_salary(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            effective_from=effective_from,
        ...
        if validate:
            return ErrorForCreateNewSalary1Pydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForCreateNewSalary1Pydantic, raw_response.body)
    ...
    def add_new_salary(
        ...
        raw_response = self.raw.add_new_salary(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            effective_from=effective_from,
