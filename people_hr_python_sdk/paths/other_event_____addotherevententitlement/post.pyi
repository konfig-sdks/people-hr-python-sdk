...
from people_hr_python_sdk.model.addotherevententitlement_parameter import AddotherevententitlementParameter as AddotherevententitlementParameterSchema
...
from people_hr_python_sdk.model.error_foraddotherevententitlement import ErrorForaddotherevententitlement as ErrorForaddotherevententitlementSchema

from people_hr_python_sdk.type.addotherevententitlement_parameter import AddotherevententitlementParameter
from people_hr_python_sdk.type.error_foraddotherevententitlement import ErrorForaddotherevententitlement
...
from people_hr_python_sdk.pydantic.error_foraddotherevententitlement import ErrorForaddotherevententitlement as ErrorForaddotherevententitlementPydantic
from people_hr_python_sdk.pydantic.addotherevententitlement_parameter import AddotherevententitlementParameter as AddotherevententitlementParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = AddotherevententitlementParameterSchema


request_body_addotherevententitlement_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForaddotherevententitlementSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForaddotherevententitlement
...
class BaseApi(api_client.Api):
    ...
    def _insert_update_entitlement_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        this_year_entitlement: typing.Union[int, float],
        next_year_entitlement: typing.Union[int, float],
        ...
        if entitlement_recorded_in is not None:
            _body["Entitlement RecordedIn"] = entitlement_recorded_in
        if this_year_entitlement is not None:
            _body["ThisYearEntitlement"] = this_year_entitlement
        if next_year_entitlement is not None:
            _body["NextYearEntitlement"] = next_year_entitlement
        args.body = _body
        return args

    async def _ainsert_update_entitlement_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Other Event  -  addotherevententitlement',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_addotherevententitlement_parameter.serialize(body, content_type)
    ...
    def _insert_update_entitlement_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class InsertUpdateEntitlementRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ainsert_update_entitlement(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._insert_update_entitlement_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            other_event_reason=other_event_reason,
            entitlement_recorded_in=entitlement_recorded_in,
            this_year_entitlement=this_year_entitlement,
            next_year_entitlement=next_year_entitlement,
        )
        return await self._ainsert_update_entitlement_oapg(
            body=args.body,
            **kwargs,
        )
    
    def insert_update_entitlement(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._insert_update_entitlement_oapg(
            body=args.body,
        )

class InsertUpdateEntitlement(BaseApi):
    ...
    async def ainsert_update_entitlement(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForaddotherevententitlementPydantic:
        raw_response = await self.raw.ainsert_update_entitlement(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            other_event_reason=other_event_reason,
        ...
        if validate:
            return ErrorForaddotherevententitlementPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForaddotherevententitlementPydantic, raw_response.body)
    ...
    def insert_update_entitlement(
        ...
        raw_response = self.raw.insert_update_entitlement(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            other_event_reason=other_event_reason,
