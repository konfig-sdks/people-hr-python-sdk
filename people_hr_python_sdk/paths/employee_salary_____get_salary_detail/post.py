...
from people_hr_python_sdk.model.error_for_get_salary_detail import ErrorForGetSalaryDetail as ErrorForGetSalaryDetailSchema
from people_hr_python_sdk.model.get_salary_detail2 import GetSalaryDetail2 as GetSalaryDetail2Schema

from people_hr_python_sdk.type.error_for_get_salary_detail import ErrorForGetSalaryDetail
from people_hr_python_sdk.type.get_salary_detail2 import GetSalaryDetail2
...
from people_hr_python_sdk.pydantic.error_for_get_salary_detail import ErrorForGetSalaryDetail as ErrorForGetSalaryDetailPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic
from people_hr_python_sdk.pydantic.get_salary_detail2 import GetSalaryDetail2 as GetSalaryDetail2Pydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = GetSalaryDetail2Schema


request_body_get_salary_detail2 = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetSalaryDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetSalaryDetail
...
class BaseApi(api_client.Api):
    ...
    def _get_salary_detail_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        if is_include_history is not None:
            _body["IsIncludeHistory"] = is_include_history
        args.body = _body
        return args

    async def _aget_salary_detail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeSalary  -  GetSalaryDetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_salary_detail2.serialize(body, content_type)
...
class GetSalaryDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_salary_detail(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._get_salary_detail_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            is_include_history=is_include_history,
        )
        return await self._aget_salary_detail_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def get_salary_detail(
        ...
        return self._get_salary_detail_oapg(
            body=args.body,
        )

class GetSalaryDetail(BaseApi):
    ...
    async def aget_salary_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetSalaryDetailPydantic:
        raw_response = await self.raw.aget_salary_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            is_include_history=is_include_history,
        ...
        if validate:
            return ErrorForGetSalaryDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetSalaryDetailPydantic, raw_response.body)
    ...
    def get_salary_detail(
        ...
        raw_response = self.raw.get_salary_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            is_include_history=is_include_history,
