...
from people_hr_python_sdk.model.error_for_update_background_check_detail import ErrorForUpdateBackgroundCheckDetail as ErrorForUpdateBackgroundCheckDetailSchema
from people_hr_python_sdk.model.update_background_check_detail_parameter import UpdateBackgroundCheckDetailParameter as UpdateBackgroundCheckDetailParameterSchema

from people_hr_python_sdk.type.error_for_update_background_check_detail import ErrorForUpdateBackgroundCheckDetail
from people_hr_python_sdk.type.update_background_check_detail_parameter import UpdateBackgroundCheckDetailParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_update_background_check_detail import ErrorForUpdateBackgroundCheckDetail as ErrorForUpdateBackgroundCheckDetailPydantic
from people_hr_python_sdk.pydantic.update_background_check_detail_parameter import UpdateBackgroundCheckDetailParameter as UpdateBackgroundCheckDetailParameterPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateBackgroundCheckDetailParameterSchema


request_body_update_background_check_detail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUpdateBackgroundCheckDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUpdateBackgroundCheckDetail
    ...
    async def _aupdate_detail_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Background Check  -  UpdateBackgroundCheckDetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_background_check_detail_parameter.serialize(body, content_type)
...
class UpdateDetail(BaseApi):
    ...
    async def aupdate_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForUpdateBackgroundCheckDetailPydantic:
        ...
        if validate:
            return ErrorForUpdateBackgroundCheckDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUpdateBackgroundCheckDetailPydantic, raw_response.body)
