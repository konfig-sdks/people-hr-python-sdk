...
from people_hr_python_sdk.model.get_query_result_by_query_name_parameter import GetQueryResultByQueryNameParameter as GetQueryResultByQueryNameParameterSchema
from people_hr_python_sdk.model.error_for_get_query_result_by_query_name import ErrorForGetQueryResultByQueryName as ErrorForGetQueryResultByQueryNameSchema

from people_hr_python_sdk.type.get_query_result_by_query_name_parameter import GetQueryResultByQueryNameParameter
from people_hr_python_sdk.type.error_for_get_query_result_by_query_name import ErrorForGetQueryResultByQueryName
from people_hr_python_sdk.type.api_key import APIKey

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_get_query_result_by_query_name import ErrorForGetQueryResultByQueryName as ErrorForGetQueryResultByQueryNamePydantic
from people_hr_python_sdk.pydantic.get_query_result_by_query_name_parameter import GetQueryResultByQueryNameParameter as GetQueryResultByQueryNameParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = GetQueryResultByQueryNameParameterSchema


request_body_get_query_result_by_query_name_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetQueryResultByQueryNameSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetQueryResultByQueryName
...
class BaseApi(api_client.Api):
    ...
    def _get_by_query_name_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        query_name: str,
        ...
        if query_name is not None:
            _body["QueryName"] = query_name
        args.body = _body
        return args

    async def _aget_by_query_name_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Query  -  GetQueryResultByQueryName',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_query_result_by_query_name_parameter.serialize(body, content_type)
...
class GetByQueryNameRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_query_name(
        self,
        api_key: APIKey,
        action: str,
        query_name: str,
        **kwargs,
        ...
        args = self._get_by_query_name_mapped_args(
            api_key=api_key,
            action=action,
            query_name=query_name,
        )
        return await self._aget_by_query_name_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_by_query_name(
        self,
        api_key: APIKey,
        action: str,
        query_name: str,
        ...
        return self._get_by_query_name_oapg(
            body=args.body,
        )

class GetByQueryName(BaseApi):
    ...
    async def aget_by_query_name(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetQueryResultByQueryNamePydantic:
        raw_response = await self.raw.aget_by_query_name(
            api_key=api_key,
            action=action,
            query_name=query_name,
            **kwargs,
        ...
        if validate:
            return ErrorForGetQueryResultByQueryNamePydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetQueryResultByQueryNamePydantic, raw_response.body)
    ...
    def get_by_query_name(
        ...
        raw_response = self.raw.get_by_query_name(
            api_key=api_key,
            action=action,
            query_name=query_name,
        )
