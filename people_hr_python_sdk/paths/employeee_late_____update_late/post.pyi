...
from people_hr_python_sdk.model.error_for_upadte_late import ErrorForUpadteLate as ErrorForUpadteLateSchema
from people_hr_python_sdk.model.update_late_parameters import UpdateLateParameters as UpdateLateParametersSchema

from people_hr_python_sdk.type.error_for_upadte_late import ErrorForUpadteLate
from people_hr_python_sdk.type.update_late_parameters import UpdateLateParameters
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.update_late_parameters import UpdateLateParameters as UpdateLateParametersPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_upadte_late import ErrorForUpadteLate as ErrorForUpadteLatePydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = UpdateLateParametersSchema


request_body_update_late_parameters = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUpadteLateSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUpadteLate
    ...
    async def _aupdate_late_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employeee Late  -  UpdateLate',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_late_parameters.serialize(body, content_type)
...
class UpdateLateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_late(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._update_late_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aupdate_late_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def update_late(
        ...
        return self._update_late_oapg(
            body=args.body,
        )

class UpdateLate(BaseApi):
    ...
    async def aupdate_late(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForUpadteLatePydantic:
        raw_response = await self.raw.aupdate_late(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            late_date=late_date,
        ...
        if validate:
            return ErrorForUpadteLatePydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUpadteLatePydantic, raw_response.body)
    ...
    def update_late(
        ...
        raw_response = self.raw.update_late(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            late_date=late_date,
