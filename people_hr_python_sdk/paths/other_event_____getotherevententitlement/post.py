...
from people_hr_python_sdk.model.getotherevententitlement_parameter import GetotherevententitlementParameter as GetotherevententitlementParameterSchema
from people_hr_python_sdk.model.error_forgetotherevententitlement import ErrorForgetotherevententitlement as ErrorForgetotherevententitlementSchema

from people_hr_python_sdk.type.error_forgetotherevententitlement import ErrorForgetotherevententitlement
from people_hr_python_sdk.type.getotherevententitlement_parameter import GetotherevententitlementParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.getotherevententitlement_parameter import GetotherevententitlementParameter as GetotherevententitlementParameterPydantic
from people_hr_python_sdk.pydantic.error_forgetotherevententitlement import ErrorForgetotherevententitlement as ErrorForgetotherevententitlementPydantic
...
# body param
SchemaForRequestBodyApplicationJson = GetotherevententitlementParameterSchema


request_body_getotherevententitlement_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForgetotherevententitlementSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForgetotherevententitlement
...
class BaseApi(api_client.Api):
    ...
    def _get_entitlement_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aget_entitlement_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Other Event  -  getotherevententitlement',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_getotherevententitlement_parameter.serialize(body, content_type)
...
class GetEntitlementRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_entitlement(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        **kwargs,
        ...
        args = self._get_entitlement_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
        )
        return await self._aget_entitlement_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def get_entitlement(
        ...
        return self._get_entitlement_oapg(
            body=args.body,
        )

class GetEntitlement(BaseApi):
    ...
    async def aget_entitlement(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForgetotherevententitlementPydantic:
        raw_response = await self.raw.aget_entitlement(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            **kwargs,
        ...
        if validate:
            return ErrorForgetotherevententitlementPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForgetotherevententitlementPydantic, raw_response.body)
    ...
    def get_entitlement(
        ...
        raw_response = self.raw.get_entitlement(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
        )
