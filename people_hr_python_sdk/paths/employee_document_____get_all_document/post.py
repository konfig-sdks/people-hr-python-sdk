...
from people_hr_python_sdk.model.error_for_get_all_document import ErrorForGetAllDocument as ErrorForGetAllDocumentSchema
...
from people_hr_python_sdk.model.get_all_document_parameter import GetAllDocumentParameter as GetAllDocumentParameterSchema

from people_hr_python_sdk.type.get_all_document_parameter import GetAllDocumentParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.error_for_get_all_document import ErrorForGetAllDocument

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.get_all_document_parameter import GetAllDocumentParameter as GetAllDocumentParameterPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_get_all_document import ErrorForGetAllDocument as ErrorForGetAllDocumentPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = GetAllDocumentParameterSchema


request_body_get_all_document_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetAllDocumentSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetAllDocument
...
class BaseApi(api_client.Api):
    ...
    def _get_all_documents_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aget_all_documents_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeDocument  -  GetAllDocument',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_all_document_parameter.serialize(body, content_type)
...
class GetAllDocumentsRaw(BaseApi):
    ...
    async def aget_all_documents(
        ...
        **kwargs,
        ...
        args = self._get_all_documents_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
        )
        return await self._aget_all_documents_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def get_all_documents(
        ...
        return self._get_all_documents_oapg(
            body=args.body,
        )

class GetAllDocuments(BaseApi):
    ...
    async def aget_all_documents(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetAllDocumentPydantic:
        raw_response = await self.raw.aget_all_documents(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            **kwargs,
        ...
        if validate:
            return ErrorForGetAllDocumentPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetAllDocumentPydantic, raw_response.body)
    ...
    def get_all_documents(
        ...
        raw_response = self.raw.get_all_documents(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
        )
