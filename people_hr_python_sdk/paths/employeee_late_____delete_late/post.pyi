...
from people_hr_python_sdk.model.error_fordeletelate import ErrorFordeletelate as ErrorFordeletelateSchema
from people_hr_python_sdk.model.employeedeletelate_parameter import EmployeedeletelateParameter as EmployeedeletelateParameterSchema

from people_hr_python_sdk.type.employeedeletelate_parameter import EmployeedeletelateParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.error_fordeletelate import ErrorFordeletelate

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.employeedeletelate_parameter import EmployeedeletelateParameter as EmployeedeletelateParameterPydantic
from people_hr_python_sdk.pydantic.error_fordeletelate import ErrorFordeletelate as ErrorFordeletelatePydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = EmployeedeletelateParameterSchema


request_body_employeedeletelate_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorFordeletelateSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorFordeletelate
    ...
    async def _adelete_late_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employeee Late  -  DeleteLate',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_employeedeletelate_parameter.serialize(body, content_type)
...
class DeleteLateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_late(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._delete_late_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            late_date=late_date,
        )
        return await self._adelete_late_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def delete_late(
        ...
        return self._delete_late_oapg(
            body=args.body,
        )

class DeleteLate(BaseApi):
    ...
    async def adelete_late(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorFordeletelatePydantic:
        raw_response = await self.raw.adelete_late(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            late_date=late_date,
        ...
        if validate:
            return ErrorFordeletelatePydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorFordeletelatePydantic, raw_response.body)
    ...
    def delete_late(
        ...
        raw_response = self.raw.delete_late(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            late_date=late_date,
