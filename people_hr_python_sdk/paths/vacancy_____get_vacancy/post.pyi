...
from people_hr_python_sdk.model.error_for_get_vacancy import ErrorForGetVacancy as ErrorForGetVacancySchema
from people_hr_python_sdk.model.get_vacancy_parameters import GetVacancyParameters as GetVacancyParametersSchema

from people_hr_python_sdk.type.error_for_get_vacancy import ErrorForGetVacancy
from people_hr_python_sdk.type.get_vacancy_parameters import GetVacancyParameters
from people_hr_python_sdk.type.api_key import APIKey

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.get_vacancy_parameters import GetVacancyParameters as GetVacancyParametersPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic
from people_hr_python_sdk.pydantic.error_for_get_vacancy import ErrorForGetVacancy as ErrorForGetVacancyPydantic

# body param
SchemaForRequestBodyApplicationJson = GetVacancyParametersSchema


request_body_get_vacancy_parameters = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetVacancySchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetVacancy
    ...
    async def _aget_detail_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Vacancy  -  GetVacancy',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_vacancy_parameters.serialize(body, content_type)
...
class GetDetail(BaseApi):
    ...
    async def aget_detail(
        ...
        **kwargs,
        ...
        if validate:
            return ErrorForGetVacancyPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetVacancyPydantic, raw_response.body)
