...
from people_hr_python_sdk.model.error_for_delete_driving_license import ErrorForDeleteDrivingLicense as ErrorForDeleteDrivingLicenseSchema
from people_hr_python_sdk.model.delete_driving_license_parameter import DeleteDrivingLicenseParameter as DeleteDrivingLicenseParameterSchema

from people_hr_python_sdk.type.error_for_delete_driving_license import ErrorForDeleteDrivingLicense
from people_hr_python_sdk.type.delete_driving_license_parameter import DeleteDrivingLicenseParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_delete_driving_license import ErrorForDeleteDrivingLicense as ErrorForDeleteDrivingLicensePydantic
...
from people_hr_python_sdk.pydantic.delete_driving_license_parameter import DeleteDrivingLicenseParameter as DeleteDrivingLicenseParameterPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = DeleteDrivingLicenseParameterSchema


request_body_delete_driving_license_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForDeleteDrivingLicenseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForDeleteDrivingLicense
...
class BaseApi(api_client.Api):
    ...
    def _remove_driving_license_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aremove_driving_license_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Driving  -  DeleteDrivingLicense',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_delete_driving_license_parameter.serialize(body, content_type)
    ...
    def _remove_driving_license_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveDrivingLicenseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_driving_license(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._remove_driving_license_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            driving_id=driving_id,
        )
        return await self._aremove_driving_license_oapg(
            body=args.body,
            **kwargs,
        )
    
    def remove_driving_license(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._remove_driving_license_oapg(
            body=args.body,
        )

class RemoveDrivingLicense(BaseApi):
    ...
    async def aremove_driving_license(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForDeleteDrivingLicensePydantic:
        raw_response = await self.raw.aremove_driving_license(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            driving_id=driving_id,
        ...
        if validate:
            return ErrorForDeleteDrivingLicensePydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForDeleteDrivingLicensePydantic, raw_response.body)
    ...
    def remove_driving_license(
        ...
        raw_response = self.raw.remove_driving_license(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            driving_id=driving_id,
