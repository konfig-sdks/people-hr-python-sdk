...
from people_hr_python_sdk.model.error_for_update_holiday_entitlement import ErrorForUpdateHolidayEntitlement as ErrorForUpdateHolidayEntitlementSchema
from people_hr_python_sdk.model.reason_for_change import ReasonForChange as ReasonForChangeSchema
from people_hr_python_sdk.model.update_holiday_entitlement_parameter import UpdateHolidayEntitlementParameter as UpdateHolidayEntitlementParameterSchema
...
from people_hr_python_sdk.type.update_holiday_entitlement_parameter import UpdateHolidayEntitlementParameter
from people_hr_python_sdk.type.error_for_update_holiday_entitlement import ErrorForUpdateHolidayEntitlement

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_update_holiday_entitlement import ErrorForUpdateHolidayEntitlement as ErrorForUpdateHolidayEntitlementPydantic
from people_hr_python_sdk.pydantic.update_holiday_entitlement_parameter import UpdateHolidayEntitlementParameter as UpdateHolidayEntitlementParameterPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateHolidayEntitlementParameterSchema


request_body_update_holiday_entitlement_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUpdateHolidayEntitlementSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUpdateHolidayEntitlement
...
class BaseApi(api_client.Api):
    ...
    def _update_holiday_entitlement_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aupdate_holiday_entitlement_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Holiday Entitlement  -  UpdateHolidayEntitlement',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_holiday_entitlement_parameter.serialize(body, content_type)
    ...
    def _update_holiday_entitlement_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateHolidayEntitlementRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_holiday_entitlement(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._update_holiday_entitlement_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aupdate_holiday_entitlement_oapg(
            body=args.body,
            **kwargs,
        )
    
    def update_holiday_entitlement(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._update_holiday_entitlement_oapg(
            body=args.body,
        )

class UpdateHolidayEntitlement(BaseApi):
    ...
    async def aupdate_holiday_entitlement(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForUpdateHolidayEntitlementPydantic:
        raw_response = await self.raw.aupdate_holiday_entitlement(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            reason_for_change=reason_for_change,
        ...
        if validate:
            return ErrorForUpdateHolidayEntitlementPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUpdateHolidayEntitlementPydantic, raw_response.body)
    ...
    def update_holiday_entitlement(
        ...
        raw_response = self.raw.update_holiday_entitlement(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            reason_for_change=reason_for_change,
