...
from people_hr_python_sdk.model.error_for_delete_holidy import ErrorForDeleteHolidy as ErrorForDeleteHolidySchema
...
from people_hr_python_sdk.model.delete_holiday_parameter import DeleteHolidayParameter as DeleteHolidayParameterSchema

from people_hr_python_sdk.type.error_for_delete_holidy import ErrorForDeleteHolidy
from people_hr_python_sdk.type.delete_holiday_parameter import DeleteHolidayParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_delete_holidy import ErrorForDeleteHolidy as ErrorForDeleteHolidyPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.delete_holiday_parameter import DeleteHolidayParameter as DeleteHolidayParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = DeleteHolidayParameterSchema


request_body_delete_holiday_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForDeleteHolidySchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForDeleteHolidy
...
class BaseApi(api_client.Api):
    ...
    def _remove_holiday_detail_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aremove_holiday_detail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Holiday  -  DeleteHoliday',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_delete_holiday_parameter.serialize(body, content_type)
    ...
    def _remove_holiday_detail_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RemoveHolidayDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_holiday_detail(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._remove_holiday_detail_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aremove_holiday_detail_oapg(
            body=args.body,
            **kwargs,
        )
    
    def remove_holiday_detail(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._remove_holiday_detail_oapg(
            body=args.body,
        )

class RemoveHolidayDetail(BaseApi):
    ...
    async def aremove_holiday_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForDeleteHolidyPydantic:
        raw_response = await self.raw.aremove_holiday_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            start_date=start_date,
        ...
        if validate:
            return ErrorForDeleteHolidyPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForDeleteHolidyPydantic, raw_response.body)
    ...
    def remove_holiday_detail(
        ...
        raw_response = self.raw.remove_holiday_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            start_date=start_date,
