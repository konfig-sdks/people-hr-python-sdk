...
from people_hr_python_sdk.model.additional_comments import AdditionalComments as AdditionalCommentsSchema
from people_hr_python_sdk.model.supporting_comments import SupportingComments as SupportingCommentsSchema
...
from people_hr_python_sdk.model.error_for_mark_as_leaver_by_id import ErrorForMarkAsLeaverById as ErrorForMarkAsLeaverByIdSchema
from people_hr_python_sdk.model.mark_as_leaver_by_id2 import MarkAsLeaverById2 as MarkAsLeaverById2Schema
from people_hr_python_sdk.model.reports_to import ReportsTo as ReportsToSchema

from people_hr_python_sdk.type.mark_as_leaver_by_id2 import MarkAsLeaverById2
from people_hr_python_sdk.type.additional_comments import AdditionalComments
from people_hr_python_sdk.type.supporting_comments import SupportingComments
from people_hr_python_sdk.type.error_for_mark_as_leaver_by_id import ErrorForMarkAsLeaverById
...
from people_hr_python_sdk.pydantic.error_for_mark_as_leaver_by_id import ErrorForMarkAsLeaverById as ErrorForMarkAsLeaverByIdPydantic
from people_hr_python_sdk.pydantic.supporting_comments import SupportingComments as SupportingCommentsPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.mark_as_leaver_by_id2 import MarkAsLeaverById2 as MarkAsLeaverById2Pydantic
from people_hr_python_sdk.pydantic.additional_comments import AdditionalComments as AdditionalCommentsPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = MarkAsLeaverById2Schema


request_body_mark_as_leaver_by_id2 = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForMarkAsLeaverByIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForMarkAsLeaverById
...
class BaseApi(api_client.Api):
    ...
    def _update_leaver_status_by_id_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        reasonfor_leaving: str,
        final_employment_date: date,
        additional_comments: typing.Optional[AdditionalComments] = None,
        final_working_date: typing.Optional[str] = None,
        markas_leaver_immediately: typing.Optional[bool] = None,
        reports_to: typing.Optional[ReportsTo] = None,
        re_employable: typing.Optional[str] = None,
        supporting_comments: typing.Optional[SupportingComments] = None,
        ...
        if reasonfor_leaving is not None:
            _body["ReasonforLeaving"] = reasonfor_leaving
        if additional_comments is not None:
            _body["AdditionalComments"] = additional_comments
        if final_employment_date is not None:
            _body["FinalEmploymentDate"] = final_employment_date
        if final_working_date is not None:
            _body["FinalWorkingDate"] = final_working_date
        if markas_leaver_immediately is not None:
            _body["MarkasLeaverImmediately"] = markas_leaver_immediately
        if reports_to is not None:
            _body["ReportsTo"] = reports_to
        if re_employable is not None:
            _body["ReEmployable"] = re_employable
        if supporting_comments is not None:
            _body["SupportingComments"] = supporting_comments
        args.body = _body
        return args

    async def _aupdate_leaver_status_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee  -  MarkAsLeaverById',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_mark_as_leaver_by_id2.serialize(body, content_type)
    ...
    def _update_leaver_status_by_id_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateLeaverStatusByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_leaver_status_by_id(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._update_leaver_status_by_id_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            reasonfor_leaving=reasonfor_leaving,
            final_employment_date=final_employment_date,
            additional_comments=additional_comments,
            final_working_date=final_working_date,
            markas_leaver_immediately=markas_leaver_immediately,
            reports_to=reports_to,
            re_employable=re_employable,
            supporting_comments=supporting_comments,
        )
        return await self._aupdate_leaver_status_by_id_oapg(
            body=args.body,
            **kwargs,
        )
    
    def update_leaver_status_by_id(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._update_leaver_status_by_id_oapg(
            body=args.body,
        )

class UpdateLeaverStatusById(BaseApi):
    ...
    async def aupdate_leaver_status_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForMarkAsLeaverByIdPydantic:
        raw_response = await self.raw.aupdate_leaver_status_by_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            reasonfor_leaving=reasonfor_leaving,
        ...
        if validate:
            return ErrorForMarkAsLeaverByIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForMarkAsLeaverByIdPydantic, raw_response.body)
    ...
    def update_leaver_status_by_id(
        ...
        raw_response = self.raw.update_leaver_status_by_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            reasonfor_leaving=reasonfor_leaving,
