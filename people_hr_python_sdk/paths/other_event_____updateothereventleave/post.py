...
from people_hr_python_sdk.model.result1_forupdateothereventleave import Result1Forupdateothereventleave as Result1ForupdateothereventleaveSchema
from people_hr_python_sdk.model.error_forupdateothereventleave import ErrorForupdateothereventleave as ErrorForupdateothereventleaveSchema
from people_hr_python_sdk.model.byte import Byte as ByteSchema
from people_hr_python_sdk.model.updateothereventleave_parameter import UpdateothereventleaveParameter as UpdateothereventleaveParameterSchema

from people_hr_python_sdk.type.updateothereventleave_parameter import UpdateothereventleaveParameter
from people_hr_python_sdk.type.error_forupdateothereventleave import ErrorForupdateothereventleave
...
from people_hr_python_sdk.type.result1_forupdateothereventleave import Result1Forupdateothereventleave

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.updateothereventleave_parameter import UpdateothereventleaveParameter as UpdateothereventleaveParameterPydantic
from people_hr_python_sdk.pydantic.result1_forupdateothereventleave import Result1Forupdateothereventleave as Result1ForupdateothereventleavePydantic
from people_hr_python_sdk.pydantic.error_forupdateothereventleave import ErrorForupdateothereventleave as ErrorForupdateothereventleavePydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateothereventleaveParameterSchema


request_body_updateothereventleave_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForupdateothereventleaveSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForupdateothereventleave
...
class BaseApi(api_client.Api):
    ...
    def _update_event_leave_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        other_event_txn_id: int,
        duration_type: Byte,
        other_event_reason: str,
        start_date: date,
        end_date: date,
        ...
        add_files: typing.Optional[Result1Forupdateothereventleave] = None,
        ...
        if other_event_txn_id is not None:
            _body["OtherEventTxnId"] = other_event_txn_id
        if duration_type is not None:
            _body["DurationType"] = duration_type
        if other_event_reason is not None:
            _body["Other Event Reason"] = other_event_reason
        ...
        if duration_in_days is not None:
            _body["DurationInDays"] = duration_in_days
    ...
    async def _aupdate_event_leave_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Other Event  -  updateothereventleave',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_updateothereventleave_parameter.serialize(body, content_type)
...
class UpdateEventLeaveRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_event_leave(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._update_event_leave_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            other_event_txn_id=other_event_txn_id,
            duration_type=duration_type,
            other_event_reason=other_event_reason,
        ...
        return await self._aupdate_event_leave_oapg(
            body=args.body,
            **kwargs,
        )
    
    def update_event_leave(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._update_event_leave_oapg(
            body=args.body,
        )

class UpdateEventLeave(BaseApi):
    ...
    async def aupdate_event_leave(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForupdateothereventleavePydantic:
        raw_response = await self.raw.aupdate_event_leave(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            other_event_txn_id=other_event_txn_id,
        ...
        if validate:
            return ErrorForupdateothereventleavePydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForupdateothereventleavePydantic, raw_response.body)
    ...
    def update_event_leave(
        ...
        raw_response = self.raw.update_event_leave(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            other_event_txn_id=other_event_txn_id,
