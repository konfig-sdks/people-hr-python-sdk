...
from people_hr_python_sdk.model.get_document_by_id_parameter import GetDocumentByIDParameter as GetDocumentByIDParameterSchema
from people_hr_python_sdk.model.error_for_get_document_by_id import ErrorForGetDocumentById as ErrorForGetDocumentByIdSchema
from people_hr_python_sdk.model.long_integer import LongInteger as LongIntegerSchema

from people_hr_python_sdk.type.get_document_by_id_parameter import GetDocumentByIDParameter
from people_hr_python_sdk.type.error_for_get_document_by_id import ErrorForGetDocumentById
...
from people_hr_python_sdk.pydantic.error_for_get_document_by_id import ErrorForGetDocumentById as ErrorForGetDocumentByIdPydantic
from people_hr_python_sdk.pydantic.long_integer import LongInteger as LongIntegerPydantic
from people_hr_python_sdk.pydantic.get_document_by_id_parameter import GetDocumentByIDParameter as GetDocumentByIDParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = GetDocumentByIDParameterSchema


request_body_get_document_by_id_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetDocumentByIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetDocumentById
    ...
    async def _aget_document_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeDocument  -  GetDocumentById',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_document_by_id_parameter.serialize(body, content_type)
...
class GetDocumentById(BaseApi):
    ...
    async def aget_document_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetDocumentByIdPydantic:
        ...
        if validate:
            return ErrorForGetDocumentByIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetDocumentByIdPydantic, raw_response.body)
