...
from people_hr_python_sdk.model.error_for_delete_cpd import ErrorForDeleteCPD as ErrorForDeleteCPDSchema
...
from people_hr_python_sdk.model.delete_cpd_parameter import DeleteCPDParameter as DeleteCPDParameterSchema

from people_hr_python_sdk.type.delete_cpd_parameter import DeleteCPDParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.error_for_delete_cpd import ErrorForDeleteCPD

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_delete_cpd import ErrorForDeleteCPD as ErrorForDeleteCPDPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.delete_cpd_parameter import DeleteCPDParameter as DeleteCPDParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = DeleteCPDParameterSchema


request_body_delete_cpd_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForDeleteCPDSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForDeleteCPD
    ...
    async def _adelete_cpd_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee CPD  -  DeleteCPD',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_delete_cpd_parameter.serialize(body, content_type)
...
class DeleteCpdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_cpd(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._delete_cpd_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            cpdid=cpdid,
        )
        return await self._adelete_cpd_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def delete_cpd(
        ...
        return self._delete_cpd_oapg(
            body=args.body,
        )

class DeleteCpd(BaseApi):
    ...
    async def adelete_cpd(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForDeleteCPDPydantic:
        raw_response = await self.raw.adelete_cpd(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            cpdid=cpdid,
        ...
        if validate:
            return ErrorForDeleteCPDPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForDeleteCPDPydantic, raw_response.body)
    ...
    def delete_cpd(
        ...
        raw_response = self.raw.delete_cpd(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            cpdid=cpdid,
