...
from people_hr_python_sdk.model.error_for_get_project_timesheet_by_transaction_id import ErrorForGetProjectTimesheetByTransactionId as ErrorForGetProjectTimesheetByTransactionIdSchema
...
from people_hr_python_sdk.model.get_project_timesheet_by_transaction_id import GetProjectTimesheetByTransactionId as GetProjectTimesheetByTransactionIdSchema

from people_hr_python_sdk.type.get_project_timesheet_by_transaction_id import GetProjectTimesheetByTransactionId
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.error_for_get_project_timesheet_by_transaction_id import ErrorForGetProjectTimesheetByTransactionId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.get_project_timesheet_by_transaction_id import GetProjectTimesheetByTransactionId as GetProjectTimesheetByTransactionIdPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_get_project_timesheet_by_transaction_id import ErrorForGetProjectTimesheetByTransactionId as ErrorForGetProjectTimesheetByTransactionIdPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = GetProjectTimesheetByTransactionIdSchema


request_body_get_project_timesheet_by_transaction_id = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetProjectTimesheetByTransactionIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetProjectTimesheetByTransactionId
...
class BaseApi(api_client.Api):
    ...
    def _get_by_transaction_id_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aget_by_transaction_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Project Timesheet  -  GetProjectTimesheetByTransactionId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_project_timesheet_by_transaction_id.serialize(body, content_type)
    ...
    def _get_by_transaction_id_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetByTransactionIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_transaction_id(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._get_by_transaction_id_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            transaction_id=transaction_id,
        )
        return await self._aget_by_transaction_id_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def get_by_transaction_id(
        ...
        return self._get_by_transaction_id_oapg(
            body=args.body,
        )

class GetByTransactionId(BaseApi):
    ...
    async def aget_by_transaction_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetProjectTimesheetByTransactionIdPydantic:
        raw_response = await self.raw.aget_by_transaction_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            transaction_id=transaction_id,
        ...
        if validate:
            return ErrorForGetProjectTimesheetByTransactionIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetProjectTimesheetByTransactionIdPydantic, raw_response.body)
    ...
    def get_by_transaction_id(
        ...
        raw_response = self.raw.get_by_transaction_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            transaction_id=transaction_id,
