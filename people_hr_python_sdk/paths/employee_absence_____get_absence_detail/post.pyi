...
from people_hr_python_sdk.model.error_for_get_absence_detail import ErrorForGetAbsenceDetail as ErrorForGetAbsenceDetailSchema
from people_hr_python_sdk.model.get_absence_detail_parameter import GetAbsenceDetailParameter as GetAbsenceDetailParameterSchema

from people_hr_python_sdk.type.error_for_get_absence_detail import ErrorForGetAbsenceDetail
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.get_absence_detail_parameter import GetAbsenceDetailParameter
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_get_absence_detail import ErrorForGetAbsenceDetail as ErrorForGetAbsenceDetailPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.get_absence_detail_parameter import GetAbsenceDetailParameter as GetAbsenceDetailParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = GetAbsenceDetailParameterSchema


request_body_get_absence_detail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetAbsenceDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetAbsenceDetail
    ...
    async def _aget_detail_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeAbsence  -  GetAbsenceDetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_absence_detail_parameter.serialize(body, content_type)
...
class GetDetail(BaseApi):
    ...
    async def aget_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetAbsenceDetailPydantic:
        ...
        if validate:
            return ErrorForGetAbsenceDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetAbsenceDetailPydantic, raw_response.body)
