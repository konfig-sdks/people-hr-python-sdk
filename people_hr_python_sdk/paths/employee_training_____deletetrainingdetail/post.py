...
from people_hr_python_sdk.model.error_fordeletetrainingdetail import ErrorFordeletetrainingdetail as ErrorFordeletetrainingdetailSchema
from people_hr_python_sdk.model.delete_training_detail_parameter import DeleteTrainingDetailParameter as DeleteTrainingDetailParameterSchema

from people_hr_python_sdk.type.delete_training_detail_parameter import DeleteTrainingDetailParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.error_fordeletetrainingdetail import ErrorFordeletetrainingdetail

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.delete_training_detail_parameter import DeleteTrainingDetailParameter as DeleteTrainingDetailParameterPydantic
from people_hr_python_sdk.pydantic.error_fordeletetrainingdetail import ErrorFordeletetrainingdetail as ErrorFordeletetrainingdetailPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = DeleteTrainingDetailParameterSchema


request_body_delete_training_detail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorFordeletetrainingdetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorFordeletetrainingdetail
...
class BaseApi(api_client.Api):
    ...
    def _remove_detail_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        if training_id is not None:
            _body["TrainingId"] = training_id
        args.body = _body
        return args

    async def _aremove_detail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Training  -  deletetrainingdetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_delete_training_detail_parameter.serialize(body, content_type)
...
class RemoveDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_detail(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._remove_detail_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            training_id=training_id,
        )
        return await self._aremove_detail_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def remove_detail(
        ...
        return self._remove_detail_oapg(
            body=args.body,
        )

class RemoveDetail(BaseApi):
    ...
    async def aremove_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorFordeletetrainingdetailPydantic:
        raw_response = await self.raw.aremove_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            training_id=training_id,
        ...
        if validate:
            return ErrorFordeletetrainingdetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorFordeletetrainingdetailPydantic, raw_response.body)
    ...
    def remove_detail(
        ...
        raw_response = self.raw.remove_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            training_id=training_id,
