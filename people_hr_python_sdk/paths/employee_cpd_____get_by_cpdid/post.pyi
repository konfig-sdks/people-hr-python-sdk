...
from people_hr_python_sdk.model.get_by_cpdid_parameter import GetByCPDIdParameter as GetByCPDIdParameterSchema
from people_hr_python_sdk.model.error_for_get_by_cpdid import ErrorForGetByCPDId as ErrorForGetByCPDIdSchema

from people_hr_python_sdk.type.error_for_get_by_cpdid import ErrorForGetByCPDId
from people_hr_python_sdk.type.get_by_cpdid_parameter import GetByCPDIdParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.get_by_cpdid_parameter import GetByCPDIdParameter as GetByCPDIdParameterPydantic
from people_hr_python_sdk.pydantic.error_for_get_by_cpdid import ErrorForGetByCPDId as ErrorForGetByCPDIdPydantic
...
# body param
SchemaForRequestBodyApplicationJson = GetByCPDIdParameterSchema


request_body_get_by_cpdid_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetByCPDIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetByCPDId
...
class BaseApi(api_client.Api):
    ...
    def _get_by_cpd_id_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aget_by_cpd_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee CPD  -  GetByCPDId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_by_cpdid_parameter.serialize(body, content_type)
...
class GetByCpdIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_cpd_id(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._get_by_cpd_id_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            cpdid=cpdid,
        )
        return await self._aget_by_cpd_id_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def get_by_cpd_id(
        ...
        return self._get_by_cpd_id_oapg(
            body=args.body,
        )

class GetByCpdId(BaseApi):
    ...
    async def aget_by_cpd_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetByCPDIdPydantic:
        raw_response = await self.raw.aget_by_cpd_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            cpdid=cpdid,
        ...
        if validate:
            return ErrorForGetByCPDIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetByCPDIdPydantic, raw_response.body)
    ...
    def get_by_cpd_id(
        ...
        raw_response = self.raw.get_by_cpd_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            cpdid=cpdid,
