...
from people_hr_python_sdk.model.deleterighttoworkdetail_parameter import DeleterighttoworkdetailParameter as DeleterighttoworkdetailParameterSchema
from people_hr_python_sdk.model.error_fordeleterighttoworkdetail import ErrorFordeleterighttoworkdetail as ErrorFordeleterighttoworkdetailSchema

from people_hr_python_sdk.type.error_fordeleterighttoworkdetail import ErrorFordeleterighttoworkdetail
from people_hr_python_sdk.type.deleterighttoworkdetail_parameter import DeleterighttoworkdetailParameter
...
from people_hr_python_sdk.pydantic.deleterighttoworkdetail_parameter import DeleterighttoworkdetailParameter as DeleterighttoworkdetailParameterPydantic
from people_hr_python_sdk.pydantic.error_fordeleterighttoworkdetail import ErrorFordeleterighttoworkdetail as ErrorFordeleterighttoworkdetailPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = DeleterighttoworkdetailParameterSchema


request_body_deleterighttoworkdetail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorFordeleterighttoworkdetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorFordeleterighttoworkdetail
    ...
    async def _adelete_detail_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Right To Work  -  deleterighttoworkdetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_deleterighttoworkdetail_parameter.serialize(body, content_type)
...
class DeleteDetail(BaseApi):
    ...
    async def adelete_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorFordeleterighttoworkdetailPydantic:
        ...
        if validate:
            return ErrorFordeleterighttoworkdetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorFordeleterighttoworkdetailPydantic, raw_response.body)
