...
from people_hr_python_sdk.model.error_for_update_training_detail import ErrorForUpdateTrainingDetail as ErrorForUpdateTrainingDetailSchema
from people_hr_python_sdk.model.update_training_detail_parameter import UpdateTrainingDetailParameter as UpdateTrainingDetailParameterSchema
from people_hr_python_sdk.model.byte import Byte as ByteSchema
from people_hr_python_sdk.model.add_files_for_employee_training import AddFilesForEmployeeTraining as AddFilesForEmployeeTrainingSchema
from people_hr_python_sdk.model.custom_columns_for_employee_training import CustomColumnsForEmployeeTraining as CustomColumnsForEmployeeTrainingSchema

from people_hr_python_sdk.type.update_training_detail_parameter import UpdateTrainingDetailParameter
from people_hr_python_sdk.type.error_for_update_training_detail import ErrorForUpdateTrainingDetail
from people_hr_python_sdk.type.add_files_for_employee_training import AddFilesForEmployeeTraining
from people_hr_python_sdk.type.custom_columns_for_employee_training import CustomColumnsForEmployeeTraining
...
from people_hr_python_sdk.pydantic.error_for_update_training_detail import ErrorForUpdateTrainingDetail as ErrorForUpdateTrainingDetailPydantic
from people_hr_python_sdk.pydantic.update_training_detail_parameter import UpdateTrainingDetailParameter as UpdateTrainingDetailParameterPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.add_files_for_employee_training import AddFilesForEmployeeTraining as AddFilesForEmployeeTrainingPydantic
from people_hr_python_sdk.pydantic.byte import Byte as BytePydantic
from people_hr_python_sdk.pydantic.custom_columns_for_employee_training import CustomColumnsForEmployeeTraining as CustomColumnsForEmployeeTrainingPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = UpdateTrainingDetailParameterSchema


request_body_update_training_detail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUpdateTrainingDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUpdateTrainingDetail
...
class BaseApi(api_client.Api):
    ...
    def _update_training_detail_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        importance: int,
        status: int,
        in_progress: typing.Optional[Byte] = None,
        training_date: typing.Optional[date] = None,
        trainind_end_date: typing.Optional[date] = None,
        training_expiry_date: typing.Optional[date] = None,
        cost: typing.Optional[str] = None,
        provider: typing.Optional[str] = None,
        notes: typing.Optional[str] = None,
        custom_columns: typing.Optional[CustomColumnsForEmployeeTraining] = None,
        add_files: typing.Optional[AddFilesForEmployeeTraining] = None,
        ...
        if training_type is not None:
            _body["TrainingType"] = training_type
        if description is not None:
            _body["Description"] = description
        if importance is not None:
            _body["Importance"] = importance
        if status is not None:
            _body["Status"] = status
        if in_progress is not None:
            _body["InProgress"] = in_progress
        if training_date is not None:
            _body["TrainingDate"] = training_date
        if trainind_end_date is not None:
            _body["TrainindEndDate"] = trainind_end_date
        if training_expiry_date is not None:
            _body["TrainingExpiryDate"] = training_expiry_date
        if cost is not None:
            _body["Cost"] = cost
    ...
    async def _aupdate_training_detail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Training  -  updatetrainingdetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_training_detail_parameter.serialize(body, content_type)
    ...
    def _update_training_detail_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateTrainingDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_training_detail(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._update_training_detail_mapped_args(
            api_key=api_key,
            action=action,
            ...
            trainind_end_date=trainind_end_date,
        ...
        return await self._aupdate_training_detail_oapg(
            body=args.body,
            **kwargs,
        )
    
    def update_training_detail(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._update_training_detail_oapg(
            body=args.body,
        )

class UpdateTrainingDetail(BaseApi):
    ...
    async def aupdate_training_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForUpdateTrainingDetailPydantic:
        raw_response = await self.raw.aupdate_training_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            training_type=training_type,
        ...
        if validate:
            return ErrorForUpdateTrainingDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUpdateTrainingDetailPydantic, raw_response.body)
    ...
    def update_training_detail(
        ...
        raw_response = self.raw.update_training_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            training_type=training_type,
