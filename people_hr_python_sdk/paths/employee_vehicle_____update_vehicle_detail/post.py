...
from people_hr_python_sdk.model.custom_columns_for_employee_vehicle_update_array import CustomColumnsForEmployeeVehicleUpdateArray as CustomColumnsForEmployeeVehicleUpdateArraySchema
from people_hr_python_sdk.model.error_for_update_vehicle_detail import ErrorForUpdateVehicleDetail as ErrorForUpdateVehicleDetailSchema
from people_hr_python_sdk.model.add_files_for_employee_vehicle_update_array import AddFilesForEmployeeVehicleUpdateArray as AddFilesForEmployeeVehicleUpdateArraySchema
from people_hr_python_sdk.model.update_vehicle_detail_definition import UpdateVehicleDetailDefinition as UpdateVehicleDetailDefinitionSchema

from people_hr_python_sdk.type.add_files_for_employee_vehicle_update_array import AddFilesForEmployeeVehicleUpdateArray
from people_hr_python_sdk.type.update_vehicle_detail_definition import UpdateVehicleDetailDefinition
from people_hr_python_sdk.type.custom_columns_for_employee_vehicle_update_array import CustomColumnsForEmployeeVehicleUpdateArray
from people_hr_python_sdk.type.error_for_update_vehicle_detail import ErrorForUpdateVehicleDetail
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_update_vehicle_detail import ErrorForUpdateVehicleDetail as ErrorForUpdateVehicleDetailPydantic
from people_hr_python_sdk.pydantic.custom_columns_for_employee_vehicle_update_array import CustomColumnsForEmployeeVehicleUpdateArray as CustomColumnsForEmployeeVehicleUpdateArrayPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.update_vehicle_detail_definition import UpdateVehicleDetailDefinition as UpdateVehicleDetailDefinitionPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic
from people_hr_python_sdk.pydantic.add_files_for_employee_vehicle_update_array import AddFilesForEmployeeVehicleUpdateArray as AddFilesForEmployeeVehicleUpdateArrayPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = UpdateVehicleDetailDefinitionSchema


request_body_update_vehicle_detail_definition = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUpdateVehicleDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUpdateVehicleDetail
...
class BaseApi(api_client.Api):
    ...
    def _update_detail_mapped_args(
        ...
        custom_columns: typing.Optional[CustomColumnsForEmployeeVehicleUpdateArray] = None,
        add_files: typing.Optional[AddFilesForEmployeeVehicleUpdateArray] = None,
    ...
    async def _aupdate_detail_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Vehicle  -  UpdateVehicleDetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_vehicle_detail_definition.serialize(body, content_type)
...
class UpdateDetail(BaseApi):
    ...
    async def aupdate_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForUpdateVehicleDetailPydantic:
        ...
        if validate:
            return ErrorForUpdateVehicleDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUpdateVehicleDetailPydantic, raw_response.body)
