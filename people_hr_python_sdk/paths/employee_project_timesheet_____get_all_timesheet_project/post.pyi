...
from people_hr_python_sdk.model.error_for_get_all_timesheet_project import ErrorForGetAllTimesheetProject as ErrorForGetAllTimesheetProjectSchema
from people_hr_python_sdk.model.get_all_timesheet_project_parameter import GetAllTimesheetProjectParameter as GetAllTimesheetProjectParameterSchema

from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.get_all_timesheet_project_parameter import GetAllTimesheetProjectParameter
from people_hr_python_sdk.type.error_for_get_all_timesheet_project import ErrorForGetAllTimesheetProject

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_get_all_timesheet_project import ErrorForGetAllTimesheetProject as ErrorForGetAllTimesheetProjectPydantic
from people_hr_python_sdk.pydantic.get_all_timesheet_project_parameter import GetAllTimesheetProjectParameter as GetAllTimesheetProjectParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = GetAllTimesheetProjectParameterSchema


request_body_get_all_timesheet_project_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetAllTimesheetProjectSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetAllTimesheetProject
...
class BaseApi(api_client.Api):
    ...
    def _list_all_timesheet_project_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _alist_all_timesheet_project_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Project Timesheet  -  GetAllTimesheetProject',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_all_timesheet_project_parameter.serialize(body, content_type)
    ...
    def _list_all_timesheet_project_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListAllTimesheetProjectRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_all_timesheet_project(
        self,
        api_key: APIKey,
        action: str,
        project_name: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_all_timesheet_project_mapped_args(
            api_key=api_key,
            action=action,
            project_name=project_name,
        )
        return await self._alist_all_timesheet_project_oapg(
            body=args.body,
            **kwargs,
        )
    
    def list_all_timesheet_project(
        self,
        api_key: APIKey,
        action: str,
        project_name: typing.Optional[str] = None,
        ...
        return self._list_all_timesheet_project_oapg(
            body=args.body,
        )

class ListAllTimesheetProject(BaseApi):
    ...
    async def alist_all_timesheet_project(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetAllTimesheetProjectPydantic:
        raw_response = await self.raw.alist_all_timesheet_project(
            api_key=api_key,
            action=action,
            project_name=project_name,
            **kwargs,
        ...
        if validate:
            return ErrorForGetAllTimesheetProjectPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetAllTimesheetProjectPydantic, raw_response.body)
    ...
    def list_all_timesheet_project(
        ...
        raw_response = self.raw.list_all_timesheet_project(
            api_key=api_key,
            action=action,
            project_name=project_name,
        )
