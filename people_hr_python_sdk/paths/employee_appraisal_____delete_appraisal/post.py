...
from people_hr_python_sdk.model.error_for_delete_appraisal import ErrorForDeleteAppraisal as ErrorForDeleteAppraisalSchema
from people_hr_python_sdk.model.delete_appraisal_parameter import DeleteAppraisalParameter as DeleteAppraisalParameterSchema
...
from people_hr_python_sdk.type.delete_appraisal_parameter import DeleteAppraisalParameter
from people_hr_python_sdk.type.error_for_delete_appraisal import ErrorForDeleteAppraisal

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_delete_appraisal import ErrorForDeleteAppraisal as ErrorForDeleteAppraisalPydantic
...
from people_hr_python_sdk.pydantic.delete_appraisal_parameter import DeleteAppraisalParameter as DeleteAppraisalParameterPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = DeleteAppraisalParameterSchema


request_body_delete_appraisal_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForDeleteAppraisalSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForDeleteAppraisal
...
class BaseApi(api_client.Api):
    ...
    def _delete_appraisal_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _adelete_appraisal_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeAppraisal  -  DeleteAppraisal',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_delete_appraisal_parameter.serialize(body, content_type)
...
class DeleteAppraisalRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_appraisal(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._delete_appraisal_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            appraisal_id=appraisal_id,
        )
        return await self._adelete_appraisal_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def delete_appraisal(
        ...
        return self._delete_appraisal_oapg(
            body=args.body,
        )

class DeleteAppraisal(BaseApi):
    ...
    async def adelete_appraisal(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForDeleteAppraisalPydantic:
        raw_response = await self.raw.adelete_appraisal(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            appraisal_id=appraisal_id,
        ...
        if validate:
            return ErrorForDeleteAppraisalPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForDeleteAppraisalPydantic, raw_response.body)
    ...
    def delete_appraisal(
        ...
        raw_response = self.raw.delete_appraisal(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            appraisal_id=appraisal_id,
