...
from people_hr_python_sdk.model.old_employee_id import OldEmployeeId as OldEmployeeIdSchema
from people_hr_python_sdk.model.update_employee_id2 import UpdateEmployeeId2 as UpdateEmployeeId2Schema
from people_hr_python_sdk.model.error_for_update_employee_id import ErrorForUpdateEmployeeId as ErrorForUpdateEmployeeIdSchema
from people_hr_python_sdk.model.reason_for_change import ReasonForChange as ReasonForChangeSchema
from people_hr_python_sdk.model.new_employee_id import NewEmployeeId as NewEmployeeIdSchema

from people_hr_python_sdk.type.old_employee_id import OldEmployeeId
from people_hr_python_sdk.type.error_for_update_employee_id import ErrorForUpdateEmployeeId
from people_hr_python_sdk.type.reason_for_change import ReasonForChange
from people_hr_python_sdk.type.update_employee_id2 import UpdateEmployeeId2
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.new_employee_id import NewEmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.old_employee_id import OldEmployeeId as OldEmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_update_employee_id import ErrorForUpdateEmployeeId as ErrorForUpdateEmployeeIdPydantic
from people_hr_python_sdk.pydantic.new_employee_id import NewEmployeeId as NewEmployeeIdPydantic
from people_hr_python_sdk.pydantic.reason_for_change import ReasonForChange as ReasonForChangePydantic
from people_hr_python_sdk.pydantic.update_employee_id2 import UpdateEmployeeId2 as UpdateEmployeeId2Pydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = UpdateEmployeeId2Schema


request_body_update_employee_id2 = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUpdateEmployeeIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUpdateEmployeeId
...
class BaseApi(api_client.Api):
    ...
    def _update_employee_id_details_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        if reason_for_change is not None:
            _body["ReasonForChange"] = reason_for_change
        if old_employee_id is not None:
            _body["OldEmployeeId"] = old_employee_id
        if new_employee_id is not None:
            _body["NewEmployeeId"] = new_employee_id
        args.body = _body
        return args

    async def _aupdate_employee_id_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee  -  UpdateEmployeeId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_employee_id2.serialize(body, content_type)
    ...
    def _update_employee_id_details_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateEmployeeIdDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_employee_id_details(
        self,
        api_key: APIKey,
        action: str,
        reason_for_change: ReasonForChange,
        ...
        **kwargs,
        ...
        args = self._update_employee_id_details_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aupdate_employee_id_details_oapg(
            body=args.body,
            **kwargs,
        )
    
    def update_employee_id_details(
        self,
        api_key: APIKey,
        action: str,
        reason_for_change: ReasonForChange,
        ...
        return self._update_employee_id_details_oapg(
            body=args.body,
        )

class UpdateEmployeeIdDetails(BaseApi):
    ...
    async def aupdate_employee_id_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForUpdateEmployeeIdPydantic:
        raw_response = await self.raw.aupdate_employee_id_details(
            api_key=api_key,
            action=action,
            reason_for_change=reason_for_change,
            old_employee_id=old_employee_id,
        ...
        if validate:
            return ErrorForUpdateEmployeeIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUpdateEmployeeIdPydantic, raw_response.body)
    ...
    def update_employee_id_details(
        ...
        raw_response = self.raw.update_employee_id_details(
            api_key=api_key,
            action=action,
            reason_for_change=reason_for_change,
            old_employee_id=old_employee_id,
