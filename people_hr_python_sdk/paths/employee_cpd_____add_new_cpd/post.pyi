...
from people_hr_python_sdk.model.addnew_cpd_parameter import AddnewCPDParameter as AddnewCPDParameterSchema
from people_hr_python_sdk.model.error_for_add_new_cpd import ErrorForAddNewCPD as ErrorForAddNewCPDSchema
...
from people_hr_python_sdk.type.addnew_cpd_parameter import AddnewCPDParameter
from people_hr_python_sdk.type.error_for_add_new_cpd import ErrorForAddNewCPD
...
from people_hr_python_sdk.pydantic.error_for_add_new_cpd import ErrorForAddNewCPD as ErrorForAddNewCPDPydantic
...
from people_hr_python_sdk.pydantic.addnew_cpd_parameter import AddnewCPDParameter as AddnewCPDParameterPydantic
...
# body param
SchemaForRequestBodyApplicationJson = AddnewCPDParameterSchema


request_body_addnew_cpd_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForAddNewCPDSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForAddNewCPD
...
class BaseApi(api_client.Api):
    ...
    def _create_new_cpd_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        activity: str,
        start_date: date,
        custom_columns: CustomColumnsArrayForEmployeeCPD,
        add_files: AddFilesArrayForEmployeeCPD,
    ...
    async def _acreate_new_cpd_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee CPD  -  AddNewCPD',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_addnew_cpd_parameter.serialize(body, content_type)
...
class CreateNewCpdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_cpd(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._create_new_cpd_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._acreate_new_cpd_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_new_cpd(
        ...
        return self._create_new_cpd_oapg(
            body=args.body,
        )

class CreateNewCpd(BaseApi):
    ...
    async def acreate_new_cpd(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForAddNewCPDPydantic:
        raw_response = await self.raw.acreate_new_cpd(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            activity=activity,
        ...
        if validate:
            return ErrorForAddNewCPDPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForAddNewCPDPydantic, raw_response.body)
    ...
    def create_new_cpd(
        ...
        raw_response = self.raw.create_new_cpd(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            activity=activity,
