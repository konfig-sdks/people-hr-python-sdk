...
from people_hr_python_sdk.model.error_forgetothereventdetail import ErrorForgetothereventdetail as ErrorForgetothereventdetailSchema
from people_hr_python_sdk.model.getothereventdetail_parameter import GetothereventdetailParameter as GetothereventdetailParameterSchema

from people_hr_python_sdk.type.getothereventdetail_parameter import GetothereventdetailParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.error_forgetothereventdetail import ErrorForgetothereventdetail

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_forgetothereventdetail import ErrorForgetothereventdetail as ErrorForgetothereventdetailPydantic
from people_hr_python_sdk.pydantic.getothereventdetail_parameter import GetothereventdetailParameter as GetothereventdetailParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = GetothereventdetailParameterSchema


request_body_getothereventdetail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForgetothereventdetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForgetothereventdetail
    ...
    async def _aget_detail_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Other Event  -  getothereventdetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_getothereventdetail_parameter.serialize(body, content_type)
...
class GetDetail(BaseApi):
    ...
    async def aget_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForgetothereventdetailPydantic:
        ...
        if validate:
            return ErrorForgetothereventdetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForgetothereventdetailPydantic, raw_response.body)
