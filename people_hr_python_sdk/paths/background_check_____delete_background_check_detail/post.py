...
from people_hr_python_sdk.model.delete_background_check_detail_parameter import DeleteBackgroundCheckDetailParameter as DeleteBackgroundCheckDetailParameterSchema
from people_hr_python_sdk.model.error_for_delete_background_check_detail import ErrorForDeleteBackgroundCheckDetail as ErrorForDeleteBackgroundCheckDetailSchema

from people_hr_python_sdk.type.error_for_delete_background_check_detail import ErrorForDeleteBackgroundCheckDetail
from people_hr_python_sdk.type.delete_background_check_detail_parameter import DeleteBackgroundCheckDetailParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_delete_background_check_detail import ErrorForDeleteBackgroundCheckDetail as ErrorForDeleteBackgroundCheckDetailPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.delete_background_check_detail_parameter import DeleteBackgroundCheckDetailParameter as DeleteBackgroundCheckDetailParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = DeleteBackgroundCheckDetailParameterSchema


request_body_delete_background_check_detail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForDeleteBackgroundCheckDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForDeleteBackgroundCheckDetail
...
class BaseApi(api_client.Api):
    ...
    def _delete_detail_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        if background_check_txn_id is not None:
            _body["BackgroundCheckTxnId"] = background_check_txn_id
        args.body = _body
        return args

    async def _adelete_detail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Background Check  -  DeleteBackgroundCheckDetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_delete_background_check_detail_parameter.serialize(body, content_type)
...
class DeleteDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_detail(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._delete_detail_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            background_check_txn_id=background_check_txn_id,
        )
        return await self._adelete_detail_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def delete_detail(
        ...
        return self._delete_detail_oapg(
            body=args.body,
        )

class DeleteDetail(BaseApi):
    ...
    async def adelete_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForDeleteBackgroundCheckDetailPydantic:
        raw_response = await self.raw.adelete_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            background_check_txn_id=background_check_txn_id,
        ...
        if validate:
            return ErrorForDeleteBackgroundCheckDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForDeleteBackgroundCheckDetailPydantic, raw_response.body)
    ...
    def delete_detail(
        ...
        raw_response = self.raw.delete_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            background_check_txn_id=background_check_txn_id,
