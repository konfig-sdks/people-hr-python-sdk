...
from people_hr_python_sdk.model.update_qualification_parameter import UpdateQualificationParameter as UpdateQualificationParameterSchema
from people_hr_python_sdk.model.add_files_for_employee_qualification import AddFilesForEmployeeQualification as AddFilesForEmployeeQualificationSchema
from people_hr_python_sdk.model.custom_columns_for_employee_qualification import CustomColumnsForEmployeeQualification as CustomColumnsForEmployeeQualificationSchema
from people_hr_python_sdk.model.error_for_update_qualification import ErrorForUpdateQualification as ErrorForUpdateQualificationSchema

from people_hr_python_sdk.type.error_for_update_qualification import ErrorForUpdateQualification
from people_hr_python_sdk.type.update_qualification_parameter import UpdateQualificationParameter
from people_hr_python_sdk.type.add_files_for_employee_qualification import AddFilesForEmployeeQualification
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.custom_columns_for_employee_qualification import CustomColumnsForEmployeeQualification

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.update_qualification_parameter import UpdateQualificationParameter as UpdateQualificationParameterPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.custom_columns_for_employee_qualification import CustomColumnsForEmployeeQualification as CustomColumnsForEmployeeQualificationPydantic
from people_hr_python_sdk.pydantic.error_for_update_qualification import ErrorForUpdateQualification as ErrorForUpdateQualificationPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic
from people_hr_python_sdk.pydantic.add_files_for_employee_qualification import AddFilesForEmployeeQualification as AddFilesForEmployeeQualificationPydantic

# body param
SchemaForRequestBodyApplicationJson = UpdateQualificationParameterSchema


request_body_update_qualification_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUpdateQualificationSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUpdateQualification
...
class BaseApi(api_client.Api):
    ...
    def _update_qualification_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        date_passed: typing.Optional[date] = None,
        expiry_date: typing.Optional[date] = None,
        comments: typing.Optional[str] = None,
        custom_columns: typing.Optional[CustomColumnsForEmployeeQualification] = None,
        add_files: typing.Optional[AddFilesForEmployeeQualification] = None,
        ...
        if qualification_id is not None:
            _body["QualificationId"] = qualification_id
        if qualification is not None:
            _body["Qualification"] = qualification
        if subject is not None:
            _body["Subject"] = subject
        if date_passed is not None:
            _body["DatePassed"] = date_passed
    ...
    async def _aupdate_qualification_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Qualification  -  UpdateQualification',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_qualification_parameter.serialize(body, content_type)
    ...
    def _update_qualification_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateQualificationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_qualification(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._update_qualification_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aupdate_qualification_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def update_qualification(
        ...
        return self._update_qualification_oapg(
            body=args.body,
        )

class UpdateQualification(BaseApi):
    ...
    async def aupdate_qualification(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForUpdateQualificationPydantic:
        raw_response = await self.raw.aupdate_qualification(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            qualification_id=qualification_id,
        ...
        if validate:
            return ErrorForUpdateQualificationPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUpdateQualificationPydantic, raw_response.body)
    ...
    def update_qualification(
        ...
        raw_response = self.raw.update_qualification(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            qualification_id=qualification_id,
