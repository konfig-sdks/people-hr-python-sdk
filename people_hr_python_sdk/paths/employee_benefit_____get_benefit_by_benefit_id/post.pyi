...
from people_hr_python_sdk.model.error_for_get_by_benefit_id_api import ErrorForGetByBenefitIdApi as ErrorForGetByBenefitIdApiSchema
from people_hr_python_sdk.model.get_by_benefit_id_parameter import GetByBenefitIdParameter as GetByBenefitIdParameterSchema

from people_hr_python_sdk.type.error_for_get_by_benefit_id_api import ErrorForGetByBenefitIdApi
from people_hr_python_sdk.type.get_by_benefit_id_parameter import GetByBenefitIdParameter
...
from people_hr_python_sdk.pydantic.error_for_get_by_benefit_id_api import ErrorForGetByBenefitIdApi as ErrorForGetByBenefitIdApiPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic
from people_hr_python_sdk.pydantic.get_by_benefit_id_parameter import GetByBenefitIdParameter as GetByBenefitIdParameterPydantic

# body param
SchemaForRequestBodyApplicationJson = GetByBenefitIdParameterSchema


request_body_get_by_benefit_id_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetByBenefitIdApiSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetByBenefitIdApi
...
class BaseApi(api_client.Api):
    ...
    def _get_by_benefit_id_details_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aget_by_benefit_id_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeBenefit  -  GetBenefitByBenefitId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_by_benefit_id_parameter.serialize(body, content_type)
    ...
    def _get_by_benefit_id_details_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetByBenefitIdDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_benefit_id_details(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._get_by_benefit_id_details_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            benefit_id=benefit_id,
        )
        return await self._aget_by_benefit_id_details_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_by_benefit_id_details(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._get_by_benefit_id_details_oapg(
            body=args.body,
        )

class GetByBenefitIdDetails(BaseApi):
    ...
    async def aget_by_benefit_id_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetByBenefitIdApiPydantic:
        raw_response = await self.raw.aget_by_benefit_id_details(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            benefit_id=benefit_id,
        ...
        if validate:
            return ErrorForGetByBenefitIdApiPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetByBenefitIdApiPydantic, raw_response.body)
    ...
    def get_by_benefit_id_details(
        ...
        raw_response = self.raw.get_by_benefit_id_details(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            benefit_id=benefit_id,
