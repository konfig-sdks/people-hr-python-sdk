...
from people_hr_python_sdk.model.error_for_update_benefit_api import ErrorForUpdateBenefitApi as ErrorForUpdateBenefitApiSchema
from people_hr_python_sdk.model.update_benefit_parameter import UpdateBenefitParameter as UpdateBenefitParameterSchema
from people_hr_python_sdk.model.recover_on_termination import RecoverOnTermination as RecoverOnTerminationSchema
from people_hr_python_sdk.model.add_files_array_for_update_benefit import AddFilesArrayForUpdateBenefit as AddFilesArrayForUpdateBenefitSchema

from people_hr_python_sdk.type.add_files_array_for_update_benefit import AddFilesArrayForUpdateBenefit
from people_hr_python_sdk.type.recover_on_termination import RecoverOnTermination
from people_hr_python_sdk.type.update_benefit_parameter import UpdateBenefitParameter
...
from people_hr_python_sdk.type.error_for_update_benefit_api import ErrorForUpdateBenefitApi

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.update_benefit_parameter import UpdateBenefitParameter as UpdateBenefitParameterPydantic
from people_hr_python_sdk.pydantic.add_files_array_for_update_benefit import AddFilesArrayForUpdateBenefit as AddFilesArrayForUpdateBenefitPydantic
...
from people_hr_python_sdk.pydantic.error_for_update_benefit_api import ErrorForUpdateBenefitApi as ErrorForUpdateBenefitApiPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateBenefitParameterSchema


request_body_update_benefit_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUpdateBenefitApiSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUpdateBenefitApi
...
class BaseApi(api_client.Api):
    ...
    def _update_details_mapped_args(
        ...
        custom_columns: typing.Optional[CustomColumnsArrayForAddNewBenefit] = None,
        add_files: typing.Optional[AddFilesArrayForUpdateBenefit] = None,
    ...
    async def _aupdate_details_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeBenefit  -  UpdateBenefit',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_benefit_parameter.serialize(body, content_type)
...
class UpdateDetails(BaseApi):
    ...
    async def aupdate_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForUpdateBenefitApiPydantic:
        ...
        if validate:
            return ErrorForUpdateBenefitApiPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUpdateBenefitApiPydantic, raw_response.body)
