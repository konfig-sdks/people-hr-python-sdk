...
from people_hr_python_sdk.model.update_next_year_holiday_entitlement_parameter import UpdateNextYearHolidayEntitlementParameter as UpdateNextYearHolidayEntitlementParameterSchema
from people_hr_python_sdk.model.reason_for_change import ReasonForChange as ReasonForChangeSchema
from people_hr_python_sdk.model.error_for_update_next_year_holiday_entitlement import ErrorForUpdateNextYearHolidayEntitlement as ErrorForUpdateNextYearHolidayEntitlementSchema

from people_hr_python_sdk.type.error_for_update_next_year_holiday_entitlement import ErrorForUpdateNextYearHolidayEntitlement
...
from people_hr_python_sdk.type.update_next_year_holiday_entitlement_parameter import UpdateNextYearHolidayEntitlementParameter
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_update_next_year_holiday_entitlement import ErrorForUpdateNextYearHolidayEntitlement as ErrorForUpdateNextYearHolidayEntitlementPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.update_next_year_holiday_entitlement_parameter import UpdateNextYearHolidayEntitlementParameter as UpdateNextYearHolidayEntitlementParameterPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateNextYearHolidayEntitlementParameterSchema


request_body_update_next_year_holiday_entitlement_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUpdateNextYearHolidayEntitlementSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUpdateNextYearHolidayEntitlement
...
class BaseApi(api_client.Api):
    ...
    def _update_next_year_entitlement_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aupdate_next_year_entitlement_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Holiday Entitlement  -  UpdateNextYearHolidayEntitlement',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_next_year_holiday_entitlement_parameter.serialize(body, content_type)
    ...
    def _update_next_year_entitlement_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateNextYearEntitlementRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_next_year_entitlement(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._update_next_year_entitlement_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aupdate_next_year_entitlement_oapg(
            body=args.body,
            **kwargs,
        )
    
    def update_next_year_entitlement(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._update_next_year_entitlement_oapg(
            body=args.body,
        )

class UpdateNextYearEntitlement(BaseApi):
    ...
    async def aupdate_next_year_entitlement(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForUpdateNextYearHolidayEntitlementPydantic:
        raw_response = await self.raw.aupdate_next_year_entitlement(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            reason_for_change=reason_for_change,
        ...
        if validate:
            return ErrorForUpdateNextYearHolidayEntitlementPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUpdateNextYearHolidayEntitlementPydantic, raw_response.body)
    ...
    def update_next_year_entitlement(
        ...
        raw_response = self.raw.update_next_year_entitlement(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            reason_for_change=reason_for_change,
