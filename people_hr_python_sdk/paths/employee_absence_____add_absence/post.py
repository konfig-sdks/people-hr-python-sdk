...
from people_hr_python_sdk.model.part_of_day import PartOfDay as PartOfDaySchema
...
from people_hr_python_sdk.model.add_absence_of_employee_parameter import AddAbsenceOfEmployeeParameter as AddAbsenceOfEmployeeParameterSchema
...
from people_hr_python_sdk.model.error_for_add_employee_absence import ErrorForAddEmployeeAbsence as ErrorForAddEmployeeAbsenceSchema

from people_hr_python_sdk.type.add_comments_array_for_absence import AddCommentsArrayForAbsence
from people_hr_python_sdk.type.error_for_add_employee_absence import ErrorForAddEmployeeAbsence
from people_hr_python_sdk.type.emergency_leave import EmergencyLeave
from people_hr_python_sdk.type.add_absence_of_employee_parameter import AddAbsenceOfEmployeeParameter
from people_hr_python_sdk.type.part_of_day import PartOfDay
...
from people_hr_python_sdk.pydantic.part_of_day import PartOfDay as PartOfDayPydantic
...
from people_hr_python_sdk.pydantic.error_for_add_employee_absence import ErrorForAddEmployeeAbsence as ErrorForAddEmployeeAbsencePydantic
from people_hr_python_sdk.pydantic.add_absence_of_employee_parameter import AddAbsenceOfEmployeeParameter as AddAbsenceOfEmployeeParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = AddAbsenceOfEmployeeParameterSchema


request_body_add_absence_of_employee_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForAddEmployeeAbsenceSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForAddEmployeeAbsence
...
class BaseApi(api_client.Api):
    ...
    def _create_new_absence_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _acreate_new_absence_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeAbsence  -  AddAbsence',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_add_absence_of_employee_parameter.serialize(body, content_type)
...
class CreateNewAbsenceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_absence(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._create_new_absence_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._acreate_new_absence_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_new_absence(
        ...
        return self._create_new_absence_oapg(
            body=args.body,
        )

class CreateNewAbsence(BaseApi):
    ...
    async def acreate_new_absence(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForAddEmployeeAbsencePydantic:
        raw_response = await self.raw.acreate_new_absence(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            duration_type=duration_type,
        ...
        if validate:
            return ErrorForAddEmployeeAbsencePydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForAddEmployeeAbsencePydantic, raw_response.body)
    ...
    def create_new_absence(
        ...
        raw_response = self.raw.create_new_absence(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            duration_type=duration_type,
