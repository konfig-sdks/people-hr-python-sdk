...
from people_hr_python_sdk.model.add_new_holiday_parameter import AddNewHolidayParameter as AddNewHolidayParameterSchema
from people_hr_python_sdk.model.error_for_add_new_holiday import ErrorForAddNewHoliday as ErrorForAddNewHolidaySchema

from people_hr_python_sdk.type.part_of_day import PartOfDay
from people_hr_python_sdk.type.error_for_add_new_holiday import ErrorForAddNewHoliday
from people_hr_python_sdk.type.add_new_holiday_parameter import AddNewHolidayParameter
...
from people_hr_python_sdk.pydantic.add_new_holiday_parameter import AddNewHolidayParameter as AddNewHolidayParameterPydantic
...
from people_hr_python_sdk.pydantic.error_for_add_new_holiday import ErrorForAddNewHoliday as ErrorForAddNewHolidayPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = AddNewHolidayParameterSchema


request_body_add_new_holiday_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForAddNewHolidaySchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForAddNewHoliday
...
class BaseApi(api_client.Api):
    ...
    def _add_new_holiday_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        part_of_day: typing.Optional[PartOfDay] = None,
        ...
        if duration_in_minutes is not None:
            _body["DurationInMinutes"] = duration_in_minutes
    ...
    async def _aadd_new_holiday_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Holiday  -  AddNewHoliday',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_add_new_holiday_parameter.serialize(body, content_type)
...
class AddNewHolidayRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_new_holiday(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._add_new_holiday_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aadd_new_holiday_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def add_new_holiday(
        ...
        return self._add_new_holiday_oapg(
            body=args.body,
        )

class AddNewHoliday(BaseApi):
    ...
    async def aadd_new_holiday(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForAddNewHolidayPydantic:
        raw_response = await self.raw.aadd_new_holiday(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            duration_type=duration_type,
        ...
        if validate:
            return ErrorForAddNewHolidayPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForAddNewHolidayPydantic, raw_response.body)
    ...
    def add_new_holiday(
        ...
        raw_response = self.raw.add_new_holiday(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            duration_type=duration_type,
