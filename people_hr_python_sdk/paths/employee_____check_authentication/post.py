...
from people_hr_python_sdk.model.email_address import EmailAddress as EmailAddressSchema
from people_hr_python_sdk.model.check_authentication_result import CheckAuthenticationResult as CheckAuthenticationResultSchema
from people_hr_python_sdk.model.password import Password as PasswordSchema
from people_hr_python_sdk.model.check_authentication2 import CheckAuthentication2 as CheckAuthentication2Schema

from people_hr_python_sdk.type.password import Password
from people_hr_python_sdk.type.check_authentication_result import CheckAuthenticationResult
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.email_address import EmailAddress
from people_hr_python_sdk.type.check_authentication2 import CheckAuthentication2

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.check_authentication2 import CheckAuthentication2 as CheckAuthentication2Pydantic
from people_hr_python_sdk.pydantic.email_address import EmailAddress as EmailAddressPydantic
from people_hr_python_sdk.pydantic.password import Password as PasswordPydantic
from people_hr_python_sdk.pydantic.check_authentication_result import CheckAuthenticationResult as CheckAuthenticationResultPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = CheckAuthentication2Schema


request_body_check_authentication2 = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CheckAuthenticationResultSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CheckAuthenticationResult
...
class BaseApi(api_client.Api):
    ...
    def _authenticate_user_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aauthenticate_user_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee  -  CheckAuthentication',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_check_authentication2.serialize(body, content_type)
...
class AuthenticateUserRaw(BaseApi):
    ...
    async def aauthenticate_user(
        ...
        **kwargs,
        ...
        args = self._authenticate_user_mapped_args(
            api_key=api_key,
            action=action,
            email_address=email_address,
            password=password,
        )
        return await self._aauthenticate_user_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def authenticate_user(
        ...
        return self._authenticate_user_oapg(
            body=args.body,
        )

class AuthenticateUser(BaseApi):
    ...
    async def aauthenticate_user(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CheckAuthenticationResultPydantic:
        raw_response = await self.raw.aauthenticate_user(
            api_key=api_key,
            action=action,
            email_address=email_address,
            password=password,
        ...
        if validate:
            return CheckAuthenticationResultPydantic(**raw_response.body)
        return api_client.construct_model_instance(CheckAuthenticationResultPydantic, raw_response.body)
    ...
    def authenticate_user(
        ...
        raw_response = self.raw.authenticate_user(
            api_key=api_key,
            action=action,
            email_address=email_address,
            password=password,
