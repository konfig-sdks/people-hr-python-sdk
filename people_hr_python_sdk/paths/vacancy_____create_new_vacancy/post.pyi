...
from people_hr_python_sdk.model.create_vacancy_detail_parameter import CreateVacancyDetailParameter as CreateVacancyDetailParameterSchema
from people_hr_python_sdk.model.api_key import APIKey as APIKeySchema
from people_hr_python_sdk.model.comment import Comment as CommentSchema
from people_hr_python_sdk.model.is_resume_mandatory import IsResumeMandatory as IsResumeMandatorySchema
from people_hr_python_sdk.model.vacancy_type import VacancyType as VacancyTypeSchema
from people_hr_python_sdk.model.is_cover_letter_mandatory import IsCoverLetterMandatory as IsCoverLetterMandatorySchema
from people_hr_python_sdk.model.is_hide_salary import IsHideSalary as IsHideSalarySchema
from people_hr_python_sdk.model.company import Company as CompanySchema
from people_hr_python_sdk.model.error_for_create_new_vacancy import ErrorForCreateNewVacancy as ErrorForCreateNewVacancySchema

from people_hr_python_sdk.type.is_hide_salary import IsHideSalary
from people_hr_python_sdk.type.is_resume_mandatory import IsResumeMandatory
from people_hr_python_sdk.type.error_for_create_new_vacancy import ErrorForCreateNewVacancy
from people_hr_python_sdk.type.company import Company
from people_hr_python_sdk.type.vacancy_type import VacancyType
from people_hr_python_sdk.type.comment import Comment
from people_hr_python_sdk.type.is_cover_letter_mandatory import IsCoverLetterMandatory
from people_hr_python_sdk.type.create_vacancy_detail_parameter import CreateVacancyDetailParameter
from people_hr_python_sdk.type.api_key import APIKey

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_create_new_vacancy import ErrorForCreateNewVacancy as ErrorForCreateNewVacancyPydantic
from people_hr_python_sdk.pydantic.company import Company as CompanyPydantic
from people_hr_python_sdk.pydantic.vacancy_type import VacancyType as VacancyTypePydantic
from people_hr_python_sdk.pydantic.comment import Comment as CommentPydantic
from people_hr_python_sdk.pydantic.create_vacancy_detail_parameter import CreateVacancyDetailParameter as CreateVacancyDetailParameterPydantic
from people_hr_python_sdk.pydantic.is_cover_letter_mandatory import IsCoverLetterMandatory as IsCoverLetterMandatoryPydantic
from people_hr_python_sdk.pydantic.is_resume_mandatory import IsResumeMandatory as IsResumeMandatoryPydantic
from people_hr_python_sdk.pydantic.is_hide_salary import IsHideSalary as IsHideSalaryPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = CreateVacancyDetailParameterSchema


request_body_create_vacancy_detail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForCreateNewVacancySchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForCreateNewVacancy
...
class BaseApi(api_client.Api):
    ...
    def _add_new_vacancy_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        vacancy_name: str,
        ...
        closing_date: typing.Optional[date] = None,
        ...
        if vacancy_name is not None:
            _body["VacancyName"] = vacancy_name
        if vacancy_description is not None:
            _body["VacancyDescription"] = vacancy_description
        ...
        if closing_date is not None:
            _body["ClosingDate"] = closing_date
        ...
        if is_cover_letter_mandatory is not None:
            _body["IsCoverLetterMandatory"] = is_cover_letter_mandatory
        if is_resume_mandatory is not None:
            _body["IsResumeMandatory"] = is_resume_mandatory
        if is_hide_salary is not None:
            _body["IsHideSalary"] = is_hide_salary
        if vacancy_type is not None:
            _body["VacancyType"] = vacancy_type
    ...
    async def _aadd_new_vacancy_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Vacancy  -  CreateNewVacancy',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_create_vacancy_detail_parameter.serialize(body, content_type)
...
class AddNewVacancyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_new_vacancy(
        self,
        api_key: APIKey,
        action: str,
        vacancy_name: str,
        ...
        **kwargs,
        ...
        args = self._add_new_vacancy_mapped_args(
            api_key=api_key,
            action=action,
            vacancy_name=vacancy_name,
            vacancy_description=vacancy_description,
            reference=reference,
            is_cover_letter_mandatory=is_cover_letter_mandatory,
            is_resume_mandatory=is_resume_mandatory,
            is_hide_salary=is_hide_salary,
        ...
        return await self._aadd_new_vacancy_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def add_new_vacancy(
        ...
        return self._add_new_vacancy_oapg(
            body=args.body,
        )

class AddNewVacancy(BaseApi):
    ...
    async def aadd_new_vacancy(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForCreateNewVacancyPydantic:
        raw_response = await self.raw.aadd_new_vacancy(
            api_key=api_key,
            action=action,
            vacancy_name=vacancy_name,
            vacancy_description=vacancy_description,
        ...
        if validate:
            return ErrorForCreateNewVacancyPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForCreateNewVacancyPydantic, raw_response.body)
    ...
    def add_new_vacancy(
        ...
        raw_response = self.raw.add_new_vacancy(
            api_key=api_key,
            action=action,
            vacancy_name=vacancy_name,
            vacancy_description=vacancy_description,
