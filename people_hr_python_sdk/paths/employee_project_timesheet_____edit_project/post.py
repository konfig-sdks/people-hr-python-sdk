...
from people_hr_python_sdk.model.edit_project_parameter import EditProjectParameter as EditProjectParameterSchema
from people_hr_python_sdk.model.error_for_edit_project import ErrorForEditProject as ErrorForEditProjectSchema

from people_hr_python_sdk.type.edit_project_parameter import EditProjectParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.error_for_edit_project import ErrorForEditProject

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.edit_project_parameter import EditProjectParameter as EditProjectParameterPydantic
from people_hr_python_sdk.pydantic.error_for_edit_project import ErrorForEditProject as ErrorForEditProjectPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = EditProjectParameterSchema


request_body_edit_project_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForEditProjectSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForEditProject
...
class BaseApi(api_client.Api):
    ...
    def _edit_project_details_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        project_name: str,
        ...
        if new_project_name is not None:
            _body["NewProjectName"] = new_project_name
        if in_use is not None:
            _body["InUse"] = in_use
        args.body = _body
        return args

    async def _aedit_project_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Project Timesheet  -  EditProject',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_edit_project_parameter.serialize(body, content_type)
    ...
    def _edit_project_details_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class EditProjectDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aedit_project_details(
        self,
        api_key: APIKey,
        action: str,
        project_name: str,
        ...
        **kwargs,
        ...
        args = self._edit_project_details_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aedit_project_details_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def edit_project_details(
        ...
        return self._edit_project_details_oapg(
            body=args.body,
        )

class EditProjectDetails(BaseApi):
    ...
    async def aedit_project_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForEditProjectPydantic:
        raw_response = await self.raw.aedit_project_details(
            api_key=api_key,
            action=action,
            project_name=project_name,
            new_project_name=new_project_name,
        ...
        if validate:
            return ErrorForEditProjectPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForEditProjectPydantic, raw_response.body)
    ...
    def edit_project_details(
        ...
        raw_response = self.raw.edit_project_details(
            api_key=api_key,
            action=action,
            project_name=project_name,
            new_project_name=new_project_name,
