...
from people_hr_python_sdk.model.error_for_get_all_employee_detail import ErrorForGetAllEmployeeDetail as ErrorForGetAllEmployeeDetailSchema
from people_hr_python_sdk.model.get_all_employee_detail_parameter import GetAllEmployeeDetailParameter as GetAllEmployeeDetailParameterSchema
from people_hr_python_sdk.model.include_leavers import IncludeLeavers as IncludeLeaversSchema

from people_hr_python_sdk.type.get_all_employee_detail_parameter import GetAllEmployeeDetailParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.error_for_get_all_employee_detail import ErrorForGetAllEmployeeDetail
from people_hr_python_sdk.type.include_leavers import IncludeLeavers

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.get_all_employee_detail_parameter import GetAllEmployeeDetailParameter as GetAllEmployeeDetailParameterPydantic
from people_hr_python_sdk.pydantic.error_for_get_all_employee_detail import ErrorForGetAllEmployeeDetail as ErrorForGetAllEmployeeDetailPydantic
from people_hr_python_sdk.pydantic.include_leavers import IncludeLeavers as IncludeLeaversPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = GetAllEmployeeDetailParameterSchema


request_body_get_all_employee_detail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetAllEmployeeDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetAllEmployeeDetail
...
class BaseApi(api_client.Api):
    ...
    def _list_employee_detail_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        include_leavers: IncludeLeavers,
        ...
        if action is not None:
            _body["Action"] = action
        if include_leavers is not None:
            _body["IncludeLeavers"] = include_leavers
        args.body = _body
        return args

    async def _alist_employee_detail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee  -  GetAllEmployeeDetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_all_employee_detail_parameter.serialize(body, content_type)
    ...
    def _list_employee_detail_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class ListEmployeeDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_employee_detail(
        self,
        api_key: APIKey,
        action: str,
        include_leavers: IncludeLeavers,
        **kwargs,
        ...
        args = self._list_employee_detail_mapped_args(
            api_key=api_key,
            action=action,
            include_leavers=include_leavers,
        )
        return await self._alist_employee_detail_oapg(
            body=args.body,
            **kwargs,
        )
    
    def list_employee_detail(
        self,
        api_key: APIKey,
        action: str,
        include_leavers: IncludeLeavers,
        ...
        return self._list_employee_detail_oapg(
            body=args.body,
        )

class ListEmployeeDetail(BaseApi):
    ...
    async def alist_employee_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetAllEmployeeDetailPydantic:
        raw_response = await self.raw.alist_employee_detail(
            api_key=api_key,
            action=action,
            include_leavers=include_leavers,
            **kwargs,
        ...
        if validate:
            return ErrorForGetAllEmployeeDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetAllEmployeeDetailPydantic, raw_response.body)
    ...
    def list_employee_detail(
        ...
        raw_response = self.raw.list_employee_detail(
            api_key=api_key,
            action=action,
            include_leavers=include_leavers,
        )
