...
from people_hr_python_sdk.model.get_timesheetdefinition import GetTimesheetdefinition as GetTimesheetdefinitionSchema
from people_hr_python_sdk.model.api_key import APIKey as APIKeySchema
from people_hr_python_sdk.model.error_for_get_timesheet_detail import ErrorForGetTimesheetDetail as ErrorForGetTimesheetDetailSchema

from people_hr_python_sdk.type.get_timesheetdefinition import GetTimesheetdefinition
from people_hr_python_sdk.type.error_for_get_timesheet_detail import ErrorForGetTimesheetDetail
...
from people_hr_python_sdk.pydantic.get_timesheetdefinition import GetTimesheetdefinition as GetTimesheetdefinitionPydantic
from people_hr_python_sdk.pydantic.error_for_get_timesheet_detail import ErrorForGetTimesheetDetail as ErrorForGetTimesheetDetailPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = GetTimesheetdefinitionSchema


request_body_get_timesheetdefinition = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetTimesheetDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetTimesheetDetail
...
class BaseApi(api_client.Api):
    ...
    def _get_detail_list_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aget_detail_list_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Timesheet  -  GetTimesheetDetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_timesheetdefinition.serialize(body, content_type)
...
class GetDetailListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_detail_list(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._get_detail_list_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aget_detail_list_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def get_detail_list(
        ...
        return self._get_detail_list_oapg(
            body=args.body,
        )

class GetDetailList(BaseApi):
    ...
    async def aget_detail_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetTimesheetDetailPydantic:
        raw_response = await self.raw.aget_detail_list(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            start_date=start_date,
        ...
        if validate:
            return ErrorForGetTimesheetDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetTimesheetDetailPydantic, raw_response.body)
    ...
    def get_detail_list(
        ...
        raw_response = self.raw.get_detail_list(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            start_date=start_date,
