...
from people_hr_python_sdk.model.get_driving_license_by_employee_id_parameter import GetDrivingLicenseByEmployeeIdParameter as GetDrivingLicenseByEmployeeIdParameterSchema
from people_hr_python_sdk.model.error_for_get_driving_license_by_employee_id import ErrorForGetDrivingLicenseByEmployeeId as ErrorForGetDrivingLicenseByEmployeeIdSchema

from people_hr_python_sdk.type.get_driving_license_by_employee_id_parameter import GetDrivingLicenseByEmployeeIdParameter
from people_hr_python_sdk.type.error_for_get_driving_license_by_employee_id import ErrorForGetDrivingLicenseByEmployeeId
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_get_driving_license_by_employee_id import ErrorForGetDrivingLicenseByEmployeeId as ErrorForGetDrivingLicenseByEmployeeIdPydantic
from people_hr_python_sdk.pydantic.get_driving_license_by_employee_id_parameter import GetDrivingLicenseByEmployeeIdParameter as GetDrivingLicenseByEmployeeIdParameterPydantic
...
# body param
SchemaForRequestBodyApplicationJson = GetDrivingLicenseByEmployeeIdParameterSchema


request_body_get_driving_license_by_employee_id_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetDrivingLicenseByEmployeeIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetDrivingLicenseByEmployeeId
...
class BaseApi(api_client.Api):
    ...
    def _get_driving_license_by_employee_id_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aget_driving_license_by_employee_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Driving  -  GetDrivingLicenseByEmployeeId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_driving_license_by_employee_id_parameter.serialize(body, content_type)
    ...
    def _get_driving_license_by_employee_id_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetDrivingLicenseByEmployeeIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_driving_license_by_employee_id(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        **kwargs,
        ...
        args = self._get_driving_license_by_employee_id_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
        )
        return await self._aget_driving_license_by_employee_id_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_driving_license_by_employee_id(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._get_driving_license_by_employee_id_oapg(
            body=args.body,
        )

class GetDrivingLicenseByEmployeeId(BaseApi):
    ...
    async def aget_driving_license_by_employee_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetDrivingLicenseByEmployeeIdPydantic:
        raw_response = await self.raw.aget_driving_license_by_employee_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            **kwargs,
        ...
        if validate:
            return ErrorForGetDrivingLicenseByEmployeeIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetDrivingLicenseByEmployeeIdPydantic, raw_response.body)
    ...
    def get_driving_license_by_employee_id(
        ...
        raw_response = self.raw.get_driving_license_by_employee_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
        )
