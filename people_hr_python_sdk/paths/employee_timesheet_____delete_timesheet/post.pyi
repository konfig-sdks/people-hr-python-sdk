...
from people_hr_python_sdk.model.error_for_delete_employee_timesheet_detail import ErrorForDeleteEmployeeTimesheetDetail as ErrorForDeleteEmployeeTimesheetDetailSchema
from people_hr_python_sdk.model.delete_timesheetdefinition import DeleteTimesheetdefinition as DeleteTimesheetdefinitionSchema

from people_hr_python_sdk.type.error_for_delete_employee_timesheet_detail import ErrorForDeleteEmployeeTimesheetDetail
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.delete_timesheetdefinition import DeleteTimesheetdefinition

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.delete_timesheetdefinition import DeleteTimesheetdefinition as DeleteTimesheetdefinitionPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_delete_employee_timesheet_detail import ErrorForDeleteEmployeeTimesheetDetail as ErrorForDeleteEmployeeTimesheetDetailPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = DeleteTimesheetdefinitionSchema


request_body_delete_timesheetdefinition = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForDeleteEmployeeTimesheetDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForDeleteEmployeeTimesheetDetail
...
class BaseApi(api_client.Api):
    ...
    def _delete_timesheet_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _adelete_timesheet_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Timesheet  -  DeleteTimesheet',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_delete_timesheetdefinition.serialize(body, content_type)
...
class DeleteTimesheetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_timesheet(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._delete_timesheet_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            timesheet_date=timesheet_date,
        )
        return await self._adelete_timesheet_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def delete_timesheet(
        ...
        return self._delete_timesheet_oapg(
            body=args.body,
        )

class DeleteTimesheet(BaseApi):
    ...
    async def adelete_timesheet(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForDeleteEmployeeTimesheetDetailPydantic:
        raw_response = await self.raw.adelete_timesheet(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            timesheet_date=timesheet_date,
        ...
        if validate:
            return ErrorForDeleteEmployeeTimesheetDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForDeleteEmployeeTimesheetDetailPydantic, raw_response.body)
    ...
    def delete_timesheet(
        ...
        raw_response = self.raw.delete_timesheet(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            timesheet_date=timesheet_date,
