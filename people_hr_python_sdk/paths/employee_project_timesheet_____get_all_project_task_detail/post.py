...
from people_hr_python_sdk.model.error_for_get_all_project_task_detail import ErrorForGetAllProjectTaskDetail as ErrorForGetAllProjectTaskDetailSchema
from people_hr_python_sdk.model.get_all_project_task_detail_parameter import GetAllProjectTaskDetailParameter as GetAllProjectTaskDetailParameterSchema

from people_hr_python_sdk.type.get_all_project_task_detail_parameter import GetAllProjectTaskDetailParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.error_for_get_all_project_task_detail import ErrorForGetAllProjectTaskDetail
...
from people_hr_python_sdk.pydantic.error_for_get_all_project_task_detail import ErrorForGetAllProjectTaskDetail as ErrorForGetAllProjectTaskDetailPydantic
from people_hr_python_sdk.pydantic.get_all_project_task_detail_parameter import GetAllProjectTaskDetailParameter as GetAllProjectTaskDetailParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = GetAllProjectTaskDetailParameterSchema


request_body_get_all_project_task_detail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetAllProjectTaskDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetAllProjectTaskDetail
...
class BaseApi(api_client.Api):
    ...
    def _get_all_project_task_detail_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        project_task_detail_name: typing.Optional[ProjectTaskDetailName] = None,
    ...
    async def _aget_all_project_task_detail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Project Timesheet  -  GetAllProjectTaskDetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_all_project_task_detail_parameter.serialize(body, content_type)
    ...
    def _get_all_project_task_detail_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetAllProjectTaskDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_project_task_detail(
        self,
        api_key: APIKey,
        action: str,
        project_task_detail_name: typing.Optional[ProjectTaskDetailName] = None,
        **kwargs,
        ...
        args = self._get_all_project_task_detail_mapped_args(
            api_key=api_key,
            action=action,
            project_task_detail_name=project_task_detail_name,
        )
        return await self._aget_all_project_task_detail_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_all_project_task_detail(
        self,
        api_key: APIKey,
        action: str,
        project_task_detail_name: typing.Optional[ProjectTaskDetailName] = None,
        ...
        return self._get_all_project_task_detail_oapg(
            body=args.body,
        )

class GetAllProjectTaskDetail(BaseApi):
    ...
    async def aget_all_project_task_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetAllProjectTaskDetailPydantic:
        raw_response = await self.raw.aget_all_project_task_detail(
            api_key=api_key,
            action=action,
            project_task_detail_name=project_task_detail_name,
            **kwargs,
        ...
        if validate:
            return ErrorForGetAllProjectTaskDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetAllProjectTaskDetailPydantic, raw_response.body)
    ...
    def get_all_project_task_detail(
        ...
        raw_response = self.raw.get_all_project_task_detail(
            api_key=api_key,
            action=action,
            project_task_detail_name=project_task_detail_name,
        )
