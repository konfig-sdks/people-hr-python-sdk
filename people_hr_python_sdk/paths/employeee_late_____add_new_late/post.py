...
from people_hr_python_sdk.model.error_for_add_new_late import ErrorForAddNewLate as ErrorForAddNewLateSchema
from people_hr_python_sdk.model.add_new_late_parameters import AddNewLateParameters as AddNewLateParametersSchema

from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.add_new_late_parameters import AddNewLateParameters
from people_hr_python_sdk.type.error_for_add_new_late import ErrorForAddNewLate

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_add_new_late import ErrorForAddNewLate as ErrorForAddNewLatePydantic
from people_hr_python_sdk.pydantic.add_new_late_parameters import AddNewLateParameters as AddNewLateParametersPydantic
...
# body param
SchemaForRequestBodyApplicationJson = AddNewLateParametersSchema


request_body_add_new_late_parameters = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForAddNewLateSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForAddNewLate
...
class BaseApi(api_client.Api):
    ...
    def _create_new_late_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        if late_date is not None:
            _body["LateDate"] = late_date
        if how_late is not None:
            _body["HowLate"] = how_late
        if comments is not None:
            _body["Comments"] = comments
        args.body = _body
        return args

    async def _acreate_new_late_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employeee Late  -  AddNewLate',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_add_new_late_parameters.serialize(body, content_type)
...
class CreateNewLateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_late(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._create_new_late_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._acreate_new_late_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_new_late(
        ...
        return self._create_new_late_oapg(
            body=args.body,
        )

class CreateNewLate(BaseApi):
    ...
    async def acreate_new_late(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForAddNewLatePydantic:
        raw_response = await self.raw.acreate_new_late(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            late_date=late_date,
        ...
        if validate:
            return ErrorForAddNewLatePydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForAddNewLatePydantic, raw_response.body)
    ...
    def create_new_late(
        ...
        raw_response = self.raw.create_new_late(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            late_date=late_date,
