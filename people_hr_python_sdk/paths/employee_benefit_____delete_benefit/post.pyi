...
from people_hr_python_sdk.model.error_for_delete_benefit import ErrorForDeleteBenefit as ErrorForDeleteBenefitSchema
...
from people_hr_python_sdk.model.delete_benefit_parameter import DeleteBenefitParameter as DeleteBenefitParameterSchema

from people_hr_python_sdk.type.delete_benefit_parameter import DeleteBenefitParameter
from people_hr_python_sdk.type.error_for_delete_benefit import ErrorForDeleteBenefit
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_delete_benefit import ErrorForDeleteBenefit as ErrorForDeleteBenefitPydantic
from people_hr_python_sdk.pydantic.delete_benefit_parameter import DeleteBenefitParameter as DeleteBenefitParameterPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DeleteBenefitParameterSchema


request_body_delete_benefit_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForDeleteBenefitSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForDeleteBenefit
...
class BaseApi(api_client.Api):
    ...
    def _delete_benefit_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _adelete_benefit_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeBenefit  -  DeleteBenefit',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_delete_benefit_parameter.serialize(body, content_type)
...
class DeleteBenefitRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_benefit(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._delete_benefit_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            benefit_id=benefit_id,
        )
        return await self._adelete_benefit_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def delete_benefit(
        ...
        return self._delete_benefit_oapg(
            body=args.body,
        )

class DeleteBenefit(BaseApi):
    ...
    async def adelete_benefit(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForDeleteBenefitPydantic:
        raw_response = await self.raw.adelete_benefit(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            benefit_id=benefit_id,
        ...
        if validate:
            return ErrorForDeleteBenefitPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForDeleteBenefitPydantic, raw_response.body)
    ...
    def delete_benefit(
        ...
        raw_response = self.raw.delete_benefit(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            benefit_id=benefit_id,
