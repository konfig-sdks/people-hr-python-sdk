...
from people_hr_python_sdk.model.custom_columns_array_for_add_new_appraisal import CustomColumnsArrayForAddNewAppraisal as CustomColumnsArrayForAddNewAppraisalSchema
from people_hr_python_sdk.model.add_files_array_for_add_new_appraisal import AddFilesArrayForAddNewAppraisal as AddFilesArrayForAddNewAppraisalSchema
from people_hr_python_sdk.model.error_for_add_new_appraisal import ErrorForAddNewAppraisal as ErrorForAddNewAppraisalSchema
from people_hr_python_sdk.model.add_new_appraisal_parameter import AddNewAppraisalParameter as AddNewAppraisalParameterSchema

from people_hr_python_sdk.type.add_files_array_for_add_new_appraisal import AddFilesArrayForAddNewAppraisal
from people_hr_python_sdk.type.add_new_appraisal_parameter import AddNewAppraisalParameter
from people_hr_python_sdk.type.custom_columns_array_for_add_new_appraisal import CustomColumnsArrayForAddNewAppraisal
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.error_for_add_new_appraisal import ErrorForAddNewAppraisal

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.custom_columns_array_for_add_new_appraisal import CustomColumnsArrayForAddNewAppraisal as CustomColumnsArrayForAddNewAppraisalPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.add_files_array_for_add_new_appraisal import AddFilesArrayForAddNewAppraisal as AddFilesArrayForAddNewAppraisalPydantic
from people_hr_python_sdk.pydantic.error_for_add_new_appraisal import ErrorForAddNewAppraisal as ErrorForAddNewAppraisalPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic
from people_hr_python_sdk.pydantic.add_new_appraisal_parameter import AddNewAppraisalParameter as AddNewAppraisalParameterPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = AddNewAppraisalParameterSchema


request_body_add_new_appraisal_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForAddNewAppraisalSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForAddNewAppraisal
...
class BaseApi(api_client.Api):
    ...
    def _create_new_appraisal_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        action_plan: str,
        objectives: str,
        custom_columns: CustomColumnsArrayForAddNewAppraisal,
        add_files: AddFilesArrayForAddNewAppraisal,
        ...
        if appraisal_review_date is not None:
            _body["AppraisalReviewDate"] = appraisal_review_date
        if reviewer is not None:
            _body["Reviewer"] = reviewer
        if notes is not None:
            _body["Notes"] = notes
        if action_plan is not None:
            _body["ActionPlan"] = action_plan
        if objectives is not None:
            _body["Objectives"] = objectives
    ...
    async def _acreate_new_appraisal_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeAppraisal  -  AddNewAppraisal',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_add_new_appraisal_parameter.serialize(body, content_type)
    ...
    def _create_new_appraisal_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateNewAppraisalRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_appraisal(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._create_new_appraisal_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            appraisal_review_date=appraisal_review_date,
            reviewer=reviewer,
            notes=notes,
        ...
        return await self._acreate_new_appraisal_oapg(
            body=args.body,
            **kwargs,
        )
    
    def create_new_appraisal(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._create_new_appraisal_oapg(
            body=args.body,
        )

class CreateNewAppraisal(BaseApi):
    ...
    async def acreate_new_appraisal(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForAddNewAppraisalPydantic:
        raw_response = await self.raw.acreate_new_appraisal(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            appraisal_review_date=appraisal_review_date,
        ...
        if validate:
            return ErrorForAddNewAppraisalPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForAddNewAppraisalPydantic, raw_response.body)
    ...
    def create_new_appraisal(
        ...
        raw_response = self.raw.create_new_appraisal(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            appraisal_review_date=appraisal_review_date,
