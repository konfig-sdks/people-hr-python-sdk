...
from people_hr_python_sdk.model.error_for_get_employee_detail_by_id import ErrorForGetEmployeeDetailById as ErrorForGetEmployeeDetailByIdSchema
...
from people_hr_python_sdk.model.get_employee_detail_by_id_parameter import GetEmployeeDetailByIdParameter as GetEmployeeDetailByIdParameterSchema

from people_hr_python_sdk.type.error_for_get_employee_detail_by_id import ErrorForGetEmployeeDetailById
from people_hr_python_sdk.type.get_employee_detail_by_id_parameter import GetEmployeeDetailByIdParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.get_employee_detail_by_id_parameter import GetEmployeeDetailByIdParameter as GetEmployeeDetailByIdParameterPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_get_employee_detail_by_id import ErrorForGetEmployeeDetailById as ErrorForGetEmployeeDetailByIdPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = GetEmployeeDetailByIdParameterSchema


request_body_get_employee_detail_by_id_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetEmployeeDetailByIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetEmployeeDetailById
    ...
    async def _aget_detail_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee  -  GetEmployeeDetailById',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_employee_detail_by_id_parameter.serialize(body, content_type)
...
class GetDetailById(BaseApi):
    ...
    async def aget_detail_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetEmployeeDetailByIdPydantic:
        ...
        if validate:
            return ErrorForGetEmployeeDetailByIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetEmployeeDetailByIdPydantic, raw_response.body)
