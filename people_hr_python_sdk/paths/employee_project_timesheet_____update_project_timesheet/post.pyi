...
from people_hr_python_sdk.model.error_for_update_project_timesheet import ErrorForUpdateProjectTimesheet as ErrorForUpdateProjectTimesheetSchema
from people_hr_python_sdk.model.update_project_timesheet_parameter import UpdateProjectTimesheetParameter as UpdateProjectTimesheetParameterSchema

from people_hr_python_sdk.type.update_project_timesheet_parameter import UpdateProjectTimesheetParameter
from people_hr_python_sdk.type.error_for_update_project_timesheet import ErrorForUpdateProjectTimesheet
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.update_project_timesheet_parameter import UpdateProjectTimesheetParameter as UpdateProjectTimesheetParameterPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_update_project_timesheet import ErrorForUpdateProjectTimesheet as ErrorForUpdateProjectTimesheetPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = UpdateProjectTimesheetParameterSchema


request_body_update_project_timesheet_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUpdateProjectTimesheetSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUpdateProjectTimesheet
...
class BaseApi(api_client.Api):
    ...
    def _update_timesheet_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aupdate_timesheet_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Project Timesheet  -  UpdateProjectTimesheet',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_project_timesheet_parameter.serialize(body, content_type)
...
class UpdateTimesheetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_timesheet(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._update_timesheet_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aupdate_timesheet_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def update_timesheet(
        ...
        return self._update_timesheet_oapg(
            body=args.body,
        )

class UpdateTimesheet(BaseApi):
    ...
    async def aupdate_timesheet(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForUpdateProjectTimesheetPydantic:
        raw_response = await self.raw.aupdate_timesheet(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            transaction_id=transaction_id,
        ...
        if validate:
            return ErrorForUpdateProjectTimesheetPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUpdateProjectTimesheetPydantic, raw_response.body)
    ...
    def update_timesheet(
        ...
        raw_response = self.raw.update_timesheet(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            transaction_id=transaction_id,
