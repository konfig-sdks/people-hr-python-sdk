...
from people_hr_python_sdk.model.error_for_delete_vehicle_detail import ErrorForDeleteVehicleDetail as ErrorForDeleteVehicleDetailSchema
from people_hr_python_sdk.model.delete_vehicle_detail_definition import DeleteVehicleDetailDefinition as DeleteVehicleDetailDefinitionSchema

from people_hr_python_sdk.type.delete_vehicle_detail_definition import DeleteVehicleDetailDefinition
from people_hr_python_sdk.type.error_for_delete_vehicle_detail import ErrorForDeleteVehicleDetail
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.delete_vehicle_detail_definition import DeleteVehicleDetailDefinition as DeleteVehicleDetailDefinitionPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_delete_vehicle_detail import ErrorForDeleteVehicleDetail as ErrorForDeleteVehicleDetailPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = DeleteVehicleDetailDefinitionSchema


request_body_delete_vehicle_detail_definition = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForDeleteVehicleDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForDeleteVehicleDetail
    ...
    async def _adelete_detail_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Vehicle  -  DeleteVehicleDetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_delete_vehicle_detail_definition.serialize(body, content_type)
...
class DeleteDetail(BaseApi):
    ...
    async def adelete_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForDeleteVehicleDetailPydantic:
        ...
        if validate:
            return ErrorForDeleteVehicleDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForDeleteVehicleDetailPydantic, raw_response.body)
