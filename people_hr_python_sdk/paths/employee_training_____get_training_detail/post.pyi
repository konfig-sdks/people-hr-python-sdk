...
from people_hr_python_sdk.model.error_for_get_training_detail import ErrorForGetTrainingDetail as ErrorForGetTrainingDetailSchema
from people_hr_python_sdk.model.get_training_detail_parameter import GetTrainingDetailParameter as GetTrainingDetailParameterSchema

from people_hr_python_sdk.type.error_for_get_training_detail import ErrorForGetTrainingDetail
from people_hr_python_sdk.type.get_training_detail_parameter import GetTrainingDetailParameter
...
from people_hr_python_sdk.pydantic.error_for_get_training_detail import ErrorForGetTrainingDetail as ErrorForGetTrainingDetailPydantic
from people_hr_python_sdk.pydantic.get_training_detail_parameter import GetTrainingDetailParameter as GetTrainingDetailParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = GetTrainingDetailParameterSchema


request_body_get_training_detail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetTrainingDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetTrainingDetail
    ...
    async def _aget_detail_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Training  -  GetTrainingDetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_training_detail_parameter.serialize(body, content_type)
...
class GetDetail(BaseApi):
    ...
    async def aget_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetTrainingDetailPydantic:
        ...
        if validate:
            return ErrorForGetTrainingDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetTrainingDetailPydantic, raw_response.body)
