...
from people_hr_python_sdk.model.error_for_get_holiday_detail import ErrorForGetHolidayDetail as ErrorForGetHolidayDetailSchema
from people_hr_python_sdk.model.get_holiday_detail_parameter import GetHolidayDetailParameter as GetHolidayDetailParameterSchema
...
from people_hr_python_sdk.type.get_holiday_detail_parameter import GetHolidayDetailParameter
from people_hr_python_sdk.type.error_for_get_holiday_detail import ErrorForGetHolidayDetail
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.get_holiday_detail_parameter import GetHolidayDetailParameter as GetHolidayDetailParameterPydantic
...
from people_hr_python_sdk.pydantic.error_for_get_holiday_detail import ErrorForGetHolidayDetail as ErrorForGetHolidayDetailPydantic

# body param
SchemaForRequestBodyApplicationJson = GetHolidayDetailParameterSchema


request_body_get_holiday_detail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetHolidayDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetHolidayDetail
...
class BaseApi(api_client.Api):
    ...
    def _get_holiday_detail_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aget_holiday_detail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Holiday  -  GetHolidayDetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_holiday_detail_parameter.serialize(body, content_type)
...
class GetHolidayDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_holiday_detail(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._get_holiday_detail_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aget_holiday_detail_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_holiday_detail(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._get_holiday_detail_oapg(
            body=args.body,
        )

class GetHolidayDetail(BaseApi):
    ...
    async def aget_holiday_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetHolidayDetailPydantic:
        raw_response = await self.raw.aget_holiday_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            start_date=start_date,
        ...
        if validate:
            return ErrorForGetHolidayDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetHolidayDetailPydantic, raw_response.body)
    ...
    def get_holiday_detail(
        ...
        raw_response = self.raw.get_holiday_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            start_date=start_date,
