...
from people_hr_python_sdk.model.get_history_by_employee_id_and_field_name_parameter import GetHistoryByEmployeeIdAndFieldNameParameter as GetHistoryByEmployeeIdAndFieldNameParameterSchema
...
from people_hr_python_sdk.model.error_for_get_history_by_employee_id_and_field_name import ErrorForGetHistoryByEmployeeIdAndFieldName as ErrorForGetHistoryByEmployeeIdAndFieldNameSchema

from people_hr_python_sdk.type.error_for_get_history_by_employee_id_and_field_name import ErrorForGetHistoryByEmployeeIdAndFieldName
from people_hr_python_sdk.type.get_history_by_employee_id_and_field_name_parameter import GetHistoryByEmployeeIdAndFieldNameParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_get_history_by_employee_id_and_field_name import ErrorForGetHistoryByEmployeeIdAndFieldName as ErrorForGetHistoryByEmployeeIdAndFieldNamePydantic
from people_hr_python_sdk.pydantic.get_history_by_employee_id_and_field_name_parameter import GetHistoryByEmployeeIdAndFieldNameParameter as GetHistoryByEmployeeIdAndFieldNameParameterPydantic
...
# body param
SchemaForRequestBodyApplicationJson = GetHistoryByEmployeeIdAndFieldNameParameterSchema


request_body_get_history_by_employee_id_and_field_name_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetHistoryByEmployeeIdAndFieldNameSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetHistoryByEmployeeIdAndFieldName
...
class BaseApi(api_client.Api):
    ...
    def _get_by_employee_id_and_field_name_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        if field_name is not None:
            _body["FieldName"] = field_name
        args.body = _body
        return args

    async def _aget_by_employee_id_and_field_name_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/History  -  GetHistoryByEmployeeIdAndFieldName',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_history_by_employee_id_and_field_name_parameter.serialize(body, content_type)
    ...
    def _get_by_employee_id_and_field_name_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetByEmployeeIdAndFieldNameRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_employee_id_and_field_name(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._get_by_employee_id_and_field_name_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            field_name=field_name,
        )
        return await self._aget_by_employee_id_and_field_name_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_by_employee_id_and_field_name(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._get_by_employee_id_and_field_name_oapg(
            body=args.body,
        )

class GetByEmployeeIdAndFieldName(BaseApi):
    ...
    async def aget_by_employee_id_and_field_name(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetHistoryByEmployeeIdAndFieldNamePydantic:
        raw_response = await self.raw.aget_by_employee_id_and_field_name(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            field_name=field_name,
        ...
        if validate:
            return ErrorForGetHistoryByEmployeeIdAndFieldNamePydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetHistoryByEmployeeIdAndFieldNamePydantic, raw_response.body)
    ...
    def get_by_employee_id_and_field_name(
        ...
        raw_response = self.raw.get_by_employee_id_and_field_name(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            field_name=field_name,
