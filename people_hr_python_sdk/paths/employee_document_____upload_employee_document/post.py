...
from people_hr_python_sdk.model.employee_access import EmployeeAccess as EmployeeAccessSchema
from people_hr_python_sdk.model.error_for_upload_employee_document import ErrorForUploadEmployeeDocument as ErrorForUploadEmployeeDocumentSchema
from people_hr_python_sdk.model.manager_access import ManagerAccess as ManagerAccessSchema
from people_hr_python_sdk.model.signature_required import SignatureRequired as SignatureRequiredSchema
from people_hr_python_sdk.model.upload_employee_document_parameter import UploadEmployeeDocumentParameter as UploadEmployeeDocumentParameterSchema

from people_hr_python_sdk.type.signature_required import SignatureRequired
from people_hr_python_sdk.type.upload_employee_document_parameter import UploadEmployeeDocumentParameter
from people_hr_python_sdk.type.manager_access import ManagerAccess
from people_hr_python_sdk.type.employee_access import EmployeeAccess
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.error_for_upload_employee_document import ErrorForUploadEmployeeDocument

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_upload_employee_document import ErrorForUploadEmployeeDocument as ErrorForUploadEmployeeDocumentPydantic
from people_hr_python_sdk.pydantic.signature_required import SignatureRequired as SignatureRequiredPydantic
from people_hr_python_sdk.pydantic.upload_employee_document_parameter import UploadEmployeeDocumentParameter as UploadEmployeeDocumentParameterPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.manager_access import ManagerAccess as ManagerAccessPydantic
from people_hr_python_sdk.pydantic.employee_access import EmployeeAccess as EmployeeAccessPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = UploadEmployeeDocumentParameterSchema


request_body_upload_employee_document_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUploadEmployeeDocumentSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUploadEmployeeDocument
...
class BaseApi(api_client.Api):
    ...
    def _submit_document_details_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        if employee_access is not None:
            _body["EmployeeAccess"] = employee_access
        if manager_access is not None:
            _body["ManagerAccess"] = manager_access
        if signature_required is not None:
            _body["SignatureRequired"] = signature_required
    ...
    async def _asubmit_document_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeDocument  -  UploadEmployeeDocument',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_upload_employee_document_parameter.serialize(body, content_type)
    ...
    def _submit_document_details_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class SubmitDocumentDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asubmit_document_details(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._submit_document_details_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._asubmit_document_details_oapg(
            body=args.body,
            **kwargs,
        )
    
    def submit_document_details(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._submit_document_details_oapg(
            body=args.body,
        )

class SubmitDocumentDetails(BaseApi):
    ...
    async def asubmit_document_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForUploadEmployeeDocumentPydantic:
        raw_response = await self.raw.asubmit_document_details(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            category=category,
        ...
        if validate:
            return ErrorForUploadEmployeeDocumentPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUploadEmployeeDocumentPydantic, raw_response.body)
    ...
    def submit_document_details(
        ...
        raw_response = self.raw.submit_document_details(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            category=category,
