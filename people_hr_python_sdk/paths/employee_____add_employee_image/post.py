...
from people_hr_python_sdk.model.error_for_add_employee_image_by_id import ErrorForAddEmployeeImageById as ErrorForAddEmployeeImageByIdSchema
from people_hr_python_sdk.model.add_employee_image_by_id2 import AddEmployeeImageById2 as AddEmployeeImageById2Schema

from people_hr_python_sdk.type.error_for_add_employee_image_by_id import ErrorForAddEmployeeImageById
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.add_employee_image_by_id2 import AddEmployeeImageById2

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_add_employee_image_by_id import ErrorForAddEmployeeImageById as ErrorForAddEmployeeImageByIdPydantic
from people_hr_python_sdk.pydantic.add_employee_image_by_id2 import AddEmployeeImageById2 as AddEmployeeImageById2Pydantic
...
# body param
SchemaForRequestBodyApplicationJson = AddEmployeeImageById2Schema


request_body_add_employee_image_by_id2 = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForAddEmployeeImageByIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForAddEmployeeImageById
...
class BaseApi(api_client.Api):
    ...
    def _add_image_by_id_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        employee_image_name: str,
        employee_image: str,
        ...
        if employee_image_name is not None:
            _body["EmployeeImageName"] = employee_image_name
        if employee_image is not None:
            _body["EmployeeImage"] = employee_image
        args.body = _body
        return args

    async def _aadd_image_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee  -  AddEmployeeImage',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_add_employee_image_by_id2.serialize(body, content_type)
...
class AddImageByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_image_by_id(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._add_image_by_id_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            employee_image_name=employee_image_name,
            employee_image=employee_image,
        )
        return await self._aadd_image_by_id_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def add_image_by_id(
        ...
        return self._add_image_by_id_oapg(
            body=args.body,
        )

class AddImageById(BaseApi):
    ...
    async def aadd_image_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForAddEmployeeImageByIdPydantic:
        raw_response = await self.raw.aadd_image_by_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            employee_image_name=employee_image_name,
        ...
        if validate:
            return ErrorForAddEmployeeImageByIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForAddEmployeeImageByIdPydantic, raw_response.body)
    ...
    def add_image_by_id(
        ...
        raw_response = self.raw.add_image_by_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            employee_image_name=employee_image_name,
