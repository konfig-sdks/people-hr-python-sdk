...
from people_hr_python_sdk.model.get_qualification_by_employee_id_parameter import GetQualificationByEmployeeIdParameter as GetQualificationByEmployeeIdParameterSchema
from people_hr_python_sdk.model.error_for_get_qualification_by_employee_id import ErrorForGetQualificationByEmployeeId as ErrorForGetQualificationByEmployeeIdSchema

from people_hr_python_sdk.type.get_qualification_by_employee_id_parameter import GetQualificationByEmployeeIdParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.error_for_get_qualification_by_employee_id import ErrorForGetQualificationByEmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_get_qualification_by_employee_id import ErrorForGetQualificationByEmployeeId as ErrorForGetQualificationByEmployeeIdPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic
from people_hr_python_sdk.pydantic.get_qualification_by_employee_id_parameter import GetQualificationByEmployeeIdParameter as GetQualificationByEmployeeIdParameterPydantic

# body param
SchemaForRequestBodyApplicationJson = GetQualificationByEmployeeIdParameterSchema


request_body_get_qualification_by_employee_id_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetQualificationByEmployeeIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetQualificationByEmployeeId
    ...
    async def _aget_by_employee_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Qualification  -  GetQualificationByEmployeeId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_qualification_by_employee_id_parameter.serialize(body, content_type)
...
class GetByEmployeeId(BaseApi):
    ...
    async def aget_by_employee_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetQualificationByEmployeeIdPydantic:
        ...
        if validate:
            return ErrorForGetQualificationByEmployeeIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetQualificationByEmployeeIdPydantic, raw_response.body)
