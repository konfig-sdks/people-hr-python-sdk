...
from people_hr_python_sdk.model.update_timesheet_definition import UpdateTimesheetDefinition as UpdateTimesheetDefinitionSchema
from people_hr_python_sdk.model.error_for_update_employee_timesheet_detail import ErrorForUpdateEmployeeTimesheetDetail as ErrorForUpdateEmployeeTimesheetDetailSchema

from people_hr_python_sdk.type.update_timesheet_definition import UpdateTimesheetDefinition
from people_hr_python_sdk.type.error_for_update_employee_timesheet_detail import ErrorForUpdateEmployeeTimesheetDetail
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.update_timesheet_definition import UpdateTimesheetDefinition as UpdateTimesheetDefinitionPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_update_employee_timesheet_detail import ErrorForUpdateEmployeeTimesheetDetail as ErrorForUpdateEmployeeTimesheetDetailPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = UpdateTimesheetDefinitionSchema


request_body_update_timesheet_definition = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUpdateEmployeeTimesheetDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUpdateEmployeeTimesheetDetail
    ...
    async def _aupdate_details_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Timesheet  -  UpdateTimesheet',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_timesheet_definition.serialize(body, content_type)
...
class UpdateDetails(BaseApi):
    ...
    async def aupdate_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForUpdateEmployeeTimesheetDetailPydantic:
        ...
        if validate:
            return ErrorForUpdateEmployeeTimesheetDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUpdateEmployeeTimesheetDetailPydantic, raw_response.body)
