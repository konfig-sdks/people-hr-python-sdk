...
from people_hr_python_sdk.model.error_for_get_driving_license_by_driving_id import ErrorForGetDrivingLicenseByDrivingId as ErrorForGetDrivingLicenseByDrivingIdSchema
from people_hr_python_sdk.model.get_driving_license_by_driving_id_parameter import GetDrivingLicenseByDrivingIdParameter as GetDrivingLicenseByDrivingIdParameterSchema

from people_hr_python_sdk.type.error_for_get_driving_license_by_driving_id import ErrorForGetDrivingLicenseByDrivingId
from people_hr_python_sdk.type.get_driving_license_by_driving_id_parameter import GetDrivingLicenseByDrivingIdParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.get_driving_license_by_driving_id_parameter import GetDrivingLicenseByDrivingIdParameter as GetDrivingLicenseByDrivingIdParameterPydantic
...
from people_hr_python_sdk.pydantic.error_for_get_driving_license_by_driving_id import ErrorForGetDrivingLicenseByDrivingId as ErrorForGetDrivingLicenseByDrivingIdPydantic

# body param
SchemaForRequestBodyApplicationJson = GetDrivingLicenseByDrivingIdParameterSchema


request_body_get_driving_license_by_driving_id_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetDrivingLicenseByDrivingIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetDrivingLicenseByDrivingId
...
class BaseApi(api_client.Api):
    ...
    def _get_driving_license_by_driving_id_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aget_driving_license_by_driving_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Driving  -  GetDrivingLicenseByDrivingId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_driving_license_by_driving_id_parameter.serialize(body, content_type)
    ...
    def _get_driving_license_by_driving_id_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetDrivingLicenseByDrivingIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_driving_license_by_driving_id(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._get_driving_license_by_driving_id_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            driving_id=driving_id,
        )
        return await self._aget_driving_license_by_driving_id_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_driving_license_by_driving_id(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._get_driving_license_by_driving_id_oapg(
            body=args.body,
        )

class GetDrivingLicenseByDrivingId(BaseApi):
    ...
    async def aget_driving_license_by_driving_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetDrivingLicenseByDrivingIdPydantic:
        raw_response = await self.raw.aget_driving_license_by_driving_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            driving_id=driving_id,
        ...
        if validate:
            return ErrorForGetDrivingLicenseByDrivingIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetDrivingLicenseByDrivingIdPydantic, raw_response.body)
    ...
    def get_driving_license_by_driving_id(
        ...
        raw_response = self.raw.get_driving_license_by_driving_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            driving_id=driving_id,
