...
from people_hr_python_sdk.model.delete_project_timesheet_parameter import DeleteProjectTimesheetParameter as DeleteProjectTimesheetParameterSchema
...
from people_hr_python_sdk.model.error_for_delete_project_timesheet import ErrorForDeleteProjectTimesheet as ErrorForDeleteProjectTimesheetSchema

from people_hr_python_sdk.type.delete_project_timesheet_parameter import DeleteProjectTimesheetParameter
from people_hr_python_sdk.type.error_for_delete_project_timesheet import ErrorForDeleteProjectTimesheet
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_delete_project_timesheet import ErrorForDeleteProjectTimesheet as ErrorForDeleteProjectTimesheetPydantic
from people_hr_python_sdk.pydantic.delete_project_timesheet_parameter import DeleteProjectTimesheetParameter as DeleteProjectTimesheetParameterPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DeleteProjectTimesheetParameterSchema


request_body_delete_project_timesheet_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForDeleteProjectTimesheetSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForDeleteProjectTimesheet
    ...
    async def _adelete_timesheet_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Project Timesheet  -  DeleteProjectTimesheet',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_delete_project_timesheet_parameter.serialize(body, content_type)
...
class DeleteTimesheet(BaseApi):
    ...
    async def adelete_timesheet(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForDeleteProjectTimesheetPydantic:
        ...
        if validate:
            return ErrorForDeleteProjectTimesheetPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForDeleteProjectTimesheetPydantic, raw_response.body)
