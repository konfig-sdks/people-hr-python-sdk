...
from people_hr_python_sdk.model.error_for_update_custom_screen_transaction import ErrorForUpdateCustomScreenTransaction as ErrorForUpdateCustomScreenTransactionSchema
...
from people_hr_python_sdk.model.add_files_for_employee_custom_screen_object import AddFilesForEmployeeCustomScreenObject as AddFilesForEmployeeCustomScreenObjectSchema
from people_hr_python_sdk.model.update_custom_screen_transaction_parameter import UpdateCustomScreenTransactionParameter as UpdateCustomScreenTransactionParameterSchema
from people_hr_python_sdk.model.custom_columns_for_employee_custom_screen_object import CustomColumnsForEmployeeCustomScreenObject as CustomColumnsForEmployeeCustomScreenObjectSchema

from people_hr_python_sdk.type.custom_columns_for_employee_custom_screen_object import CustomColumnsForEmployeeCustomScreenObject
from people_hr_python_sdk.type.error_for_update_custom_screen_transaction import ErrorForUpdateCustomScreenTransaction
from people_hr_python_sdk.type.update_custom_screen_transaction_parameter import UpdateCustomScreenTransactionParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.add_files_for_employee_custom_screen_object import AddFilesForEmployeeCustomScreenObject

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.update_custom_screen_transaction_parameter import UpdateCustomScreenTransactionParameter as UpdateCustomScreenTransactionParameterPydantic
from people_hr_python_sdk.pydantic.add_files_for_employee_custom_screen_object import AddFilesForEmployeeCustomScreenObject as AddFilesForEmployeeCustomScreenObjectPydantic
from people_hr_python_sdk.pydantic.custom_columns_for_employee_custom_screen_object import CustomColumnsForEmployeeCustomScreenObject as CustomColumnsForEmployeeCustomScreenObjectPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_update_custom_screen_transaction import ErrorForUpdateCustomScreenTransaction as ErrorForUpdateCustomScreenTransactionPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = UpdateCustomScreenTransactionParameterSchema


request_body_update_custom_screen_transaction_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUpdateCustomScreenTransactionSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUpdateCustomScreenTransaction
...
class BaseApi(api_client.Api):
    ...
    def _update_custom_screen_transaction_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        screen_id: int,
        custom_screen_transaction_id: int,
        custom_columns: CustomColumnsForEmployeeCustomScreenObject,
        add_files: AddFilesForEmployeeCustomScreenObject,
        ...
        if screen_id is not None:
            _body["ScreenId"] = screen_id
        if custom_screen_transaction_id is not None:
            _body["CustomScreenTransactionId"] = custom_screen_transaction_id
    ...
    async def _aupdate_custom_screen_transaction_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Custom Screen  -  UpdateCustomScreenTransaction',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_custom_screen_transaction_parameter.serialize(body, content_type)
    ...
    def _update_custom_screen_transaction_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateCustomScreenTransactionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_custom_screen_transaction(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._update_custom_screen_transaction_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            screen_id=screen_id,
            custom_screen_transaction_id=custom_screen_transaction_id,
            custom_columns=custom_columns,
            add_files=add_files,
        )
        return await self._aupdate_custom_screen_transaction_oapg(
            body=args.body,
            **kwargs,
        )
    
    def update_custom_screen_transaction(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._update_custom_screen_transaction_oapg(
            body=args.body,
        )

class UpdateCustomScreenTransaction(BaseApi):
    ...
    async def aupdate_custom_screen_transaction(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForUpdateCustomScreenTransactionPydantic:
        raw_response = await self.raw.aupdate_custom_screen_transaction(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            screen_id=screen_id,
        ...
        if validate:
            return ErrorForUpdateCustomScreenTransactionPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUpdateCustomScreenTransactionPydantic, raw_response.body)
    ...
    def update_custom_screen_transaction(
        ...
        raw_response = self.raw.update_custom_screen_transaction(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            screen_id=screen_id,
