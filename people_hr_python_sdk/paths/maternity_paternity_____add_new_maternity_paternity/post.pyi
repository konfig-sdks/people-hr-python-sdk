...
from people_hr_python_sdk.model.add_comments_array_for_maternity_paternity import AddCommentsArrayForMaternityPaternity as AddCommentsArrayForMaternityPaternitySchema
from people_hr_python_sdk.model.employee_id import EmployeeId as EmployeeIdSchema
from people_hr_python_sdk.model.error_for_add_new_maternity_paternity_api import ErrorForAddNewMaternityPaternityApi as ErrorForAddNewMaternityPaternityApiSchema
from people_hr_python_sdk.model.api_key import APIKey as APIKeySchema
from people_hr_python_sdk.model.add_new_maternity_paternity_parameter import AddNewMaternityPaternityParameter as AddNewMaternityPaternityParameterSchema
from people_hr_python_sdk.model.add_files_array_for_add_new_maternity_paternity import AddFilesArrayForAddNewMaternityPaternity as AddFilesArrayForAddNewMaternityPaternitySchema

from people_hr_python_sdk.type.add_new_maternity_paternity_parameter import AddNewMaternityPaternityParameter
from people_hr_python_sdk.type.error_for_add_new_maternity_paternity_api import ErrorForAddNewMaternityPaternityApi
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.add_comments_array_for_maternity_paternity import AddCommentsArrayForMaternityPaternity
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.add_files_array_for_add_new_maternity_paternity import AddFilesArrayForAddNewMaternityPaternity

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_add_new_maternity_paternity_api import ErrorForAddNewMaternityPaternityApi as ErrorForAddNewMaternityPaternityApiPydantic
from people_hr_python_sdk.pydantic.add_comments_array_for_maternity_paternity import AddCommentsArrayForMaternityPaternity as AddCommentsArrayForMaternityPaternityPydantic
from people_hr_python_sdk.pydantic.add_files_array_for_add_new_maternity_paternity import AddFilesArrayForAddNewMaternityPaternity as AddFilesArrayForAddNewMaternityPaternityPydantic
from people_hr_python_sdk.pydantic.add_new_maternity_paternity_parameter import AddNewMaternityPaternityParameter as AddNewMaternityPaternityParameterPydantic
...
# body param
SchemaForRequestBodyApplicationJson = AddNewMaternityPaternityParameterSchema


request_body_add_new_maternity_paternity_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForAddNewMaternityPaternityApiSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForAddNewMaternityPaternityApi
...
class BaseApi(api_client.Api):
    ...
    def _add_new_details_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        add_comments: AddCommentsArrayForMaternityPaternity,
        add_files: AddFilesArrayForAddNewMaternityPaternity,
        ...
        if actual_start_date is not None:
            _body["ActualStartDate"] = actual_start_date
        if actual_end_date is not None:
            _body["ActualEndDate"] = actual_end_date
    ...
    async def _aadd_new_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Maternity Paternity  -  AddNewMaternityPaternity',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_add_new_maternity_paternity_parameter.serialize(body, content_type)
...
class AddNewDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_new_details(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._add_new_details_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aadd_new_details_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def add_new_details(
        ...
        return self._add_new_details_oapg(
            body=args.body,
        )

class AddNewDetails(BaseApi):
    ...
    async def aadd_new_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForAddNewMaternityPaternityApiPydantic:
        raw_response = await self.raw.aadd_new_details(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            due_date=due_date,
        ...
        if validate:
            return ErrorForAddNewMaternityPaternityApiPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForAddNewMaternityPaternityApiPydantic, raw_response.body)
    ...
    def add_new_details(
        ...
        raw_response = self.raw.add_new_details(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            due_date=due_date,
