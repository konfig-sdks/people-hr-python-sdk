...
from people_hr_python_sdk.model.add_new_qualification_parameter import AddNewQualificationParameter as AddNewQualificationParameterSchema
...
from people_hr_python_sdk.model.error_for_add_new_qualification import ErrorForAddNewQualification as ErrorForAddNewQualificationSchema
...
from people_hr_python_sdk.type.error_for_add_new_qualification import ErrorForAddNewQualification
...
from people_hr_python_sdk.type.add_new_qualification_parameter import AddNewQualificationParameter
...
from people_hr_python_sdk.pydantic.add_new_qualification_parameter import AddNewQualificationParameter as AddNewQualificationParameterPydantic
from people_hr_python_sdk.pydantic.error_for_add_new_qualification import ErrorForAddNewQualification as ErrorForAddNewQualificationPydantic
...
# body param
SchemaForRequestBodyApplicationJson = AddNewQualificationParameterSchema


request_body_add_new_qualification_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForAddNewQualificationSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForAddNewQualification
...
class BaseApi(api_client.Api):
    ...
    def _add_new_qualification_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aadd_new_qualification_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Qualification  -  AddNewQualification',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_add_new_qualification_parameter.serialize(body, content_type)
    ...
    def _add_new_qualification_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class AddNewQualificationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_new_qualification(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._add_new_qualification_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aadd_new_qualification_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def add_new_qualification(
        ...
        return self._add_new_qualification_oapg(
            body=args.body,
        )

class AddNewQualification(BaseApi):
    ...
    async def aadd_new_qualification(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForAddNewQualificationPydantic:
        raw_response = await self.raw.aadd_new_qualification(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            qualification=qualification,
        ...
        if validate:
            return ErrorForAddNewQualificationPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForAddNewQualificationPydantic, raw_response.body)
    ...
    def add_new_qualification(
        ...
        raw_response = self.raw.add_new_qualification(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            qualification=qualification,
