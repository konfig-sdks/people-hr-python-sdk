...
from people_hr_python_sdk.model.get_by_maternity_paternity_parameter import GetByMaternityPaternityParameter as GetByMaternityPaternityParameterSchema
from people_hr_python_sdk.model.error_for_get_by_maternity_paternity_id import ErrorForGetByMaternityPaternityId as ErrorForGetByMaternityPaternityIdSchema

from people_hr_python_sdk.type.error_for_get_by_maternity_paternity_id import ErrorForGetByMaternityPaternityId
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.get_by_maternity_paternity_parameter import GetByMaternityPaternityParameter

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.get_by_maternity_paternity_parameter import GetByMaternityPaternityParameter as GetByMaternityPaternityParameterPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_get_by_maternity_paternity_id import ErrorForGetByMaternityPaternityId as ErrorForGetByMaternityPaternityIdPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = GetByMaternityPaternityParameterSchema


request_body_get_by_maternity_paternity_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetByMaternityPaternityIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetByMaternityPaternityId
...
class BaseApi(api_client.Api):
    ...
    def _get_details_by_mat_pat_id_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aget_details_by_mat_pat_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Maternity Paternity  -  GetByMaternityPaternityId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_by_maternity_paternity_parameter.serialize(body, content_type)
    ...
    def _get_details_by_mat_pat_id_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetDetailsByMatPatIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_details_by_mat_pat_id(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._get_details_by_mat_pat_id_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            maternity_paternity_txn_id=maternity_paternity_txn_id,
        )
        return await self._aget_details_by_mat_pat_id_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_details_by_mat_pat_id(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._get_details_by_mat_pat_id_oapg(
            body=args.body,
        )

class GetDetailsByMatPatId(BaseApi):
    ...
    async def aget_details_by_mat_pat_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetByMaternityPaternityIdPydantic:
        raw_response = await self.raw.aget_details_by_mat_pat_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            maternity_paternity_txn_id=maternity_paternity_txn_id,
        ...
        if validate:
            return ErrorForGetByMaternityPaternityIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetByMaternityPaternityIdPydantic, raw_response.body)
    ...
    def get_details_by_mat_pat_id(
        ...
        raw_response = self.raw.get_details_by_mat_pat_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            maternity_paternity_txn_id=maternity_paternity_txn_id,
