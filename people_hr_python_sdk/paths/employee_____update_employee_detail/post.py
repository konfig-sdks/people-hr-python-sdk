...
from people_hr_python_sdk.model.error_for_update_employee_detail import ErrorForUpdateEmployeeDetail as ErrorForUpdateEmployeeDetailSchema
...
from people_hr_python_sdk.model.update_employee_detail3 import UpdateEmployeeDetail3 as UpdateEmployeeDetail3Schema
...
from people_hr_python_sdk.type.error_for_update_employee_detail import ErrorForUpdateEmployeeDetail
...
from people_hr_python_sdk.type.update_employee_detail3 import UpdateEmployeeDetail3
...
from people_hr_python_sdk.pydantic.error_for_update_employee_detail import ErrorForUpdateEmployeeDetail as ErrorForUpdateEmployeeDetailPydantic
...
from people_hr_python_sdk.pydantic.update_employee_detail3 import UpdateEmployeeDetail3 as UpdateEmployeeDetail3Pydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateEmployeeDetail3Schema


request_body_update_employee_detail3 = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUpdateEmployeeDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUpdateEmployeeDetail
...
class BaseApi(api_client.Api):
    ...
    def _update_detail_mapped_args(
        ...
        if reports_to_effective_date is not None:
            _body["ReportsToEffectiveDate"] = reports_to_effective_date
        if company is not None:
            _body["Company"] = company
        if company_effective_date is not None:
            _body["CompanyEffectiveDate"] = company_effective_date
        ...
        if location_effective_date is not None:
            _body["LocationEffectiveDate"] = location_effective_date
        if department is not None:
            _body["Department"] = department
        if department_effective_date is not None:
            _body["DepartmentEffectiveDate"] = department_effective_date
        ...
        if employment_type_effective_date is not None:
            _body["EmploymentTypeEffectiveDate"] = employment_type_effective_date
    ...
    async def _aupdate_detail_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee  -  UpdateEmployeeDetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_employee_detail3.serialize(body, content_type)
    ...
    async def aupdate_detail(
        ...
        **kwargs,
        ...
        args = self._update_detail_mapped_args(
            ...
            company_effective_date=company_effective_date,
            job_role=job_role,
            job_role_effective_date=job_role_effective_date,
            location=location,
            location_effective_date=location_effective_date,
            department=department,
            department_effective_date=department_effective_date,
            employment_type_effective_date=employment_type_effective_date,
            title=title,
            email=email,
...
class UpdateDetail(BaseApi):
    ...
    async def aupdate_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForUpdateEmployeeDetailPydantic:
        ...
        if validate:
            return ErrorForUpdateEmployeeDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUpdateEmployeeDetailPydantic, raw_response.body)
