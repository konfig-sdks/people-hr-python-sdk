...
from people_hr_python_sdk.model.error_for_delete_maternity_paternity import ErrorForDeleteMaternityPaternity as ErrorForDeleteMaternityPaternitySchema
...
from people_hr_python_sdk.model.delete_maternity_paternity_parameter import DeleteMaternityPaternityParameter as DeleteMaternityPaternityParameterSchema

from people_hr_python_sdk.type.error_for_delete_maternity_paternity import ErrorForDeleteMaternityPaternity
from people_hr_python_sdk.type.delete_maternity_paternity_parameter import DeleteMaternityPaternityParameter
...
from people_hr_python_sdk.pydantic.error_for_delete_maternity_paternity import ErrorForDeleteMaternityPaternity as ErrorForDeleteMaternityPaternityPydantic
from people_hr_python_sdk.pydantic.delete_maternity_paternity_parameter import DeleteMaternityPaternityParameter as DeleteMaternityPaternityParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = DeleteMaternityPaternityParameterSchema


request_body_delete_maternity_paternity_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForDeleteMaternityPaternitySchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForDeleteMaternityPaternity
...
class BaseApi(api_client.Api):
    ...
    def _delete_details_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _adelete_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Maternity Paternity  -  DeleteMaternityPaternity',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_delete_maternity_paternity_parameter.serialize(body, content_type)
...
class DeleteDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_details(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._delete_details_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            maternity_paternity_txn_id=maternity_paternity_txn_id,
        )
        return await self._adelete_details_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def delete_details(
        ...
        return self._delete_details_oapg(
            body=args.body,
        )

class DeleteDetails(BaseApi):
    ...
    async def adelete_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForDeleteMaternityPaternityPydantic:
        raw_response = await self.raw.adelete_details(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            maternity_paternity_txn_id=maternity_paternity_txn_id,
        ...
        if validate:
            return ErrorForDeleteMaternityPaternityPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForDeleteMaternityPaternityPydantic, raw_response.body)
    ...
    def delete_details(
        ...
        raw_response = self.raw.delete_details(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            maternity_paternity_txn_id=maternity_paternity_txn_id,
