...
from people_hr_python_sdk.model.get_qualification_by_qualification_id_parameter import GetQualificationByQualificationIdParameter as GetQualificationByQualificationIdParameterSchema
from people_hr_python_sdk.model.error_for_get_qualification_by_qualification_id import ErrorForGetQualificationByQualificationId as ErrorForGetQualificationByQualificationIdSchema

from people_hr_python_sdk.type.error_for_get_qualification_by_qualification_id import ErrorForGetQualificationByQualificationId
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.get_qualification_by_qualification_id_parameter import GetQualificationByQualificationIdParameter

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.get_qualification_by_qualification_id_parameter import GetQualificationByQualificationIdParameter as GetQualificationByQualificationIdParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic
from people_hr_python_sdk.pydantic.error_for_get_qualification_by_qualification_id import ErrorForGetQualificationByQualificationId as ErrorForGetQualificationByQualificationIdPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = GetQualificationByQualificationIdParameterSchema


request_body_get_qualification_by_qualification_id_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetQualificationByQualificationIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetQualificationByQualificationId
...
class BaseApi(api_client.Api):
    ...
    def _get_by_qualification_id_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aget_by_qualification_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Qualification  -  GetQualificationByQualificationId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_qualification_by_qualification_id_parameter.serialize(body, content_type)
    ...
    def _get_by_qualification_id_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetByQualificationIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_qualification_id(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._get_by_qualification_id_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            qualification_id=qualification_id,
        )
        return await self._aget_by_qualification_id_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_by_qualification_id(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._get_by_qualification_id_oapg(
            body=args.body,
        )

class GetByQualificationId(BaseApi):
    ...
    async def aget_by_qualification_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetQualificationByQualificationIdPydantic:
        raw_response = await self.raw.aget_by_qualification_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            qualification_id=qualification_id,
        ...
        if validate:
            return ErrorForGetQualificationByQualificationIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetQualificationByQualificationIdPydantic, raw_response.body)
    ...
    def get_by_qualification_id(
        ...
        raw_response = self.raw.get_by_qualification_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            qualification_id=qualification_id,
