...
from people_hr_python_sdk.model.create_new_timesheet_definition import CreateNewTimesheetDefinition as CreateNewTimesheetDefinitionSchema
from people_hr_python_sdk.model.error_for_create_new_employee_timesheet_detail import ErrorForCreateNewEmployeeTimesheetDetail as ErrorForCreateNewEmployeeTimesheetDetailSchema

from people_hr_python_sdk.type.error_for_create_new_employee_timesheet_detail import ErrorForCreateNewEmployeeTimesheetDetail
from people_hr_python_sdk.type.create_new_timesheet_definition import CreateNewTimesheetDefinition
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.create_new_timesheet_definition import CreateNewTimesheetDefinition as CreateNewTimesheetDefinitionPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_create_new_employee_timesheet_detail import ErrorForCreateNewEmployeeTimesheetDetail as ErrorForCreateNewEmployeeTimesheetDetailPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = CreateNewTimesheetDefinitionSchema


request_body_create_new_timesheet_definition = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForCreateNewEmployeeTimesheetDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForCreateNewEmployeeTimesheetDetail
...
class BaseApi(api_client.Api):
    ...
    def _create_new_timesheet_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        timesheet_date: date,
        time_in1: typing.Optional[str] = None,
        time_out1: typing.Optional[str] = None,
        time_in2: typing.Optional[str] = None,
        time_out2: typing.Optional[str] = None,
        time_in3: typing.Optional[str] = None,
        time_out3: typing.Optional[str] = None,
        time_in4: typing.Optional[str] = None,
        time_out4: typing.Optional[str] = None,
        time_in5: typing.Optional[str] = None,
        time_out5: typing.Optional[str] = None,
        time_in6: typing.Optional[str] = None,
        time_out6: typing.Optional[str] = None,
        time_in7: typing.Optional[str] = None,
        time_out7: typing.Optional[str] = None,
        time_in8: typing.Optional[str] = None,
        time_out8: typing.Optional[str] = None,
        time_in9: typing.Optional[str] = None,
        time_out9: typing.Optional[str] = None,
        time_in10: typing.Optional[str] = None,
        time_out10: typing.Optional[str] = None,
        time_in11: typing.Optional[str] = None,
        time_out11: typing.Optional[str] = None,
        time_in12: typing.Optional[str] = None,
        time_out12: typing.Optional[str] = None,
        time_in13: typing.Optional[str] = None,
        time_out13: typing.Optional[str] = None,
        time_in14: typing.Optional[str] = None,
        time_out14: typing.Optional[str] = None,
        time_in15: typing.Optional[str] = None,
        time_out15: typing.Optional[str] = None,
        ...
        if timesheet_date is not None:
            _body["TimesheetDate"] = timesheet_date
        if time_in1 is not None:
            _body["TimeIn1"] = time_in1
        if time_out1 is not None:
            _body["TimeOut1"] = time_out1
        if time_in2 is not None:
            _body["TimeIn2"] = time_in2
        if time_out2 is not None:
            _body["TimeOut2"] = time_out2
        if time_in3 is not None:
            _body["TimeIn3"] = time_in3
        if time_out3 is not None:
            _body["TimeOut3"] = time_out3
        if time_in4 is not None:
            _body["TimeIn4"] = time_in4
        if time_out4 is not None:
            _body["TimeOut4"] = time_out4
        if time_in5 is not None:
            _body["TimeIn5"] = time_in5
        if time_out5 is not None:
            _body["TimeOut5"] = time_out5
        if time_in6 is not None:
            _body["TimeIn6"] = time_in6
        if time_out6 is not None:
            _body["TimeOut6"] = time_out6
        if time_in7 is not None:
            _body["TimeIn7"] = time_in7
        if time_out7 is not None:
            _body["TimeOut7"] = time_out7
        if time_in8 is not None:
            _body["TimeIn8"] = time_in8
        if time_out8 is not None:
            _body["TimeOut8"] = time_out8
        if time_in9 is not None:
            _body["TimeIn9"] = time_in9
        if time_out9 is not None:
            _body["TimeOut9"] = time_out9
        if time_in10 is not None:
            _body["TimeIn10"] = time_in10
        if time_out10 is not None:
            _body["TimeOut10"] = time_out10
        if time_in11 is not None:
            _body["TimeIn11"] = time_in11
        if time_out11 is not None:
            _body["TimeOut11"] = time_out11
        if time_in12 is not None:
            _body["TimeIn12"] = time_in12
        if time_out12 is not None:
            _body["TimeOut12"] = time_out12
        if time_in13 is not None:
            _body["TimeIn13"] = time_in13
        if time_out13 is not None:
            _body["TimeOut13"] = time_out13
        if time_in14 is not None:
            _body["TimeIn14"] = time_in14
        if time_out14 is not None:
            _body["TimeOut14"] = time_out14
        if time_in15 is not None:
            _body["TimeIn15"] = time_in15
        if time_out15 is not None:
            _body["TimeOut15"] = time_out15
        if comments is not None:
            _body["Comments"] = comments
        args.body = _body
        return args

    async def _acreate_new_timesheet_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Timesheet  -  CreateNewTimesheet',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_create_new_timesheet_definition.serialize(body, content_type)
    ...
    def _create_new_timesheet_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateNewTimesheetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_timesheet(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._create_new_timesheet_mapped_args(
            api_key=api_key,
            action=action,
            ...
            time_out9=time_out9,
            time_in10=time_in10,
            time_out10=time_out10,
            time_in11=time_in11,
            time_out11=time_out11,
            time_in12=time_in12,
            time_out12=time_out12,
            time_in13=time_in13,
            time_out13=time_out13,
            time_in14=time_in14,
            time_out14=time_out14,
            time_in15=time_in15,
            time_out15=time_out15,
            comments=comments,
        )
        return await self._acreate_new_timesheet_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_new_timesheet(
        ...
        return self._create_new_timesheet_oapg(
            body=args.body,
        )

class CreateNewTimesheet(BaseApi):
    ...
    async def acreate_new_timesheet(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForCreateNewEmployeeTimesheetDetailPydantic:
        raw_response = await self.raw.acreate_new_timesheet(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            timesheet_date=timesheet_date,
        ...
        if validate:
            return ErrorForCreateNewEmployeeTimesheetDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForCreateNewEmployeeTimesheetDetailPydantic, raw_response.body)
    ...
    def create_new_timesheet(
        ...
        raw_response = self.raw.create_new_timesheet(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            timesheet_date=timesheet_date,
