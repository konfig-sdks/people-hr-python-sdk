...
from people_hr_python_sdk.model.get_query_result_parameter import GetQueryResultParameter as GetQueryResultParameterSchema
from people_hr_python_sdk.model.error_for_get_query_result import ErrorForGetQueryResult as ErrorForGetQueryResultSchema

from people_hr_python_sdk.type.error_for_get_query_result import ErrorForGetQueryResult
from people_hr_python_sdk.type.get_query_result_parameter import GetQueryResultParameter
from people_hr_python_sdk.type.api_key import APIKey

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_get_query_result import ErrorForGetQueryResult as ErrorForGetQueryResultPydantic
from people_hr_python_sdk.pydantic.get_query_result_parameter import GetQueryResultParameter as GetQueryResultParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = GetQueryResultParameterSchema


request_body_get_query_result_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetQueryResultSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetQueryResult
...
class BaseApi(api_client.Api):
    ...
    def _get_result_by_query_id_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        query_name: str,
    ...
    async def _aget_result_by_query_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Query  -  GetQueryResult',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_query_result_parameter.serialize(body, content_type)
    ...
    def _get_result_by_query_id_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetResultByQueryIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_result_by_query_id(
        self,
        api_key: APIKey,
        action: str,
        query_name: str,
        **kwargs,
        ...
        args = self._get_result_by_query_id_mapped_args(
            api_key=api_key,
            action=action,
            query_name=query_name,
        )
        return await self._aget_result_by_query_id_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def get_result_by_query_id(
        ...
        return self._get_result_by_query_id_oapg(
            body=args.body,
        )

class GetResultByQueryId(BaseApi):
    ...
    async def aget_result_by_query_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetQueryResultPydantic:
        raw_response = await self.raw.aget_result_by_query_id(
            api_key=api_key,
            action=action,
            query_name=query_name,
            **kwargs,
        ...
        if validate:
            return ErrorForGetQueryResultPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetQueryResultPydantic, raw_response.body)
    ...
    def get_result_by_query_id(
        ...
        raw_response = self.raw.get_result_by_query_id(
            api_key=api_key,
            action=action,
            query_name=query_name,
        )
