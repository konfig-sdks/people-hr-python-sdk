...
from people_hr_python_sdk.model.error_for_create_project_timesheet import ErrorForCreateProjectTimesheet as ErrorForCreateProjectTimesheetSchema
from people_hr_python_sdk.model.create_project_timesheet_parameter import CreateProjectTimesheetParameter as CreateProjectTimesheetParameterSchema

from people_hr_python_sdk.type.error_for_create_project_timesheet import ErrorForCreateProjectTimesheet
from people_hr_python_sdk.type.create_project_timesheet_parameter import CreateProjectTimesheetParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_create_project_timesheet import ErrorForCreateProjectTimesheet as ErrorForCreateProjectTimesheetPydantic
...
from people_hr_python_sdk.pydantic.create_project_timesheet_parameter import CreateProjectTimesheetParameter as CreateProjectTimesheetParameterPydantic

# body param
SchemaForRequestBodyApplicationJson = CreateProjectTimesheetParameterSchema


request_body_create_project_timesheet_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForCreateProjectTimesheetSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForCreateProjectTimesheet
...
class BaseApi(api_client.Api):
    ...
    def _create_timesheet_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        project_timesheet_date: date,
        timesheet_project: str,
        timesheet_task: str,
        timesheet_detail: str,
        start_time: str,
        end_time: str,
        total_hours: str,
        quantity: int,
        ...
        if project_timesheet_date is not None:
            _body["ProjectTimesheetDate"] = project_timesheet_date
        if timesheet_project is not None:
            _body["TimesheetProject"] = timesheet_project
        if timesheet_task is not None:
            _body["TimesheetTask"] = timesheet_task
        if timesheet_detail is not None:
            _body["TimesheetDetail"] = timesheet_detail
        if start_time is not None:
            _body["StartTime"] = start_time
        if end_time is not None:
            _body["EndTime"] = end_time
        if total_hours is not None:
            _body["TotalHours"] = total_hours
    ...
    async def _acreate_timesheet_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Project Timesheet  -  CreateProjectTimesheet',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_create_project_timesheet_parameter.serialize(body, content_type)
...
class CreateTimesheetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_timesheet(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._create_timesheet_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            project_timesheet_date=project_timesheet_date,
        ...
        return await self._acreate_timesheet_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_timesheet(
        ...
        return self._create_timesheet_oapg(
            body=args.body,
        )

class CreateTimesheet(BaseApi):
    ...
    async def acreate_timesheet(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForCreateProjectTimesheetPydantic:
        raw_response = await self.raw.acreate_timesheet(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            project_timesheet_date=project_timesheet_date,
        ...
        if validate:
            return ErrorForCreateProjectTimesheetPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForCreateProjectTimesheetPydantic, raw_response.body)
    ...
    def create_timesheet(
        ...
        raw_response = self.raw.create_timesheet(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            project_timesheet_date=project_timesheet_date,
