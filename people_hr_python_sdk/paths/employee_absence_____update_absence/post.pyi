...
from people_hr_python_sdk.model.byte import Byte as ByteSchema
from people_hr_python_sdk.model.add_comments_array_for_absence import AddCommentsArrayForAbsence as AddCommentsArrayForAbsenceSchema
from people_hr_python_sdk.model.error_for_update_absence_details import ErrorForUpdateAbsenceDetails as ErrorForUpdateAbsenceDetailsSchema
from people_hr_python_sdk.model.update_absence_detail_parameter import UpdateAbsenceDetailParameter as UpdateAbsenceDetailParameterSchema
from people_hr_python_sdk.model.emergency_leave import EmergencyLeave as EmergencyLeaveSchema
from people_hr_python_sdk.model.add_files_array_for_absence import AddFilesArrayForAbsence as AddFilesArrayForAbsenceSchema
from people_hr_python_sdk.model.part_of_day_for_update_absence import PartOfDayForUpdateAbsence as PartOfDayForUpdateAbsenceSchema

from people_hr_python_sdk.type.error_for_update_absence_details import ErrorForUpdateAbsenceDetails
from people_hr_python_sdk.type.part_of_day_for_update_absence import PartOfDayForUpdateAbsence
from people_hr_python_sdk.type.add_comments_array_for_absence import AddCommentsArrayForAbsence
from people_hr_python_sdk.type.emergency_leave import EmergencyLeave
from people_hr_python_sdk.type.update_absence_detail_parameter import UpdateAbsenceDetailParameter
from people_hr_python_sdk.type.add_files_array_for_absence import AddFilesArrayForAbsence
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.byte import Byte

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.emergency_leave import EmergencyLeave as EmergencyLeavePydantic
from people_hr_python_sdk.pydantic.add_files_array_for_absence import AddFilesArrayForAbsence as AddFilesArrayForAbsencePydantic
from people_hr_python_sdk.pydantic.part_of_day_for_update_absence import PartOfDayForUpdateAbsence as PartOfDayForUpdateAbsencePydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_update_absence_details import ErrorForUpdateAbsenceDetails as ErrorForUpdateAbsenceDetailsPydantic
from people_hr_python_sdk.pydantic.add_comments_array_for_absence import AddCommentsArrayForAbsence as AddCommentsArrayForAbsencePydantic
from people_hr_python_sdk.pydantic.byte import Byte as BytePydantic
from people_hr_python_sdk.pydantic.update_absence_detail_parameter import UpdateAbsenceDetailParameter as UpdateAbsenceDetailParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = UpdateAbsenceDetailParameterSchema


request_body_update_absence_detail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUpdateAbsenceDetailsSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUpdateAbsenceDetails
...
class BaseApi(api_client.Api):
    ...
    def _update_absence_record_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        end_date: date,
        duration: int,
        absence_paid_status: Byte,
        emergency_leave: EmergencyLeave,
        part_of_day: typing.Optional[PartOfDayForUpdateAbsence] = None,
        add_comments: typing.Optional[AddCommentsArrayForAbsence] = None,
        add_files: typing.Optional[AddFilesArrayForAbsence] = None,
        ...
        if old_start_date is not None:
            _body["OldStartDate"] = old_start_date
        if old_end_date is not None:
            _body["OldEndDate"] = old_end_date
        if duration_type is not None:
            _body["DurationType"] = duration_type
        ...
        if part_of_day is not None:
            _body["PartOfDay"] = part_of_day
        if duration is not None:
            _body["Duration"] = duration
        if absence_paid_status is not None:
            _body["AbsencePaidStatus"] = absence_paid_status
        if emergency_leave is not None:
            _body["EmergencyLeave"] = emergency_leave
        if add_comments is not None:
            _body["AddComments"] = add_comments
        if add_files is not None:
            _body["AddFiles"] = add_files
        args.body = _body
        return args

    async def _aupdate_absence_record_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeAbsence  -  UpdateAbsence',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_absence_detail_parameter.serialize(body, content_type)
    ...
    def _update_absence_record_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateAbsenceRecordRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_absence_record(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._update_absence_record_mapped_args(
            api_key=api_key,
            action=action,
            ...
            end_date=end_date,
            duration=duration,
            absence_paid_status=absence_paid_status,
            emergency_leave=emergency_leave,
            part_of_day=part_of_day,
            add_comments=add_comments,
            add_files=add_files,
        )
        return await self._aupdate_absence_record_oapg(
            body=args.body,
            **kwargs,
        )
    
    def update_absence_record(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._update_absence_record_oapg(
            body=args.body,
        )

class UpdateAbsenceRecord(BaseApi):
    ...
    async def aupdate_absence_record(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForUpdateAbsenceDetailsPydantic:
        raw_response = await self.raw.aupdate_absence_record(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            old_start_date=old_start_date,
        ...
        if validate:
            return ErrorForUpdateAbsenceDetailsPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUpdateAbsenceDetailsPydantic, raw_response.body)
    ...
    def update_absence_record(
        ...
        raw_response = self.raw.update_absence_record(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            old_start_date=old_start_date,
