...
from people_hr_python_sdk.model.error_for_update_holiday import ErrorForUpdateHoliday as ErrorForUpdateHolidaySchema
from people_hr_python_sdk.model.update_holiday_parameter import UpdateHolidayParameter as UpdateHolidayParameterSchema

from people_hr_python_sdk.type.part_of_day import PartOfDay
from people_hr_python_sdk.type.error_for_update_holiday import ErrorForUpdateHoliday
from people_hr_python_sdk.type.update_holiday_parameter import UpdateHolidayParameter
...
from people_hr_python_sdk.pydantic.error_for_update_holiday import ErrorForUpdateHoliday as ErrorForUpdateHolidayPydantic
from people_hr_python_sdk.pydantic.byte import Byte as BytePydantic
from people_hr_python_sdk.pydantic.update_holiday_parameter import UpdateHolidayParameter as UpdateHolidayParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = UpdateHolidayParameterSchema


request_body_update_holiday_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUpdateHolidaySchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUpdateHoliday
    ...
    async def _aupdate_detail_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Holiday  -  UpdateHoliday',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_holiday_parameter.serialize(body, content_type)
...
class UpdateDetail(BaseApi):
    ...
    async def aupdate_detail(
        ...
        **kwargs,
        ...
        if validate:
            return ErrorForUpdateHolidayPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUpdateHolidayPydantic, raw_response.body)
