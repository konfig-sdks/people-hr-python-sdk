...
from people_hr_python_sdk.model.error_for_add_new_driving_license import ErrorForAddNewDrivingLicense as ErrorForAddNewDrivingLicenseSchema
...
from people_hr_python_sdk.model.add_new_driving_license_parameter import AddNewDrivingLicenseParameter as AddNewDrivingLicenseParameterSchema
...
from people_hr_python_sdk.type.error_for_add_new_driving_license import ErrorForAddNewDrivingLicense
...
from people_hr_python_sdk.type.add_new_driving_license_parameter import AddNewDrivingLicenseParameter

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.license_number import LicenseNumber as LicenseNumberPydantic
from people_hr_python_sdk.pydantic.error_for_add_new_driving_license import ErrorForAddNewDrivingLicense as ErrorForAddNewDrivingLicensePydantic
from people_hr_python_sdk.pydantic.add_new_driving_license_parameter import AddNewDrivingLicenseParameter as AddNewDrivingLicenseParameterPydantic
...
# body param
SchemaForRequestBodyApplicationJson = AddNewDrivingLicenseParameterSchema


request_body_add_new_driving_license_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForAddNewDrivingLicenseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForAddNewDrivingLicense
...
class BaseApi(api_client.Api):
    ...
    def _add_new_driving_license_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aadd_new_driving_license_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Driving  -  AddNewDrivingLicense',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_add_new_driving_license_parameter.serialize(body, content_type)
    ...
    def _add_new_driving_license_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class AddNewDrivingLicenseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_new_driving_license(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._add_new_driving_license_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aadd_new_driving_license_oapg(
            body=args.body,
            **kwargs,
        )
    
    def add_new_driving_license(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._add_new_driving_license_oapg(
            body=args.body,
        )

class AddNewDrivingLicense(BaseApi):
    ...
    async def aadd_new_driving_license(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForAddNewDrivingLicensePydantic:
        raw_response = await self.raw.aadd_new_driving_license(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            license_number=license_number,
        ...
        if validate:
            return ErrorForAddNewDrivingLicensePydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForAddNewDrivingLicensePydantic, raw_response.body)
    ...
    def add_new_driving_license(
        ...
        raw_response = self.raw.add_new_driving_license(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            license_number=license_number,
