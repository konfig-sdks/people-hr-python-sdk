...
from people_hr_python_sdk.model.error_for_add_new_custom_screen_transaction import ErrorForAddNewCustomScreenTransaction as ErrorForAddNewCustomScreenTransactionSchema
...
from people_hr_python_sdk.model.add_new_custom_screen_transaction_parameter import AddNewCustomScreenTransactionParameter as AddNewCustomScreenTransactionParameterSchema
...
from people_hr_python_sdk.type.error_for_add_new_custom_screen_transaction import ErrorForAddNewCustomScreenTransaction
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.add_new_custom_screen_transaction_parameter import AddNewCustomScreenTransactionParameter
...
from people_hr_python_sdk.pydantic.add_new_custom_screen_transaction_parameter import AddNewCustomScreenTransactionParameter as AddNewCustomScreenTransactionParameterPydantic
...
from people_hr_python_sdk.pydantic.error_for_add_new_custom_screen_transaction import ErrorForAddNewCustomScreenTransaction as ErrorForAddNewCustomScreenTransactionPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = AddNewCustomScreenTransactionParameterSchema


request_body_add_new_custom_screen_transaction_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForAddNewCustomScreenTransactionSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForAddNewCustomScreenTransaction
...
class BaseApi(api_client.Api):
    ...
    def _add_new_custom_screen_transaction_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aadd_new_custom_screen_transaction_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Custom Screen  -  AddNewCustomScreenTransaction',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_add_new_custom_screen_transaction_parameter.serialize(body, content_type)
    ...
    def _add_new_custom_screen_transaction_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class AddNewCustomScreenTransactionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_new_custom_screen_transaction(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._add_new_custom_screen_transaction_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aadd_new_custom_screen_transaction_oapg(
            body=args.body,
            **kwargs,
        )
    
    def add_new_custom_screen_transaction(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._add_new_custom_screen_transaction_oapg(
            body=args.body,
        )

class AddNewCustomScreenTransaction(BaseApi):
    ...
    async def aadd_new_custom_screen_transaction(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForAddNewCustomScreenTransactionPydantic:
        raw_response = await self.raw.aadd_new_custom_screen_transaction(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            screen_id=screen_id,
        ...
        if validate:
            return ErrorForAddNewCustomScreenTransactionPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForAddNewCustomScreenTransactionPydantic, raw_response.body)
    ...
    def add_new_custom_screen_transaction(
        ...
        raw_response = self.raw.add_new_custom_screen_transaction(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            screen_id=screen_id,
