...
from people_hr_python_sdk.model.check_duplicate_applicant_parameter import CheckDuplicateApplicantParameter as CheckDuplicateApplicantParameterSchema
...
from people_hr_python_sdk.model.error_for_check_duplicate_applicant import ErrorForCheckDuplicateApplicant as ErrorForCheckDuplicateApplicantSchema

from people_hr_python_sdk.type.error_for_check_duplicate_applicant import ErrorForCheckDuplicateApplicant
...
from people_hr_python_sdk.type.check_duplicate_applicant_parameter import CheckDuplicateApplicantParameter

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_check_duplicate_applicant import ErrorForCheckDuplicateApplicant as ErrorForCheckDuplicateApplicantPydantic
...
from people_hr_python_sdk.pydantic.check_duplicate_applicant_parameter import CheckDuplicateApplicantParameter as CheckDuplicateApplicantParameterPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CheckDuplicateApplicantParameterSchema


request_body_check_duplicate_applicant_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForCheckDuplicateApplicantSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForCheckDuplicateApplicant
...
class BaseApi(api_client.Api):
    ...
    def _check_duplicate_applicant_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _acheck_duplicate_applicant_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Applicant  -  CheckDuplicateApplicant',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_check_duplicate_applicant_parameter.serialize(body, content_type)
    ...
    def _check_duplicate_applicant_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CheckDuplicateApplicantRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_duplicate_applicant(
        self,
        api_key: APIKey,
        action: str,
        first_name: FirstName,
        ...
        **kwargs,
        ...
        args = self._check_duplicate_applicant_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._acheck_duplicate_applicant_oapg(
            body=args.body,
            **kwargs,
        )
    
    def check_duplicate_applicant(
        self,
        api_key: APIKey,
        action: str,
        first_name: FirstName,
        ...
        return self._check_duplicate_applicant_oapg(
            body=args.body,
        )

class CheckDuplicateApplicant(BaseApi):
    ...
    async def acheck_duplicate_applicant(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForCheckDuplicateApplicantPydantic:
        raw_response = await self.raw.acheck_duplicate_applicant(
            api_key=api_key,
            action=action,
            first_name=first_name,
            last_name=last_name,
        ...
        if validate:
            return ErrorForCheckDuplicateApplicantPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForCheckDuplicateApplicantPydantic, raw_response.body)
    ...
    def check_duplicate_applicant(
        ...
        raw_response = self.raw.check_duplicate_applicant(
            api_key=api_key,
            action=action,
            first_name=first_name,
            last_name=last_name,
