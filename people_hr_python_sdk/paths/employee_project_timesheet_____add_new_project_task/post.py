...
from people_hr_python_sdk.model.error_for_add_new_project_task import ErrorForAddNewProjectTask as ErrorForAddNewProjectTaskSchema
from people_hr_python_sdk.model.project_task_name import ProjectTaskName as ProjectTaskNameSchema
from people_hr_python_sdk.model.add_new_project_task_parameter import AddNewProjectTaskParameter as AddNewProjectTaskParameterSchema

from people_hr_python_sdk.type.project_task_name import ProjectTaskName
from people_hr_python_sdk.type.add_new_project_task_parameter import AddNewProjectTaskParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.error_for_add_new_project_task import ErrorForAddNewProjectTask

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_add_new_project_task import ErrorForAddNewProjectTask as ErrorForAddNewProjectTaskPydantic
from people_hr_python_sdk.pydantic.project_task_name import ProjectTaskName as ProjectTaskNamePydantic
from people_hr_python_sdk.pydantic.add_new_project_task_parameter import AddNewProjectTaskParameter as AddNewProjectTaskParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = AddNewProjectTaskParameterSchema


request_body_add_new_project_task_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForAddNewProjectTaskSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForAddNewProjectTask
...
class BaseApi(api_client.Api):
    ...
    def _add_new_project_task_detail_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aadd_new_project_task_detail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Project Timesheet  -  AddNewProjectTask',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_add_new_project_task_parameter.serialize(body, content_type)
    ...
    def _add_new_project_task_detail_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class AddNewProjectTaskDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_new_project_task_detail(
        self,
        api_key: APIKey,
        action: str,
        project_task_name: ProjectTaskName,
        ...
        **kwargs,
        ...
        args = self._add_new_project_task_detail_mapped_args(
            api_key=api_key,
            action=action,
            project_task_name=project_task_name,
            in_use=in_use,
        )
        return await self._aadd_new_project_task_detail_oapg(
            body=args.body,
            **kwargs,
        )
    
    def add_new_project_task_detail(
        self,
        api_key: APIKey,
        action: str,
        project_task_name: ProjectTaskName,
        ...
        return self._add_new_project_task_detail_oapg(
            body=args.body,
        )

class AddNewProjectTaskDetail(BaseApi):
    ...
    async def aadd_new_project_task_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForAddNewProjectTaskPydantic:
        raw_response = await self.raw.aadd_new_project_task_detail(
            api_key=api_key,
            action=action,
            project_task_name=project_task_name,
            in_use=in_use,
        ...
        if validate:
            return ErrorForAddNewProjectTaskPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForAddNewProjectTaskPydantic, raw_response.body)
    ...
    def add_new_project_task_detail(
        ...
        raw_response = self.raw.add_new_project_task_detail(
            api_key=api_key,
            action=action,
            project_task_name=project_task_name,
            in_use=in_use,
