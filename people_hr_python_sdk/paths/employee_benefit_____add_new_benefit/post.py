...
from people_hr_python_sdk.model.custom_columns_array_for_add_new_benefit import CustomColumnsArrayForAddNewBenefit as CustomColumnsArrayForAddNewBenefitSchema
from people_hr_python_sdk.model.api_key import APIKey as APIKeySchema
from people_hr_python_sdk.model.recover_on_termination import RecoverOnTermination as RecoverOnTerminationSchema
from people_hr_python_sdk.model.add_new_benefit_parameter import AddNewBenefitParameter as AddNewBenefitParameterSchema
from people_hr_python_sdk.model.error_for_add_new_benefit_api import ErrorForAddNewBenefitApi as ErrorForAddNewBenefitApiSchema
from people_hr_python_sdk.model.add_files_array_for_add_new_benefit import AddFilesArrayForAddNewBenefit as AddFilesArrayForAddNewBenefitSchema

from people_hr_python_sdk.type.recover_on_termination import RecoverOnTermination
from people_hr_python_sdk.type.add_new_benefit_parameter import AddNewBenefitParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.add_files_array_for_add_new_benefit import AddFilesArrayForAddNewBenefit
from people_hr_python_sdk.type.custom_columns_array_for_add_new_benefit import CustomColumnsArrayForAddNewBenefit
from people_hr_python_sdk.type.error_for_add_new_benefit_api import ErrorForAddNewBenefitApi

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.custom_columns_array_for_add_new_benefit import CustomColumnsArrayForAddNewBenefit as CustomColumnsArrayForAddNewBenefitPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.recover_on_termination import RecoverOnTermination as RecoverOnTerminationPydantic
from people_hr_python_sdk.pydantic.error_for_add_new_benefit_api import ErrorForAddNewBenefitApi as ErrorForAddNewBenefitApiPydantic
from people_hr_python_sdk.pydantic.add_new_benefit_parameter import AddNewBenefitParameter as AddNewBenefitParameterPydantic
from people_hr_python_sdk.pydantic.add_files_array_for_add_new_benefit import AddFilesArrayForAddNewBenefit as AddFilesArrayForAddNewBenefitPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = AddNewBenefitParameterSchema


request_body_add_new_benefit_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForAddNewBenefitApiSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForAddNewBenefitApi
...
class BaseApi(api_client.Api):
    ...
    def _create_new_benefit_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        date_awarded: String,
        expiry_date: date,
        recover_on_termination: RecoverOnTermination,
        custom_columns: CustomColumnsArrayForAddNewBenefit,
        add_files: AddFilesArrayForAddNewBenefit,
        ...
        if benefit is not None:
            _body["Benefit"] = benefit
        if date_awarded is not None:
            _body["DateAwarded"] = date_awarded
        ...
        if recover_on_termination is not None:
            _body["RecoverOnTermination"] = recover_on_termination
    ...
    async def _acreate_new_benefit_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeBenefit  -  AddNewBenefit',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_add_new_benefit_parameter.serialize(body, content_type)
...
class CreateNewBenefitRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_benefit(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._create_new_benefit_mapped_args(
            api_key=api_key,
            action=action,
            ...
            recover_on_termination=recover_on_termination,
            custom_columns=custom_columns,
            add_files=add_files,
            value=value,
            comments=comments,
        )
        return await self._acreate_new_benefit_oapg(
            body=args.body,
            **kwargs,
        )
    
    def create_new_benefit(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._create_new_benefit_oapg(
            body=args.body,
        )

class CreateNewBenefit(BaseApi):
    ...
    async def acreate_new_benefit(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForAddNewBenefitApiPydantic:
        raw_response = await self.raw.acreate_new_benefit(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            benefit=benefit,
        ...
        if validate:
            return ErrorForAddNewBenefitApiPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForAddNewBenefitApiPydantic, raw_response.body)
    ...
    def create_new_benefit(
        ...
        raw_response = self.raw.create_new_benefit(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            benefit=benefit,
