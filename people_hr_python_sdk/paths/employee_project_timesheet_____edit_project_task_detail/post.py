...
from people_hr_python_sdk.model.error_for_edit_project_task_detail import ErrorForEditProjectTaskDetail as ErrorForEditProjectTaskDetailSchema
...
from people_hr_python_sdk.model.edit_project_task_detail_parameter import EditProjectTaskDetailParameter as EditProjectTaskDetailParameterSchema

from people_hr_python_sdk.type.error_for_edit_project_task_detail import ErrorForEditProjectTaskDetail
from people_hr_python_sdk.type.edit_project_task_detail_parameter import EditProjectTaskDetailParameter
...
from people_hr_python_sdk.pydantic.error_for_edit_project_task_detail import ErrorForEditProjectTaskDetail as ErrorForEditProjectTaskDetailPydantic
from people_hr_python_sdk.pydantic.edit_project_task_detail_parameter import EditProjectTaskDetailParameter as EditProjectTaskDetailParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = EditProjectTaskDetailParameterSchema


request_body_edit_project_task_detail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForEditProjectTaskDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForEditProjectTaskDetail
...
class BaseApi(api_client.Api):
    ...
    def _edit_task_detail_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        project_task_detail_name: ProjectTaskDetailName,
        new_project_task_detail_name: str,
        in_use: str,
        ...
        if new_project_task_detail_name is not None:
            _body["New_ProjectTaskDetailName"] = new_project_task_detail_name
        if in_use is not None:
            _body["InUse"] = in_use
        args.body = _body
        return args

    async def _aedit_task_detail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Project Timesheet  -  EditProjectTaskDetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_edit_project_task_detail_parameter.serialize(body, content_type)
...
class EditTaskDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aedit_task_detail(
        self,
        api_key: APIKey,
        action: str,
        project_task_detail_name: ProjectTaskDetailName,
        ...
        **kwargs,
        ...
        args = self._edit_task_detail_mapped_args(
            api_key=api_key,
            action=action,
            project_task_detail_name=project_task_detail_name,
            new_project_task_detail_name=new_project_task_detail_name,
            in_use=in_use,
        )
        return await self._aedit_task_detail_oapg(
            body=args.body,
            **kwargs,
        )
    
    def edit_task_detail(
        self,
        api_key: APIKey,
        action: str,
        project_task_detail_name: ProjectTaskDetailName,
        ...
        return self._edit_task_detail_oapg(
            body=args.body,
        )

class EditTaskDetail(BaseApi):
    ...
    async def aedit_task_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForEditProjectTaskDetailPydantic:
        raw_response = await self.raw.aedit_task_detail(
            api_key=api_key,
            action=action,
            project_task_detail_name=project_task_detail_name,
            new_project_task_detail_name=new_project_task_detail_name,
        ...
        if validate:
            return ErrorForEditProjectTaskDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForEditProjectTaskDetailPydantic, raw_response.body)
    ...
    def edit_task_detail(
        ...
        raw_response = self.raw.edit_task_detail(
            api_key=api_key,
            action=action,
            project_task_detail_name=project_task_detail_name,
            new_project_task_detail_name=new_project_task_detail_name,
