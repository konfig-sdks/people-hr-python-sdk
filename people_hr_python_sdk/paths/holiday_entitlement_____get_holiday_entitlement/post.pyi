...
from people_hr_python_sdk.model.error_for_get_holiday_entitlement import ErrorForGetHolidayEntitlement as ErrorForGetHolidayEntitlementSchema
from people_hr_python_sdk.model.get_holiday_entitlement_parameter import GetHolidayEntitlementParameter as GetHolidayEntitlementParameterSchema

from people_hr_python_sdk.type.get_holiday_entitlement_parameter import GetHolidayEntitlementParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.error_for_get_holiday_entitlement import ErrorForGetHolidayEntitlement

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_get_holiday_entitlement import ErrorForGetHolidayEntitlement as ErrorForGetHolidayEntitlementPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.get_holiday_entitlement_parameter import GetHolidayEntitlementParameter as GetHolidayEntitlementParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = GetHolidayEntitlementParameterSchema


request_body_get_holiday_entitlement_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetHolidayEntitlementSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetHolidayEntitlement
...
class BaseApi(api_client.Api):
    ...
    def _get_holiday_entitlement_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aget_holiday_entitlement_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Holiday Entitlement  -  GetHolidayEntitlement',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_holiday_entitlement_parameter.serialize(body, content_type)
    ...
    def _get_holiday_entitlement_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetHolidayEntitlementRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_holiday_entitlement(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._get_holiday_entitlement_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aget_holiday_entitlement_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def get_holiday_entitlement(
        ...
        return self._get_holiday_entitlement_oapg(
            body=args.body,
        )

class GetHolidayEntitlement(BaseApi):
    ...
    async def aget_holiday_entitlement(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetHolidayEntitlementPydantic:
        raw_response = await self.raw.aget_holiday_entitlement(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            start_date=start_date,
        ...
        if validate:
            return ErrorForGetHolidayEntitlementPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetHolidayEntitlementPydantic, raw_response.body)
    ...
    def get_holiday_entitlement(
        ...
        raw_response = self.raw.get_holiday_entitlement(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            start_date=start_date,
