...
from people_hr_python_sdk.model.custom_columns_for_employee_driving import CustomColumnsForEmployeeDriving as CustomColumnsForEmployeeDrivingSchema
from people_hr_python_sdk.model.error_for_update_driving_license import ErrorForUpdateDrivingLicense as ErrorForUpdateDrivingLicenseSchema
from people_hr_python_sdk.model.update_driving_license_parameter import UpdateDrivingLicenseParameter as UpdateDrivingLicenseParameterSchema
from people_hr_python_sdk.model.license_number import LicenseNumber as LicenseNumberSchema
from people_hr_python_sdk.model.add_files_for_employee_driving import AddFilesForEmployeeDriving as AddFilesForEmployeeDrivingSchema

from people_hr_python_sdk.type.custom_columns_for_employee_driving import CustomColumnsForEmployeeDriving
from people_hr_python_sdk.type.license_number import LicenseNumber
from people_hr_python_sdk.type.error_for_update_driving_license import ErrorForUpdateDrivingLicense
from people_hr_python_sdk.type.add_files_for_employee_driving import AddFilesForEmployeeDriving
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.update_driving_license_parameter import UpdateDrivingLicenseParameter

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.license_number import LicenseNumber as LicenseNumberPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_update_driving_license import ErrorForUpdateDrivingLicense as ErrorForUpdateDrivingLicensePydantic
from people_hr_python_sdk.pydantic.add_files_for_employee_driving import AddFilesForEmployeeDriving as AddFilesForEmployeeDrivingPydantic
from people_hr_python_sdk.pydantic.custom_columns_for_employee_driving import CustomColumnsForEmployeeDriving as CustomColumnsForEmployeeDrivingPydantic
from people_hr_python_sdk.pydantic.update_driving_license_parameter import UpdateDrivingLicenseParameter as UpdateDrivingLicenseParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = UpdateDrivingLicenseParameterSchema


request_body_update_driving_license_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUpdateDrivingLicenseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUpdateDrivingLicense
...
class BaseApi(api_client.Api):
    ...
    def _update_driving_license_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        custom_columns: typing.Optional[CustomColumnsForEmployeeDriving] = None,
        add_files: typing.Optional[AddFilesForEmployeeDriving] = None,
        ...
        if driving_id is not None:
            _body["DrivingId"] = driving_id
        if license_number is not None:
            _body["LicenseNumber"] = license_number
        if license_type is not None:
            _body["LicenseType"] = license_type
    ...
    async def _aupdate_driving_license_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Driving  -  UpdateDrivingLicense',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_driving_license_parameter.serialize(body, content_type)
    ...
    def _update_driving_license_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateDrivingLicenseRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_driving_license(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._update_driving_license_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aupdate_driving_license_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def update_driving_license(
        ...
        return self._update_driving_license_oapg(
            body=args.body,
        )

class UpdateDrivingLicense(BaseApi):
    ...
    async def aupdate_driving_license(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForUpdateDrivingLicensePydantic:
        raw_response = await self.raw.aupdate_driving_license(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            driving_id=driving_id,
        ...
        if validate:
            return ErrorForUpdateDrivingLicensePydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUpdateDrivingLicensePydantic, raw_response.body)
    ...
    def update_driving_license(
        ...
        raw_response = self.raw.update_driving_license(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            driving_id=driving_id,
