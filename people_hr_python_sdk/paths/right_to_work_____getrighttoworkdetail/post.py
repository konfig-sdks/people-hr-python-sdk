...
from people_hr_python_sdk.model.error_forgetrighttoworkdetail import ErrorForgetrighttoworkdetail as ErrorForgetrighttoworkdetailSchema
from people_hr_python_sdk.model.get_right_to_work_detail_parameter import GetRightToWorkDetailParameter as GetRightToWorkDetailParameterSchema

from people_hr_python_sdk.type.error_forgetrighttoworkdetail import ErrorForgetrighttoworkdetail
from people_hr_python_sdk.type.get_right_to_work_detail_parameter import GetRightToWorkDetailParameter
...
from people_hr_python_sdk.pydantic.get_right_to_work_detail_parameter import GetRightToWorkDetailParameter as GetRightToWorkDetailParameterPydantic
from people_hr_python_sdk.pydantic.error_forgetrighttoworkdetail import ErrorForgetrighttoworkdetail as ErrorForgetrighttoworkdetailPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = GetRightToWorkDetailParameterSchema


request_body_get_right_to_work_detail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForgetrighttoworkdetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForgetrighttoworkdetail
    ...
    async def _aget_detail_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Right To Work  -  getrighttoworkdetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_right_to_work_detail_parameter.serialize(body, content_type)
...
class GetDetail(BaseApi):
    ...
    async def aget_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForgetrighttoworkdetailPydantic:
        ...
        if validate:
            return ErrorForgetrighttoworkdetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForgetrighttoworkdetailPydantic, raw_response.body)
