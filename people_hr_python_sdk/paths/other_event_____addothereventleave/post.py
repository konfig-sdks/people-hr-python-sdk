...
from people_hr_python_sdk.model.result1_foraddothereventleave import Result1Foraddothereventleave as Result1ForaddothereventleaveSchema
from people_hr_python_sdk.model.byte import Byte as ByteSchema
from people_hr_python_sdk.model.addothereventleave_parameter import AddothereventleaveParameter as AddothereventleaveParameterSchema
from people_hr_python_sdk.model.error_foraddothereventleave import ErrorForaddothereventleave as ErrorForaddothereventleaveSchema

from people_hr_python_sdk.type.addothereventleave_parameter import AddothereventleaveParameter
from people_hr_python_sdk.type.error_foraddothereventleave import ErrorForaddothereventleave
from people_hr_python_sdk.type.result1_foraddothereventleave import Result1Foraddothereventleave
...
from people_hr_python_sdk.pydantic.addothereventleave_parameter import AddothereventleaveParameter as AddothereventleaveParameterPydantic
from people_hr_python_sdk.pydantic.error_foraddothereventleave import ErrorForaddothereventleave as ErrorForaddothereventleavePydantic
...
from people_hr_python_sdk.pydantic.result1_foraddothereventleave import Result1Foraddothereventleave as Result1ForaddothereventleavePydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = AddothereventleaveParameterSchema


request_body_addothereventleave_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForaddothereventleaveSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForaddothereventleave
...
class BaseApi(api_client.Api):
    ...
    def _create_event_leave_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        add_files: typing.Optional[Result1Foraddothereventleave] = None,
    ...
    async def _acreate_event_leave_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Other Event  -  addothereventleave',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_addothereventleave_parameter.serialize(body, content_type)
...
class CreateEventLeaveRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_event_leave(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._create_event_leave_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._acreate_event_leave_oapg(
            body=args.body,
            **kwargs,
        )
    
    def create_event_leave(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._create_event_leave_oapg(
            body=args.body,
        )

class CreateEventLeave(BaseApi):
    ...
    async def acreate_event_leave(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForaddothereventleavePydantic:
        raw_response = await self.raw.acreate_event_leave(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            duration_type=duration_type,
        ...
        if validate:
            return ErrorForaddothereventleavePydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForaddothereventleavePydantic, raw_response.body)
    ...
    def create_event_leave(
        ...
        raw_response = self.raw.create_event_leave(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            duration_type=duration_type,
