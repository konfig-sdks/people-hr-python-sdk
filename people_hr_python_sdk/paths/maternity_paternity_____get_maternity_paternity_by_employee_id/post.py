...
from people_hr_python_sdk.model.get_maternity_paternity_by_employee_id_parameter import GetMaternityPaternityByEmployeeIdParameter as GetMaternityPaternityByEmployeeIdParameterSchema
...
from people_hr_python_sdk.model.error_for_get_by_maternity_paternity_by_emp_id import ErrorForGetByMaternityPaternityByEmpId as ErrorForGetByMaternityPaternityByEmpIdSchema

from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.error_for_get_by_maternity_paternity_by_emp_id import ErrorForGetByMaternityPaternityByEmpId
from people_hr_python_sdk.type.get_maternity_paternity_by_employee_id_parameter import GetMaternityPaternityByEmployeeIdParameter

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_get_by_maternity_paternity_by_emp_id import ErrorForGetByMaternityPaternityByEmpId as ErrorForGetByMaternityPaternityByEmpIdPydantic
from people_hr_python_sdk.pydantic.get_maternity_paternity_by_employee_id_parameter import GetMaternityPaternityByEmployeeIdParameter as GetMaternityPaternityByEmployeeIdParameterPydantic
...
# body param
SchemaForRequestBodyApplicationJson = GetMaternityPaternityByEmployeeIdParameterSchema


request_body_get_maternity_paternity_by_employee_id_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetByMaternityPaternityByEmpIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetByMaternityPaternityByEmpId
...
class BaseApi(api_client.Api):
    ...
    def _get_by_employee_id_mapped_args(
        ...
        actual_start_date: typing.Optional[date] = None,
        actual_end_date: typing.Optional[date] = None,
    ...
    async def _aget_by_employee_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Maternity Paternity  -  GetMaternityPaternityByEmployeeId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_maternity_paternity_by_employee_id_parameter.serialize(body, content_type)
...
class GetByEmployeeId(BaseApi):
    ...
    async def aget_by_employee_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetByMaternityPaternityByEmpIdPydantic:
        ...
        if validate:
            return ErrorForGetByMaternityPaternityByEmpIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetByMaternityPaternityByEmpIdPydantic, raw_response.body)
