...
from people_hr_python_sdk.model.post_code import PostCode as PostCodeSchema
from people_hr_python_sdk.model.additional_questions_for_createnew_applicant_array import AdditionalQuestionsForCreatenewApplicantArray as AdditionalQuestionsForCreatenewApplicantArraySchema
from people_hr_python_sdk.model.gender import Gender as GenderSchema
from people_hr_python_sdk.model.error_for_create_new_applicant import ErrorForCreateNewApplicant as ErrorForCreateNewApplicantSchema
from people_hr_python_sdk.model.email import Email as EmailSchema
from people_hr_python_sdk.model.documents_for_create_new_applicant_array import DocumentsForCreateNewApplicantArray as DocumentsForCreateNewApplicantArraySchema
from people_hr_python_sdk.model.internal_questions_for_create_new_applicant_array import InternalQuestionsForCreateNewApplicantArray as InternalQuestionsForCreateNewApplicantArraySchema
from people_hr_python_sdk.model.create_applicant_detail_parameter import CreateApplicantDetailParameter as CreateApplicantDetailParameterSchema
...
from people_hr_python_sdk.type.internal_questions_for_create_new_applicant_array import InternalQuestionsForCreateNewApplicantArray
from people_hr_python_sdk.type.error_for_create_new_applicant import ErrorForCreateNewApplicant
from people_hr_python_sdk.type.create_applicant_detail_parameter import CreateApplicantDetailParameter
from people_hr_python_sdk.type.post_code import PostCode
...
from people_hr_python_sdk.type.documents_for_create_new_applicant_array import DocumentsForCreateNewApplicantArray
from people_hr_python_sdk.type.additional_questions_for_createnew_applicant_array import AdditionalQuestionsForCreatenewApplicantArray

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_create_new_applicant import ErrorForCreateNewApplicant as ErrorForCreateNewApplicantPydantic
...
from people_hr_python_sdk.pydantic.post_code import PostCode as PostCodePydantic
from people_hr_python_sdk.pydantic.create_applicant_detail_parameter import CreateApplicantDetailParameter as CreateApplicantDetailParameterPydantic
from people_hr_python_sdk.pydantic.first_name import FirstName as FirstNamePydantic
from people_hr_python_sdk.pydantic.documents_for_create_new_applicant_array import DocumentsForCreateNewApplicantArray as DocumentsForCreateNewApplicantArrayPydantic
from people_hr_python_sdk.pydantic.internal_questions_for_create_new_applicant_array import InternalQuestionsForCreateNewApplicantArray as InternalQuestionsForCreateNewApplicantArrayPydantic
from people_hr_python_sdk.pydantic.email import Email as EmailPydantic
from people_hr_python_sdk.pydantic.additional_questions_for_createnew_applicant_array import AdditionalQuestionsForCreatenewApplicantArray as AdditionalQuestionsForCreatenewApplicantArrayPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = CreateApplicantDetailParameterSchema


request_body_create_applicant_detail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForCreateNewApplicantSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForCreateNewApplicant
...
class BaseApi(api_client.Api):
    ...
    def _create_new_applicant_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        first_name: FirstName,
        last_name: LastName,
        documents: DocumentsForCreateNewApplicantArray,
        skills: str,
        vacancy_reference: typing.Optional[str] = None,
        email: typing.Optional[Email] = None,
        gender: typing.Optional[Gender] = None,
        date_of_birth: typing.Optional[date] = None,
        post_code: typing.Optional[PostCode] = None,
        address: typing.Optional[str] = None,
        phone_number: typing.Optional[str] = None,
        other_contact_details: typing.Optional[str] = None,
        source: typing.Optional[str] = None,
        additional_questions: typing.Optional[AdditionalQuestionsForCreatenewApplicantArray] = None,
        internal_questions: typing.Optional[InternalQuestionsForCreateNewApplicantArray] = None,
        recruitment_cost: typing.Optional[int] = None,
        date_last_contacted: typing.Optional[date] = None,
        ...
        if action is not None:
            _body["Action"] = action
        if vacancy_reference is not None:
            _body["VacancyReference"] = vacancy_reference
        ...
        if other_contact_details is not None:
            _body["OtherContactDetails"] = other_contact_details
        if source is not None:
            _body["Source"] = source
        if additional_questions is not None:
            _body["AdditionalQuestions"] = additional_questions
        if internal_questions is not None:
            _body["InternalQuestions"] = internal_questions
        if documents is not None:
            _body["Documents"] = documents
        if skills is not None:
            _body["Skills"] = skills
        if recruitment_cost is not None:
            _body["RecruitmentCost"] = recruitment_cost
        if date_last_contacted is not None:
            _body["DateLastContacted"] = date_last_contacted
        args.body = _body
        return args

    async def _acreate_new_applicant_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Applicant  -  CreateNewApplicant',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_create_applicant_detail_parameter.serialize(body, content_type)
    ...
    def _create_new_applicant_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CreateNewApplicantRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_applicant(
        self,
        api_key: APIKey,
        action: str,
        first_name: FirstName,
        ...
        **kwargs,
        ...
        args = self._create_new_applicant_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._acreate_new_applicant_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_new_applicant(
        ...
        return self._create_new_applicant_oapg(
            body=args.body,
        )

class CreateNewApplicant(BaseApi):
    ...
    async def acreate_new_applicant(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForCreateNewApplicantPydantic:
        raw_response = await self.raw.acreate_new_applicant(
            api_key=api_key,
            action=action,
            first_name=first_name,
            last_name=last_name,
        ...
        if validate:
            return ErrorForCreateNewApplicantPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForCreateNewApplicantPydantic, raw_response.body)
    ...
    def create_new_applicant(
        ...
        raw_response = self.raw.create_new_applicant(
            api_key=api_key,
            action=action,
            first_name=first_name,
            last_name=last_name,
