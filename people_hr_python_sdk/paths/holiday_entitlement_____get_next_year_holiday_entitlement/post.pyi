...
from people_hr_python_sdk.model.get_next_year_holiday_entitlement_parameter import GetNextYearHolidayEntitlementParameter as GetNextYearHolidayEntitlementParameterSchema
from people_hr_python_sdk.model.error_for_get_next_year_holiday_entitlement import ErrorForGetNextYearHolidayEntitlement as ErrorForGetNextYearHolidayEntitlementSchema

from people_hr_python_sdk.type.error_for_get_next_year_holiday_entitlement import ErrorForGetNextYearHolidayEntitlement
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.get_next_year_holiday_entitlement_parameter import GetNextYearHolidayEntitlementParameter

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.get_next_year_holiday_entitlement_parameter import GetNextYearHolidayEntitlementParameter as GetNextYearHolidayEntitlementParameterPydantic
from people_hr_python_sdk.pydantic.error_for_get_next_year_holiday_entitlement import ErrorForGetNextYearHolidayEntitlement as ErrorForGetNextYearHolidayEntitlementPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = GetNextYearHolidayEntitlementParameterSchema


request_body_get_next_year_holiday_entitlement_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetNextYearHolidayEntitlementSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetNextYearHolidayEntitlement
...
class BaseApi(api_client.Api):
    ...
    def _get_next_year_entitlement_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aget_next_year_entitlement_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Holiday Entitlement  -  GetNextYearHolidayEntitlement',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_next_year_holiday_entitlement_parameter.serialize(body, content_type)
    ...
    def _get_next_year_entitlement_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetNextYearEntitlementRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_next_year_entitlement(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        **kwargs,
        ...
        args = self._get_next_year_entitlement_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
        )
        return await self._aget_next_year_entitlement_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_next_year_entitlement(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._get_next_year_entitlement_oapg(
            body=args.body,
        )

class GetNextYearEntitlement(BaseApi):
    ...
    async def aget_next_year_entitlement(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetNextYearHolidayEntitlementPydantic:
        raw_response = await self.raw.aget_next_year_entitlement(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            **kwargs,
        ...
        if validate:
            return ErrorForGetNextYearHolidayEntitlementPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetNextYearHolidayEntitlementPydantic, raw_response.body)
    ...
    def get_next_year_entitlement(
        ...
        raw_response = self.raw.get_next_year_entitlement(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
        )
