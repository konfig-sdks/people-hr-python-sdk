...
from people_hr_python_sdk.model.error_for_get_late_by_employee_id import ErrorForGetLateByEmployeeId as ErrorForGetLateByEmployeeIdSchema
from people_hr_python_sdk.model.get_late_by_employee_id_parameter import GetLateByEmployeeIdParameter as GetLateByEmployeeIdParameterSchema

from people_hr_python_sdk.type.get_late_by_employee_id_parameter import GetLateByEmployeeIdParameter
from people_hr_python_sdk.type.error_for_get_late_by_employee_id import ErrorForGetLateByEmployeeId
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.get_late_by_employee_id_parameter import GetLateByEmployeeIdParameter as GetLateByEmployeeIdParameterPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_get_late_by_employee_id import ErrorForGetLateByEmployeeId as ErrorForGetLateByEmployeeIdPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = GetLateByEmployeeIdParameterSchema


request_body_get_late_by_employee_id_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetLateByEmployeeIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetLateByEmployeeId
    ...
    async def _aget_by_employee_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employeee Late  -  GetLateByEmployeeId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_late_by_employee_id_parameter.serialize(body, content_type)
...
class GetByEmployeeId(BaseApi):
    ...
    async def aget_by_employee_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetLateByEmployeeIdPydantic:
        ...
        if validate:
            return ErrorForGetLateByEmployeeIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetLateByEmployeeIdPydantic, raw_response.body)
