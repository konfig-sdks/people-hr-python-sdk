...
from people_hr_python_sdk.model.error_for_add_background_check_detail import ErrorForAddBackgroundCheckDetail as ErrorForAddBackgroundCheckDetailSchema
from people_hr_python_sdk.model.add_background_check_detail_parameter import AddBackgroundCheckDetailParameter as AddBackgroundCheckDetailParameterSchema

from people_hr_python_sdk.type.error_for_add_background_check_detail import ErrorForAddBackgroundCheckDetail
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.add_background_check_detail_parameter import AddBackgroundCheckDetailParameter

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.add_background_check_detail_parameter import AddBackgroundCheckDetailParameter as AddBackgroundCheckDetailParameterPydantic
from people_hr_python_sdk.pydantic.error_for_add_background_check_detail import ErrorForAddBackgroundCheckDetail as ErrorForAddBackgroundCheckDetailPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = AddBackgroundCheckDetailParameterSchema


request_body_add_background_check_detail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForAddBackgroundCheckDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForAddBackgroundCheckDetail
...
class BaseApi(api_client.Api):
    ...
    def _add_detail_mapped_args(
        ...
        document_name: str,
        file: str,
        date_completed: typing.Optional[date] = None,
        ...
        if type_of_check is not None:
            _body["TypeOfCheck"] = type_of_check
        if date_completed is not None:
            _body["DateCompleted"] = date_completed
    ...
    async def _aadd_detail_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Background Check  -  AddBackgroundCheckDetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_add_background_check_detail_parameter.serialize(body, content_type)
...
class AddDetail(BaseApi):
    ...
    async def aadd_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForAddBackgroundCheckDetailPydantic:
        ...
        if validate:
            return ErrorForAddBackgroundCheckDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForAddBackgroundCheckDetailPydantic, raw_response.body)
