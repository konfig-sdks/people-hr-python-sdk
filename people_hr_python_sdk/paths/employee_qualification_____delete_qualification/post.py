...
from people_hr_python_sdk.model.delete_qualification_parameter import DeleteQualificationParameter as DeleteQualificationParameterSchema
from people_hr_python_sdk.model.error_for_delete_qualification import ErrorForDeleteQualification as ErrorForDeleteQualificationSchema

from people_hr_python_sdk.type.error_for_delete_qualification import ErrorForDeleteQualification
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.delete_qualification_parameter import DeleteQualificationParameter

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_delete_qualification import ErrorForDeleteQualification as ErrorForDeleteQualificationPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.delete_qualification_parameter import DeleteQualificationParameter as DeleteQualificationParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = DeleteQualificationParameterSchema


request_body_delete_qualification_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForDeleteQualificationSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForDeleteQualification
...
class BaseApi(api_client.Api):
    ...
    def _delete_qualification_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _adelete_qualification_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Qualification  -  DeleteQualification',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_delete_qualification_parameter.serialize(body, content_type)
    ...
    def _delete_qualification_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteQualificationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_qualification(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._delete_qualification_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            qualification_id=qualification_id,
        )
        return await self._adelete_qualification_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def delete_qualification(
        ...
        return self._delete_qualification_oapg(
            body=args.body,
        )

class DeleteQualification(BaseApi):
    ...
    async def adelete_qualification(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForDeleteQualificationPydantic:
        raw_response = await self.raw.adelete_qualification(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            qualification_id=qualification_id,
        ...
        if validate:
            return ErrorForDeleteQualificationPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForDeleteQualificationPydantic, raw_response.body)
    ...
    def delete_qualification(
        ...
        raw_response = self.raw.delete_qualification(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            qualification_id=qualification_id,
