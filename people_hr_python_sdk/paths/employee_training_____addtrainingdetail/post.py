...
from people_hr_python_sdk.model.error_for_add_training_detail import ErrorForAddTrainingDetail as ErrorForAddTrainingDetailSchema
...
from people_hr_python_sdk.model.add_training_detail_parameter import AddTrainingDetailParameter as AddTrainingDetailParameterSchema

from people_hr_python_sdk.type.error_for_add_training_detail import ErrorForAddTrainingDetail
...
from people_hr_python_sdk.type.add_training_detail_parameter import AddTrainingDetailParameter
...
from people_hr_python_sdk.pydantic.add_training_detail_parameter import AddTrainingDetailParameter as AddTrainingDetailParameterPydantic
...
from people_hr_python_sdk.pydantic.error_for_add_training_detail import ErrorForAddTrainingDetail as ErrorForAddTrainingDetailPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = AddTrainingDetailParameterSchema


request_body_add_training_detail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForAddTrainingDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForAddTrainingDetail
...
class BaseApi(api_client.Api):
    ...
    def _add_training_detail_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aadd_training_detail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Training  -  addtrainingdetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_add_training_detail_parameter.serialize(body, content_type)
...
class AddTrainingDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_training_detail(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._add_training_detail_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aadd_training_detail_oapg(
            body=args.body,
            **kwargs,
        )
    
    def add_training_detail(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._add_training_detail_oapg(
            body=args.body,
        )

class AddTrainingDetail(BaseApi):
    ...
    async def aadd_training_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForAddTrainingDetailPydantic:
        raw_response = await self.raw.aadd_training_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            training_type=training_type,
        ...
        if validate:
            return ErrorForAddTrainingDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForAddTrainingDetailPydantic, raw_response.body)
    ...
    def add_training_detail(
        ...
        raw_response = self.raw.add_training_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            training_type=training_type,
