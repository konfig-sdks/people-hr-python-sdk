...
from people_hr_python_sdk.model.error_for_update_appraisal import ErrorForUpdateAppraisal as ErrorForUpdateAppraisalSchema
from people_hr_python_sdk.model.add_files_array_for_update_appraisal import AddFilesArrayForUpdateAppraisal as AddFilesArrayForUpdateAppraisalSchema
...
from people_hr_python_sdk.model.custom_columns_array_for_update_appraisal import CustomColumnsArrayForUpdateAppraisal as CustomColumnsArrayForUpdateAppraisalSchema
from people_hr_python_sdk.model.update_appraisal_parameter import UpdateAppraisalParameter as UpdateAppraisalParameterSchema

from people_hr_python_sdk.type.error_for_update_appraisal import ErrorForUpdateAppraisal
from people_hr_python_sdk.type.add_files_array_for_update_appraisal import AddFilesArrayForUpdateAppraisal
from people_hr_python_sdk.type.update_appraisal_parameter import UpdateAppraisalParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.custom_columns_array_for_update_appraisal import CustomColumnsArrayForUpdateAppraisal

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.add_files_array_for_update_appraisal import AddFilesArrayForUpdateAppraisal as AddFilesArrayForUpdateAppraisalPydantic
from people_hr_python_sdk.pydantic.custom_columns_array_for_update_appraisal import CustomColumnsArrayForUpdateAppraisal as CustomColumnsArrayForUpdateAppraisalPydantic
from people_hr_python_sdk.pydantic.update_appraisal_parameter import UpdateAppraisalParameter as UpdateAppraisalParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic
from people_hr_python_sdk.pydantic.error_for_update_appraisal import ErrorForUpdateAppraisal as ErrorForUpdateAppraisalPydantic

# body param
SchemaForRequestBodyApplicationJson = UpdateAppraisalParameterSchema


request_body_update_appraisal_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUpdateAppraisalSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUpdateAppraisal
...
class BaseApi(api_client.Api):
    ...
    def _update_user_appraisal_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        action_plan: str,
        objectives: str,
        custom_columns: CustomColumnsArrayForUpdateAppraisal,
        add_files: AddFilesArrayForUpdateAppraisal,
    ...
    async def _aupdate_user_appraisal_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeAppraisal  -  UpdateAppraisal',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_appraisal_parameter.serialize(body, content_type)
    ...
    def _update_user_appraisal_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateUserAppraisalRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_user_appraisal(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._update_user_appraisal_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aupdate_user_appraisal_oapg(
            body=args.body,
            **kwargs,
        )
    
    def update_user_appraisal(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._update_user_appraisal_oapg(
            body=args.body,
        )

class UpdateUserAppraisal(BaseApi):
    ...
    async def aupdate_user_appraisal(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForUpdateAppraisalPydantic:
        raw_response = await self.raw.aupdate_user_appraisal(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            appraisal_review_date=appraisal_review_date,
        ...
        if validate:
            return ErrorForUpdateAppraisalPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUpdateAppraisalPydantic, raw_response.body)
    ...
    def update_user_appraisal(
        ...
        raw_response = self.raw.update_user_appraisal(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            appraisal_review_date=appraisal_review_date,
