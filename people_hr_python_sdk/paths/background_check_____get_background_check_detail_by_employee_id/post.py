...
from people_hr_python_sdk.model.get_background_check_detail_by_employee_id_parameter import GetBackgroundCheckDetailByEmployeeIdParameter as GetBackgroundCheckDetailByEmployeeIdParameterSchema
...
from people_hr_python_sdk.model.error_for_get_background_check_detail_by_employee_id import ErrorForGetBackgroundCheckDetailByEmployeeId as ErrorForGetBackgroundCheckDetailByEmployeeIdSchema

from people_hr_python_sdk.type.get_background_check_detail_by_employee_id_parameter import GetBackgroundCheckDetailByEmployeeIdParameter
from people_hr_python_sdk.type.error_for_get_background_check_detail_by_employee_id import ErrorForGetBackgroundCheckDetailByEmployeeId
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.get_background_check_detail_by_employee_id_parameter import GetBackgroundCheckDetailByEmployeeIdParameter as GetBackgroundCheckDetailByEmployeeIdParameterPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_get_background_check_detail_by_employee_id import ErrorForGetBackgroundCheckDetailByEmployeeId as ErrorForGetBackgroundCheckDetailByEmployeeIdPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = GetBackgroundCheckDetailByEmployeeIdParameterSchema


request_body_get_background_check_detail_by_employee_id_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetBackgroundCheckDetailByEmployeeIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetBackgroundCheckDetailByEmployeeId
...
class BaseApi(api_client.Api):
    ...
    def _get_detail_by_employee_id_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aget_detail_by_employee_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Background Check  -  GetBackgroundCheckDetailByEmployeeId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_background_check_detail_by_employee_id_parameter.serialize(body, content_type)
    ...
    def _get_detail_by_employee_id_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetDetailByEmployeeIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_detail_by_employee_id(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        **kwargs,
        ...
        args = self._get_detail_by_employee_id_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
        )
        return await self._aget_detail_by_employee_id_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_detail_by_employee_id(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._get_detail_by_employee_id_oapg(
            body=args.body,
        )

class GetDetailByEmployeeId(BaseApi):
    ...
    async def aget_detail_by_employee_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetBackgroundCheckDetailByEmployeeIdPydantic:
        raw_response = await self.raw.aget_detail_by_employee_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            **kwargs,
        ...
        if validate:
            return ErrorForGetBackgroundCheckDetailByEmployeeIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetBackgroundCheckDetailByEmployeeIdPydantic, raw_response.body)
    ...
    def get_detail_by_employee_id(
        ...
        raw_response = self.raw.get_detail_by_employee_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
        )
