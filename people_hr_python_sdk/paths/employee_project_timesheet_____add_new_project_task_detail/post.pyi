...
from people_hr_python_sdk.model.add_new_project_task_detail_parameter import AddNewProjectTaskDetailParameter as AddNewProjectTaskDetailParameterSchema
from people_hr_python_sdk.model.project_task_detail_name import ProjectTaskDetailName as ProjectTaskDetailNameSchema
from people_hr_python_sdk.model.error_for_add_new_project_task_detail import ErrorForAddNewProjectTaskDetail as ErrorForAddNewProjectTaskDetailSchema

from people_hr_python_sdk.type.add_new_project_task_detail_parameter import AddNewProjectTaskDetailParameter
from people_hr_python_sdk.type.error_for_add_new_project_task_detail import ErrorForAddNewProjectTaskDetail
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.project_task_detail_name import ProjectTaskDetailName

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_add_new_project_task_detail import ErrorForAddNewProjectTaskDetail as ErrorForAddNewProjectTaskDetailPydantic
from people_hr_python_sdk.pydantic.project_task_detail_name import ProjectTaskDetailName as ProjectTaskDetailNamePydantic
from people_hr_python_sdk.pydantic.add_new_project_task_detail_parameter import AddNewProjectTaskDetailParameter as AddNewProjectTaskDetailParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = AddNewProjectTaskDetailParameterSchema


request_body_add_new_project_task_detail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForAddNewProjectTaskDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForAddNewProjectTaskDetail
...
class BaseApi(api_client.Api):
    ...
    def _add_new_project_task_detail_0_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        project_task_detail_name: ProjectTaskDetailName,
        in_use: str,
        ...
        if action is not None:
            _body["Action"] = action
        if project_task_detail_name is not None:
            _body["ProjectTaskDetailName"] = project_task_detail_name
        if in_use is not None:
            _body["InUse"] = in_use
        args.body = _body
        return args

    async def _aadd_new_project_task_detail_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Project Timesheet  -  AddNewProjectTaskDetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_add_new_project_task_detail_parameter.serialize(body, content_type)
    ...
    def _add_new_project_task_detail_0_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class AddNewProjectTaskDetail0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_new_project_task_detail_0(
        self,
        api_key: APIKey,
        action: str,
        project_task_detail_name: ProjectTaskDetailName,
        ...
        **kwargs,
        ...
        args = self._add_new_project_task_detail_0_mapped_args(
            api_key=api_key,
            action=action,
            project_task_detail_name=project_task_detail_name,
            in_use=in_use,
        )
        return await self._aadd_new_project_task_detail_0_oapg(
            body=args.body,
            **kwargs,
        )
    
    def add_new_project_task_detail_0(
        self,
        api_key: APIKey,
        action: str,
        project_task_detail_name: ProjectTaskDetailName,
        ...
        return self._add_new_project_task_detail_0_oapg(
            body=args.body,
        )

class AddNewProjectTaskDetail0(BaseApi):
    ...
    async def aadd_new_project_task_detail_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForAddNewProjectTaskDetailPydantic:
        raw_response = await self.raw.aadd_new_project_task_detail_0(
            api_key=api_key,
            action=action,
            project_task_detail_name=project_task_detail_name,
            in_use=in_use,
        ...
        if validate:
            return ErrorForAddNewProjectTaskDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForAddNewProjectTaskDetailPydantic, raw_response.body)
    ...
    def add_new_project_task_detail_0(
        ...
        raw_response = self.raw.add_new_project_task_detail_0(
            api_key=api_key,
            action=action,
            project_task_detail_name=project_task_detail_name,
            in_use=in_use,
