...
from people_hr_python_sdk.model.get_custom_screen_by_employee_id_parameter import GetCustomScreenByEmployeeIdParameter as GetCustomScreenByEmployeeIdParameterSchema
...
from people_hr_python_sdk.model.error_for_get_custom_screen_by_employee_id import ErrorForGetCustomScreenByEmployeeId as ErrorForGetCustomScreenByEmployeeIdSchema

from people_hr_python_sdk.type.get_custom_screen_by_employee_id_parameter import GetCustomScreenByEmployeeIdParameter
from people_hr_python_sdk.type.error_for_get_custom_screen_by_employee_id import ErrorForGetCustomScreenByEmployeeId
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_get_custom_screen_by_employee_id import ErrorForGetCustomScreenByEmployeeId as ErrorForGetCustomScreenByEmployeeIdPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.get_custom_screen_by_employee_id_parameter import GetCustomScreenByEmployeeIdParameter as GetCustomScreenByEmployeeIdParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = GetCustomScreenByEmployeeIdParameterSchema


request_body_get_custom_screen_by_employee_id_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetCustomScreenByEmployeeIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetCustomScreenByEmployeeId
...
class BaseApi(api_client.Api):
    ...
    def _get_screen_by_employee_id_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        screen_id: int,
    ...
    async def _aget_screen_by_employee_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Custom Screen  -  GetCustomScreenByEmployeeId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_custom_screen_by_employee_id_parameter.serialize(body, content_type)
    ...
    def _get_screen_by_employee_id_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetScreenByEmployeeIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_screen_by_employee_id(
        self,
        api_key: APIKey,
        action: str,
        screen_id: int,
        ...
        **kwargs,
        ...
        args = self._get_screen_by_employee_id_mapped_args(
            api_key=api_key,
            action=action,
            screen_id=screen_id,
            employee_id=employee_id,
        )
        return await self._aget_screen_by_employee_id_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_screen_by_employee_id(
        self,
        api_key: APIKey,
        action: str,
        screen_id: int,
        ...
        return self._get_screen_by_employee_id_oapg(
            body=args.body,
        )

class GetScreenByEmployeeId(BaseApi):
    ...
    async def aget_screen_by_employee_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetCustomScreenByEmployeeIdPydantic:
        raw_response = await self.raw.aget_screen_by_employee_id(
            api_key=api_key,
            action=action,
            screen_id=screen_id,
            employee_id=employee_id,
        ...
        if validate:
            return ErrorForGetCustomScreenByEmployeeIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetCustomScreenByEmployeeIdPydantic, raw_response.body)
    ...
    def get_screen_by_employee_id(
        ...
        raw_response = self.raw.get_screen_by_employee_id(
            api_key=api_key,
            action=action,
            screen_id=screen_id,
            employee_id=employee_id,
