...
from people_hr_python_sdk.model.error_for_get_benefit_by_employee_id import ErrorForGetBenefitByEmployeeId as ErrorForGetBenefitByEmployeeIdSchema
...
from people_hr_python_sdk.model.get_benefit_by_employee_id_parameter import GetBenefitByEmployeeIdParameter as GetBenefitByEmployeeIdParameterSchema

from people_hr_python_sdk.type.error_for_get_benefit_by_employee_id import ErrorForGetBenefitByEmployeeId
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.get_benefit_by_employee_id_parameter import GetBenefitByEmployeeIdParameter

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_get_benefit_by_employee_id import ErrorForGetBenefitByEmployeeId as ErrorForGetBenefitByEmployeeIdPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic
from people_hr_python_sdk.pydantic.get_benefit_by_employee_id_parameter import GetBenefitByEmployeeIdParameter as GetBenefitByEmployeeIdParameterPydantic

# body param
SchemaForRequestBodyApplicationJson = GetBenefitByEmployeeIdParameterSchema


request_body_get_benefit_by_employee_id_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetBenefitByEmployeeIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetBenefitByEmployeeId
...
class BaseApi(api_client.Api):
    ...
    def _get_by_employee_id_details_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aget_by_employee_id_details_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeBenefit  -  GetBenefitByEmployeeId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_benefit_by_employee_id_parameter.serialize(body, content_type)
    ...
    def _get_by_employee_id_details_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetByEmployeeIdDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_employee_id_details(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        **kwargs,
        ...
        args = self._get_by_employee_id_details_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
        )
        return await self._aget_by_employee_id_details_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_by_employee_id_details(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._get_by_employee_id_details_oapg(
            body=args.body,
        )

class GetByEmployeeIdDetails(BaseApi):
    ...
    async def aget_by_employee_id_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetBenefitByEmployeeIdPydantic:
        raw_response = await self.raw.aget_by_employee_id_details(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            **kwargs,
        ...
        if validate:
            return ErrorForGetBenefitByEmployeeIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetBenefitByEmployeeIdPydantic, raw_response.body)
    ...
    def get_by_employee_id_details(
        ...
        raw_response = self.raw.get_by_employee_id_details(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
        )
