...
from people_hr_python_sdk.model.error_for_employee_absence_delete import ErrorForEmployeeAbsenceDelete as ErrorForEmployeeAbsenceDeleteSchema
from people_hr_python_sdk.model.delete_absence_of_employee_parameter import DeleteAbsenceOfEmployeeParameter as DeleteAbsenceOfEmployeeParameterSchema

from people_hr_python_sdk.type.error_for_employee_absence_delete import ErrorForEmployeeAbsenceDelete
from people_hr_python_sdk.type.delete_absence_of_employee_parameter import DeleteAbsenceOfEmployeeParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_employee_absence_delete import ErrorForEmployeeAbsenceDelete as ErrorForEmployeeAbsenceDeletePydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.delete_absence_of_employee_parameter import DeleteAbsenceOfEmployeeParameter as DeleteAbsenceOfEmployeeParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = DeleteAbsenceOfEmployeeParameterSchema


request_body_delete_absence_of_employee_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForEmployeeAbsenceDeleteSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForEmployeeAbsenceDelete
...
class BaseApi(api_client.Api):
    ...
    def _remove_absence_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aremove_absence_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeAbsence  -  DeleteAbsence',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_delete_absence_of_employee_parameter.serialize(body, content_type)
...
class RemoveAbsenceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_absence(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._remove_absence_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aremove_absence_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def remove_absence(
        ...
        return self._remove_absence_oapg(
            body=args.body,
        )

class RemoveAbsence(BaseApi):
    ...
    async def aremove_absence(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForEmployeeAbsenceDeletePydantic:
        raw_response = await self.raw.aremove_absence(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            start_date=start_date,
        ...
        if validate:
            return ErrorForEmployeeAbsenceDeletePydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForEmployeeAbsenceDeletePydantic, raw_response.body)
    ...
    def remove_absence(
        ...
        raw_response = self.raw.remove_absence(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            start_date=start_date,
