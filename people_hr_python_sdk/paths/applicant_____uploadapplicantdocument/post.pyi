...
from people_hr_python_sdk.model.uploadapplicantdocument_parameter import UploadapplicantdocumentParameter as UploadapplicantdocumentParameterSchema
from people_hr_python_sdk.model.error_foruploadapplicantdocument import ErrorForuploadapplicantdocument as ErrorForuploadapplicantdocumentSchema
from people_hr_python_sdk.model.bigint import Bigint as BigintSchema

from people_hr_python_sdk.type.error_foruploadapplicantdocument import ErrorForuploadapplicantdocument
from people_hr_python_sdk.type.bigint import Bigint
from people_hr_python_sdk.type.uploadapplicantdocument_parameter import UploadapplicantdocumentParameter
from people_hr_python_sdk.type.api_key import APIKey

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.bigint import Bigint as BigintPydantic
from people_hr_python_sdk.pydantic.uploadapplicantdocument_parameter import UploadapplicantdocumentParameter as UploadapplicantdocumentParameterPydantic
from people_hr_python_sdk.pydantic.error_foruploadapplicantdocument import ErrorForuploadapplicantdocument as ErrorForuploadapplicantdocumentPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = UploadapplicantdocumentParameterSchema


request_body_uploadapplicantdocument_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForuploadapplicantdocumentSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForuploadapplicantdocument
    ...
    async def _aupload_document_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Applicant  -  uploadapplicantdocument',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_uploadapplicantdocument_parameter.serialize(body, content_type)
...
class UploadDocument(BaseApi):
    ...
    async def aupload_document(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForuploadapplicantdocumentPydantic:
        ...
        if validate:
            return ErrorForuploadapplicantdocumentPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForuploadapplicantdocumentPydantic, raw_response.body)
