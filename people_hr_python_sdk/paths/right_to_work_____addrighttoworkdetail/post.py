...
from people_hr_python_sdk.model.error_foraddrighttoworkdetail import ErrorForaddrighttoworkdetail as ErrorForaddrighttoworkdetailSchema
from people_hr_python_sdk.model.long_integer import LongInteger as LongIntegerSchema
from people_hr_python_sdk.model.add_new_right_to_work_detail_parameter import AddNewRightToWorkDetailParameter as AddNewRightToWorkDetailParameterSchema

from people_hr_python_sdk.type.add_new_right_to_work_detail_parameter import AddNewRightToWorkDetailParameter
from people_hr_python_sdk.type.error_foraddrighttoworkdetail import ErrorForaddrighttoworkdetail
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.long_integer import LongInteger

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.long_integer import LongInteger as LongIntegerPydantic
from people_hr_python_sdk.pydantic.add_new_right_to_work_detail_parameter import AddNewRightToWorkDetailParameter as AddNewRightToWorkDetailParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic
from people_hr_python_sdk.pydantic.error_foraddrighttoworkdetail import ErrorForaddrighttoworkdetail as ErrorForaddrighttoworkdetailPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = AddNewRightToWorkDetailParameterSchema


request_body_add_new_right_to_work_detail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForaddrighttoworkdetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForaddrighttoworkdetail
...
class BaseApi(api_client.Api):
    ...
    def _add_detail_mapped_args(
        ...
        document_id: typing.Optional[LongInteger] = None,
        valid_from: typing.Optional[date] = None,
        valid_to: typing.Optional[date] = None,
    ...
    async def _aadd_detail_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Right To Work  -  addrighttoworkdetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_add_new_right_to_work_detail_parameter.serialize(body, content_type)
...
class AddDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_detail(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._add_detail_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aadd_detail_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def add_detail(
        ...
        return self._add_detail_oapg(
            body=args.body,
        )

class AddDetail(BaseApi):
    ...
    async def aadd_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForaddrighttoworkdetailPydantic:
        raw_response = await self.raw.aadd_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            document_name=document_name,
        ...
        if validate:
            return ErrorForaddrighttoworkdetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForaddrighttoworkdetailPydantic, raw_response.body)
    ...
    def add_detail(
        ...
        raw_response = self.raw.add_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            document_name=document_name,
