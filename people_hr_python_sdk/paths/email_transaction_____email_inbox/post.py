...
from people_hr_python_sdk.model.email_from import EmailFrom as EmailFromSchema
from people_hr_python_sdk.model.result1_for_email_bcc_for_email_inbox import Result1ForEmailBccForEmailInbox as Result1ForEmailBccForEmailInboxSchema
from people_hr_python_sdk.model.error_for_email_inbox import ErrorForEmailInbox as ErrorForEmailInboxSchema
from people_hr_python_sdk.model.email_inbox_parameter import EmailInboxParameter as EmailInboxParameterSchema
from people_hr_python_sdk.model.email_subject import EmailSubject as EmailSubjectSchema
from people_hr_python_sdk.model.result1_for_email_cc_for_email_inbox import Result1ForEmailCcForEmailInbox as Result1ForEmailCcForEmailInboxSchema
from people_hr_python_sdk.model.result1_for_attachment_for_email_inbox import Result1ForAttachmentForEmailInbox as Result1ForAttachmentForEmailInboxSchema
from people_hr_python_sdk.model.result1_for_email_to_for_email_inbox import Result1ForEmailToForEmailInbox as Result1ForEmailToForEmailInboxSchema

from people_hr_python_sdk.type.result1_for_email_to_for_email_inbox import Result1ForEmailToForEmailInbox
from people_hr_python_sdk.type.email_subject import EmailSubject
from people_hr_python_sdk.type.result1_for_email_bcc_for_email_inbox import Result1ForEmailBccForEmailInbox
from people_hr_python_sdk.type.email_inbox_parameter import EmailInboxParameter
from people_hr_python_sdk.type.result1_for_attachment_for_email_inbox import Result1ForAttachmentForEmailInbox
from people_hr_python_sdk.type.email_from import EmailFrom
from people_hr_python_sdk.type.result1_for_email_cc_for_email_inbox import Result1ForEmailCcForEmailInbox
from people_hr_python_sdk.type.error_for_email_inbox import ErrorForEmailInbox

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.email_subject import EmailSubject as EmailSubjectPydantic
from people_hr_python_sdk.pydantic.result1_for_email_bcc_for_email_inbox import Result1ForEmailBccForEmailInbox as Result1ForEmailBccForEmailInboxPydantic
from people_hr_python_sdk.pydantic.email_from import EmailFrom as EmailFromPydantic
from people_hr_python_sdk.pydantic.error_for_email_inbox import ErrorForEmailInbox as ErrorForEmailInboxPydantic
from people_hr_python_sdk.pydantic.result1_for_email_to_for_email_inbox import Result1ForEmailToForEmailInbox as Result1ForEmailToForEmailInboxPydantic
from people_hr_python_sdk.pydantic.email_inbox_parameter import EmailInboxParameter as EmailInboxParameterPydantic
from people_hr_python_sdk.pydantic.result1_for_attachment_for_email_inbox import Result1ForAttachmentForEmailInbox as Result1ForAttachmentForEmailInboxPydantic
from people_hr_python_sdk.pydantic.result1_for_email_cc_for_email_inbox import Result1ForEmailCcForEmailInbox as Result1ForEmailCcForEmailInboxPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = EmailInboxParameterSchema


request_body_email_inbox_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForEmailInboxSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForEmailInbox
...
class BaseApi(api_client.Api):
    ...
    def _submit_email_inbox_mapped_args(
        self,
        action: str,
        email_from: EmailFrom,
        email_to: Result1ForEmailToForEmailInbox,
        email_subject: EmailSubject,
        email_cc: typing.Optional[Result1ForEmailCcForEmailInbox] = None,
        email_bcc: typing.Optional[Result1ForEmailBccForEmailInbox] = None,
        attachment: typing.Optional[Result1ForAttachmentForEmailInbox] = None,
        ...
        if email_to is not None:
            _body["EmailTo"] = email_to
        if email_cc is not None:
            _body["EmailCc"] = email_cc
        if email_bcc is not None:
            _body["EmailBcc"] = email_bcc
    ...
    async def _asubmit_email_inbox_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Email Transaction  -  EmailInbox',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_email_inbox_parameter.serialize(body, content_type)
...
class SubmitEmailInboxRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asubmit_email_inbox(
        self,
        action: str,
        email_from: EmailFrom,
        email_to: Result1ForEmailToForEmailInbox,
        ...
        **kwargs,
        ...
        args = self._submit_email_inbox_mapped_args(
            action=action,
        ...
        return await self._asubmit_email_inbox_oapg(
            body=args.body,
            **kwargs,
        )
    
    def submit_email_inbox(
        self,
        action: str,
        email_from: EmailFrom,
        email_to: Result1ForEmailToForEmailInbox,
        ...
        return self._submit_email_inbox_oapg(
            body=args.body,
        )

class SubmitEmailInbox(BaseApi):
    ...
    async def asubmit_email_inbox(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForEmailInboxPydantic:
        raw_response = await self.raw.asubmit_email_inbox(
            action=action,
            email_from=email_from,
            email_to=email_to,
            email_subject=email_subject,
        ...
        if validate:
            return ErrorForEmailInboxPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForEmailInboxPydantic, raw_response.body)
    ...
    def submit_email_inbox(
        ...
        raw_response = self.raw.submit_email_inbox(
            action=action,
            email_from=email_from,
            email_to=email_to,
            email_subject=email_subject,
