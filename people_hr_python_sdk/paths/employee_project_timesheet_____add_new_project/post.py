...
from people_hr_python_sdk.model.add_new_project_parameter import AddNewProjectParameter as AddNewProjectParameterSchema
from people_hr_python_sdk.model.error_for_add_new_project import ErrorForAddNewProject as ErrorForAddNewProjectSchema
from people_hr_python_sdk.model.api_key import APIKey as APIKeySchema

from people_hr_python_sdk.type.add_new_project_parameter import AddNewProjectParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.error_for_add_new_project import ErrorForAddNewProject

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_add_new_project import ErrorForAddNewProject as ErrorForAddNewProjectPydantic
from people_hr_python_sdk.pydantic.add_new_project_parameter import AddNewProjectParameter as AddNewProjectParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = AddNewProjectParameterSchema


request_body_add_new_project_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForAddNewProjectSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForAddNewProject
...
class BaseApi(api_client.Api):
    ...
    def _add_project_detail_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        project_name: str,
    ...
    async def _aadd_project_detail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Project Timesheet  -  AddNewProject',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_add_new_project_parameter.serialize(body, content_type)
...
class AddProjectDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_project_detail(
        self,
        api_key: APIKey,
        action: str,
        project_name: str,
        ...
        **kwargs,
        ...
        args = self._add_project_detail_mapped_args(
            api_key=api_key,
            action=action,
            project_name=project_name,
            in_use=in_use,
        )
        return await self._aadd_project_detail_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def add_project_detail(
        ...
        return self._add_project_detail_oapg(
            body=args.body,
        )

class AddProjectDetail(BaseApi):
    ...
    async def aadd_project_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForAddNewProjectPydantic:
        raw_response = await self.raw.aadd_project_detail(
            api_key=api_key,
            action=action,
            project_name=project_name,
            in_use=in_use,
        ...
        if validate:
            return ErrorForAddNewProjectPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForAddNewProjectPydantic, raw_response.body)
    ...
    def add_project_detail(
        ...
        raw_response = self.raw.add_project_detail(
            api_key=api_key,
            action=action,
            project_name=project_name,
            in_use=in_use,
