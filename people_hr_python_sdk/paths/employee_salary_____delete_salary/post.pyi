...
from people_hr_python_sdk.model.delete_salary_parameter import DeleteSalaryParameter as DeleteSalaryParameterSchema
from people_hr_python_sdk.model.error_for_delete_salary import ErrorForDeleteSalary as ErrorForDeleteSalarySchema

from people_hr_python_sdk.type.delete_salary_parameter import DeleteSalaryParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.error_for_delete_salary import ErrorForDeleteSalary

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.delete_salary_parameter import DeleteSalaryParameter as DeleteSalaryParameterPydantic
...
from people_hr_python_sdk.pydantic.error_for_delete_salary import ErrorForDeleteSalary as ErrorForDeleteSalaryPydantic

# body param
SchemaForRequestBodyApplicationJson = DeleteSalaryParameterSchema


request_body_delete_salary_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForDeleteSalarySchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForDeleteSalary
...
class BaseApi(api_client.Api):
    ...
    def _delete_salary_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _adelete_salary_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeSalary  -  DeleteSalary',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_delete_salary_parameter.serialize(body, content_type)
...
class DeleteSalaryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_salary(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._delete_salary_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            effective_from=effective_from,
        )
        return await self._adelete_salary_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def delete_salary(
        ...
        return self._delete_salary_oapg(
            body=args.body,
        )

class DeleteSalary(BaseApi):
    ...
    async def adelete_salary(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForDeleteSalaryPydantic:
        raw_response = await self.raw.adelete_salary(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            effective_from=effective_from,
        ...
        if validate:
            return ErrorForDeleteSalaryPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForDeleteSalaryPydantic, raw_response.body)
    ...
    def delete_salary(
        ...
        raw_response = self.raw.delete_salary(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            effective_from=effective_from,
