...
from people_hr_python_sdk.model.error_for_get_vehicle_detail_by_employee_id import ErrorForGetVehicleDetailByEmployeeId as ErrorForGetVehicleDetailByEmployeeIdSchema
from people_hr_python_sdk.model.api_key import APIKey as APIKeySchema
from people_hr_python_sdk.model.get_vehicle_detail_by_employee_id_definition import GetVehicleDetailByEmployeeIdDefinition as GetVehicleDetailByEmployeeIdDefinitionSchema

from people_hr_python_sdk.type.error_for_get_vehicle_detail_by_employee_id import ErrorForGetVehicleDetailByEmployeeId
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.get_vehicle_detail_by_employee_id_definition import GetVehicleDetailByEmployeeIdDefinition

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_get_vehicle_detail_by_employee_id import ErrorForGetVehicleDetailByEmployeeId as ErrorForGetVehicleDetailByEmployeeIdPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.get_vehicle_detail_by_employee_id_definition import GetVehicleDetailByEmployeeIdDefinition as GetVehicleDetailByEmployeeIdDefinitionPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = GetVehicleDetailByEmployeeIdDefinitionSchema


request_body_get_vehicle_detail_by_employee_id_definition = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetVehicleDetailByEmployeeIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetVehicleDetailByEmployeeId
    ...
    async def _aget_detail_by_employee_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Vehicle  -  GetVehicleByEmployeeId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_vehicle_detail_by_employee_id_definition.serialize(body, content_type)
...
class GetDetailByEmployeeId(BaseApi):
    ...
    async def aget_detail_by_employee_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetVehicleDetailByEmployeeIdPydantic:
        ...
        if validate:
            return ErrorForGetVehicleDetailByEmployeeIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetVehicleDetailByEmployeeIdPydantic, raw_response.body)
