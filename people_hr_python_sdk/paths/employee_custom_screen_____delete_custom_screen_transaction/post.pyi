...
from people_hr_python_sdk.model.delete_custom_screen_transaction_parameter import DeleteCustomScreenTransactionParameter as DeleteCustomScreenTransactionParameterSchema
from people_hr_python_sdk.model.error_for_delete_custom_screen_transaction import ErrorForDeleteCustomScreenTransaction as ErrorForDeleteCustomScreenTransactionSchema

from people_hr_python_sdk.type.delete_custom_screen_transaction_parameter import DeleteCustomScreenTransactionParameter
from people_hr_python_sdk.type.error_for_delete_custom_screen_transaction import ErrorForDeleteCustomScreenTransaction
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_delete_custom_screen_transaction import ErrorForDeleteCustomScreenTransaction as ErrorForDeleteCustomScreenTransactionPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.delete_custom_screen_transaction_parameter import DeleteCustomScreenTransactionParameter as DeleteCustomScreenTransactionParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = DeleteCustomScreenTransactionParameterSchema


request_body_delete_custom_screen_transaction_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForDeleteCustomScreenTransactionSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForDeleteCustomScreenTransaction
...
class BaseApi(api_client.Api):
    ...
    def _delete_custom_screen_transaction_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _adelete_custom_screen_transaction_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Custom Screen  -  DeleteCustomScreenTransaction',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_delete_custom_screen_transaction_parameter.serialize(body, content_type)
    ...
    def _delete_custom_screen_transaction_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteCustomScreenTransactionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_custom_screen_transaction(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._delete_custom_screen_transaction_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._adelete_custom_screen_transaction_oapg(
            body=args.body,
            **kwargs,
        )
    
    def delete_custom_screen_transaction(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._delete_custom_screen_transaction_oapg(
            body=args.body,
        )

class DeleteCustomScreenTransaction(BaseApi):
    ...
    async def adelete_custom_screen_transaction(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForDeleteCustomScreenTransactionPydantic:
        raw_response = await self.raw.adelete_custom_screen_transaction(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            screen_id=screen_id,
        ...
        if validate:
            return ErrorForDeleteCustomScreenTransactionPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForDeleteCustomScreenTransactionPydantic, raw_response.body)
    ...
    def delete_custom_screen_transaction(
        ...
        raw_response = self.raw.delete_custom_screen_transaction(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            screen_id=screen_id,
