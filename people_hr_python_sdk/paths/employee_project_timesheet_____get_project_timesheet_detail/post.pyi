...
from people_hr_python_sdk.model.error_for_get_project_timesheet_detail import ErrorForGetProjectTimesheetDetail as ErrorForGetProjectTimesheetDetailSchema
...
from people_hr_python_sdk.model.get_project_timesheet_detail import GetProjectTimesheetDetail as GetProjectTimesheetDetailSchema

from people_hr_python_sdk.type.get_project_timesheet_detail import GetProjectTimesheetDetail
from people_hr_python_sdk.type.error_for_get_project_timesheet_detail import ErrorForGetProjectTimesheetDetail
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.get_project_timesheet_detail import GetProjectTimesheetDetail as GetProjectTimesheetDetailPydantic
...
from people_hr_python_sdk.pydantic.error_for_get_project_timesheet_detail import ErrorForGetProjectTimesheetDetail as ErrorForGetProjectTimesheetDetailPydantic

# body param
SchemaForRequestBodyApplicationJson = GetProjectTimesheetDetailSchema


request_body_get_project_timesheet_detail = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetProjectTimesheetDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetProjectTimesheetDetail
...
class BaseApi(api_client.Api):
    ...
    def _get_project_timesheet_detail_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aget_project_timesheet_detail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Project Timesheet  -  GetProjectTimesheetDetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_project_timesheet_detail.serialize(body, content_type)
    ...
    def _get_project_timesheet_detail_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetProjectTimesheetDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_project_timesheet_detail(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._get_project_timesheet_detail_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aget_project_timesheet_detail_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_project_timesheet_detail(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._get_project_timesheet_detail_oapg(
            body=args.body,
        )

class GetProjectTimesheetDetail(BaseApi):
    ...
    async def aget_project_timesheet_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetProjectTimesheetDetailPydantic:
        raw_response = await self.raw.aget_project_timesheet_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            start_date=start_date,
        ...
        if validate:
            return ErrorForGetProjectTimesheetDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetProjectTimesheetDetailPydantic, raw_response.body)
    ...
    def get_project_timesheet_detail(
        ...
        raw_response = self.raw.get_project_timesheet_detail(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            start_date=start_date,
