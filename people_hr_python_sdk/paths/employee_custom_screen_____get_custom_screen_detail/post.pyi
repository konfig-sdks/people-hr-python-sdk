...
from people_hr_python_sdk.model.error_for_get_custom_screen_detail import ErrorForGetCustomScreenDetail as ErrorForGetCustomScreenDetailSchema
from people_hr_python_sdk.model.api_key import APIKey as APIKeySchema
from people_hr_python_sdk.model.get_custom_screen_detail_parameter import GetCustomScreenDetailParameter as GetCustomScreenDetailParameterSchema

from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.error_for_get_custom_screen_detail import ErrorForGetCustomScreenDetail
from people_hr_python_sdk.type.get_custom_screen_detail_parameter import GetCustomScreenDetailParameter

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.get_custom_screen_detail_parameter import GetCustomScreenDetailParameter as GetCustomScreenDetailParameterPydantic
from people_hr_python_sdk.pydantic.error_for_get_custom_screen_detail import ErrorForGetCustomScreenDetail as ErrorForGetCustomScreenDetailPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = GetCustomScreenDetailParameterSchema


request_body_get_custom_screen_detail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetCustomScreenDetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetCustomScreenDetail
    ...
    async def _aget_detail_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Custom Screen  -  GetCustomScreenDetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_custom_screen_detail_parameter.serialize(body, content_type)
...
class GetDetail(BaseApi):
    ...
    async def aget_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetCustomScreenDetailPydantic:
        ...
        if validate:
            return ErrorForGetCustomScreenDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetCustomScreenDetailPydantic, raw_response.body)
