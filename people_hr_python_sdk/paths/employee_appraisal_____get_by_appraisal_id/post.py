...
from people_hr_python_sdk.model.get_by_appraisal_id_for_employee_appraisal import GetByAppraisalIdForEmployeeAppraisal as GetByAppraisalIdForEmployeeAppraisalSchema
from people_hr_python_sdk.model.error_for_get_by_appraisal_id import ErrorForGetByAppraisalId as ErrorForGetByAppraisalIdSchema

from people_hr_python_sdk.type.error_for_get_by_appraisal_id import ErrorForGetByAppraisalId
from people_hr_python_sdk.type.get_by_appraisal_id_for_employee_appraisal import GetByAppraisalIdForEmployeeAppraisal
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.get_by_appraisal_id_for_employee_appraisal import GetByAppraisalIdForEmployeeAppraisal as GetByAppraisalIdForEmployeeAppraisalPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_get_by_appraisal_id import ErrorForGetByAppraisalId as ErrorForGetByAppraisalIdPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = GetByAppraisalIdForEmployeeAppraisalSchema


request_body_get_by_appraisal_id_for_employee_appraisal = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetByAppraisalIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetByAppraisalId
...
class BaseApi(api_client.Api):
    ...
    def _get_by_appraisal_id_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        ...
        if appraisal_id is not None:
            _body["AppraisalId"] = appraisal_id
        args.body = _body
        return args

    async def _aget_by_appraisal_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeAppraisal  -  GetByAppraisalId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_by_appraisal_id_for_employee_appraisal.serialize(body, content_type)
...
class GetByAppraisalIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_appraisal_id(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._get_by_appraisal_id_mapped_args(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            appraisal_id=appraisal_id,
        )
        return await self._aget_by_appraisal_id_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_by_appraisal_id(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._get_by_appraisal_id_oapg(
            body=args.body,
        )

class GetByAppraisalId(BaseApi):
    ...
    async def aget_by_appraisal_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetByAppraisalIdPydantic:
        raw_response = await self.raw.aget_by_appraisal_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            appraisal_id=appraisal_id,
        ...
        if validate:
            return ErrorForGetByAppraisalIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetByAppraisalIdPydantic, raw_response.body)
    ...
    def get_by_appraisal_id(
        ...
        raw_response = self.raw.get_by_appraisal_id(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            appraisal_id=appraisal_id,
