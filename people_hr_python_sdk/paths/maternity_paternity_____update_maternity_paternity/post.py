...
from people_hr_python_sdk.model.update_maternity_paternity_parameter import UpdateMaternityPaternityParameter as UpdateMaternityPaternityParameterSchema
...
from people_hr_python_sdk.model.error_for_update_maternity_paternity_api import ErrorForUpdateMaternityPaternityApi as ErrorForUpdateMaternityPaternityApiSchema

from people_hr_python_sdk.type.update_maternity_paternity_parameter import UpdateMaternityPaternityParameter
from people_hr_python_sdk.type.error_for_update_maternity_paternity_api import ErrorForUpdateMaternityPaternityApi
...
from people_hr_python_sdk.pydantic.update_maternity_paternity_parameter import UpdateMaternityPaternityParameter as UpdateMaternityPaternityParameterPydantic
...
from people_hr_python_sdk.pydantic.error_for_update_maternity_paternity_api import ErrorForUpdateMaternityPaternityApi as ErrorForUpdateMaternityPaternityApiPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UpdateMaternityPaternityParameterSchema


request_body_update_maternity_paternity_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUpdateMaternityPaternityApiSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUpdateMaternityPaternityApi
...
class BaseApi(api_client.Api):
    ...
    def _update_details_mapped_args(
        ...
        if maternity_paternity_txn_id is not None:
            _body["MaternityPaternityTxnId"] = maternity_paternity_txn_id
    ...
    async def _aupdate_details_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Maternity Paternity  -  UpdateMaternityPaternity',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_maternity_paternity_parameter.serialize(body, content_type)
    ...
    async def aupdate_details(
        ...
        **kwargs,
        ...
        args = self._update_details_mapped_args(
            ...
            maternity_paternity_txn_id=maternity_paternity_txn_id,
            due_date=due_date,
...
class UpdateDetails(BaseApi):
    ...
    async def aupdate_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForUpdateMaternityPaternityApiPydantic:
        ...
        if validate:
            return ErrorForUpdateMaternityPaternityApiPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUpdateMaternityPaternityApiPydantic, raw_response.body)
