...
from people_hr_python_sdk.model.error_for_get_all_vacancy import ErrorForGetAllVacancy as ErrorForGetAllVacancySchema
from people_hr_python_sdk.model.get_all_vacancy_parameters import GetAllVacancyParameters as GetAllVacancyParametersSchema

from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.error_for_get_all_vacancy import ErrorForGetAllVacancy
from people_hr_python_sdk.type.get_all_vacancy_parameters import GetAllVacancyParameters

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_get_all_vacancy import ErrorForGetAllVacancy as ErrorForGetAllVacancyPydantic
from people_hr_python_sdk.pydantic.get_all_vacancy_parameters import GetAllVacancyParameters as GetAllVacancyParametersPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = GetAllVacancyParametersSchema


request_body_get_all_vacancy_parameters = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetAllVacancySchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetAllVacancy
...
class BaseApi(api_client.Api):
    ...
    def _get_all_vacancies_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aget_all_vacancies_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Vacancy  -  GetAllVacancies',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_all_vacancy_parameters.serialize(body, content_type)
...
class GetAllVacanciesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_vacancies(
        self,
        api_key: APIKey,
        action: str,
        **kwargs,
        ...
        args = self._get_all_vacancies_mapped_args(
            api_key=api_key,
            action=action,
        )
        return await self._aget_all_vacancies_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def get_all_vacancies(
        ...
        return self._get_all_vacancies_oapg(
            body=args.body,
        )

class GetAllVacancies(BaseApi):
    ...
    async def aget_all_vacancies(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetAllVacancyPydantic:
        raw_response = await self.raw.aget_all_vacancies(
            api_key=api_key,
            action=action,
            **kwargs,
        )
        if validate:
            return ErrorForGetAllVacancyPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetAllVacancyPydantic, raw_response.body)
    ...
    def get_all_vacancies(
        ...
        raw_response = self.raw.get_all_vacancies(
            api_key=api_key,
            action=action,
        )
        if validate:
