...
from people_hr_python_sdk.model.error_for_get_all_project_task import ErrorForGetAllProjectTask as ErrorForGetAllProjectTaskSchema
from people_hr_python_sdk.model.get_all_project_task_parameter import GetAllProjectTaskParameter as GetAllProjectTaskParameterSchema
...
from people_hr_python_sdk.type.error_for_get_all_project_task import ErrorForGetAllProjectTask
from people_hr_python_sdk.type.get_all_project_task_parameter import GetAllProjectTaskParameter
...
from people_hr_python_sdk.pydantic.get_all_project_task_parameter import GetAllProjectTaskParameter as GetAllProjectTaskParameterPydantic
from people_hr_python_sdk.pydantic.error_for_get_all_project_task import ErrorForGetAllProjectTask as ErrorForGetAllProjectTaskPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = GetAllProjectTaskParameterSchema


request_body_get_all_project_task_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetAllProjectTaskSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetAllProjectTask
...
class BaseApi(api_client.Api):
    ...
    def _get_all_project_task_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        project_task_name: typing.Optional[ProjectTaskName] = None,
    ...
    async def _aget_all_project_task_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Project Timesheet  -  GetAllProjectTask',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_all_project_task_parameter.serialize(body, content_type)
    ...
    def _get_all_project_task_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetAllProjectTaskRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_project_task(
        self,
        api_key: APIKey,
        action: str,
        project_task_name: typing.Optional[ProjectTaskName] = None,
        **kwargs,
        ...
        args = self._get_all_project_task_mapped_args(
            api_key=api_key,
            action=action,
            project_task_name=project_task_name,
        )
        return await self._aget_all_project_task_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_all_project_task(
        self,
        api_key: APIKey,
        action: str,
        project_task_name: typing.Optional[ProjectTaskName] = None,
        ...
        return self._get_all_project_task_oapg(
            body=args.body,
        )

class GetAllProjectTask(BaseApi):
    ...
    async def aget_all_project_task(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetAllProjectTaskPydantic:
        raw_response = await self.raw.aget_all_project_task(
            api_key=api_key,
            action=action,
            project_task_name=project_task_name,
            **kwargs,
        ...
        if validate:
            return ErrorForGetAllProjectTaskPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetAllProjectTaskPydantic, raw_response.body)
    ...
    def get_all_project_task(
        ...
        raw_response = self.raw.get_all_project_task(
            api_key=api_key,
            action=action,
            project_task_name=project_task_name,
        )
