...
from people_hr_python_sdk.model.work_pattern_parameter import WorkPatternParameter as WorkPatternParameterSchema
from people_hr_python_sdk.model.error_for_work_pattern import ErrorForWorkPattern as ErrorForWorkPatternSchema

from people_hr_python_sdk.type.work_pattern_parameter import WorkPatternParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.error_for_work_pattern import ErrorForWorkPattern

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_work_pattern import ErrorForWorkPattern as ErrorForWorkPatternPydantic
from people_hr_python_sdk.pydantic.work_pattern_parameter import WorkPatternParameter as WorkPatternParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = WorkPatternParameterSchema


request_body_work_pattern_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForWorkPatternSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForWorkPattern
...
class BaseApi(api_client.Api):
    ...
    def _get_work_detail_mapped_args(
        self,
        api_key: APIKey,
        action: str,
        work_pattern_id: int,
        work_pattern_name: typing.Optional[str] = None,
        ...
        if action is not None:
            _body["Action"] = action
        if work_pattern_id is not None:
            _body["WorkPatternId"] = work_pattern_id
        if work_pattern_name is not None:
            _body["WorkPatternName"] = work_pattern_name
        args.body = _body
        return args

    async def _aget_work_detail_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/WorkPattern  -  GetWorkPatternDetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_work_pattern_parameter.serialize(body, content_type)
...
class GetWorkDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_work_detail(
        self,
        api_key: APIKey,
        action: str,
        work_pattern_id: int,
        ...
        **kwargs,
        ...
        args = self._get_work_detail_mapped_args(
            api_key=api_key,
            action=action,
            work_pattern_id=work_pattern_id,
            work_pattern_name=work_pattern_name,
        )
        return await self._aget_work_detail_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def get_work_detail(
        ...
        return self._get_work_detail_oapg(
            body=args.body,
        )

class GetWorkDetail(BaseApi):
    ...
    async def aget_work_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForWorkPatternPydantic:
        raw_response = await self.raw.aget_work_detail(
            api_key=api_key,
            action=action,
            work_pattern_id=work_pattern_id,
            work_pattern_name=work_pattern_name,
        ...
        if validate:
            return ErrorForWorkPatternPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForWorkPatternPydantic, raw_response.body)
    ...
    def get_work_detail(
        ...
        raw_response = self.raw.get_work_detail(
            api_key=api_key,
            action=action,
            work_pattern_id=work_pattern_id,
            work_pattern_name=work_pattern_name,
