...
from people_hr_python_sdk.model.get_by_employee_id_for_employee_appraisal import GetByEmployeeIdForEmployeeAppraisal as GetByEmployeeIdForEmployeeAppraisalSchema
from people_hr_python_sdk.model.error_for_employee_appraisal_get_employee_by_id import ErrorForEmployeeAppraisalGetEmployeeById as ErrorForEmployeeAppraisalGetEmployeeByIdSchema

from people_hr_python_sdk.type.get_by_employee_id_for_employee_appraisal import GetByEmployeeIdForEmployeeAppraisal
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.error_for_employee_appraisal_get_employee_by_id import ErrorForEmployeeAppraisalGetEmployeeById

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.get_by_employee_id_for_employee_appraisal import GetByEmployeeIdForEmployeeAppraisal as GetByEmployeeIdForEmployeeAppraisalPydantic
from people_hr_python_sdk.pydantic.error_for_employee_appraisal_get_employee_by_id import ErrorForEmployeeAppraisalGetEmployeeById as ErrorForEmployeeAppraisalGetEmployeeByIdPydantic
...
# body param
SchemaForRequestBodyApplicationJson = GetByEmployeeIdForEmployeeAppraisalSchema


request_body_get_by_employee_id_for_employee_appraisal = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForEmployeeAppraisalGetEmployeeByIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForEmployeeAppraisalGetEmployeeById
    ...
    async def _aget_by_employee_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/EmployeeAppraisal  -  GetByEmployeeId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_by_employee_id_for_employee_appraisal.serialize(body, content_type)
...
class GetByEmployeeId(BaseApi):
    ...
    async def aget_by_employee_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForEmployeeAppraisalGetEmployeeByIdPydantic:
        ...
        if validate:
            return ErrorForEmployeeAppraisalGetEmployeeByIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForEmployeeAppraisalGetEmployeeByIdPydantic, raw_response.body)
