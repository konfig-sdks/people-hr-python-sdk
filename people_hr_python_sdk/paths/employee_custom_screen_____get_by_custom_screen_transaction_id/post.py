...
from people_hr_python_sdk.model.get_by_custom_screen_transaction_id_parameter import GetByCustomScreenTransactionIdParameter as GetByCustomScreenTransactionIdParameterSchema
from people_hr_python_sdk.model.error_for_get_by_custom_screen_transaction_id import ErrorForGetByCustomScreenTransactionId as ErrorForGetByCustomScreenTransactionIdSchema

from people_hr_python_sdk.type.get_by_custom_screen_transaction_id_parameter import GetByCustomScreenTransactionIdParameter
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.error_for_get_by_custom_screen_transaction_id import ErrorForGetByCustomScreenTransactionId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.get_by_custom_screen_transaction_id_parameter import GetByCustomScreenTransactionIdParameter as GetByCustomScreenTransactionIdParameterPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.error_for_get_by_custom_screen_transaction_id import ErrorForGetByCustomScreenTransactionId as ErrorForGetByCustomScreenTransactionIdPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = GetByCustomScreenTransactionIdParameterSchema


request_body_get_by_custom_screen_transaction_id_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetByCustomScreenTransactionIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetByCustomScreenTransactionId
...
class BaseApi(api_client.Api):
    ...
    def _get_by_custom_screen_transaction_mapped_args(
        self,
        api_key: APIKey,
        action: str,
    ...
    async def _aget_by_custom_screen_transaction_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee Custom Screen  -  GetByCustomScreenTransactionId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_by_custom_screen_transaction_id_parameter.serialize(body, content_type)
    ...
    def _get_by_custom_screen_transaction_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetByCustomScreenTransactionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_custom_screen_transaction(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._get_by_custom_screen_transaction_mapped_args(
            api_key=api_key,
            action=action,
        ...
        return await self._aget_by_custom_screen_transaction_oapg(
            body=args.body,
            **kwargs,
        )
    
    def get_by_custom_screen_transaction(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        return self._get_by_custom_screen_transaction_oapg(
            body=args.body,
        )

class GetByCustomScreenTransaction(BaseApi):
    ...
    async def aget_by_custom_screen_transaction(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetByCustomScreenTransactionIdPydantic:
        raw_response = await self.raw.aget_by_custom_screen_transaction(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            screen_id=screen_id,
        ...
        if validate:
            return ErrorForGetByCustomScreenTransactionIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetByCustomScreenTransactionIdPydantic, raw_response.body)
    ...
    def get_by_custom_screen_transaction(
        ...
        raw_response = self.raw.get_by_custom_screen_transaction(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            screen_id=screen_id,
