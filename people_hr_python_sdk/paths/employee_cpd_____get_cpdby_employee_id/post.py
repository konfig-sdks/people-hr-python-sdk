...
from people_hr_python_sdk.model.error_for_get_cpdby_employee_id import ErrorForGetCPDByEmployeeId as ErrorForGetCPDByEmployeeIdSchema
from people_hr_python_sdk.model.get_cpdby_employee_id_parameter import GetCPDByEmployeeIdParameter as GetCPDByEmployeeIdParameterSchema

from people_hr_python_sdk.type.get_cpdby_employee_id_parameter import GetCPDByEmployeeIdParameter
from people_hr_python_sdk.type.error_for_get_cpdby_employee_id import ErrorForGetCPDByEmployeeId
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.get_cpdby_employee_id_parameter import GetCPDByEmployeeIdParameter as GetCPDByEmployeeIdParameterPydantic
from people_hr_python_sdk.pydantic.error_for_get_cpdby_employee_id import ErrorForGetCPDByEmployeeId as ErrorForGetCPDByEmployeeIdPydantic
...
# body param
SchemaForRequestBodyApplicationJson = GetCPDByEmployeeIdParameterSchema


request_body_get_cpdby_employee_id_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForGetCPDByEmployeeIdSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForGetCPDByEmployeeId
    ...
    async def _aget_by_employee_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee CPD  -  GetCPDByEmployeeId',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_get_cpdby_employee_id_parameter.serialize(body, content_type)
...
class GetByEmployeeId(BaseApi):
    ...
    async def aget_by_employee_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForGetCPDByEmployeeIdPydantic:
        ...
        if validate:
            return ErrorForGetCPDByEmployeeIdPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForGetCPDByEmployeeIdPydantic, raw_response.body)
