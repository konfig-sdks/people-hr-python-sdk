...
from people_hr_python_sdk.model.error_for_update_cpd import ErrorForUpdateCPD as ErrorForUpdateCPDSchema
from people_hr_python_sdk.model.add_files_array_for_employee_cpd import AddFilesArrayForEmployeeCPD as AddFilesArrayForEmployeeCPDSchema
...
from people_hr_python_sdk.model.custom_columns_array_for_employee_cpd import CustomColumnsArrayForEmployeeCPD as CustomColumnsArrayForEmployeeCPDSchema
from people_hr_python_sdk.model.update_cpd_parameter import UpdateCPDParameter as UpdateCPDParameterSchema

from people_hr_python_sdk.type.error_for_update_cpd import ErrorForUpdateCPD
from people_hr_python_sdk.type.update_cpd_parameter import UpdateCPDParameter
from people_hr_python_sdk.type.custom_columns_array_for_employee_cpd import CustomColumnsArrayForEmployeeCPD
from people_hr_python_sdk.type.api_key import APIKey
from people_hr_python_sdk.type.employee_id import EmployeeId
from people_hr_python_sdk.type.add_files_array_for_employee_cpd import AddFilesArrayForEmployeeCPD

from ...api_client import Dictionary
from people_hr_python_sdk.pydantic.error_for_update_cpd import ErrorForUpdateCPD as ErrorForUpdateCPDPydantic
from people_hr_python_sdk.pydantic.update_cpd_parameter import UpdateCPDParameter as UpdateCPDParameterPydantic
from people_hr_python_sdk.pydantic.custom_columns_array_for_employee_cpd import CustomColumnsArrayForEmployeeCPD as CustomColumnsArrayForEmployeeCPDPydantic
from people_hr_python_sdk.pydantic.employee_id import EmployeeId as EmployeeIdPydantic
from people_hr_python_sdk.pydantic.add_files_array_for_employee_cpd import AddFilesArrayForEmployeeCPD as AddFilesArrayForEmployeeCPDPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = UpdateCPDParameterSchema


request_body_update_cpd_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForUpdateCPDSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForUpdateCPD
...
class BaseApi(api_client.Api):
    ...
    def _update_cpd_mapped_args(
        ...
        roll_number: typing.Optional[str] = None,
        date_admitted: typing.Optional[date] = None,
        hours_required: typing.Optional[int] = None,
        hours_accredited: typing.Optional[int] = None,
        notes: typing.Optional[str] = None,
        custom_columns: typing.Optional[CustomColumnsArrayForEmployeeCPD] = None,
        add_files: typing.Optional[AddFilesArrayForEmployeeCPD] = None,
        ...
        if date_admitted is not None:
            _body["DateAdmitted"] = date_admitted
        if hours_required is not None:
            _body["HoursRequired"] = hours_required
        if hours_accredited is not None:
            _body["HoursAccredited"] = hours_accredited
    ...
    async def _aupdate_cpd_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Employee CPD  -  UpdateCPD',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_update_cpd_parameter.serialize(body, content_type)
...
class UpdateCpdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_cpd(
        self,
        api_key: APIKey,
        action: str,
        employee_id: EmployeeId,
        ...
        **kwargs,
        ...
        args = self._update_cpd_mapped_args(
            api_key=api_key,
            action=action,
            ...
            hours_accredited=hours_accredited,
            notes=notes,
            custom_columns=custom_columns,
            add_files=add_files,
        )
        return await self._aupdate_cpd_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def update_cpd(
        ...
        return self._update_cpd_oapg(
            body=args.body,
        )

class UpdateCpd(BaseApi):
    ...
    async def aupdate_cpd(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForUpdateCPDPydantic:
        raw_response = await self.raw.aupdate_cpd(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            cpdid=cpdid,
        ...
        if validate:
            return ErrorForUpdateCPDPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForUpdateCPDPydantic, raw_response.body)
    ...
    def update_cpd(
        ...
        raw_response = self.raw.update_cpd(
            api_key=api_key,
            action=action,
            employee_id=employee_id,
            cpdid=cpdid,
