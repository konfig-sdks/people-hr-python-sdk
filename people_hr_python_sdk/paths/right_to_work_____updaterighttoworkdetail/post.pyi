...
from people_hr_python_sdk.model.error_forupdaterighttoworkdetail import ErrorForupdaterighttoworkdetail as ErrorForupdaterighttoworkdetailSchema
from people_hr_python_sdk.model.updaterighttoworkdetail_parameter import UpdaterighttoworkdetailParameter as UpdaterighttoworkdetailParameterSchema
from people_hr_python_sdk.model.long_integer import LongInteger as LongIntegerSchema

from people_hr_python_sdk.type.error_forupdaterighttoworkdetail import ErrorForupdaterighttoworkdetail
from people_hr_python_sdk.type.updaterighttoworkdetail_parameter import UpdaterighttoworkdetailParameter
...
from people_hr_python_sdk.pydantic.error_forupdaterighttoworkdetail import ErrorForupdaterighttoworkdetail as ErrorForupdaterighttoworkdetailPydantic
...
from people_hr_python_sdk.pydantic.updaterighttoworkdetail_parameter import UpdaterighttoworkdetailParameter as UpdaterighttoworkdetailParameterPydantic
from people_hr_python_sdk.pydantic.api_key import APIKey as APIKeyPydantic

# body param
SchemaForRequestBodyApplicationJson = UpdaterighttoworkdetailParameterSchema


request_body_updaterighttoworkdetail_parameter = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = ErrorForupdaterighttoworkdetailSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ErrorForupdaterighttoworkdetail
...
class BaseApi(api_client.Api):
    ...
    def _update_detail_mapped_args(
        ...
        if right_to_work_txn_id is not None:
            _body["RightToWorkTxnId"] = right_to_work_txn_id
    ...
    async def _aupdate_detail_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/Right To Work  -  updaterighttoworkdetail',
            body=body,
            headers=_headers,
        )
        serialized_data = request_body_updaterighttoworkdetail_parameter.serialize(body, content_type)
    ...
    async def aupdate_detail(
        ...
        **kwargs,
        ...
        args = self._update_detail_mapped_args(
            ...
            right_to_work_txn_id=right_to_work_txn_id,
...
class UpdateDetail(BaseApi):
    ...
    async def aupdate_detail(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ErrorForupdaterighttoworkdetailPydantic:
        ...
        if validate:
            return ErrorForupdaterighttoworkdetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(ErrorForupdaterighttoworkdetailPydantic, raw_response.body)
