...
from people_hr_python_sdk.pydantic.result_get_employee_detail_company_effective_date import ResultGetEmployeeDetailCompanyEffectiveDate
from people_hr_python_sdk.pydantic.result_get_employee_detail_department_effective_date import ResultGetEmployeeDetailDepartmentEffectiveDate
from people_hr_python_sdk.pydantic.result_get_employee_detail_employee_status import ResultGetEmployeeDetailEmployeeStatus
from people_hr_python_sdk.pydantic.result_get_employee_detail_employment_type_effective_date import ResultGetEmployeeDetailEmploymentTypeEffectiveDate
from people_hr_python_sdk.pydantic.result_get_employee_detail_holiday_allowance_days import ResultGetEmployeeDetailHolidayAllowanceDays
from people_hr_python_sdk.pydantic.result_get_employee_detail_holiday_allowance_mins import ResultGetEmployeeDetailHolidayAllowanceMins
from people_hr_python_sdk.pydantic.result_get_employee_detail_job_role_change_date import ResultGetEmployeeDetailJobRoleChangeDate
from people_hr_python_sdk.pydantic.result_get_employee_detail_location_effective_date import ResultGetEmployeeDetailLocationEffectiveDate
from people_hr_python_sdk.pydantic.result_get_employee_detail_reports_to_effective_date import ResultGetEmployeeDetailReportsToEffectiveDate
from people_hr_python_sdk.pydantic.result_get_employee_detail_reports_to_email_address import ResultGetEmployeeDetailReportsToEmailAddress
from people_hr_python_sdk.pydantic.result_get_employee_detail_reports_to_employee_id import ResultGetEmployeeDetailReportsToEmployeeId
...
class ResultGetEmployeeDetail(BaseModel):
    ...
    company_effective_date: typing.Optional[ResultGetEmployeeDetailCompanyEffectiveDate] = Field(None, alias='CompanyEffectiveDate')

    # Location name of employee
    location: typing.Optional[LocationObject] = Field(None, alias='Location')

    location_effective_date: typing.Optional[ResultGetEmployeeDetailLocationEffectiveDate] = Field(None, alias='LocationEffectiveDate')

    # Department name of employee
    department: typing.Optional[DepartmentObject] = Field(None, alias='Department')

    department_effective_date: typing.Optional[ResultGetEmployeeDetailDepartmentEffectiveDate] = Field(None, alias='DepartmentEffectiveDate')

    job_role_change_date: typing.Optional[ResultGetEmployeeDetailJobRoleChangeDate] = Field(None, alias='JobRoleChangeDate')

    # Reports to value
    reports_to: typing.Optional[ReportsToObject] = Field(None, alias='ReportsTo')

    reports_to_effective_date: typing.Optional[ResultGetEmployeeDetailReportsToEffectiveDate] = Field(None, alias='ReportsToEffectiveDate')

    reports_to_employee_id: typing.Optional[ResultGetEmployeeDetailReportsToEmployeeId] = Field(None, alias='ReportsToEmployeeId')

    reports_to_email_address: typing.Optional[ResultGetEmployeeDetailReportsToEmailAddress] = Field(None, alias='ReportsToEmailAddress')
    ...
    employment_type_effective_date: typing.Optional[ResultGetEmployeeDetailEmploymentTypeEffectiveDate] = Field(None, alias='EmploymentTypeEffectiveDate')

    employee_status: typing.Optional[ResultGetEmployeeDetailEmployeeStatus] = Field(None, alias='EmployeeStatus')

    holiday_allowance_days: typing.Optional[ResultGetEmployeeDetailHolidayAllowanceDays] = Field(None, alias='HolidayAllowanceDays')

    holiday_allowance_mins: typing.Optional[ResultGetEmployeeDetailHolidayAllowanceMins] = Field(None, alias='HolidayAllowanceMins')
