...
class CreateEmployeeDetailParameter(BaseModel):
    ...
    entitlement_this_year: typing.Optional[str] = Field(None, alias='EntitlementThisYear')

    # Entitlement next year default value 
    entitlement_next_year: typing.Optional[str] = Field(None, alias='EntitlementNextYear')
