...
from people_hr_python_sdk.pydantic.add_files_for_employee_vehicle_update_array import AddFilesForEmployeeVehicleUpdateArray
from people_hr_python_sdk.pydantic.api_key import APIKey
from people_hr_python_sdk.pydantic.custom_columns_for_employee_vehicle_update_array import CustomColumnsForEmployeeVehicleUpdateArray
from people_hr_python_sdk.pydantic.employee_id import EmployeeId

class UpdateVehicleDetailDefinition(BaseModel):
    ...
    # Make default value 
    make: typing.Optional[str] = Field(None, alias='Make')

    # Model default value 
    model: typing.Optional[str] = Field(None, alias='Model')

    # Colour default value 
    colour: typing.Optional[str] = Field(None, alias='Colour')

    # EngineSize default value 
    engine_size: typing.Optional[str] = Field(None, alias='EngineSize')

    # FuelType default value 
    fuel_type: typing.Optional[str] = Field(None, alias='FuelType')

    # InsuranceCompany default value 
    insurance_company: typing.Optional[str] = Field(None, alias='InsuranceCompany')

    # PolicyNumber default value 
    policy_number: typing.Optional[str] = Field(None, alias='PolicyNumber')

    # MOTExpiryDate default value 
    m_o_t_expiry_date: typing.Optional[date] = Field(None, alias='MOTExpiryDate')

    # InsuranceExpiryDate default value 
    insurance_expiry_date: typing.Optional[date] = Field(None, alias='InsuranceExpiryDate')
    ...
    custom_columns: typing.Optional[CustomColumnsForEmployeeVehicleUpdateArray] = Field(None, alias='CustomColumns')

    # AddFiles to update employee's vehicle detail
    add_files: typing.Optional[AddFilesForEmployeeVehicleUpdateArray] = Field(None, alias='AddFiles')
