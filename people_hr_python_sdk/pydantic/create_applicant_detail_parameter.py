...
from people_hr_python_sdk.pydantic.additional_questions_for_createnew_applicant_array import AdditionalQuestionsForCreatenewApplicantArray
from people_hr_python_sdk.pydantic.api_key import APIKey
from people_hr_python_sdk.pydantic.documents_for_create_new_applicant_array import DocumentsForCreateNewApplicantArray
...
from people_hr_python_sdk.pydantic.internal_questions_for_create_new_applicant_array import InternalQuestionsForCreateNewApplicantArray
from people_hr_python_sdk.pydantic.last_name import LastName
from people_hr_python_sdk.pydantic.post_code import PostCode

class CreateApplicantDetailParameter(BaseModel):
    ...
    documents: DocumentsForCreateNewApplicantArray = Field(alias='Documents')

    # Skills default value
    skills: str = Field(alias='Skills')

    # VacancyReference default value 
    vacancy_reference: typing.Optional[str] = Field(None, alias='VacancyReference')
    ...
    other_contact_details: typing.Optional[str] = Field(None, alias='OtherContactDetails')

    # Source default value
    source: typing.Optional[str] = Field(None, alias='Source')

    # Source for create new applicant
    additional_questions: typing.Optional[AdditionalQuestionsForCreatenewApplicantArray] = Field(None, alias='AdditionalQuestions')

    # Internal questions for create new applicant
    internal_questions: typing.Optional[InternalQuestionsForCreateNewApplicantArray] = Field(None, alias='InternalQuestions')

    # Recruitment cost default value
    recruitment_cost: typing.Optional[int] = Field(None, alias='RecruitmentCost')

    # Date last contacted default value
    date_last_contacted: typing.Optional[date] = Field(None, alias='DateLastContacted')
