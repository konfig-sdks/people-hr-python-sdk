...
from people_hr_python_sdk.pydantic.add_comments_array_for_absence import AddCommentsArrayForAbsence
from people_hr_python_sdk.pydantic.add_files_array_for_absence import AddFilesArrayForAbsence
from people_hr_python_sdk.pydantic.api_key import APIKey
from people_hr_python_sdk.pydantic.byte import Byte
from people_hr_python_sdk.pydantic.emergency_leave import EmergencyLeave
from people_hr_python_sdk.pydantic.employee_id import EmployeeId
from people_hr_python_sdk.pydantic.part_of_day_for_update_absence import PartOfDayForUpdateAbsence

class UpdateAbsenceDetailParameter(BaseModel):
    ...
    old_start_date: date = Field(alias='OldStartDate')

    # Old end date default value 
    old_end_date: date = Field(alias='OldEndDate')

    # Duration type default value 
    duration_type: Byte = Field(alias='DurationType')
    ...
    absence_paid_status: Byte = Field(alias='AbsencePaidStatus')

    # EmergencyLeave for update absence
    emergency_leave: EmergencyLeave = Field(alias='EmergencyLeave')

    # PartOfDay for update absence
    part_of_day: typing.Optional[PartOfDayForUpdateAbsence] = Field(None, alias='PartOfDay')

    # AddComments array list
    add_comments: typing.Optional[AddCommentsArrayForAbsence] = Field(None, alias='AddComments')

    # AddFiles array list
    add_files: typing.Optional[AddFilesArrayForAbsence] = Field(None, alias='AddFiles')
