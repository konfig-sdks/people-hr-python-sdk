...
from people_hr_python_sdk.pydantic.add_files_for_employee_vehicle_add_array import AddFilesForEmployeeVehicleAddArray
from people_hr_python_sdk.pydantic.api_key import APIKey
from people_hr_python_sdk.pydantic.custom_columns_for_employee_vehicle_add_array import CustomColumnsForEmployeeVehicleAddArray
from people_hr_python_sdk.pydantic.employee_id import EmployeeId

class AddNewVehicleDetailDefinition(BaseModel):
    ...
    custom_columns: typing.Optional[CustomColumnsForEmployeeVehicleAddArray] = Field(None, alias='CustomColumns')

    # AddFiles to add employee's new vehicle detail
    add_files: typing.Optional[AddFilesForEmployeeVehicleAddArray] = Field(None, alias='AddFiles')
