...
from people_hr_python_sdk.pydantic.result_additional_questions_arrayobject import ResultAdditionalQuestionsArrayobject
from people_hr_python_sdk.pydantic.result_internal_questions_arrayobject import ResultInternalQuestionsArrayobject

class ResultGetAllVacancyObjectItem(BaseModel):
    # Vacancy name value
    vacancy_name: typing.Optional[str] = Field(None, alias='VacancyName')

    # Vacancy description value
    vacancy_description: typing.Optional[str] = Field(None, alias='VacancyDescription')
    ...
    # Closing date value
    closing_date: typing.Optional[date] = Field(None, alias='ClosingDate')
    ...
    # IsHideSalary value
    is_hide_salary: typing.Optional[Literal["false", "true"]] = Field(None, alias='IsHideSalary')

    # Job title value
    job_title: typing.Optional[str] = Field(None, alias='JobTitle')

    # Vacancy type value
    vacancy_type: typing.Optional[Literal["External", "Internal", "Both"]] = Field(None, alias='VacancyType')
    ...
    # JobBordUrl value
    job_bord_url: typing.Optional[str] = Field(None, alias='JobBordUrl')

    # Additional questions array list
    additional_questions: typing.Optional[ResultAdditionalQuestionsArrayobject] = Field(None, alias='AdditionalQuestions')

    # Internal questions array list
    internal_questions: typing.Optional[ResultInternalQuestionsArrayobject] = Field(None, alias='InternalQuestions')
