...
from people_hr_python_sdk.pydantic.comment import Comment
from people_hr_python_sdk.pydantic.company import Company
from people_hr_python_sdk.pydantic.is_cover_letter_mandatory import IsCoverLetterMandatory
from people_hr_python_sdk.pydantic.is_hide_salary import IsHideSalary
from people_hr_python_sdk.pydantic.is_resume_mandatory import IsResumeMandatory
from people_hr_python_sdk.pydantic.vacancy_type import VacancyType

class CreateVacancyDetailParameter(BaseModel):
    ...
    # Title default value 
    vacancy_description: str = Field(alias='VacancyDescription')

    # Reference default value 
    reference: str = Field(alias='Reference')

    # Is cover letter mandatory for create new vacancy
    is_cover_letter_mandatory: IsCoverLetterMandatory = Field(alias='IsCoverLetterMandatory')

    # Is resume mandatory for create new vacancy
    is_resume_mandatory: IsResumeMandatory = Field(alias='IsResumeMandatory')

    # Is hide salary for create new vacancy
    is_hide_salary: IsHideSalary = Field(alias='IsHideSalary')

    # Vacancy type for create new vacancy
    vacancy_type: VacancyType = Field(alias='VacancyType')
