...
from people_hr_python_sdk.pydantic.add_files_for_employee_training import AddFilesForEmployeeTraining
from people_hr_python_sdk.pydantic.api_key import APIKey
from people_hr_python_sdk.pydantic.byte import Byte
from people_hr_python_sdk.pydantic.custom_columns_for_employee_training import CustomColumnsForEmployeeTraining
from people_hr_python_sdk.pydantic.employee_id import EmployeeId

class UpdateTrainingDetailParameter(BaseModel):
    ...
    # Training type
    training_type: str = Field(alias='TrainingType')
    ...
    in_progress: typing.Optional[Byte] = Field(None, alias='InProgress')

    # Training date default value
    training_date: typing.Optional[date] = Field(None, alias='TrainingDate')

    # Training end date default value
    trainind_end_date: typing.Optional[date] = Field(None, alias='TrainindEndDate')

    # Training expiry date default value
    training_expiry_date: typing.Optional[date] = Field(None, alias='TrainingExpiryDate')
    ...
    custom_columns: typing.Optional[CustomColumnsForEmployeeTraining] = Field(None, alias='CustomColumns')

    # Add files for update training detail
    add_files: typing.Optional[AddFilesForEmployeeTraining] = Field(None, alias='AddFiles')
