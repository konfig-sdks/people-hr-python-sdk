...
class CommentsArrayItem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Comments", "PostedBy", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Comments", "PostedBy", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        PostedBy: typing.Union[MetaOapg.properties.PostedBy, decimal.Decimal, int, schemas.Unset] = schemas.unset,
