...
class EditProjectTaskParameter(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def ProjectTaskName() -> typing.Type['ProjectTaskName']:
                return ProjectTaskName
        
            @staticmethod
            def New_ProjectTaskName() -> typing.Type['NewProjectTaskName']:
                return NewProjectTaskName
            InUse = schemas.StrSchema
            __annotations__ = {
                "APIKey": APIKey,
                "Action": Action,
                "ProjectTaskName": ProjectTaskName,
                "New_ProjectTaskName": New_ProjectTaskName,
                "InUse": InUse,
            }
    
    APIKey: 'APIKey'
    New_ProjectTaskName: 'NewProjectTaskName'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ProjectTaskName"]) -> 'ProjectTaskName': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["New_ProjectTaskName"]) -> 'NewProjectTaskName': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "ProjectTaskName", "New_ProjectTaskName", "InUse", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ProjectTaskName"]) -> 'ProjectTaskName': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["New_ProjectTaskName"]) -> 'NewProjectTaskName': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "ProjectTaskName", "New_ProjectTaskName", "InUse", ], str]):
