...
class WeekDetailArrayForWorkPatternItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class WorkPatternDay(
                ...
                def SUNDAY(cls):
                    return cls("Sunday")
            TotalWorkingDays = schemas.Schema
            TotalWorkingMins = schemas.IntSchema
            ShiftStartTime = schemas.StrSchema
            ShiftEndTime = schemas.StrSchema
            BreakTime = schemas.StrSchema
            __annotations__ = {
                "WeekNumber": WeekNumber,
                "WorkPatternDay": WorkPatternDay,
                "TotalWorkingDays": TotalWorkingDays,
                "TotalWorkingMins": TotalWorkingMins,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["WorkPatternDay"]) -> MetaOapg.properties.WorkPatternDay: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["TotalWorkingDays"]) -> MetaOapg.properties.TotalWorkingDays: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["TotalWorkingMins"]) -> MetaOapg.properties.TotalWorkingMins: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["WeekNumber", "WorkPatternDay", "TotalWorkingDays", "TotalWorkingMins", "ShiftStartTime", "ShiftEndTime", "BreakTime", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["WorkPatternDay"]) -> typing.Union[MetaOapg.properties.WorkPatternDay, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TotalWorkingDays"]) -> typing.Union[MetaOapg.properties.TotalWorkingDays, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TotalWorkingMins"]) -> typing.Union[MetaOapg.properties.TotalWorkingMins, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["WeekNumber", "WorkPatternDay", "TotalWorkingDays", "TotalWorkingMins", "ShiftStartTime", "ShiftEndTime", "BreakTime", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        WorkPatternDay: typing.Union[MetaOapg.properties.WorkPatternDay, str, schemas.Unset] = schemas.unset,
        TotalWorkingDays: typing.Union[MetaOapg.properties.TotalWorkingDays, schemas.Unset] = schemas.unset,
        TotalWorkingMins: typing.Union[MetaOapg.properties.TotalWorkingMins, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ShiftStartTime: typing.Union[MetaOapg.properties.ShiftStartTime, str, schemas.Unset] = schemas.unset,
        ShiftEndTime: typing.Union[MetaOapg.properties.ShiftEndTime, str, schemas.Unset] = schemas.unset,
        BreakTime: typing.Union[MetaOapg.properties.BreakTime, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'WeekDetailArrayForWorkPatternItem':
