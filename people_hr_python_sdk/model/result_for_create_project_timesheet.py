...
class ResultForCreateProjectTimesheet(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["TransactionId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["TransactionId", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        TransactionId: typing.Union[MetaOapg.properties.TransactionId, schemas.Unset] = schemas.unset,
