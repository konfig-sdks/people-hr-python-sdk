...
class BankDetailObject(
    ...
    Bank detail contain displayValue and FieldHistory array values
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def BankName() -> typing.Type['BankNameObject']:
                return BankNameObject
        
            @staticmethod
            def BankAddress() -> typing.Type['BankAddressObject']:
                return BankAddressObject
        
            @staticmethod
            def BankCode() -> typing.Type['BankCodeObject']:
                return BankCodeObject
        
            @staticmethod
            def AccountNumber() -> typing.Type['AccountNumberObject']:
                return AccountNumberObject
        
            @staticmethod
            def AccountName() -> typing.Type['AccountNameObject']:
                return AccountNameObject
            __annotations__ = {
                "BankName": BankName,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["BankName"]) -> 'BankNameObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["BankAddress"]) -> 'BankAddressObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["BankCode"]) -> 'BankCodeObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AccountNumber"]) -> 'AccountNumberObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AccountName"]) -> 'AccountNameObject': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["BankName", "BankAddress", "BankCode", "AccountNumber", "AccountName", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["BankName"]) -> typing.Union['BankNameObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["BankAddress"]) -> typing.Union['BankAddressObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["BankCode"]) -> typing.Union['BankCodeObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AccountNumber"]) -> typing.Union['AccountNumberObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AccountName"]) -> typing.Union['AccountNameObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["BankName", "BankAddress", "BankCode", "AccountNumber", "AccountName", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        BankName: typing.Union['BankNameObject', schemas.Unset] = schemas.unset,
        BankAddress: typing.Union['BankAddressObject', schemas.Unset] = schemas.unset,
        BankCode: typing.Union['BankCodeObject', schemas.Unset] = schemas.unset,
        AccountNumber: typing.Union['AccountNumberObject', schemas.Unset] = schemas.unset,
        AccountName: typing.Union['AccountNameObject', schemas.Unset] = schemas.unset,
