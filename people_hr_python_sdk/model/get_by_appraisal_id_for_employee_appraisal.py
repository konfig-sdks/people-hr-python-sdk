...
class GetByAppraisalIdForEmployeeAppraisal(
    schemas.DictSchema
):
    """
    ...
    AppraisalId: MetaOapg.properties.AppraisalId
    EmployeeId: 'EmployeeId'
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "AppraisalId", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AppraisalId"]) -> MetaOapg.properties.AppraisalId: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "AppraisalId", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        AppraisalId: typing.Union[MetaOapg.properties.AppraisalId, decimal.Decimal, int, ],
        EmployeeId: 'EmployeeId',
