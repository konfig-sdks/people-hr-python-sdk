...
class AddEmployeeImageById2(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            def EmployeeId() -> typing.Type['EmployeeId']:
                return EmployeeId
            EmployeeImageName = schemas.StrSchema
            EmployeeImage = schemas.StrSchema
            __annotations__ = {
                "APIKey": APIKey,
                "Action": Action,
                "EmployeeId": EmployeeId,
                "EmployeeImageName": EmployeeImageName,
                "EmployeeImage": EmployeeImage,
            }
    
    APIKey: 'APIKey'
    Action: MetaOapg.properties.Action
    EmployeeImage: MetaOapg.properties.EmployeeImage
    EmployeeId: 'EmployeeId'
    EmployeeImageName: MetaOapg.properties.EmployeeImageName
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["EmployeeImageName"]) -> MetaOapg.properties.EmployeeImageName: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "EmployeeImageName", "EmployeeImage", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["EmployeeImageName"]) -> MetaOapg.properties.EmployeeImageName: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["EmployeeImage"]) -> MetaOapg.properties.EmployeeImage: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "EmployeeImageName", "EmployeeImage", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        EmployeeImage: typing.Union[MetaOapg.properties.EmployeeImage, str, ],
        EmployeeId: 'EmployeeId',
        EmployeeImageName: typing.Union[MetaOapg.properties.EmployeeImageName, str, ],
