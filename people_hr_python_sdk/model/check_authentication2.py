...
class CheckAuthentication2(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def Password() -> typing.Type['Password']:
                return Password
            __annotations__ = {
                "APIKey": APIKey,
                "Action": Action,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Password"]) -> 'Password': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmailAddress", "Password", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["EmailAddress"]) -> 'EmailAddress': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Password"]) -> 'Password': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmailAddress", "Password", ], str]):
