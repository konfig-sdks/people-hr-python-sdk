...
class AddFilesForGetEmployeeDrivingItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            Descriptions = schemas.StrSchema
            DocumentCategory = schemas.StrSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DocumentCategory"]) -> MetaOapg.properties.DocumentCategory: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["SignatureRequired"]) -> MetaOapg.properties.SignatureRequired: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["DocumentName", "FileUrl", "Descriptions", "DocumentCategory", "SignatureRequired", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DocumentCategory"]) -> typing.Union[MetaOapg.properties.DocumentCategory, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["SignatureRequired"]) -> typing.Union[MetaOapg.properties.SignatureRequired, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["DocumentName", "FileUrl", "Descriptions", "DocumentCategory", "SignatureRequired", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        Descriptions: typing.Union[MetaOapg.properties.Descriptions, str, schemas.Unset] = schemas.unset,
        DocumentCategory: typing.Union[MetaOapg.properties.DocumentCategory, str, schemas.Unset] = schemas.unset,
        SignatureRequired: typing.Union[MetaOapg.properties.SignatureRequired, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'AddFilesForGetEmployeeDrivingItem':
