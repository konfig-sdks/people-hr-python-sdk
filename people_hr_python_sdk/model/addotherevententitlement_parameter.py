...
class AddotherevententitlementParameter(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            entitlement_recorded_in = schemas.IntSchema
            ThisYearEntitlement = schemas.NumberSchema
            NextYearEntitlement = schemas.NumberSchema
            __annotations__ = {
                "APIKey": APIKey,
                "Action": Action,
                "EmployeeId": EmployeeId,
                "Other Event Reason": other_event_reason,
                "Entitlement RecordedIn": entitlement_recorded_in,
                "ThisYearEntitlement": ThisYearEntitlement,
                "NextYearEntitlement": NextYearEntitlement,
            }
    
    APIKey: 'APIKey'
    Action: MetaOapg.properties.Action
    NextYearEntitlement: MetaOapg.properties.NextYearEntitlement
    ThisYearEntitlement: MetaOapg.properties.ThisYearEntitlement
    EmployeeId: 'EmployeeId'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Entitlement RecordedIn"]) -> MetaOapg.properties.entitlement_recorded_in: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ThisYearEntitlement"]) -> MetaOapg.properties.ThisYearEntitlement: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["NextYearEntitlement"]) -> MetaOapg.properties.NextYearEntitlement: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "Other Event Reason", "Entitlement RecordedIn", "ThisYearEntitlement", "NextYearEntitlement", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Entitlement RecordedIn"]) -> MetaOapg.properties.entitlement_recorded_in: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ThisYearEntitlement"]) -> MetaOapg.properties.ThisYearEntitlement: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["NextYearEntitlement"]) -> MetaOapg.properties.NextYearEntitlement: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "Other Event Reason", "Entitlement RecordedIn", "ThisYearEntitlement", "NextYearEntitlement", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        NextYearEntitlement: typing.Union[MetaOapg.properties.NextYearEntitlement, decimal.Decimal, int, float, ],
        ThisYearEntitlement: typing.Union[MetaOapg.properties.ThisYearEntitlement, decimal.Decimal, int, float, ],
        EmployeeId: 'EmployeeId',
