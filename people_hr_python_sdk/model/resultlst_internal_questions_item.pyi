...
class ResultlstInternalQuestionsItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            QuestionOptions = schemas.StrSchema
            __annotations__ = {
                "QuestionOptions": QuestionOptions,
            }
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["QuestionOptions"]) -> MetaOapg.properties.QuestionOptions: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["QuestionOptions", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["QuestionOptions"]) -> typing.Union[MetaOapg.properties.QuestionOptions, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["QuestionOptions", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        QuestionOptions: typing.Union[MetaOapg.properties.QuestionOptions, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ResultlstInternalQuestionsItem':
