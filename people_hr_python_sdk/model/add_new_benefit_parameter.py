...
class AddNewBenefitParameter(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def AddFiles() -> typing.Type['AddFilesArrayForAddNewBenefit']:
                return AddFilesArrayForAddNewBenefit
    ...
    CustomColumns: 'CustomColumnsArrayForAddNewBenefit'
    Benefit: MetaOapg.properties.Benefit
    RecoverOnTermination: 'RecoverOnTermination'
    EmployeeId: 'EmployeeId'
    AddFiles: 'AddFilesArrayForAddNewBenefit'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AddFiles"]) -> 'AddFilesArrayForAddNewBenefit': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "Benefit", "DateAwarded", "ExpiryDate", "RecoverOnTermination", "CustomColumns", "AddFiles", "Value", "Comments", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CustomColumns"]) -> 'CustomColumnsArrayForAddNewBenefit': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AddFiles"]) -> 'AddFilesArrayForAddNewBenefit': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "Benefit", "DateAwarded", "ExpiryDate", "RecoverOnTermination", "CustomColumns", "AddFiles", "Value", "Comments", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ExpiryDate: typing.Union[MetaOapg.properties.ExpiryDate, str, date, ],
        CustomColumns: 'CustomColumnsArrayForAddNewBenefit',
