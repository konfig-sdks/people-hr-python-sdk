...
class FieldHistoryForJobRoleObjectItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["JobRole", "EffectiveDate", "ChangedOn", "ReasonForChange", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["JobRole", "EffectiveDate", "ChangedOn", "ReasonForChange", ], str]):
    ...
    ) -> 'FieldHistoryForJobRoleObjectItem':
