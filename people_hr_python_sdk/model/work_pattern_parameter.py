...
class WorkPatternParameter(
    ...
    WorkPatternId: MetaOapg.properties.WorkPatternId
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "WorkPatternId", "WorkPatternName", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["WorkPatternId"]) -> MetaOapg.properties.WorkPatternId: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "WorkPatternId", "WorkPatternName", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        WorkPatternId: typing.Union[MetaOapg.properties.WorkPatternId, decimal.Decimal, int, ],
