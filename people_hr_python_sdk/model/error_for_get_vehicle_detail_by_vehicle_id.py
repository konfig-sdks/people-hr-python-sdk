...
class ErrorForGetVehicleDetailByVehicleId(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def Result() -> typing.Type['ResultGetVehicleDetailByVehicleIdObject']:
                return ResultGetVehicleDetailByVehicleIdObject
            __annotations__ = {
                "IsError": IsError,
                "Status": Status,
                "Message": Message,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Result"]) -> 'ResultGetVehicleDetailByVehicleIdObject': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Result"]) -> typing.Union['ResultGetVehicleDetailByVehicleIdObject', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        Result: typing.Union['ResultGetVehicleDetailByVehicleIdObject', schemas.Unset] = schemas.unset,
