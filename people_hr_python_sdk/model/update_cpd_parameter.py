...
class UpdateCPDParameter(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            def EmployeeId() -> typing.Type['EmployeeId']:
                return EmployeeId
            CPDId = schemas.IntSchema
            Activity = schemas.StrSchema
            StartDate = schemas.DateSchema
            EndDate = schemas.DateSchema
            RollNumber = schemas.StrSchema
            DateAdmitted = schemas.DateSchema
            HoursRequired = schemas.IntSchema
            HoursAccredited = schemas.IntSchema
            Notes = schemas.StrSchema
        
            @staticmethod
            def CustomColumns() -> typing.Type['CustomColumnsArrayForEmployeeCPD']:
                return CustomColumnsArrayForEmployeeCPD
        
            @staticmethod
            def AddFiles() -> typing.Type['AddFilesArrayForEmployeeCPD']:
                return AddFilesArrayForEmployeeCPD
            __annotations__ = {
                "APIKey": APIKey,
                "Action": Action,
                ...
                "HoursAccredited": HoursAccredited,
                "Notes": Notes,
    ...
    CPDId: MetaOapg.properties.CPDId
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["CPDId"]) -> MetaOapg.properties.CPDId: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DateAdmitted"]) -> MetaOapg.properties.DateAdmitted: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["HoursRequired"]) -> MetaOapg.properties.HoursRequired: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["HoursAccredited"]) -> MetaOapg.properties.HoursAccredited: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Notes"]) -> MetaOapg.properties.Notes: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["CustomColumns"]) -> 'CustomColumnsArrayForEmployeeCPD': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AddFiles"]) -> 'AddFilesArrayForEmployeeCPD': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "CPDId", "Activity", "StartDate", "EndDate", "RollNumber", "DateAdmitted", "HoursRequired", "HoursAccredited", "Notes", "CustomColumns", "AddFiles", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CPDId"]) -> MetaOapg.properties.CPDId: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DateAdmitted"]) -> typing.Union[MetaOapg.properties.DateAdmitted, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["HoursRequired"]) -> typing.Union[MetaOapg.properties.HoursRequired, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["HoursAccredited"]) -> typing.Union[MetaOapg.properties.HoursAccredited, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Notes"]) -> typing.Union[MetaOapg.properties.Notes, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CustomColumns"]) -> typing.Union['CustomColumnsArrayForEmployeeCPD', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AddFiles"]) -> typing.Union['AddFilesArrayForEmployeeCPD', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "CPDId", "Activity", "StartDate", "EndDate", "RollNumber", "DateAdmitted", "HoursRequired", "HoursAccredited", "Notes", "CustomColumns", "AddFiles", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        CPDId: typing.Union[MetaOapg.properties.CPDId, decimal.Decimal, int, ],
        ...
        RollNumber: typing.Union[MetaOapg.properties.RollNumber, str, schemas.Unset] = schemas.unset,
        DateAdmitted: typing.Union[MetaOapg.properties.DateAdmitted, str, date, schemas.Unset] = schemas.unset,
        HoursRequired: typing.Union[MetaOapg.properties.HoursRequired, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        HoursAccredited: typing.Union[MetaOapg.properties.HoursAccredited, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        Notes: typing.Union[MetaOapg.properties.Notes, str, schemas.Unset] = schemas.unset,
        CustomColumns: typing.Union['CustomColumnsArrayForEmployeeCPD', schemas.Unset] = schemas.unset,
        AddFiles: typing.Union['AddFilesArrayForEmployeeCPD', schemas.Unset] = schemas.unset,
