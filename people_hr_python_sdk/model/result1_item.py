...
class Result1Item(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            SalaryType = schemas.StrSchema
            PaymentFrequency = schemas.StrSchema
            SalaryAmount = schemas.IntSchema
            TotalSalaryAmount = schemas.IntSchema
            Currency = schemas.StrSchema
            ChangeReason = schemas.StrSchema
            Comments = schemas.StrSchema
        
            @staticmethod
            def Deductions() -> typing.Type['DeductionsObject']:
                return DeductionsObject
        
            @staticmethod
            def Entitlements() -> typing.Type['EntitlementsObject']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["SalaryType"]) -> MetaOapg.properties.SalaryType: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["TotalSalaryAmount"]) -> MetaOapg.properties.TotalSalaryAmount: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Deductions"]) -> 'DeductionsObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Entitlements"]) -> 'EntitlementsObject': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["EffectiveFrom", "SalaryType", "PaymentFrequency", "SalaryAmount", "TotalSalaryAmount", "Currency", "ChangeReason", "Comments", "Deductions", "Entitlements", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["SalaryType"]) -> typing.Union[MetaOapg.properties.SalaryType, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TotalSalaryAmount"]) -> typing.Union[MetaOapg.properties.TotalSalaryAmount, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Deductions"]) -> typing.Union['DeductionsObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Entitlements"]) -> typing.Union['EntitlementsObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["EffectiveFrom", "SalaryType", "PaymentFrequency", "SalaryAmount", "TotalSalaryAmount", "Currency", "ChangeReason", "Comments", "Deductions", "Entitlements", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        EffectiveFrom: typing.Union[MetaOapg.properties.EffectiveFrom, str, schemas.Unset] = schemas.unset,
        SalaryType: typing.Union[MetaOapg.properties.SalaryType, str, schemas.Unset] = schemas.unset,
        PaymentFrequency: typing.Union[MetaOapg.properties.PaymentFrequency, str, schemas.Unset] = schemas.unset,
        SalaryAmount: typing.Union[MetaOapg.properties.SalaryAmount, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        TotalSalaryAmount: typing.Union[MetaOapg.properties.TotalSalaryAmount, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ...
        Deductions: typing.Union['DeductionsObject', schemas.Unset] = schemas.unset,
        Entitlements: typing.Union['EntitlementsObject', schemas.Unset] = schemas.unset,
