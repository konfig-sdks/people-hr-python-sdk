...
class Result1ForgetothereventdetailItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            OtherLeaveTxnId = schemas.IntSchema
            StartDate = schemas.DateSchema
            EndDate = schemas.DateSchema
            DurationType = schemas.IntSchema
            DurationInDays = schemas.IntSchema
            DurationInMinutes = schemas.IntSchema
        
            @staticmethod
            def StartTime() -> typing.Type['Timespan']:
                return Timespan
        
            @staticmethod
            def EndTime() -> typing.Type['Timespan']:
                return Timespan
            DurationInDaysThisPeriod = schemas.IntSchema
            DurationInMinutesThisPeriod = schemas.IntSchema
            RequesterComments = schemas.StrSchema
            ApproverComments = schemas.StrSchema
            Approver = schemas.StrSchema
            Reason = schemas.StrSchema
            Status = schemas.StrSchema
            LastActionDateTime = schemas.StrSchema
            __annotations__ = {
                "OtherLeaveTxnId": OtherLeaveTxnId,
                "StartDate": StartDate,
                "EndDate": EndDate,
                ...
                "StartTime": StartTime,
                "EndTime": EndTime,
                "DurationInDaysThisPeriod": DurationInDaysThisPeriod,
                "DurationInMinutesThisPeriod": DurationInMinutesThisPeriod,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["OtherLeaveTxnId"]) -> MetaOapg.properties.OtherLeaveTxnId: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DurationType"]) -> MetaOapg.properties.DurationType: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DurationInDays"]) -> MetaOapg.properties.DurationInDays: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DurationInMinutes"]) -> MetaOapg.properties.DurationInMinutes: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["StartTime"]) -> 'Timespan': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["EndTime"]) -> 'Timespan': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DurationInDaysThisPeriod"]) -> MetaOapg.properties.DurationInDaysThisPeriod: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DurationInMinutesThisPeriod"]) -> MetaOapg.properties.DurationInMinutesThisPeriod: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["RequesterComments"]) -> MetaOapg.properties.RequesterComments: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ApproverComments"]) -> MetaOapg.properties.ApproverComments: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["LastActionDateTime"]) -> MetaOapg.properties.LastActionDateTime: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["OtherLeaveTxnId", "StartDate", "EndDate", "DurationType", "DurationInDays", "DurationInMinutes", "StartTime", "EndTime", "DurationInDaysThisPeriod", "DurationInMinutesThisPeriod", "RequesterComments", "ApproverComments", "Approver", "Reason", "Status", "LastActionDateTime", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["OtherLeaveTxnId"]) -> typing.Union[MetaOapg.properties.OtherLeaveTxnId, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DurationType"]) -> typing.Union[MetaOapg.properties.DurationType, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DurationInDays"]) -> typing.Union[MetaOapg.properties.DurationInDays, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DurationInMinutes"]) -> typing.Union[MetaOapg.properties.DurationInMinutes, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["StartTime"]) -> typing.Union['Timespan', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["EndTime"]) -> typing.Union['Timespan', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DurationInDaysThisPeriod"]) -> typing.Union[MetaOapg.properties.DurationInDaysThisPeriod, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DurationInMinutesThisPeriod"]) -> typing.Union[MetaOapg.properties.DurationInMinutesThisPeriod, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ApproverComments"]) -> typing.Union[MetaOapg.properties.ApproverComments, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["LastActionDateTime"]) -> typing.Union[MetaOapg.properties.LastActionDateTime, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["OtherLeaveTxnId", "StartDate", "EndDate", "DurationType", "DurationInDays", "DurationInMinutes", "StartTime", "EndTime", "DurationInDaysThisPeriod", "DurationInMinutesThisPeriod", "RequesterComments", "ApproverComments", "Approver", "Reason", "Status", "LastActionDateTime", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        OtherLeaveTxnId: typing.Union[MetaOapg.properties.OtherLeaveTxnId, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ...
        DurationType: typing.Union[MetaOapg.properties.DurationType, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        DurationInDays: typing.Union[MetaOapg.properties.DurationInDays, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        DurationInMinutes: typing.Union[MetaOapg.properties.DurationInMinutes, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        StartTime: typing.Union['Timespan', schemas.Unset] = schemas.unset,
        EndTime: typing.Union['Timespan', schemas.Unset] = schemas.unset,
        DurationInDaysThisPeriod: typing.Union[MetaOapg.properties.DurationInDaysThisPeriod, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        DurationInMinutesThisPeriod: typing.Union[MetaOapg.properties.DurationInMinutesThisPeriod, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        RequesterComments: typing.Union[MetaOapg.properties.RequesterComments, str, schemas.Unset] = schemas.unset,
        ApproverComments: typing.Union[MetaOapg.properties.ApproverComments, str, schemas.Unset] = schemas.unset,
        ...
        LastActionDateTime: typing.Union[MetaOapg.properties.LastActionDateTime, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'Result1ForgetothereventdetailItem':
...
from people_hr_python_sdk.model.timespan import Timespan
