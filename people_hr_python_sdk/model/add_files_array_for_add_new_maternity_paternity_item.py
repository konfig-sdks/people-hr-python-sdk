...
class AddFilesArrayForAddNewMaternityPaternityItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["DocumentName", "File", "Description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["DocumentName", "File", "Description", ], str]):
    ...
    ) -> 'AddFilesArrayForAddNewMaternityPaternityItem':
