...
class EditProjectTaskDetailParameter(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def ProjectTaskDetailName() -> typing.Type['ProjectTaskDetailName']:
                return ProjectTaskDetailName
            New_ProjectTaskDetailName = schemas.StrSchema
            InUse = schemas.StrSchema
            __annotations__ = {
                "APIKey": APIKey,
                "Action": Action,
                "ProjectTaskDetailName": ProjectTaskDetailName,
                "New_ProjectTaskDetailName": New_ProjectTaskDetailName,
                "InUse": InUse,
            }
    ...
    ProjectTaskDetailName: 'ProjectTaskDetailName'
    New_ProjectTaskDetailName: MetaOapg.properties.New_ProjectTaskDetailName
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ProjectTaskDetailName"]) -> 'ProjectTaskDetailName': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["New_ProjectTaskDetailName"]) -> MetaOapg.properties.New_ProjectTaskDetailName: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "ProjectTaskDetailName", "New_ProjectTaskDetailName", "InUse", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ProjectTaskDetailName"]) -> 'ProjectTaskDetailName': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["New_ProjectTaskDetailName"]) -> MetaOapg.properties.New_ProjectTaskDetailName: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "ProjectTaskDetailName", "New_ProjectTaskDetailName", "InUse", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ProjectTaskDetailName: 'ProjectTaskDetailName',
        New_ProjectTaskDetailName: typing.Union[MetaOapg.properties.New_ProjectTaskDetailName, str, ],
