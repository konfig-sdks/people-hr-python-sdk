...
class ResultGetProjectTimesheetByTransactionIdObject(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["TransactionId", "ProjectTimesheetDate", "TimesheetProject", "TimesheetTask", "TimesheetDetail", "StartTime", "EndTime", "TotalHours", "Quantity", "Notes", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["TransactionId", "ProjectTimesheetDate", "TimesheetProject", "TimesheetTask", "TimesheetDetail", "StartTime", "EndTime", "TotalHours", "Quantity", "Notes", ], str]):
