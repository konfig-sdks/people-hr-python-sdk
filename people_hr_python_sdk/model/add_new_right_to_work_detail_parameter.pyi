...
class AddNewRightToWorkDetailParameter(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "DocumentName", "File", "DocumentType", "DocumentId", "ValidFrom", "ValidTo", "Duration", "Comments", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "DocumentName", "File", "DocumentType", "DocumentId", "ValidFrom", "ValidTo", "Duration", "Comments", ], str]):
