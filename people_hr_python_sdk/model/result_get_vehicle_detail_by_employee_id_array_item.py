...
class ResultGetVehicleDetailByEmployeeIdArrayItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            VehicleId = schemas.IntSchema
            Registration = schemas.StrSchema
            Make = schemas.StrSchema
            Model = schemas.StrSchema
            Color = schemas.StrSchema
            EngineSize = schemas.StrSchema
            FuelType = schemas.StrSchema
            InsuranceCompany = schemas.StrSchema
            PolicyNumber = schemas.StrSchema
            MOTExpiryDate = schemas.DateSchema
            InsuranceExpiryDate = schemas.DateSchema
            Comments = schemas.StrSchema
        
            @staticmethod
            def CustomColumns() -> typing.Type['CustomColumnsForGetVehicleByIdArray']:
                return CustomColumnsForGetVehicleByIdArray
        
            @staticmethod
            def AddFiles() -> typing.Type['AddFilesForGetVehicleByIdArray']:
                return AddFilesForGetVehicleByIdArray
            __annotations__ = {
                "VehicleId": VehicleId,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["VehicleId"]) -> MetaOapg.properties.VehicleId: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["EngineSize"]) -> MetaOapg.properties.EngineSize: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["FuelType"]) -> MetaOapg.properties.FuelType: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["InsuranceCompany"]) -> MetaOapg.properties.InsuranceCompany: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["PolicyNumber"]) -> MetaOapg.properties.PolicyNumber: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["MOTExpiryDate"]) -> MetaOapg.properties.MOTExpiryDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["InsuranceExpiryDate"]) -> MetaOapg.properties.InsuranceExpiryDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Comments"]) -> MetaOapg.properties.Comments: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["CustomColumns"]) -> 'CustomColumnsForGetVehicleByIdArray': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AddFiles"]) -> 'AddFilesForGetVehicleByIdArray': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["VehicleId", "Registration", "Make", "Model", "Color", "EngineSize", "FuelType", "InsuranceCompany", "PolicyNumber", "MOTExpiryDate", "InsuranceExpiryDate", "Comments", "CustomColumns", "AddFiles", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["VehicleId"]) -> typing.Union[MetaOapg.properties.VehicleId, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Registration"]) -> typing.Union[MetaOapg.properties.Registration, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["EngineSize"]) -> typing.Union[MetaOapg.properties.EngineSize, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["FuelType"]) -> typing.Union[MetaOapg.properties.FuelType, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["InsuranceCompany"]) -> typing.Union[MetaOapg.properties.InsuranceCompany, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["PolicyNumber"]) -> typing.Union[MetaOapg.properties.PolicyNumber, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["MOTExpiryDate"]) -> typing.Union[MetaOapg.properties.MOTExpiryDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["InsuranceExpiryDate"]) -> typing.Union[MetaOapg.properties.InsuranceExpiryDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Comments"]) -> typing.Union[MetaOapg.properties.Comments, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CustomColumns"]) -> typing.Union['CustomColumnsForGetVehicleByIdArray', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AddFiles"]) -> typing.Union['AddFilesForGetVehicleByIdArray', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["VehicleId", "Registration", "Make", "Model", "Color", "EngineSize", "FuelType", "InsuranceCompany", "PolicyNumber", "MOTExpiryDate", "InsuranceExpiryDate", "Comments", "CustomColumns", "AddFiles", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        VehicleId: typing.Union[MetaOapg.properties.VehicleId, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        Registration: typing.Union[MetaOapg.properties.Registration, str, schemas.Unset] = schemas.unset,
        ...
        EngineSize: typing.Union[MetaOapg.properties.EngineSize, str, schemas.Unset] = schemas.unset,
        FuelType: typing.Union[MetaOapg.properties.FuelType, str, schemas.Unset] = schemas.unset,
        InsuranceCompany: typing.Union[MetaOapg.properties.InsuranceCompany, str, schemas.Unset] = schemas.unset,
        PolicyNumber: typing.Union[MetaOapg.properties.PolicyNumber, str, schemas.Unset] = schemas.unset,
        MOTExpiryDate: typing.Union[MetaOapg.properties.MOTExpiryDate, str, date, schemas.Unset] = schemas.unset,
        InsuranceExpiryDate: typing.Union[MetaOapg.properties.InsuranceExpiryDate, str, date, schemas.Unset] = schemas.unset,
        Comments: typing.Union[MetaOapg.properties.Comments, str, schemas.Unset] = schemas.unset,
        CustomColumns: typing.Union['CustomColumnsForGetVehicleByIdArray', schemas.Unset] = schemas.unset,
        AddFiles: typing.Union['AddFilesForGetVehicleByIdArray', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ResultGetVehicleDetailByEmployeeIdArrayItem':
