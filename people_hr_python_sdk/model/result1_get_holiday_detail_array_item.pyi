...
class Result1GetHolidayDetailArrayItem(
    schemas.DictSchema
):
    """
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["IsToilHoliday"]) -> MetaOapg.properties.IsToilHoliday: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["StartDate", "EndDate", "DurationType", "DurationInDays", "DurationInMinutes", "DurationInDaysThisPeriod", "DurationInMinutesThisPeriod", "PartOfDay", "RequesterComments", "ApproverComments", "Approver", "Status", "LastActionDateTime", "IsToilHoliday", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["IsToilHoliday"]) -> typing.Union[MetaOapg.properties.IsToilHoliday, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["StartDate", "EndDate", "DurationType", "DurationInDays", "DurationInMinutes", "DurationInDaysThisPeriod", "DurationInMinutesThisPeriod", "PartOfDay", "RequesterComments", "ApproverComments", "Approver", "Status", "LastActionDateTime", "IsToilHoliday", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        IsToilHoliday: typing.Union[MetaOapg.properties.IsToilHoliday, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'Result1GetHolidayDetailArrayItem':
