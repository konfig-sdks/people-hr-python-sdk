...
class ErrorForGetByCustomScreenTransactionId(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def Result() -> typing.Type['Result1GetByCustomScreenTransactionIdObject']:
                return Result1GetByCustomScreenTransactionIdObject
            __annotations__ = {
                "IsError": IsError,
                "Status": Status,
                "Message": Message,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Result"]) -> 'Result1GetByCustomScreenTransactionIdObject': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Result"]) -> typing.Union['Result1GetByCustomScreenTransactionIdObject', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        Result: typing.Union['Result1GetByCustomScreenTransactionIdObject', schemas.Unset] = schemas.unset,
