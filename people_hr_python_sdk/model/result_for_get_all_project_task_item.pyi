...
class ResultForGetAllProjectTaskItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ProjectTaskId = schemas.IntSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ProjectTaskId"]) -> MetaOapg.properties.ProjectTaskId: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ProjectTaskId", "ProjectTaskName", "Status", "ProjectName", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ProjectTaskId"]) -> typing.Union[MetaOapg.properties.ProjectTaskId, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ProjectTaskId", "ProjectTaskName", "Status", "ProjectName", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ProjectTaskId: typing.Union[MetaOapg.properties.ProjectTaskId, decimal.Decimal, int, schemas.Unset] = schemas.unset,
    ...
    ) -> 'ResultForGetAllProjectTaskItem':
