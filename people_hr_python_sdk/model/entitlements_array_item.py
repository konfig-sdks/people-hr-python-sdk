...
class EntitlementsArrayItem(
    ...
    Entitlement: MetaOapg.properties.Entitlement
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Entitlement", "DisplayAsAmountOrPercentage", "Amount", "IncludeInTotalSalary", "Percentage", "Comments", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Entitlement"]) -> MetaOapg.properties.Entitlement: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Entitlement", "DisplayAsAmountOrPercentage", "Amount", "IncludeInTotalSalary", "Percentage", "Comments", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        Entitlement: typing.Union[MetaOapg.properties.Entitlement, str, ],
