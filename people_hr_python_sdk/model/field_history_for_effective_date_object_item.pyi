...
class FieldHistoryForEffectiveDateObjectItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["FieldData", "EffectiveDate", "ChangedOn", "ReasonForChange", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["FieldData", "EffectiveDate", "ChangedOn", "ReasonForChange", ], str]):
    ...
    ) -> 'FieldHistoryForEffectiveDateObjectItem':
