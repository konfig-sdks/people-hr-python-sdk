...
class Result2GetHistoryByEmployeeIdAndFieldNameItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            FieldData = schemas.StrSchema
            EffectiveDate = schemas.DateSchema
            ReasonForChange = schemas.StrSchema
            ChangedOn = schemas.DateSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["FieldData"]) -> MetaOapg.properties.FieldData: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["EffectiveDate"]) -> MetaOapg.properties.EffectiveDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ReasonForChange"]) -> MetaOapg.properties.ReasonForChange: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ChangedOn"]) -> MetaOapg.properties.ChangedOn: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["FieldData", "EffectiveDate", "ReasonForChange", "ChangedOn", "CreatedBy", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["FieldData"]) -> typing.Union[MetaOapg.properties.FieldData, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ReasonForChange"]) -> typing.Union[MetaOapg.properties.ReasonForChange, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ChangedOn"]) -> typing.Union[MetaOapg.properties.ChangedOn, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["FieldData", "EffectiveDate", "ReasonForChange", "ChangedOn", "CreatedBy", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        FieldData: typing.Union[MetaOapg.properties.FieldData, str, schemas.Unset] = schemas.unset,
        EffectiveDate: typing.Union[MetaOapg.properties.EffectiveDate, str, date, schemas.Unset] = schemas.unset,
        ReasonForChange: typing.Union[MetaOapg.properties.ReasonForChange, str, schemas.Unset] = schemas.unset,
        ChangedOn: typing.Union[MetaOapg.properties.ChangedOn, str, date, schemas.Unset] = schemas.unset,
    ...
    ) -> 'Result2GetHistoryByEmployeeIdAndFieldNameItem':
