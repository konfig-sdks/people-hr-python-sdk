...
class ErrorForGetDrivingLicenseByDrivingId(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def Result() -> typing.Type['ResultForGetDrivingLicenseByDrivingIdObject']:
                return ResultForGetDrivingLicenseByDrivingIdObject
            __annotations__ = {
                "IsError": IsError,
                "Status": Status,
                "Message": Message,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Result"]) -> 'ResultForGetDrivingLicenseByDrivingIdObject': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Result"]) -> typing.Union['ResultForGetDrivingLicenseByDrivingIdObject', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        Result: typing.Union['ResultForGetDrivingLicenseByDrivingIdObject', schemas.Unset] = schemas.unset,
