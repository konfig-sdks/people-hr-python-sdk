...
class ResultForGetProjectTimesheetDetailItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["TransactionId", "ProjectTimesheetDate", "TimesheetProject", "TimesheetTask", "TimesheetDetail", "StartTime", "EndTime", "TotalHours", "Quantity", "Notes", "ChangedDate", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ProjectTimesheetDate"]) -> typing.Union[MetaOapg.properties.ProjectTimesheetDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TimesheetProject"]) -> typing.Union[MetaOapg.properties.TimesheetProject, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TimesheetTask"]) -> typing.Union[MetaOapg.properties.TimesheetTask, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TimesheetDetail"]) -> typing.Union[MetaOapg.properties.TimesheetDetail, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["TransactionId", "ProjectTimesheetDate", "TimesheetProject", "TimesheetTask", "TimesheetDetail", "StartTime", "EndTime", "TotalHours", "Quantity", "Notes", "ChangedDate", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ProjectTimesheetDate: typing.Union[MetaOapg.properties.ProjectTimesheetDate, str, date, schemas.Unset] = schemas.unset,
        TimesheetProject: typing.Union[MetaOapg.properties.TimesheetProject, str, schemas.Unset] = schemas.unset,
        TimesheetTask: typing.Union[MetaOapg.properties.TimesheetTask, str, schemas.Unset] = schemas.unset,
        TimesheetDetail: typing.Union[MetaOapg.properties.TimesheetDetail, str, schemas.Unset] = schemas.unset,
        ...
        TotalHours: typing.Union[MetaOapg.properties.TotalHours, str, schemas.Unset] = schemas.unset,
    ...
    ) -> 'ResultForGetProjectTimesheetDetailItem':
