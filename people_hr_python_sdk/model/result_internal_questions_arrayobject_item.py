...
class ResultInternalQuestionsArrayobjectItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def QuestionId() -> typing.Type['Byte']:
                return Byte
        
            @staticmethod
            def QuestionType() -> typing.Type['Byte']:
                return Byte
            ...
            AdditionalOrInternalType = schemas.IntSchema
        
            @staticmethod
            def QuestionOptions() -> typing.Type['ResultlstInternalQuestions']:
                return ResultlstInternalQuestions
            __annotations__ = {
                "QuestionId": QuestionId,
                "QuestionType": QuestionType,
                "IsMandatory": IsMandatory,
                "Question": Question,
                "AdditionalOrInternalType": AdditionalOrInternalType,
                "QuestionOptions": QuestionOptions,
            }
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["QuestionId"]) -> 'Byte': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["QuestionType"]) -> 'Byte': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AdditionalOrInternalType"]) -> MetaOapg.properties.AdditionalOrInternalType: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["QuestionOptions"]) -> 'ResultlstInternalQuestions': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["QuestionId", "QuestionType", "IsMandatory", "Question", "AdditionalOrInternalType", "QuestionOptions", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["QuestionId"]) -> typing.Union['Byte', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["QuestionType"]) -> typing.Union['Byte', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AdditionalOrInternalType"]) -> typing.Union[MetaOapg.properties.AdditionalOrInternalType, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["QuestionOptions"]) -> typing.Union['ResultlstInternalQuestions', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["QuestionId", "QuestionType", "IsMandatory", "Question", "AdditionalOrInternalType", "QuestionOptions", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        QuestionId: typing.Union['Byte', schemas.Unset] = schemas.unset,
        QuestionType: typing.Union['Byte', schemas.Unset] = schemas.unset,
        IsMandatory: typing.Union[MetaOapg.properties.IsMandatory, str, schemas.Unset] = schemas.unset,
        Question: typing.Union[MetaOapg.properties.Question, str, schemas.Unset] = schemas.unset,
        AdditionalOrInternalType: typing.Union[MetaOapg.properties.AdditionalOrInternalType, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        QuestionOptions: typing.Union['ResultlstInternalQuestions', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ResultInternalQuestionsArrayobjectItem':
