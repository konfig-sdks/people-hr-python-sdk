...
class UpdateTrainingDetailParameter(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            def EmployeeId() -> typing.Type['EmployeeId']:
                return EmployeeId
            TrainingType = schemas.StrSchema
            Description = schemas.StrSchema
            Importance = schemas.IntSchema
            Status = schemas.IntSchema
        
            @staticmethod
            def InProgress() -> typing.Type['Byte']:
                return Byte
            TrainingDate = schemas.DateSchema
            TrainindEndDate = schemas.DateSchema
            TrainingExpiryDate = schemas.DateSchema
            Cost = schemas.StrSchema
            Provider = schemas.StrSchema
            Notes = schemas.StrSchema
        
            @staticmethod
            def CustomColumns() -> typing.Type['CustomColumnsForEmployeeTraining']:
                return CustomColumnsForEmployeeTraining
        
            @staticmethod
            def AddFiles() -> typing.Type['AddFilesForEmployeeTraining']:
                return AddFilesForEmployeeTraining
            __annotations__ = {
                "APIKey": APIKey,
                "Action": Action,
                ...
                "TrainindEndDate": TrainindEndDate,
    ...
    Importance: MetaOapg.properties.Importance
    Status: MetaOapg.properties.Status
    APIKey: 'APIKey'
    Action: MetaOapg.properties.Action
    Progress: schemas.AnyTypeSchema
    Description: MetaOapg.properties.Description
    TrainingId: schemas.AnyTypeSchema
    TrainingType: MetaOapg.properties.TrainingType
    EmployeeId: 'EmployeeId'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["InProgress"]) -> 'Byte': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["TrainingDate"]) -> MetaOapg.properties.TrainingDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["TrainindEndDate"]) -> MetaOapg.properties.TrainindEndDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["TrainingExpiryDate"]) -> MetaOapg.properties.TrainingExpiryDate: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["CustomColumns"]) -> 'CustomColumnsForEmployeeTraining': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AddFiles"]) -> 'AddFilesForEmployeeTraining': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "TrainingType", "Description", "Importance", "Status", "InProgress", "TrainingDate", "TrainindEndDate", "TrainingExpiryDate", "Cost", "Provider", "Notes", "CustomColumns", "AddFiles", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TrainingType"]) -> MetaOapg.properties.TrainingType: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Description"]) -> MetaOapg.properties.Description: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Importance"]) -> MetaOapg.properties.Importance: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Status"]) -> MetaOapg.properties.Status: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["InProgress"]) -> typing.Union['Byte', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TrainingDate"]) -> typing.Union[MetaOapg.properties.TrainingDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TrainindEndDate"]) -> typing.Union[MetaOapg.properties.TrainindEndDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TrainingExpiryDate"]) -> typing.Union[MetaOapg.properties.TrainingExpiryDate, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CustomColumns"]) -> typing.Union['CustomColumnsForEmployeeTraining', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AddFiles"]) -> typing.Union['AddFilesForEmployeeTraining', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "TrainingType", "Description", "Importance", "Status", "InProgress", "TrainingDate", "TrainindEndDate", "TrainingExpiryDate", "Cost", "Provider", "Notes", "CustomColumns", "AddFiles", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        Importance: typing.Union[MetaOapg.properties.Importance, decimal.Decimal, int, ],
        Status: typing.Union[MetaOapg.properties.Status, decimal.Decimal, int, ],
        APIKey: 'APIKey',
        Action: typing.Union[MetaOapg.properties.Action, str, ],
        Progress: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        Description: typing.Union[MetaOapg.properties.Description, str, ],
        TrainingId: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        TrainingType: typing.Union[MetaOapg.properties.TrainingType, str, ],
        EmployeeId: 'EmployeeId',
        InProgress: typing.Union['Byte', schemas.Unset] = schemas.unset,
        TrainingDate: typing.Union[MetaOapg.properties.TrainingDate, str, date, schemas.Unset] = schemas.unset,
        TrainindEndDate: typing.Union[MetaOapg.properties.TrainindEndDate, str, date, schemas.Unset] = schemas.unset,
        TrainingExpiryDate: typing.Union[MetaOapg.properties.TrainingExpiryDate, str, date, schemas.Unset] = schemas.unset,
        ...
        CustomColumns: typing.Union['CustomColumnsForEmployeeTraining', schemas.Unset] = schemas.unset,
        AddFiles: typing.Union['AddFilesForEmployeeTraining', schemas.Unset] = schemas.unset,
...
from people_hr_python_sdk.model.byte import Byte
