...
class Result1ForAttachmentForEmailInboxItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["FileName", "Size", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["FileName", "Size", ], str]):
    ...
    ) -> 'Result1ForAttachmentForEmailInboxItem':
