...
class ResultEmployeeAbsenceArrayItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            DurationDays = schemas.IntSchema
            ...
            class BackToWorkInterviewRequried(
                schemas.EnumBase,
                schemas.StrSchema
            ):
                ...
                def TRUE(cls):
                    return cls("true")
            BackToWorkInterviewDate = schemas.StrSchema
            MedicalCertificateType = schemas.IntSchema
            MedicalCertificateReceivedDate = schemas.StrSchema
            Reason = schemas.StrSchema
        
            @staticmethod
            def Comments() -> typing.Type['CommentsArray']:
                return CommentsArray
            AbsencePaidStatus = schemas.IntSchema
            ...
            __annotations__ = {
                ...
                "PartOfDay": PartOfDay,
                "BackToWorkInterviewRequried": BackToWorkInterviewRequried,
                "BackToWorkInterviewDate": BackToWorkInterviewDate,
                "MedicalCertificateType": MedicalCertificateType,
                "MedicalCertificateReceivedDate": MedicalCertificateReceivedDate,
                "Reason": Reason,
                "Comments": Comments,
                "AbsencePaidStatus": AbsencePaidStatus,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["PartOfDay"]) -> MetaOapg.properties.PartOfDay: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["BackToWorkInterviewRequried"]) -> MetaOapg.properties.BackToWorkInterviewRequried: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["BackToWorkInterviewDate"]) -> MetaOapg.properties.BackToWorkInterviewDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["MedicalCertificateType"]) -> MetaOapg.properties.MedicalCertificateType: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["MedicalCertificateReceivedDate"]) -> MetaOapg.properties.MedicalCertificateReceivedDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Reason"]) -> MetaOapg.properties.Reason: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Comments"]) -> 'CommentsArray': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AbsencePaidStatus"]) -> MetaOapg.properties.AbsencePaidStatus: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["EmergencyLeave"]) -> MetaOapg.properties.EmergencyLeave: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["StartDate", "EndDate", "DurationDays", "DurationInDaysThisPeriod", "PartOfDay", "BackToWorkInterviewRequried", "BackToWorkInterviewDate", "MedicalCertificateType", "MedicalCertificateReceivedDate", "Reason", "Comments", "AbsencePaidStatus", "EmergencyLeave", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["PartOfDay"]) -> typing.Union[MetaOapg.properties.PartOfDay, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["BackToWorkInterviewRequried"]) -> typing.Union[MetaOapg.properties.BackToWorkInterviewRequried, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["BackToWorkInterviewDate"]) -> typing.Union[MetaOapg.properties.BackToWorkInterviewDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["MedicalCertificateType"]) -> typing.Union[MetaOapg.properties.MedicalCertificateType, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["MedicalCertificateReceivedDate"]) -> typing.Union[MetaOapg.properties.MedicalCertificateReceivedDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Reason"]) -> typing.Union[MetaOapg.properties.Reason, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Comments"]) -> typing.Union['CommentsArray', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AbsencePaidStatus"]) -> typing.Union[MetaOapg.properties.AbsencePaidStatus, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["EmergencyLeave"]) -> typing.Union[MetaOapg.properties.EmergencyLeave, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["StartDate", "EndDate", "DurationDays", "DurationInDaysThisPeriod", "PartOfDay", "BackToWorkInterviewRequried", "BackToWorkInterviewDate", "MedicalCertificateType", "MedicalCertificateReceivedDate", "Reason", "Comments", "AbsencePaidStatus", "EmergencyLeave", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        DurationDays: typing.Union[MetaOapg.properties.DurationDays, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ...
        PartOfDay: typing.Union[MetaOapg.properties.PartOfDay, str, schemas.Unset] = schemas.unset,
        BackToWorkInterviewRequried: typing.Union[MetaOapg.properties.BackToWorkInterviewRequried, str, schemas.Unset] = schemas.unset,
        BackToWorkInterviewDate: typing.Union[MetaOapg.properties.BackToWorkInterviewDate, str, schemas.Unset] = schemas.unset,
        MedicalCertificateType: typing.Union[MetaOapg.properties.MedicalCertificateType, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        MedicalCertificateReceivedDate: typing.Union[MetaOapg.properties.MedicalCertificateReceivedDate, str, schemas.Unset] = schemas.unset,
        Reason: typing.Union[MetaOapg.properties.Reason, str, schemas.Unset] = schemas.unset,
        Comments: typing.Union['CommentsArray', schemas.Unset] = schemas.unset,
        AbsencePaidStatus: typing.Union[MetaOapg.properties.AbsencePaidStatus, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        EmergencyLeave: typing.Union[MetaOapg.properties.EmergencyLeave, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ResultEmployeeAbsenceArrayItem':
