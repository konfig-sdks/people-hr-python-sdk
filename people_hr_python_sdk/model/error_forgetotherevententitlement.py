...
class ErrorForgetotherevententitlement(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def Result() -> typing.Type['Result1Forgetotherevententitlement']:
                return Result1Forgetotherevententitlement
            __annotations__ = {
                "IsError": IsError,
                "Status": Status,
                "Message": Message,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Result"]) -> 'Result1Forgetotherevententitlement': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Result"]) -> typing.Union['Result1Forgetotherevententitlement', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        Result: typing.Union['Result1Forgetotherevententitlement', schemas.Unset] = schemas.unset,
