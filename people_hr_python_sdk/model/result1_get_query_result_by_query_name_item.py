...
class Result1GetQueryResultByQueryNameItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            annual_leave_start_date = schemas.DateSchema
            annual_leave_end_date = schemas.DateSchema
            allowance_type = schemas.StrSchema
            allowance__days = schemas.StrSchema
            __annotations__ = {
                "Employee Id": employee_id,
                "First Name": first_name,
                "Last Name": last_name,
                "Annual Leave Start Date": annual_leave_start_date,
                "Annual Leave End Date": annual_leave_end_date,
                "Allowance Type": allowance_type,
                "Allowance (Days)": allowance__days,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Annual Leave Start Date"]) -> MetaOapg.properties.annual_leave_start_date: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Annual Leave End Date"]) -> MetaOapg.properties.annual_leave_end_date: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Allowance Type"]) -> MetaOapg.properties.allowance_type: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Allowance (Days)"]) -> MetaOapg.properties.allowance__days: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Employee Id", "First Name", "Last Name", "Annual Leave Start Date", "Annual Leave End Date", "Allowance Type", "Allowance (Days)", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Annual Leave Start Date"]) -> typing.Union[MetaOapg.properties.annual_leave_start_date, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Annual Leave End Date"]) -> typing.Union[MetaOapg.properties.annual_leave_end_date, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Allowance Type"]) -> typing.Union[MetaOapg.properties.allowance_type, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Allowance (Days)"]) -> typing.Union[MetaOapg.properties.allowance__days, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Employee Id", "First Name", "Last Name", "Annual Leave Start Date", "Annual Leave End Date", "Allowance Type", "Allowance (Days)", ], str]):
    ...
    ) -> 'Result1GetQueryResultByQueryNameItem':
