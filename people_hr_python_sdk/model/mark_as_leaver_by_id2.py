...
class MarkAsLeaverById2(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            FinalEmploymentDate = schemas.DateSchema
        
            @staticmethod
            def AdditionalComments() -> typing.Type['AdditionalComments']:
                return AdditionalComments
            FinalWorkingDate = schemas.StrSchema
            MarkasLeaverImmediately = schemas.BoolSchema
        
            @staticmethod
            def ReportsTo() -> typing.Type['ReportsTo']:
                return ReportsTo
            ReEmployable = schemas.StrSchema
        
            @staticmethod
            def SupportingComments() -> typing.Type['SupportingComments']:
            ...
            __annotations__ = {
                ...
                "FinalEmploymentDate": FinalEmploymentDate,
                "AdditionalComments": AdditionalComments,
                "FinalWorkingDate": FinalWorkingDate,
                "MarkasLeaverImmediately": MarkasLeaverImmediately,
                "ReportsTo": ReportsTo,
                "ReEmployable": ReEmployable,
                "SupportingComments": SupportingComments,
            }
    
    APIKey: 'APIKey'
    Action: MetaOapg.properties.Action
    FinalEmploymentDate: MetaOapg.properties.FinalEmploymentDate
    EmployeeId: 'EmployeeId'
    ReasonforLeaving: MetaOapg.properties.ReasonforLeaving
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["FinalEmploymentDate"]) -> MetaOapg.properties.FinalEmploymentDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AdditionalComments"]) -> 'AdditionalComments': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["FinalWorkingDate"]) -> MetaOapg.properties.FinalWorkingDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["MarkasLeaverImmediately"]) -> MetaOapg.properties.MarkasLeaverImmediately: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ReportsTo"]) -> 'ReportsTo': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ReEmployable"]) -> MetaOapg.properties.ReEmployable: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["SupportingComments"]) -> 'SupportingComments': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "ReasonforLeaving", "FinalEmploymentDate", "AdditionalComments", "FinalWorkingDate", "MarkasLeaverImmediately", "ReportsTo", "ReEmployable", "SupportingComments", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ReasonforLeaving"]) -> MetaOapg.properties.ReasonforLeaving: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["FinalEmploymentDate"]) -> MetaOapg.properties.FinalEmploymentDate: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AdditionalComments"]) -> typing.Union['AdditionalComments', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["FinalWorkingDate"]) -> typing.Union[MetaOapg.properties.FinalWorkingDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["MarkasLeaverImmediately"]) -> typing.Union[MetaOapg.properties.MarkasLeaverImmediately, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ReportsTo"]) -> typing.Union['ReportsTo', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ReEmployable"]) -> typing.Union[MetaOapg.properties.ReEmployable, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["SupportingComments"]) -> typing.Union['SupportingComments', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "ReasonforLeaving", "FinalEmploymentDate", "AdditionalComments", "FinalWorkingDate", "MarkasLeaverImmediately", "ReportsTo", "ReEmployable", "SupportingComments", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        FinalEmploymentDate: typing.Union[MetaOapg.properties.FinalEmploymentDate, str, date, ],
        EmployeeId: 'EmployeeId',
        ReasonforLeaving: typing.Union[MetaOapg.properties.ReasonforLeaving, str, ],
        AdditionalComments: typing.Union['AdditionalComments', schemas.Unset] = schemas.unset,
        FinalWorkingDate: typing.Union[MetaOapg.properties.FinalWorkingDate, str, schemas.Unset] = schemas.unset,
        MarkasLeaverImmediately: typing.Union[MetaOapg.properties.MarkasLeaverImmediately, bool, schemas.Unset] = schemas.unset,
        ReportsTo: typing.Union['ReportsTo', schemas.Unset] = schemas.unset,
        ReEmployable: typing.Union[MetaOapg.properties.ReEmployable, str, schemas.Unset] = schemas.unset,
        SupportingComments: typing.Union['SupportingComments', schemas.Unset] = schemas.unset,
