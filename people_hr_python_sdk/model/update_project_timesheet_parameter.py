...
class UpdateProjectTimesheetParameter(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "TransactionId", "TimesheetProject", "TimesheetTask", "TimesheetDetail", "StartTime", "EndTime", "TotalHours", "Quantity", "Notes", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "TransactionId", "TimesheetProject", "TimesheetTask", "TimesheetDetail", "StartTime", "EndTime", "TotalHours", "Quantity", "Notes", ], str]):
