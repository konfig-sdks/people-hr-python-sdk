...
class UpdateBenefitParameter(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def DateAwarded() -> typing.Type['String']:
                return String
        
            @staticmethod
            def RecoverOnTermination() -> typing.Type['RecoverOnTermination']:
                return RecoverOnTermination
            ExpiryDate = schemas.DateSchema
            Value = schemas.StrSchema
        
            @staticmethod
            def CustomColumns() -> typing.Type['CustomColumnsArrayForAddNewBenefit']:
                return CustomColumnsArrayForAddNewBenefit
        
            @staticmethod
            def AddFiles() -> typing.Type['AddFilesArrayForUpdateBenefit']:
                return AddFilesArrayForUpdateBenefit
            __annotations__ = {
                "APIKey": APIKey,
                "Action": Action,
    ...
    BenefitId: MetaOapg.properties.BenefitId
    Benefit: MetaOapg.properties.Benefit
    RecoverOnTermination: 'RecoverOnTermination'
    EmployeeId: 'EmployeeId'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DateAwarded"]) -> 'String': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["RecoverOnTermination"]) -> 'RecoverOnTermination': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["CustomColumns"]) -> 'CustomColumnsArrayForAddNewBenefit': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AddFiles"]) -> 'AddFilesArrayForUpdateBenefit': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "Benefit", "BenefitId", "DateAwarded", "RecoverOnTermination", "ExpiryDate", "Value", "CustomColumns", "AddFiles", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Benefit"]) -> MetaOapg.properties.Benefit: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["BenefitId"]) -> MetaOapg.properties.BenefitId: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DateAwarded"]) -> 'String': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["RecoverOnTermination"]) -> 'RecoverOnTermination': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CustomColumns"]) -> typing.Union['CustomColumnsArrayForAddNewBenefit', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AddFiles"]) -> typing.Union['AddFilesArrayForUpdateBenefit', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "Benefit", "BenefitId", "DateAwarded", "RecoverOnTermination", "ExpiryDate", "Value", "CustomColumns", "AddFiles", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        BenefitId: typing.Union[MetaOapg.properties.BenefitId, decimal.Decimal, int, ],
        Benefit: typing.Union[MetaOapg.properties.Benefit, str, ],
        RecoverOnTermination: 'RecoverOnTermination',
        EmployeeId: 'EmployeeId',
        ExpiryDate: typing.Union[MetaOapg.properties.ExpiryDate, str, date, schemas.Unset] = schemas.unset,
        Value: typing.Union[MetaOapg.properties.Value, str, schemas.Unset] = schemas.unset,
        CustomColumns: typing.Union['CustomColumnsArrayForAddNewBenefit', schemas.Unset] = schemas.unset,
        AddFiles: typing.Union['AddFilesArrayForUpdateBenefit', schemas.Unset] = schemas.unset,
