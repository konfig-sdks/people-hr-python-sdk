...
class Result1ForEmailBccForEmailInboxItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["EmailId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["EmailId", ], str]):
    ...
    ) -> 'Result1ForEmailBccForEmailInboxItem':
