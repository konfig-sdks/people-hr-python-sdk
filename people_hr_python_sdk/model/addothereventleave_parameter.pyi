...
class AddothereventleaveParameter(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def AddFiles() -> typing.Type['Result1Foraddothereventleave']:
                return Result1Foraddothereventleave
            __annotations__ = {
                "APIKey": APIKey,
                "Action": Action,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AddFiles"]) -> 'Result1Foraddothereventleave': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "DurationType", "Other Event Reason", "StartDate", "EndDate", "DurationInDays", "StartTime", "EndTime", "Comments", "AddFiles", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AddFiles"]) -> typing.Union['Result1Foraddothereventleave', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "DurationType", "Other Event Reason", "StartDate", "EndDate", "DurationInDays", "StartTime", "EndTime", "Comments", "AddFiles", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        AddFiles: typing.Union['Result1Foraddothereventleave', schemas.Unset] = schemas.unset,
