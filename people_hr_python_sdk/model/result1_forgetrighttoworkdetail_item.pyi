...
class Result1ForgetrighttoworkdetailItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            RightToWorkId = schemas.IntSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["RightToWorkId"]) -> MetaOapg.properties.RightToWorkId: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["RightToWorkId", "DocumentType", "DocumentId", "ValidFrom", "ValidTo", "Duration", "DocumentName", "DocumentURL", "Comments", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["RightToWorkId"]) -> typing.Union[MetaOapg.properties.RightToWorkId, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["RightToWorkId", "DocumentType", "DocumentId", "ValidFrom", "ValidTo", "Duration", "DocumentName", "DocumentURL", "Comments", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        RightToWorkId: typing.Union[MetaOapg.properties.RightToWorkId, decimal.Decimal, int, schemas.Unset] = schemas.unset,
    ...
    ) -> 'Result1ForgetrighttoworkdetailItem':
