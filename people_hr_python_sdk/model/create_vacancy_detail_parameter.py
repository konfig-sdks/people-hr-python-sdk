...
class CreateVacancyDetailParameter(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def IsCoverLetterMandatory() -> typing.Type['IsCoverLetterMandatory']:
                return IsCoverLetterMandatory
        
            @staticmethod
            def IsResumeMandatory() -> typing.Type['IsResumeMandatory']:
                return IsResumeMandatory
        
            @staticmethod
            def IsHideSalary() -> typing.Type['IsHideSalary']:
                return IsHideSalary
        
            @staticmethod
            def VacancyType() -> typing.Type['VacancyType']:
                return VacancyType
            ...
            __annotations__ = {
                ...
                "Reference": Reference,
                "IsCoverLetterMandatory": IsCoverLetterMandatory,
                "IsResumeMandatory": IsResumeMandatory,
    ...
    VacancyDescription: MetaOapg.properties.VacancyDescription
    VacancyName: MetaOapg.properties.VacancyName
    VacancyType: 'VacancyType'
    IsResumeMandatory: 'IsResumeMandatory'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["IsCoverLetterMandatory"]) -> 'IsCoverLetterMandatory': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["IsResumeMandatory"]) -> 'IsResumeMandatory': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["IsHideSalary"]) -> 'IsHideSalary': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["VacancyType"]) -> 'VacancyType': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "VacancyName", "VacancyDescription", "Reference", "IsCoverLetterMandatory", "IsResumeMandatory", "IsHideSalary", "VacancyType", "Company", "Location", "Department", "ClosingDate", "Comment", "SalaryRange", "JobDescription", "JobTitle", "City", "Country", "Experience", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["VacancyName"]) -> MetaOapg.properties.VacancyName: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["VacancyDescription"]) -> MetaOapg.properties.VacancyDescription: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Reference"]) -> MetaOapg.properties.Reference: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["IsCoverLetterMandatory"]) -> 'IsCoverLetterMandatory': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["IsResumeMandatory"]) -> 'IsResumeMandatory': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["IsHideSalary"]) -> 'IsHideSalary': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["VacancyType"]) -> 'VacancyType': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "VacancyName", "VacancyDescription", "Reference", "IsCoverLetterMandatory", "IsResumeMandatory", "IsHideSalary", "VacancyType", "Company", "Location", "Department", "ClosingDate", "Comment", "SalaryRange", "JobDescription", "JobTitle", "City", "Country", "Experience", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        VacancyDescription: typing.Union[MetaOapg.properties.VacancyDescription, str, ],
        VacancyName: typing.Union[MetaOapg.properties.VacancyName, str, ],
        VacancyType: 'VacancyType',
        IsResumeMandatory: 'IsResumeMandatory',
