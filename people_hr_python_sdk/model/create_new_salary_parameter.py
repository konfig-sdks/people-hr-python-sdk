...
class CreateNewSalaryParameter(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            def EmployeeId() -> typing.Type['EmployeeId']:
                return EmployeeId
            EffectiveFrom = schemas.DateSchema
        
            @staticmethod
            def SalaryType() -> typing.Type['SalaryType']:
                return SalaryType
        
            @staticmethod
            def PaymentFrequency() -> typing.Type['PaymentFrequency']:
                return PaymentFrequency
            SalaryAmount = schemas.IntSchema
            CurrencyCode = schemas.StrSchema
            ChangeReason = schemas.StrSchema
        
            @staticmethod
            def Deductions() -> typing.Type['DeductionsArray']:
                return DeductionsArray
        
            @staticmethod
            def Entitlements() -> typing.Type['EntitlementsArray']:
    ...
    SalaryAmount: MetaOapg.properties.SalaryAmount
    DisplayAsAmountOrPercentage: schemas.AnyTypeSchema
    Percentage: schemas.AnyTypeSchema
    Deduction: schemas.AnyTypeSchema
    Amount: schemas.AnyTypeSchema
    IncludeInTotalSalary: schemas.AnyTypeSchema
    PaymentFrequency: 'PaymentFrequency'
    ChangeReason: MetaOapg.properties.ChangeReason
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["SalaryType"]) -> 'SalaryType': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["PaymentFrequency"]) -> 'PaymentFrequency': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Deductions"]) -> 'DeductionsArray': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Entitlements"]) -> 'EntitlementsArray': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "EffectiveFrom", "SalaryType", "PaymentFrequency", "SalaryAmount", "CurrencyCode", "ChangeReason", "Deductions", "Entitlements", "Comments", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["SalaryType"]) -> 'SalaryType': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["PaymentFrequency"]) -> 'PaymentFrequency': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["SalaryAmount"]) -> MetaOapg.properties.SalaryAmount: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CurrencyCode"]) -> MetaOapg.properties.CurrencyCode: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ChangeReason"]) -> MetaOapg.properties.ChangeReason: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Deductions"]) -> 'DeductionsArray': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Entitlements"]) -> 'EntitlementsArray': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "EffectiveFrom", "SalaryType", "PaymentFrequency", "SalaryAmount", "CurrencyCode", "ChangeReason", "Deductions", "Entitlements", "Comments", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        SalaryAmount: typing.Union[MetaOapg.properties.SalaryAmount, decimal.Decimal, int, ],
        DisplayAsAmountOrPercentage: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        Percentage: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        Deduction: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        IncludeInTotalSalary: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        PaymentFrequency: 'PaymentFrequency',
        ChangeReason: typing.Union[MetaOapg.properties.ChangeReason, str, ],
        CurrencyCode: typing.Union[MetaOapg.properties.CurrencyCode, str, ],
        APIKey: 'APIKey',
        SalaryType: 'SalaryType',
        Entitlements: 'EntitlementsArray',
        Deductions: 'DeductionsArray',
        EffectiveFrom: typing.Union[MetaOapg.properties.EffectiveFrom, str, date, ],
        EmployeeId: 'EmployeeId',
        ...
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
        ...
        return super().__new__(
            ...
            *args,
            Action=Action,
            SalaryAmount=SalaryAmount,
            DisplayAsAmountOrPercentage=DisplayAsAmountOrPercentage,
            Percentage=Percentage,
            Deduction=Deduction,
            Amount=Amount,
            IncludeInTotalSalary=IncludeInTotalSalary,
            PaymentFrequency=PaymentFrequency,
            ChangeReason=ChangeReason,
            CurrencyCode=CurrencyCode,
            APIKey=APIKey,
