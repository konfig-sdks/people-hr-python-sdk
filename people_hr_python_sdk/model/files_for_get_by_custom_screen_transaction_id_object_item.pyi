...
class FilesForGetByCustomScreenTransactionIdObjectItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["DocumentName", "Description", "FileUrl", "Category", "SignatureRequired", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["DocumentName", "Description", "FileUrl", "Category", "SignatureRequired", ], str]):
    ...
    ) -> 'FilesForGetByCustomScreenTransactionIdObjectItem':
