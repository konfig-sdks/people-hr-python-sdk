...
class AddAbsenceOfEmployeeParameter(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "DurationType", "Reason", "StartDate", "EndDate", "PartOfDay", "Duration", "AbsencePaidStatus", "EmergencyLeave", "AddComments", "AddFiles", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["PartOfDay"]) -> 'PartOfDay': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "DurationType", "Reason", "StartDate", "EndDate", "PartOfDay", "Duration", "AbsencePaidStatus", "EmergencyLeave", "AddComments", "AddFiles", ], str]):
