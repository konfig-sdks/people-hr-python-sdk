...
class CreateProjectTimesheetParameter(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            def EmployeeId() -> typing.Type['EmployeeId']:
                return EmployeeId
            ProjectTimesheetDate = schemas.DateSchema
            TimesheetProject = schemas.StrSchema
            TimesheetTask = schemas.StrSchema
            TimesheetDetail = schemas.StrSchema
            StartTime = schemas.StrSchema
            EndTime = schemas.StrSchema
            TotalHours = schemas.StrSchema
            ...
            __annotations__ = {
                ...
                "ProjectTimesheetDate": ProjectTimesheetDate,
    ...
    TimesheetDetail: MetaOapg.properties.TimesheetDetail
    TimesheetTask: MetaOapg.properties.TimesheetTask
    EndTime: MetaOapg.properties.EndTime
    StartTime: MetaOapg.properties.StartTime
    ProjectTimesheetDate: MetaOapg.properties.ProjectTimesheetDate
    Quantity: MetaOapg.properties.Quantity
    TimesheetProject: MetaOapg.properties.TimesheetProject
    TotalHours: MetaOapg.properties.TotalHours
    EmployeeId: 'EmployeeId'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ProjectTimesheetDate"]) -> MetaOapg.properties.ProjectTimesheetDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["TimesheetProject"]) -> MetaOapg.properties.TimesheetProject: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["TimesheetTask"]) -> MetaOapg.properties.TimesheetTask: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["TimesheetDetail"]) -> MetaOapg.properties.TimesheetDetail: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "ProjectTimesheetDate", "TimesheetProject", "TimesheetTask", "TimesheetDetail", "StartTime", "EndTime", "TotalHours", "Quantity", "Notes", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ProjectTimesheetDate"]) -> MetaOapg.properties.ProjectTimesheetDate: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TimesheetProject"]) -> MetaOapg.properties.TimesheetProject: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TimesheetTask"]) -> MetaOapg.properties.TimesheetTask: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TimesheetDetail"]) -> MetaOapg.properties.TimesheetDetail: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TotalHours"]) -> MetaOapg.properties.TotalHours: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "ProjectTimesheetDate", "TimesheetProject", "TimesheetTask", "TimesheetDetail", "StartTime", "EndTime", "TotalHours", "Quantity", "Notes", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        TimesheetDetail: typing.Union[MetaOapg.properties.TimesheetDetail, str, ],
        TimesheetTask: typing.Union[MetaOapg.properties.TimesheetTask, str, ],
        EndTime: typing.Union[MetaOapg.properties.EndTime, str, ],
        StartTime: typing.Union[MetaOapg.properties.StartTime, str, ],
        ProjectTimesheetDate: typing.Union[MetaOapg.properties.ProjectTimesheetDate, str, date, ],
        Quantity: typing.Union[MetaOapg.properties.Quantity, decimal.Decimal, int, ],
        TimesheetProject: typing.Union[MetaOapg.properties.TimesheetProject, str, ],
        TotalHours: typing.Union[MetaOapg.properties.TotalHours, str, ],
        EmployeeId: 'EmployeeId',
