...
class UpdateNextYearHolidayEntitlementParameter(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "ReasonForChange", "EntitlementNextYear", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "ReasonForChange", "EntitlementNextYear", ], str]):
