...
class ResultForGetQualificationByQualificationIdObject(
    schemas.DictSchema
):
    """
    This class is auto generated by Konfig (https://konfigthis.com)

    The Result For Get Qualification By QualificationId Result Array
    """
    ...
    class MetaOapg:
        ...
        class properties:
            QualificationId = schemas.IntSchema
            Qualification = schemas.StrSchema
            Subject = schemas.StrSchema
            DatePassed = schemas.DateSchema
            ExpiryDate = schemas.DateSchema
            Comments = schemas.StrSchema
        
            @staticmethod
            def Customfields() -> typing.Type['CustomColumnsForGetEmployeeQualification']:
                return CustomColumnsForGetEmployeeQualification
        
            @staticmethod
            def Files() -> typing.Type['AddFilesForGetEmployeeQualification']:
                return AddFilesForGetEmployeeQualification
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["QualificationId"]) -> MetaOapg.properties.QualificationId: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Qualification"]) -> MetaOapg.properties.Qualification: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Subject"]) -> MetaOapg.properties.Subject: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DatePassed"]) -> MetaOapg.properties.DatePassed: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Customfields"]) -> 'CustomColumnsForGetEmployeeQualification': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Files"]) -> 'AddFilesForGetEmployeeQualification': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["QualificationId", "Qualification", "Subject", "DatePassed", "ExpiryDate", "Comments", "Customfields", "Files", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["QualificationId"]) -> typing.Union[MetaOapg.properties.QualificationId, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Qualification"]) -> typing.Union[MetaOapg.properties.Qualification, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Subject"]) -> typing.Union[MetaOapg.properties.Subject, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DatePassed"]) -> typing.Union[MetaOapg.properties.DatePassed, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Customfields"]) -> typing.Union['CustomColumnsForGetEmployeeQualification', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Files"]) -> typing.Union['AddFilesForGetEmployeeQualification', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["QualificationId", "Qualification", "Subject", "DatePassed", "ExpiryDate", "Comments", "Customfields", "Files", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        QualificationId: typing.Union[MetaOapg.properties.QualificationId, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        Qualification: typing.Union[MetaOapg.properties.Qualification, str, schemas.Unset] = schemas.unset,
        Subject: typing.Union[MetaOapg.properties.Subject, str, schemas.Unset] = schemas.unset,
        DatePassed: typing.Union[MetaOapg.properties.DatePassed, str, date, schemas.Unset] = schemas.unset,
        ...
        Customfields: typing.Union['CustomColumnsForGetEmployeeQualification', schemas.Unset] = schemas.unset,
        Files: typing.Union['AddFilesForGetEmployeeQualification', schemas.Unset] = schemas.unset,
