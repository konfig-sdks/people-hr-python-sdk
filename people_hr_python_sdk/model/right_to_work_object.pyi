...
class RightToWorkObject(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def DocumentType() -> typing.Type['RightToWorkObjectDocumentType']:
                return RightToWorkObjectDocumentType
        
            @staticmethod
            def DocumentId() -> typing.Type['RightToWorkObjectDocumentId']:
                return RightToWorkObjectDocumentId
        
            @staticmethod
            def ValidFrom() -> typing.Type['RightToWorkObjectValidFrom']:
                return RightToWorkObjectValidFrom
        
            @staticmethod
            def ValidTo() -> typing.Type['RightToWorkObjectValidTo']:
                return RightToWorkObjectValidTo
        
            @staticmethod
            def Duration() -> typing.Type['RightToWorkObjectDuration']:
                return RightToWorkObjectDuration
        
            @staticmethod
            def RightToWorkComments() -> typing.Type['RightToWorkObjectRightToWorkComments']:
                return RightToWorkObjectRightToWorkComments
            __annotations__ = {
                ...
                "ValidTo": ValidTo,
                "Duration": Duration,
                "RightToWorkComments": RightToWorkComments,
            }
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DocumentType"]) -> 'RightToWorkObjectDocumentType': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DocumentId"]) -> 'RightToWorkObjectDocumentId': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ValidFrom"]) -> 'RightToWorkObjectValidFrom': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ValidTo"]) -> 'RightToWorkObjectValidTo': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Duration"]) -> 'RightToWorkObjectDuration': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["RightToWorkComments"]) -> 'RightToWorkObjectRightToWorkComments': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["DocumentType", "DocumentId", "ValidFrom", "ValidTo", "Duration", "RightToWorkComments", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DocumentType"]) -> typing.Union['RightToWorkObjectDocumentType', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DocumentId"]) -> typing.Union['RightToWorkObjectDocumentId', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ValidFrom"]) -> typing.Union['RightToWorkObjectValidFrom', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ValidTo"]) -> typing.Union['RightToWorkObjectValidTo', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Duration"]) -> typing.Union['RightToWorkObjectDuration', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["RightToWorkComments"]) -> typing.Union['RightToWorkObjectRightToWorkComments', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["DocumentType", "DocumentId", "ValidFrom", "ValidTo", "Duration", "RightToWorkComments", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        DocumentType: typing.Union['RightToWorkObjectDocumentType', schemas.Unset] = schemas.unset,
        DocumentId: typing.Union['RightToWorkObjectDocumentId', schemas.Unset] = schemas.unset,
        ValidFrom: typing.Union['RightToWorkObjectValidFrom', schemas.Unset] = schemas.unset,
        ValidTo: typing.Union['RightToWorkObjectValidTo', schemas.Unset] = schemas.unset,
        Duration: typing.Union['RightToWorkObjectDuration', schemas.Unset] = schemas.unset,
        RightToWorkComments: typing.Union['RightToWorkObjectRightToWorkComments', schemas.Unset] = schemas.unset,
