...
class AddBackgroundCheckDetailParameter(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "TypeOfCheck", "DocumentName", "File", "DateCompleted", "ExpiryDate", "Comments", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "TypeOfCheck", "DocumentName", "File", "DateCompleted", "ExpiryDate", "Comments", ], str]):
