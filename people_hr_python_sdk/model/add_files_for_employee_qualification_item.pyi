...
class AddFilesForEmployeeQualificationItem(
    schemas.DictSchema
):
    """
    ...
    SignatureRequired: MetaOapg.properties.SignatureRequired
    DocumentCategory: MetaOapg.properties.DocumentCategory
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["DocumentName", "File", "DocumentCategory", "SignatureRequired", "Descriptions", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DocumentCategory"]) -> MetaOapg.properties.DocumentCategory: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["SignatureRequired"]) -> MetaOapg.properties.SignatureRequired: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["DocumentName", "File", "DocumentCategory", "SignatureRequired", "Descriptions", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        SignatureRequired: typing.Union[MetaOapg.properties.SignatureRequired, str, ],
        DocumentCategory: typing.Union[MetaOapg.properties.DocumentCategory, str, ],
    ...
    ) -> 'AddFilesForEmployeeQualificationItem':
