...
class EntitlementsObjectItem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Entitlement", "Amount", "Percentage", "Comments", "IncludeInTotalSalary", "DisplayAsAmountOrPercentage", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Entitlement", "Amount", "Percentage", "Comments", "IncludeInTotalSalary", "DisplayAsAmountOrPercentage", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        Entitlement: typing.Union[MetaOapg.properties.Entitlement, str, schemas.Unset] = schemas.unset,
