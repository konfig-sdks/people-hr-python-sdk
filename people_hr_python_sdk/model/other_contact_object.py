...
class OtherContactObject(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def OtherContactName() -> typing.Type['OtherContactObjectOtherContactName']:
                return OtherContactObjectOtherContactName
        
            @staticmethod
            def Relationship() -> typing.Type['OtherContactObjectRelationship']:
                return OtherContactObjectRelationship
        
            @staticmethod
            def OtheContactAddress() -> typing.Type['OtherContactObjectOtheContactAddress']:
                return OtherContactObjectOtheContactAddress
        
            @staticmethod
            def Telephone() -> typing.Type['OtherContactObjectTelephone']:
                return OtherContactObjectTelephone
        
            @staticmethod
            def Mobile() -> typing.Type['OtherContactObjectMobile']:
                return OtherContactObjectMobile
        
            @staticmethod
            def Comments() -> typing.Type['OtherContactObjectComments']:
                return OtherContactObjectComments
            __annotations__ = {
                "OtherContactName": OtherContactName,
                "Relationship": Relationship,
                "OtheContactAddress": OtheContactAddress,
                "Telephone": Telephone,
                "Mobile": Mobile,
                "Comments": Comments,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["OtherContactName"]) -> 'OtherContactObjectOtherContactName': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Relationship"]) -> 'OtherContactObjectRelationship': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["OtheContactAddress"]) -> 'OtherContactObjectOtheContactAddress': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Telephone"]) -> 'OtherContactObjectTelephone': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Mobile"]) -> 'OtherContactObjectMobile': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Comments"]) -> 'OtherContactObjectComments': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["OtherContactName", "Relationship", "OtheContactAddress", "Telephone", "Mobile", "Comments", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["OtherContactName"]) -> typing.Union['OtherContactObjectOtherContactName', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Relationship"]) -> typing.Union['OtherContactObjectRelationship', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["OtheContactAddress"]) -> typing.Union['OtherContactObjectOtheContactAddress', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Telephone"]) -> typing.Union['OtherContactObjectTelephone', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Mobile"]) -> typing.Union['OtherContactObjectMobile', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Comments"]) -> typing.Union['OtherContactObjectComments', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["OtherContactName", "Relationship", "OtheContactAddress", "Telephone", "Mobile", "Comments", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        OtherContactName: typing.Union['OtherContactObjectOtherContactName', schemas.Unset] = schemas.unset,
        Relationship: typing.Union['OtherContactObjectRelationship', schemas.Unset] = schemas.unset,
        OtheContactAddress: typing.Union['OtherContactObjectOtheContactAddress', schemas.Unset] = schemas.unset,
        Telephone: typing.Union['OtherContactObjectTelephone', schemas.Unset] = schemas.unset,
        Mobile: typing.Union['OtherContactObjectMobile', schemas.Unset] = schemas.unset,
        Comments: typing.Union['OtherContactObjectComments', schemas.Unset] = schemas.unset,
