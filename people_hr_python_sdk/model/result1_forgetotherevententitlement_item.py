...
class Result1ForgetotherevententitlementItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ReasonName = schemas.StrSchema
            StartDate = schemas.DateSchema
            EndDate = schemas.DateSchema
            EntitlementRecordedIn = schemas.StrSchema
            EntitlementDurationInDays = schemas.IntSchema
            EntitlementDurationInMins = schemas.IntSchema
            __annotations__ = {
                "ReasonName": ReasonName,
                "StartDate": StartDate,
                "EndDate": EndDate,
                "EntitlementRecordedIn": EntitlementRecordedIn,
                "EntitlementDurationInDays": EntitlementDurationInDays,
                "EntitlementDurationInMins": EntitlementDurationInMins,
            }
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ReasonName"]) -> MetaOapg.properties.ReasonName: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["EntitlementRecordedIn"]) -> MetaOapg.properties.EntitlementRecordedIn: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["EntitlementDurationInDays"]) -> MetaOapg.properties.EntitlementDurationInDays: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["EntitlementDurationInMins"]) -> MetaOapg.properties.EntitlementDurationInMins: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ReasonName", "StartDate", "EndDate", "EntitlementRecordedIn", "EntitlementDurationInDays", "EntitlementDurationInMins", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ReasonName"]) -> typing.Union[MetaOapg.properties.ReasonName, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["EntitlementRecordedIn"]) -> typing.Union[MetaOapg.properties.EntitlementRecordedIn, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["EntitlementDurationInDays"]) -> typing.Union[MetaOapg.properties.EntitlementDurationInDays, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["EntitlementDurationInMins"]) -> typing.Union[MetaOapg.properties.EntitlementDurationInMins, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ReasonName", "StartDate", "EndDate", "EntitlementRecordedIn", "EntitlementDurationInDays", "EntitlementDurationInMins", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ReasonName: typing.Union[MetaOapg.properties.ReasonName, str, schemas.Unset] = schemas.unset,
        ...
        EntitlementRecordedIn: typing.Union[MetaOapg.properties.EntitlementRecordedIn, str, schemas.Unset] = schemas.unset,
        EntitlementDurationInDays: typing.Union[MetaOapg.properties.EntitlementDurationInDays, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        EntitlementDurationInMins: typing.Union[MetaOapg.properties.EntitlementDurationInMins, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'Result1ForgetotherevententitlementItem':
