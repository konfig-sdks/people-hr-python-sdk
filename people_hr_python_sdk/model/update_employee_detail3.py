...
class UpdateEmployeeDetail3(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def ReasonForChange() -> typing.Type['ReasonForChange']:
            ...
            ReportsToEffectiveDate = schemas.DateSchema
            CompanyEffectiveDate = schemas.DateSchema
            ...
            LocationEffectiveDate = schemas.DateSchema
            Department = schemas.StrSchema
            DepartmentEffectiveDate = schemas.DateSchema
            EmploymentTypeEffectiveDate = schemas.DateSchema
    ...
    FirstName: 'FirstName'
    LocationEffectiveDate: MetaOapg.properties.LocationEffectiveDate
    JobRoleEffectiveDate: MetaOapg.properties.JobRoleEffectiveDate
    EmploymentTypeEffectiveDate: MetaOapg.properties.EmploymentTypeEffectiveDate
    Gender: 'Gender'
    CompanyEffectiveDate: MetaOapg.properties.CompanyEffectiveDate
    JobRole: 'JobRole'
    StartDate: MetaOapg.properties.StartDate
    APIKey: 'APIKey'
    Department: MetaOapg.properties.Department
    DepartmentEffectiveDate: MetaOapg.properties.DepartmentEffectiveDate
    LastName: 'LastName'
    ReasonForChange: 'ReasonForChange'
    EmployeeId: 'EmployeeId'
    ReportsToEffectiveDate: MetaOapg.properties.ReportsToEffectiveDate
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ReasonForChange"]) -> 'ReasonForChange': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ReportsToEffectiveDate"]) -> MetaOapg.properties.ReportsToEffectiveDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["CompanyEffectiveDate"]) -> MetaOapg.properties.CompanyEffectiveDate: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["LocationEffectiveDate"]) -> MetaOapg.properties.LocationEffectiveDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Department"]) -> MetaOapg.properties.Department: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DepartmentEffectiveDate"]) -> MetaOapg.properties.DepartmentEffectiveDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["EmploymentTypeEffectiveDate"]) -> MetaOapg.properties.EmploymentTypeEffectiveDate: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "ReasonForChange", "EmployeeId", "FirstName", "LastName", "Gender", "StartDate", "ReportsToEffectiveDate", "CompanyEffectiveDate", "JobRole", "JobRoleEffectiveDate", "Location", "LocationEffectiveDate", "Department", "DepartmentEffectiveDate", "EmploymentTypeEffectiveDate", "Title", "Email", "DateOfBirth", "ReportsTo", "Company", "NationalInsuranceNumber", "Nationality", "EmploymentType", "Address", "PersonalPhoneNumber", "Payroll Company", "Payroll ID", "Time & Attendance ID", "Rota ID", "CRM ID", "ATS ID", "Performance ID", "Benefits ID", "System1 ID", "System2 ID", "System3 ID", "APIColumn1", "APIColumn2", "APIColumn3", "APIColumn4", "APIColumn5", "PersonalEmail", "MethodOfRecruitment", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ReasonForChange"]) -> 'ReasonForChange': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ReportsToEffectiveDate"]) -> MetaOapg.properties.ReportsToEffectiveDate: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CompanyEffectiveDate"]) -> MetaOapg.properties.CompanyEffectiveDate: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["LocationEffectiveDate"]) -> MetaOapg.properties.LocationEffectiveDate: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Department"]) -> MetaOapg.properties.Department: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DepartmentEffectiveDate"]) -> MetaOapg.properties.DepartmentEffectiveDate: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["EmploymentTypeEffectiveDate"]) -> MetaOapg.properties.EmploymentTypeEffectiveDate: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        FirstName: 'FirstName',
        LocationEffectiveDate: typing.Union[MetaOapg.properties.LocationEffectiveDate, str, date, ],
        JobRoleEffectiveDate: typing.Union[MetaOapg.properties.JobRoleEffectiveDate, str, date, ],
        EmploymentTypeEffectiveDate: typing.Union[MetaOapg.properties.EmploymentTypeEffectiveDate, str, date, ],
        Gender: 'Gender',
        CompanyEffectiveDate: typing.Union[MetaOapg.properties.CompanyEffectiveDate, str, date, ],
        JobRole: 'JobRole',
        StartDate: typing.Union[MetaOapg.properties.StartDate, str, date, ],
        APIKey: 'APIKey',
        Department: typing.Union[MetaOapg.properties.Department, str, ],
        DepartmentEffectiveDate: typing.Union[MetaOapg.properties.DepartmentEffectiveDate, str, date, ],
        LastName: 'LastName',
        ReasonForChange: 'ReasonForChange',
        EmployeeId: 'EmployeeId',
        ReportsToEffectiveDate: typing.Union[MetaOapg.properties.ReportsToEffectiveDate, str, date, ],
