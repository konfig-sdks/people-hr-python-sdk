...
class CreateApplicantDetailParameter(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def Documents() -> typing.Type['DocumentsForCreateNewApplicantArray']:
                return DocumentsForCreateNewApplicantArray
            Skills = schemas.StrSchema
            VacancyReference = schemas.StrSchema
            ...
            OtherContactDetails = schemas.StrSchema
            Source = schemas.StrSchema
        
            @staticmethod
            def AdditionalQuestions() -> typing.Type['AdditionalQuestionsForCreatenewApplicantArray']:
                return AdditionalQuestionsForCreatenewApplicantArray
        
            @staticmethod
            def InternalQuestions() -> typing.Type['InternalQuestionsForCreateNewApplicantArray']:
                return InternalQuestionsForCreateNewApplicantArray
            RecruitmentCost = schemas.IntSchema
            DateLastContacted = schemas.DateSchema
            __annotations__ = {
                "APIKey": APIKey,
                "Action": Action,
                "FirstName": FirstName,
    ...
    QuestionId: schemas.AnyTypeSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Documents"]) -> 'DocumentsForCreateNewApplicantArray': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Skills"]) -> MetaOapg.properties.Skills: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["VacancyReference"]) -> MetaOapg.properties.VacancyReference: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["OtherContactDetails"]) -> MetaOapg.properties.OtherContactDetails: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Source"]) -> MetaOapg.properties.Source: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AdditionalQuestions"]) -> 'AdditionalQuestionsForCreatenewApplicantArray': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["InternalQuestions"]) -> 'InternalQuestionsForCreateNewApplicantArray': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["RecruitmentCost"]) -> MetaOapg.properties.RecruitmentCost: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DateLastContacted"]) -> MetaOapg.properties.DateLastContacted: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "FirstName", "LastName", "Documents", "Skills", "VacancyReference", "Email", "Gender", "DateOfBirth", "PostCode", "Address", "PhoneNumber", "OtherContactDetails", "Source", "AdditionalQuestions", "InternalQuestions", "RecruitmentCost", "DateLastContacted", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Documents"]) -> 'DocumentsForCreateNewApplicantArray': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Skills"]) -> MetaOapg.properties.Skills: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["VacancyReference"]) -> typing.Union[MetaOapg.properties.VacancyReference, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["OtherContactDetails"]) -> typing.Union[MetaOapg.properties.OtherContactDetails, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Source"]) -> typing.Union[MetaOapg.properties.Source, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AdditionalQuestions"]) -> typing.Union['AdditionalQuestionsForCreatenewApplicantArray', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["InternalQuestions"]) -> typing.Union['InternalQuestionsForCreateNewApplicantArray', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["RecruitmentCost"]) -> typing.Union[MetaOapg.properties.RecruitmentCost, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DateLastContacted"]) -> typing.Union[MetaOapg.properties.DateLastContacted, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "FirstName", "LastName", "Documents", "Skills", "VacancyReference", "Email", "Gender", "DateOfBirth", "PostCode", "Address", "PhoneNumber", "OtherContactDetails", "Source", "AdditionalQuestions", "InternalQuestions", "RecruitmentCost", "DateLastContacted", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        QuestionId: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        Skills: typing.Union[MetaOapg.properties.Skills, str, ],
        FirstName: 'FirstName',
        Documents: 'DocumentsForCreateNewApplicantArray',
        LastName: 'LastName',
        VacancyReference: typing.Union[MetaOapg.properties.VacancyReference, str, schemas.Unset] = schemas.unset,
        ...
        OtherContactDetails: typing.Union[MetaOapg.properties.OtherContactDetails, str, schemas.Unset] = schemas.unset,
        Source: typing.Union[MetaOapg.properties.Source, str, schemas.Unset] = schemas.unset,
        AdditionalQuestions: typing.Union['AdditionalQuestionsForCreatenewApplicantArray', schemas.Unset] = schemas.unset,
        InternalQuestions: typing.Union['InternalQuestionsForCreateNewApplicantArray', schemas.Unset] = schemas.unset,
        RecruitmentCost: typing.Union[MetaOapg.properties.RecruitmentCost, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        DateLastContacted: typing.Union[MetaOapg.properties.DateLastContacted, str, date, schemas.Unset] = schemas.unset,
