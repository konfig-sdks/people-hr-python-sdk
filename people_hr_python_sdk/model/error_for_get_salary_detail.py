...
class ErrorForGetSalaryDetail(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def Result() -> typing.Type['Result1']:
                return Result1
            __annotations__ = {
                "IsError": IsError,
                "Status": Status,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Result"]) -> 'Result1': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Result"]) -> typing.Union['Result1', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        Result: typing.Union['Result1', schemas.Unset] = schemas.unset,
