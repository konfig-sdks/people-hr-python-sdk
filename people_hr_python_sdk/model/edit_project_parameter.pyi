...
class EditProjectParameter(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            NewProjectName = schemas.StrSchema
    ...
    NewProjectName: MetaOapg.properties.NewProjectName
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["NewProjectName"]) -> MetaOapg.properties.NewProjectName: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "ProjectName", "NewProjectName", "InUse", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["NewProjectName"]) -> MetaOapg.properties.NewProjectName: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "ProjectName", "NewProjectName", "InUse", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        NewProjectName: typing.Union[MetaOapg.properties.NewProjectName, str, ],
