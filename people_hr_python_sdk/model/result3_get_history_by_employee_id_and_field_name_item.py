...
class Result3GetHistoryByEmployeeIdAndFieldNameItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["OldValue", "NewValue", "ReasonForChange", "ChangedOn", "CreatedBy", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["OldValue", "NewValue", "ReasonForChange", "ChangedOn", "CreatedBy", ], str]):
    ...
    ) -> 'Result3GetHistoryByEmployeeIdAndFieldNameItem':
