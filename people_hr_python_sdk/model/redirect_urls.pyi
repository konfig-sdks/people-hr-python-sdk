...
class RedirectUrls(
    ...
    decline: MetaOapg.properties.decline
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["error", "success", "decline", "cancel", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["decline"]) -> MetaOapg.properties.decline: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["error", "success", "decline", "cancel", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        decline: typing.Union[MetaOapg.properties.decline, str, ],
