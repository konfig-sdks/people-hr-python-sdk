...
class AddFilesForEmployeeVehicleUpdateArrayItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["DocumentName", "File", "DocumentCategory", "SignatureRequired", "Description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["DocumentName", "File", "DocumentCategory", "SignatureRequired", "Description", ], str]):
    ...
    ) -> 'AddFilesForEmployeeVehicleUpdateArrayItem':
