...
class AddNewAppraisalParameter(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def CustomColumns() -> typing.Type['CustomColumnsArrayForAddNewAppraisal']:
                return CustomColumnsArrayForAddNewAppraisal
        
            @staticmethod
            def AddFiles() -> typing.Type['AddFilesArrayForAddNewAppraisal']:
                return AddFilesArrayForAddNewAppraisal
            __annotations__ = {
                "APIKey": APIKey,
                "Action": Action,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["CustomColumns"]) -> 'CustomColumnsArrayForAddNewAppraisal': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AddFiles"]) -> 'AddFilesArrayForAddNewAppraisal': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CustomColumns"]) -> 'CustomColumnsArrayForAddNewAppraisal': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AddFiles"]) -> 'AddFilesArrayForAddNewAppraisal': ...
