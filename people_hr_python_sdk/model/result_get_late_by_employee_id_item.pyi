...
class ResultGetLateByEmployeeIdItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            LateDate = schemas.DateSchema
            LateMinutes = schemas.IntSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["LateDate"]) -> MetaOapg.properties.LateDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["LateMinutes"]) -> MetaOapg.properties.LateMinutes: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["EmployeeId", "LateDate", "LateMinutes", "Comments", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["LateDate"]) -> typing.Union[MetaOapg.properties.LateDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["LateMinutes"]) -> typing.Union[MetaOapg.properties.LateMinutes, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["EmployeeId", "LateDate", "LateMinutes", "Comments", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        LateDate: typing.Union[MetaOapg.properties.LateDate, str, date, schemas.Unset] = schemas.unset,
        LateMinutes: typing.Union[MetaOapg.properties.LateMinutes, decimal.Decimal, int, schemas.Unset] = schemas.unset,
