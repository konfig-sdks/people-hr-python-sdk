...
class EmploymentTypeObject(
    schemas.DictSchema
):
    """
    This class is auto generated by Konfig (https://konfigthis.com)

    company object contain displayValue and fieldHistoryForEffectiveDate array
    """
    ...
    class MetaOapg:
        ...
        class properties:
            DisplayValue = schemas.StrSchema
        
            @staticmethod
            def FieldHistoryForEffectiveDate() -> typing.Type['FieldHistoryForEffectiveDateObject']:
                return FieldHistoryForEffectiveDateObject
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DisplayValue"]) -> MetaOapg.properties.DisplayValue: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["FieldHistoryForEffectiveDate"]) -> 'FieldHistoryForEffectiveDateObject': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["DisplayValue", "FieldHistoryForEffectiveDate", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DisplayValue"]) -> typing.Union[MetaOapg.properties.DisplayValue, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["FieldHistoryForEffectiveDate"]) -> typing.Union['FieldHistoryForEffectiveDateObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["DisplayValue", "FieldHistoryForEffectiveDate", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        DisplayValue: typing.Union[MetaOapg.properties.DisplayValue, str, schemas.Unset] = schemas.unset,
        FieldHistoryForEffectiveDate: typing.Union['FieldHistoryForEffectiveDateObject', schemas.Unset] = schemas.unset,
