...
class CustomColumnsForEmployeeCustomScreenObjectItem(
    schemas.DictSchema
):
    """
    ...
    ColumnValue: MetaOapg.properties.ColumnValue
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ColumnValue"]) -> MetaOapg.properties.ColumnValue: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ColumnValue: typing.Union[MetaOapg.properties.ColumnValue, str, ],
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'CustomColumnsForEmployeeCustomScreenObjectItem':
