...
class DeductionsArrayItem(
    ...
    DisplayAsAmountOrPercentage: MetaOapg.properties.DisplayAsAmountOrPercentage
    Deduction: MetaOapg.properties.Deduction
    Amount: MetaOapg.properties.Amount
    IncludeInTotalSalary: MetaOapg.properties.IncludeInTotalSalary
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Deduction", "DisplayAsAmountOrPercentage", "Amount", "IncludeInTotalSalary", "Percentage", "Comments", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Deduction"]) -> MetaOapg.properties.Deduction: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DisplayAsAmountOrPercentage"]) -> MetaOapg.properties.DisplayAsAmountOrPercentage: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Amount"]) -> MetaOapg.properties.Amount: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["IncludeInTotalSalary"]) -> MetaOapg.properties.IncludeInTotalSalary: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Deduction", "DisplayAsAmountOrPercentage", "Amount", "IncludeInTotalSalary", "Percentage", "Comments", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        DisplayAsAmountOrPercentage: typing.Union[MetaOapg.properties.DisplayAsAmountOrPercentage, str, ],
        Deduction: typing.Union[MetaOapg.properties.Deduction, str, ],
        Amount: typing.Union[MetaOapg.properties.Amount, decimal.Decimal, int, ],
        IncludeInTotalSalary: typing.Union[MetaOapg.properties.IncludeInTotalSalary, str, ],
