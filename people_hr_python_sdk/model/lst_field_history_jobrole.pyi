...
class LstFieldHistoryJobrole(
    schemas.DictSchema
):
    """
    This class is auto generated by Konfig (https://konfigthis.com)

    lst Field history job role contain fieldHistoryForJobRole array
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["FieldHistoryForJobRole", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["FieldHistoryForJobRole", ], str]):
