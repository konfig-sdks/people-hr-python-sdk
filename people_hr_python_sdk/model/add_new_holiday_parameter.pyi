...
class AddNewHolidayParameter(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "DurationType", "StartDate", "EndDate", "DurationInDays", "DurationInMinutes", "PartOfDay", "Comments", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "DurationType", "StartDate", "EndDate", "DurationInDays", "DurationInMinutes", "PartOfDay", "Comments", ], str]):
