...
class GetAllDocumentArrayItem(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def DocumentId() -> typing.Type['LongInteger']:
                return LongInteger
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DocumentId"]) -> 'LongInteger': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["EmployeeAccess"]) -> MetaOapg.properties.EmployeeAccess: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ManagerAccess"]) -> MetaOapg.properties.ManagerAccess: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["SignRequired"]) -> MetaOapg.properties.SignRequired: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["EmployeeId", "DocumentId", "DocumentName", "URL", "Comments", "EmployeeAccess", "ManagerAccess", "SignRequired", "Category", "AddedOn", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DocumentId"]) -> typing.Union['LongInteger', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["EmployeeAccess"]) -> typing.Union[MetaOapg.properties.EmployeeAccess, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["SignRequired"]) -> typing.Union[MetaOapg.properties.SignRequired, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["EmployeeId", "DocumentId", "DocumentName", "URL", "Comments", "EmployeeAccess", "ManagerAccess", "SignRequired", "Category", "AddedOn", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        DocumentId: typing.Union['LongInteger', schemas.Unset] = schemas.unset,
        ...
        EmployeeAccess: typing.Union[MetaOapg.properties.EmployeeAccess, str, schemas.Unset] = schemas.unset,
        ManagerAccess: typing.Union[MetaOapg.properties.ManagerAccess, str, schemas.Unset] = schemas.unset,
        SignRequired: typing.Union[MetaOapg.properties.SignRequired, str, schemas.Unset] = schemas.unset,
        Category: typing.Union[MetaOapg.properties.Category, str, schemas.Unset] = schemas.unset,
        AddedOn: typing.Union[MetaOapg.properties.AddedOn, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'GetAllDocumentArrayItem':
...
from people_hr_python_sdk.model.long_integer import LongInteger
