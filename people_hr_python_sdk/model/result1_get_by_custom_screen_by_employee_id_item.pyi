...
class Result1GetByCustomScreenByEmployeeIdItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            TxnId = schemas.IntSchema
        
            @staticmethod
            def Customfields() -> typing.Type['CustomfieldsForGetCustomScreenDetailObject']:
                return CustomfieldsForGetCustomScreenDetailObject
        
            @staticmethod
            def Files() -> typing.Type['FilesForGetByCustomScreenTransactionIdObject']:
                return FilesForGetByCustomScreenTransactionIdObject
            __annotations__ = {
                "TxnId": TxnId,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Customfields"]) -> 'CustomfieldsForGetCustomScreenDetailObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Files"]) -> 'FilesForGetByCustomScreenTransactionIdObject': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["TxnId", "Customfields", "Files", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TxnId"]) -> typing.Union[MetaOapg.properties.TxnId, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Customfields"]) -> typing.Union['CustomfieldsForGetCustomScreenDetailObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Files"]) -> typing.Union['FilesForGetByCustomScreenTransactionIdObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["TxnId", "Customfields", "Files", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        TxnId: typing.Union[MetaOapg.properties.TxnId, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        Customfields: typing.Union['CustomfieldsForGetCustomScreenDetailObject', schemas.Unset] = schemas.unset,
        Files: typing.Union['FilesForGetByCustomScreenTransactionIdObject', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'Result1GetByCustomScreenByEmployeeIdItem':
