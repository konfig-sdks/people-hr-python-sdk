...
class BackgroundDetailObject(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def CheckType() -> typing.Type['BackgroundDetailObjectCheckType']:
                return BackgroundDetailObjectCheckType
        
            @staticmethod
            def CompletionDate() -> typing.Type['BackgroundDetailObjectCompletionDate']:
                return BackgroundDetailObjectCompletionDate
        
            @staticmethod
            def ExpiryDate() -> typing.Type['BackgroundDetailObjectExpiryDate']:
                return BackgroundDetailObjectExpiryDate
        
            @staticmethod
            def BackgroundDetailComments() -> typing.Type['BackgroundDetailObjectBackgroundDetailComments']:
                return BackgroundDetailObjectBackgroundDetailComments
            __annotations__ = {
                "CheckType": CheckType,
                "CompletionDate": CompletionDate,
                "ExpiryDate": ExpiryDate,
                "BackgroundDetailComments": BackgroundDetailComments,
            }
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["CheckType"]) -> 'BackgroundDetailObjectCheckType': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["CompletionDate"]) -> 'BackgroundDetailObjectCompletionDate': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ExpiryDate"]) -> 'BackgroundDetailObjectExpiryDate': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["BackgroundDetailComments"]) -> 'BackgroundDetailObjectBackgroundDetailComments': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["CheckType", "CompletionDate", "ExpiryDate", "BackgroundDetailComments", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CheckType"]) -> typing.Union['BackgroundDetailObjectCheckType', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CompletionDate"]) -> typing.Union['BackgroundDetailObjectCompletionDate', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ExpiryDate"]) -> typing.Union['BackgroundDetailObjectExpiryDate', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["BackgroundDetailComments"]) -> typing.Union['BackgroundDetailObjectBackgroundDetailComments', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["CheckType", "CompletionDate", "ExpiryDate", "BackgroundDetailComments", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        CheckType: typing.Union['BackgroundDetailObjectCheckType', schemas.Unset] = schemas.unset,
        CompletionDate: typing.Union['BackgroundDetailObjectCompletionDate', schemas.Unset] = schemas.unset,
        ExpiryDate: typing.Union['BackgroundDetailObjectExpiryDate', schemas.Unset] = schemas.unset,
        BackgroundDetailComments: typing.Union['BackgroundDetailObjectBackgroundDetailComments', schemas.Unset] = schemas.unset,
