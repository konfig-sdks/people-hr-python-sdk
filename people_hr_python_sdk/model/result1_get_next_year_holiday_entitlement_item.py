...
class Result1GetNextYearHolidayEntitlementItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            MeasuredIn = schemas.StrSchema
            Entitlement = schemas.IntSchema
            __annotations__ = {
                "StartDate": StartDate,
                "EndDate": EndDate,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["MeasuredIn"]) -> MetaOapg.properties.MeasuredIn: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["StartDate", "EndDate", "MeasuredIn", "Entitlement", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["MeasuredIn"]) -> typing.Union[MetaOapg.properties.MeasuredIn, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["StartDate", "EndDate", "MeasuredIn", "Entitlement", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        MeasuredIn: typing.Union[MetaOapg.properties.MeasuredIn, str, schemas.Unset] = schemas.unset,
        Entitlement: typing.Union[MetaOapg.properties.Entitlement, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'Result1GetNextYearHolidayEntitlementItem':
