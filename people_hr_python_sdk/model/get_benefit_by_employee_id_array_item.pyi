...
class GetBenefitByEmployeeIdArrayItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            BenefitId = schemas.IntSchema
            Benefit = schemas.StrSchema
            DateAwarded = schemas.DateSchema
            ExpiryDate = schemas.DateSchema
            ...
            @staticmethod
            def Customfields() -> typing.Type['CustomfieldArrayForEmployeeBenefit']:
                return CustomfieldArrayForEmployeeBenefit
        
            @staticmethod
            def Files() -> typing.Type['FileArrayForEmployeeBenefit']:
                return FileArrayForEmployeeBenefit
            __annotations__ = {
                "BenefitId": BenefitId,
                "Benefit": Benefit,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["BenefitId"]) -> MetaOapg.properties.BenefitId: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Benefit"]) -> MetaOapg.properties.Benefit: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DateAwarded"]) -> MetaOapg.properties.DateAwarded: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["RecoverOnTermination"]) -> MetaOapg.properties.RecoverOnTermination: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Customfields"]) -> 'CustomfieldArrayForEmployeeBenefit': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Files"]) -> 'FileArrayForEmployeeBenefit': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["BenefitId", "Benefit", "DateAwarded", "ExpiryDate", "Value", "Comments", "RecoverOnTermination", "Customfields", "Files", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["BenefitId"]) -> typing.Union[MetaOapg.properties.BenefitId, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Benefit"]) -> typing.Union[MetaOapg.properties.Benefit, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DateAwarded"]) -> typing.Union[MetaOapg.properties.DateAwarded, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["RecoverOnTermination"]) -> typing.Union[MetaOapg.properties.RecoverOnTermination, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Customfields"]) -> typing.Union['CustomfieldArrayForEmployeeBenefit', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Files"]) -> typing.Union['FileArrayForEmployeeBenefit', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["BenefitId", "Benefit", "DateAwarded", "ExpiryDate", "Value", "Comments", "RecoverOnTermination", "Customfields", "Files", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        BenefitId: typing.Union[MetaOapg.properties.BenefitId, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        Benefit: typing.Union[MetaOapg.properties.Benefit, str, schemas.Unset] = schemas.unset,
        DateAwarded: typing.Union[MetaOapg.properties.DateAwarded, str, date, schemas.Unset] = schemas.unset,
        ExpiryDate: typing.Union[MetaOapg.properties.ExpiryDate, str, date, schemas.Unset] = schemas.unset,
        ...
        RecoverOnTermination: typing.Union[MetaOapg.properties.RecoverOnTermination, str, schemas.Unset] = schemas.unset,
        Customfields: typing.Union['CustomfieldArrayForEmployeeBenefit', schemas.Unset] = schemas.unset,
        Files: typing.Union['FileArrayForEmployeeBenefit', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'GetBenefitByEmployeeIdArrayItem':
