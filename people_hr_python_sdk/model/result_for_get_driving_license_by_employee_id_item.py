...
class ResultForGetDrivingLicenseByEmployeeIdItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            DrivingId = schemas.IntSchema
            LicenseNumber = schemas.StrSchema
            LicenseType = schemas.StrSchema
            ExpiryDate = schemas.DateSchema
            Comments = schemas.StrSchema
        
            @staticmethod
            def Customfields() -> typing.Type['CustomColumnsForGetEmployeeDriving']:
                return CustomColumnsForGetEmployeeDriving
        
            @staticmethod
            def Files() -> typing.Type['AddFilesForGetEmployeeDriving']:
                return AddFilesForGetEmployeeDriving
            __annotations__ = {
                "DrivingId": DrivingId,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DrivingId"]) -> MetaOapg.properties.DrivingId: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["LicenseNumber"]) -> MetaOapg.properties.LicenseNumber: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Customfields"]) -> 'CustomColumnsForGetEmployeeDriving': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Files"]) -> 'AddFilesForGetEmployeeDriving': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["DrivingId", "LicenseNumber", "LicenseType", "ExpiryDate", "Comments", "Customfields", "Files", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DrivingId"]) -> typing.Union[MetaOapg.properties.DrivingId, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["LicenseNumber"]) -> typing.Union[MetaOapg.properties.LicenseNumber, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Customfields"]) -> typing.Union['CustomColumnsForGetEmployeeDriving', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Files"]) -> typing.Union['AddFilesForGetEmployeeDriving', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["DrivingId", "LicenseNumber", "LicenseType", "ExpiryDate", "Comments", "Customfields", "Files", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        DrivingId: typing.Union[MetaOapg.properties.DrivingId, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        LicenseNumber: typing.Union[MetaOapg.properties.LicenseNumber, str, schemas.Unset] = schemas.unset,
        ...
        Customfields: typing.Union['CustomColumnsForGetEmployeeDriving', schemas.Unset] = schemas.unset,
        Files: typing.Union['AddFilesForGetEmployeeDriving', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ResultForGetDrivingLicenseByEmployeeIdItem':
