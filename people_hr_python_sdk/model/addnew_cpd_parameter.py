...
class AddnewCPDParameter(
    ...
    CustomColumns: 'CustomColumnsArrayForEmployeeCPD'
    Activity: MetaOapg.properties.Activity
    EmployeeId: 'EmployeeId'
    AddFiles: 'AddFilesArrayForEmployeeCPD'
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "Activity", "StartDate", "CustomColumns", "AddFiles", "EndDate", "RollNumber", "DateAdmitted", "HoursRequired", "HoursAccredited", "Notes", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CustomColumns"]) -> 'CustomColumnsArrayForEmployeeCPD': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AddFiles"]) -> 'AddFilesArrayForEmployeeCPD': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "Activity", "StartDate", "CustomColumns", "AddFiles", "EndDate", "RollNumber", "DateAdmitted", "HoursRequired", "HoursAccredited", "Notes", ], str]):
