...
class GetEmployeeByIdArrayItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            AppraisalId = schemas.NumberSchema
            ...
            @staticmethod
            def Customfields() -> typing.Type['ArrayForGetByAppraisalIdArray']:
                return ArrayForGetByAppraisalIdArray
        
            @staticmethod
            def Files() -> typing.Type['ArrayForGetAppraisalByIdFile']:
                return ArrayForGetAppraisalByIdFile
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Customfields"]) -> 'ArrayForGetByAppraisalIdArray': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Files"]) -> 'ArrayForGetAppraisalByIdFile': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["AppraisalId", "AppraisalReviewDate", "Reviewer", "Note", "ActionPlan", "Objectives", "Customfields", "Files", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AppraisalReviewDate"]) -> typing.Union[MetaOapg.properties.AppraisalReviewDate, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ActionPlan"]) -> typing.Union[MetaOapg.properties.ActionPlan, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Objectives"]) -> typing.Union[MetaOapg.properties.Objectives, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Customfields"]) -> typing.Union['ArrayForGetByAppraisalIdArray', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Files"]) -> typing.Union['ArrayForGetAppraisalByIdFile', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["AppraisalId", "AppraisalReviewDate", "Reviewer", "Note", "ActionPlan", "Objectives", "Customfields", "Files", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        AppraisalId: typing.Union[MetaOapg.properties.AppraisalId, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
        AppraisalReviewDate: typing.Union[MetaOapg.properties.AppraisalReviewDate, str, date, schemas.Unset] = schemas.unset,
        Reviewer: typing.Union[MetaOapg.properties.Reviewer, str, schemas.Unset] = schemas.unset,
        Note: typing.Union[MetaOapg.properties.Note, str, schemas.Unset] = schemas.unset,
        ActionPlan: typing.Union[MetaOapg.properties.ActionPlan, str, schemas.Unset] = schemas.unset,
        Objectives: typing.Union[MetaOapg.properties.Objectives, str, schemas.Unset] = schemas.unset,
        Customfields: typing.Union['ArrayForGetByAppraisalIdArray', schemas.Unset] = schemas.unset,
        Files: typing.Union['ArrayForGetAppraisalByIdFile', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'GetEmployeeByIdArrayItem':
