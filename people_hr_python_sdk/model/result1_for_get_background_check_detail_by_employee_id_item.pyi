...
class Result1ForGetBackgroundCheckDetailByEmployeeIdItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            BackgroundCheckDetailId = schemas.IntSchema
            TypeOfCheck = schemas.StrSchema
            DateCompleted = schemas.DateSchema
            ExpiryDate = schemas.DateSchema
            DocumentName = schemas.StrSchema
            DocumentURL = schemas.StrSchema
            Comments = schemas.StrSchema
            __annotations__ = {
                "BackgroundCheckDetailId": BackgroundCheckDetailId,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["BackgroundCheckDetailId"]) -> MetaOapg.properties.BackgroundCheckDetailId: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["TypeOfCheck"]) -> MetaOapg.properties.TypeOfCheck: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DateCompleted"]) -> MetaOapg.properties.DateCompleted: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["BackgroundCheckDetailId", "TypeOfCheck", "DateCompleted", "ExpiryDate", "DocumentName", "DocumentURL", "Comments", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["BackgroundCheckDetailId"]) -> typing.Union[MetaOapg.properties.BackgroundCheckDetailId, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TypeOfCheck"]) -> typing.Union[MetaOapg.properties.TypeOfCheck, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DateCompleted"]) -> typing.Union[MetaOapg.properties.DateCompleted, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["BackgroundCheckDetailId", "TypeOfCheck", "DateCompleted", "ExpiryDate", "DocumentName", "DocumentURL", "Comments", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        BackgroundCheckDetailId: typing.Union[MetaOapg.properties.BackgroundCheckDetailId, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        TypeOfCheck: typing.Union[MetaOapg.properties.TypeOfCheck, str, schemas.Unset] = schemas.unset,
        DateCompleted: typing.Union[MetaOapg.properties.DateCompleted, str, date, schemas.Unset] = schemas.unset,
    ...
    ) -> 'Result1ForGetBackgroundCheckDetailByEmployeeIdItem':
