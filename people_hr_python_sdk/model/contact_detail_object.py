...
class ContactDetailObject(
    schemas.DictSchema
):
    """
    This class is auto generated by Konfig (https://konfigthis.com)

    ContactDetail contain displayValue and FieldHistory array values
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def Address() -> typing.Type['AddressObject']:
                return AddressObject
        
            @staticmethod
            def WorkPhoneNumber() -> typing.Type['WorkPhoneNumberObject']:
                return WorkPhoneNumberObject
        
            @staticmethod
            def PersonalPhoneNumber() -> typing.Type['PersonalPhoneNumberObject']:
                return PersonalPhoneNumberObject
        
            @staticmethod
            def PersonalEmail() -> typing.Type['PersonalEmailObject']:
                return PersonalEmailObject
        
            @staticmethod
            def Mobile() -> typing.Type['MobileObject']:
                return MobileObject
            __annotations__ = {
                "Address": Address,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Address"]) -> 'AddressObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["WorkPhoneNumber"]) -> 'WorkPhoneNumberObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["PersonalPhoneNumber"]) -> 'PersonalPhoneNumberObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["PersonalEmail"]) -> 'PersonalEmailObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Mobile"]) -> 'MobileObject': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Address", "WorkPhoneNumber", "PersonalPhoneNumber", "PersonalEmail", "Mobile", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Address"]) -> typing.Union['AddressObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["WorkPhoneNumber"]) -> typing.Union['WorkPhoneNumberObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["PersonalPhoneNumber"]) -> typing.Union['PersonalPhoneNumberObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["PersonalEmail"]) -> typing.Union['PersonalEmailObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Mobile"]) -> typing.Union['MobileObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Address", "WorkPhoneNumber", "PersonalPhoneNumber", "PersonalEmail", "Mobile", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        Address: typing.Union['AddressObject', schemas.Unset] = schemas.unset,
        WorkPhoneNumber: typing.Union['WorkPhoneNumberObject', schemas.Unset] = schemas.unset,
        PersonalPhoneNumber: typing.Union['PersonalPhoneNumberObject', schemas.Unset] = schemas.unset,
        PersonalEmail: typing.Union['PersonalEmailObject', schemas.Unset] = schemas.unset,
        Mobile: typing.Union['MobileObject', schemas.Unset] = schemas.unset,
