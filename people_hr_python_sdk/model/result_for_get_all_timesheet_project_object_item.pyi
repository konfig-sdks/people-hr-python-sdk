...
class ResultForGetAllTimesheetProjectObjectItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            SpecificEmployee = schemas.StrSchema
            JobRoleType = schemas.StrSchema
            __annotations__ = {
                "ProjectId": ProjectId,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["SpecificEmployee"]) -> MetaOapg.properties.SpecificEmployee: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["JobRoleType"]) -> MetaOapg.properties.JobRoleType: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ProjectId", "ProjectName", "Status", "CompanyName", "LocationName", "DepartmentName", "EmploymentType", "SpecificEmployee", "JobRoleType", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["SpecificEmployee"]) -> typing.Union[MetaOapg.properties.SpecificEmployee, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["JobRoleType"]) -> typing.Union[MetaOapg.properties.JobRoleType, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ProjectId", "ProjectName", "Status", "CompanyName", "LocationName", "DepartmentName", "EmploymentType", "SpecificEmployee", "JobRoleType", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        SpecificEmployee: typing.Union[MetaOapg.properties.SpecificEmployee, str, schemas.Unset] = schemas.unset,
        JobRoleType: typing.Union[MetaOapg.properties.JobRoleType, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ResultForGetAllTimesheetProjectObjectItem':
