...
class ResultCreateNewApplicant(
    schemas.DictSchema
):
    """
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["IsDuplicate"]) -> MetaOapg.properties.IsDuplicate: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["IsDuplicate", "ApplicantId", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["IsDuplicate"]) -> typing.Union[MetaOapg.properties.IsDuplicate, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["IsDuplicate", "ApplicantId", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        IsDuplicate: typing.Union[MetaOapg.properties.IsDuplicate, str, schemas.Unset] = schemas.unset,
        ApplicantId: typing.Union[MetaOapg.properties.ApplicantId, decimal.Decimal, int, schemas.Unset] = schemas.unset,
