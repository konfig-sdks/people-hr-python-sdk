...
class UpdateAbsenceDetailParameter(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            def EmployeeId() -> typing.Type['EmployeeId']:
                return EmployeeId
            OldStartDate = schemas.DateSchema
            OldEndDate = schemas.DateSchema
        
            @staticmethod
            def DurationType() -> typing.Type['Byte']:
                return Byte
            ...
            @staticmethod
            def AbsencePaidStatus() -> typing.Type['Byte']:
                return Byte
        
            @staticmethod
            def EmergencyLeave() -> typing.Type['EmergencyLeave']:
                return EmergencyLeave
        
            @staticmethod
            def PartOfDay() -> typing.Type['PartOfDayForUpdateAbsence']:
                return PartOfDayForUpdateAbsence
        
            @staticmethod
            def AddComments() -> typing.Type['AddCommentsArrayForAbsence']:
                return AddCommentsArrayForAbsence
        
            @staticmethod
            def AddFiles() -> typing.Type['AddFilesArrayForAbsence']:
                return AddFilesArrayForAbsence
            __annotations__ = {
                "APIKey": APIKey,
                "Action": Action,
    ...
    DurationType: 'Byte'
    OldEndDate: MetaOapg.properties.OldEndDate
    StartDate: MetaOapg.properties.StartDate
    APIKey: 'APIKey'
    Action: MetaOapg.properties.Action
    OldStartDate: MetaOapg.properties.OldStartDate
    EmergencyLeave: 'EmergencyLeave'
    AbsencePaidStatus: 'Byte'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["OldStartDate"]) -> MetaOapg.properties.OldStartDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["OldEndDate"]) -> MetaOapg.properties.OldEndDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DurationType"]) -> 'Byte': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AbsencePaidStatus"]) -> 'Byte': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["EmergencyLeave"]) -> 'EmergencyLeave': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["PartOfDay"]) -> 'PartOfDayForUpdateAbsence': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AddComments"]) -> 'AddCommentsArrayForAbsence': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AddFiles"]) -> 'AddFilesArrayForAbsence': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "OldStartDate", "OldEndDate", "DurationType", "Reason", "StartDate", "EndDate", "Duration", "AbsencePaidStatus", "EmergencyLeave", "PartOfDay", "AddComments", "AddFiles", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["OldStartDate"]) -> MetaOapg.properties.OldStartDate: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["OldEndDate"]) -> MetaOapg.properties.OldEndDate: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DurationType"]) -> 'Byte': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AbsencePaidStatus"]) -> 'Byte': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["EmergencyLeave"]) -> 'EmergencyLeave': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["PartOfDay"]) -> typing.Union['PartOfDayForUpdateAbsence', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AddComments"]) -> typing.Union['AddCommentsArrayForAbsence', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AddFiles"]) -> typing.Union['AddFilesArrayForAbsence', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "OldStartDate", "OldEndDate", "DurationType", "Reason", "StartDate", "EndDate", "Duration", "AbsencePaidStatus", "EmergencyLeave", "PartOfDay", "AddComments", "AddFiles", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        DurationType: 'Byte',
        OldEndDate: typing.Union[MetaOapg.properties.OldEndDate, str, date, ],
        StartDate: typing.Union[MetaOapg.properties.StartDate, str, date, ],
        APIKey: 'APIKey',
        Action: typing.Union[MetaOapg.properties.Action, str, ],
        OldStartDate: typing.Union[MetaOapg.properties.OldStartDate, str, date, ],
        EmergencyLeave: 'EmergencyLeave',
        AbsencePaidStatus: 'Byte',
        ...
        PartOfDay: typing.Union['PartOfDayForUpdateAbsence', schemas.Unset] = schemas.unset,
        AddComments: typing.Union['AddCommentsArrayForAbsence', schemas.Unset] = schemas.unset,
        AddFiles: typing.Union['AddFilesArrayForAbsence', schemas.Unset] = schemas.unset,
