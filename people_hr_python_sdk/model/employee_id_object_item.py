...
class EmployeeIdObjectItem(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["OldValue", "NewValue", "ChangedOn", "ReasonForChange", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["OldValue", "NewValue", "ChangedOn", "ReasonForChange", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ChangedOn: typing.Union[MetaOapg.properties.ChangedOn, str, schemas.Unset] = schemas.unset,
