...
class ResultForGetByMaternityPaternityIdItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            MaternityPaternityTxnId = schemas.IntSchema
            ExpectedDate = schemas.DateSchema
            DueWeekStartDate = schemas.DateSchema
            DueWeekEndDate = schemas.DateSchema
            EarliestStartDate = schemas.DateSchema
            ContinousWeeksService = schemas.StrSchema
            OrdinaryLeaveStartDate = schemas.DateSchema
            OrdinaryLeaveEndDate = schemas.DateSchema
            AdditionalLeaveStartDate = schemas.DateSchema
            AdditionalLeaveEndDate = schemas.DateSchema
            ActualStartDate = schemas.DateSchema
            ActualEndDate = schemas.DateSchema
        
            @staticmethod
            def Comments() -> typing.Type['CommentssArrayForGetDetail']:
                return CommentssArrayForGetDetail
        
            @staticmethod
            def Files() -> typing.Type['FilesArrayForMaternityPaternity']:
                return FilesArrayForMaternityPaternity
            ReferenceId = schemas.StrSchema
            __annotations__ = {
                "MaternityPaternityTxnId": MaternityPaternityTxnId,
                "ExpectedDate": ExpectedDate,
                "DueWeekStartDate": DueWeekStartDate,
                "DueWeekEndDate": DueWeekEndDate,
                "EarliestStartDate": EarliestStartDate,
                "ContinousWeeksService": ContinousWeeksService,
                "OrdinaryLeaveStartDate": OrdinaryLeaveStartDate,
                "OrdinaryLeaveEndDate": OrdinaryLeaveEndDate,
                "AdditionalLeaveStartDate": AdditionalLeaveStartDate,
                "AdditionalLeaveEndDate": AdditionalLeaveEndDate,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["MaternityPaternityTxnId"]) -> MetaOapg.properties.MaternityPaternityTxnId: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ExpectedDate"]) -> MetaOapg.properties.ExpectedDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DueWeekStartDate"]) -> MetaOapg.properties.DueWeekStartDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DueWeekEndDate"]) -> MetaOapg.properties.DueWeekEndDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["EarliestStartDate"]) -> MetaOapg.properties.EarliestStartDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ContinousWeeksService"]) -> MetaOapg.properties.ContinousWeeksService: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["OrdinaryLeaveStartDate"]) -> MetaOapg.properties.OrdinaryLeaveStartDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["OrdinaryLeaveEndDate"]) -> MetaOapg.properties.OrdinaryLeaveEndDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AdditionalLeaveStartDate"]) -> MetaOapg.properties.AdditionalLeaveStartDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AdditionalLeaveEndDate"]) -> MetaOapg.properties.AdditionalLeaveEndDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ActualStartDate"]) -> MetaOapg.properties.ActualStartDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ActualEndDate"]) -> MetaOapg.properties.ActualEndDate: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Comments"]) -> 'CommentssArrayForGetDetail': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Files"]) -> 'FilesArrayForMaternityPaternity': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["MaternityPaternityTxnId", "ExpectedDate", "DueWeekStartDate", "DueWeekEndDate", "EarliestStartDate", "ContinousWeeksService", "OrdinaryLeaveStartDate", "OrdinaryLeaveEndDate", "AdditionalLeaveStartDate", "AdditionalLeaveEndDate", "ActualStartDate", "ActualEndDate", "Comments", "Files", "ReferenceId", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["MaternityPaternityTxnId"]) -> typing.Union[MetaOapg.properties.MaternityPaternityTxnId, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ExpectedDate"]) -> typing.Union[MetaOapg.properties.ExpectedDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DueWeekStartDate"]) -> typing.Union[MetaOapg.properties.DueWeekStartDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DueWeekEndDate"]) -> typing.Union[MetaOapg.properties.DueWeekEndDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["EarliestStartDate"]) -> typing.Union[MetaOapg.properties.EarliestStartDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ContinousWeeksService"]) -> typing.Union[MetaOapg.properties.ContinousWeeksService, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["OrdinaryLeaveStartDate"]) -> typing.Union[MetaOapg.properties.OrdinaryLeaveStartDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["OrdinaryLeaveEndDate"]) -> typing.Union[MetaOapg.properties.OrdinaryLeaveEndDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AdditionalLeaveStartDate"]) -> typing.Union[MetaOapg.properties.AdditionalLeaveStartDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AdditionalLeaveEndDate"]) -> typing.Union[MetaOapg.properties.AdditionalLeaveEndDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ActualStartDate"]) -> typing.Union[MetaOapg.properties.ActualStartDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ActualEndDate"]) -> typing.Union[MetaOapg.properties.ActualEndDate, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Comments"]) -> typing.Union['CommentssArrayForGetDetail', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Files"]) -> typing.Union['FilesArrayForMaternityPaternity', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        MaternityPaternityTxnId: typing.Union[MetaOapg.properties.MaternityPaternityTxnId, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ExpectedDate: typing.Union[MetaOapg.properties.ExpectedDate, str, date, schemas.Unset] = schemas.unset,
        DueWeekStartDate: typing.Union[MetaOapg.properties.DueWeekStartDate, str, date, schemas.Unset] = schemas.unset,
        DueWeekEndDate: typing.Union[MetaOapg.properties.DueWeekEndDate, str, date, schemas.Unset] = schemas.unset,
        EarliestStartDate: typing.Union[MetaOapg.properties.EarliestStartDate, str, date, schemas.Unset] = schemas.unset,
        ContinousWeeksService: typing.Union[MetaOapg.properties.ContinousWeeksService, str, schemas.Unset] = schemas.unset,
        OrdinaryLeaveStartDate: typing.Union[MetaOapg.properties.OrdinaryLeaveStartDate, str, date, schemas.Unset] = schemas.unset,
        OrdinaryLeaveEndDate: typing.Union[MetaOapg.properties.OrdinaryLeaveEndDate, str, date, schemas.Unset] = schemas.unset,
        AdditionalLeaveStartDate: typing.Union[MetaOapg.properties.AdditionalLeaveStartDate, str, date, schemas.Unset] = schemas.unset,
        AdditionalLeaveEndDate: typing.Union[MetaOapg.properties.AdditionalLeaveEndDate, str, date, schemas.Unset] = schemas.unset,
        ActualStartDate: typing.Union[MetaOapg.properties.ActualStartDate, str, date, schemas.Unset] = schemas.unset,
        ActualEndDate: typing.Union[MetaOapg.properties.ActualEndDate, str, date, schemas.Unset] = schemas.unset,
        Comments: typing.Union['CommentssArrayForGetDetail', schemas.Unset] = schemas.unset,
        Files: typing.Union['FilesArrayForMaternityPaternity', schemas.Unset] = schemas.unset,
    ...
    ) -> 'ResultForGetByMaternityPaternityIdItem':
