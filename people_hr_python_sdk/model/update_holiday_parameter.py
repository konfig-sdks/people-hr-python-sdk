...
class UpdateHolidayParameter(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def PartOfDay() -> typing.Type['PartOfDay']:
                return PartOfDay
    ...
    DurationInMinutes: MetaOapg.properties.DurationInMinutes
    OldStartDate: MetaOapg.properties.OldStartDate
    DurationInDays: MetaOapg.properties.DurationInDays
    EmployeeId: 'EmployeeId'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["PartOfDay"]) -> 'PartOfDay': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "OldStartDate", "OldEndDate", "DurationType", "StartDate", "EndDate", "DurationInDays", "DurationInMinutes", "PartOfDay", "Comments", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DurationInDays"]) -> MetaOapg.properties.DurationInDays: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DurationInMinutes"]) -> MetaOapg.properties.DurationInMinutes: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["PartOfDay"]) -> typing.Union['PartOfDay', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "OldStartDate", "OldEndDate", "DurationType", "StartDate", "EndDate", "DurationInDays", "DurationInMinutes", "PartOfDay", "Comments", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        DurationInMinutes: typing.Union[MetaOapg.properties.DurationInMinutes, decimal.Decimal, int, ],
        OldStartDate: typing.Union[MetaOapg.properties.OldStartDate, str, date, ],
        DurationInDays: typing.Union[MetaOapg.properties.DurationInDays, decimal.Decimal, int, ],
        EmployeeId: 'EmployeeId',
        EndDate: typing.Union[MetaOapg.properties.EndDate, str, date, ],
        PartOfDay: typing.Union['PartOfDay', schemas.Unset] = schemas.unset,
