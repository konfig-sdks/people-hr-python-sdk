...
class GetAllProjectTaskParameter(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "ProjectTaskName", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ProjectTaskName"]) -> typing.Union['ProjectTaskName', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "ProjectTaskName", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ProjectTaskName: typing.Union['ProjectTaskName', schemas.Unset] = schemas.unset,
