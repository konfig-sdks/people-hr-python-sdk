...
class UpdateCustomScreenTransactionParameter(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            def EmployeeId() -> typing.Type['EmployeeId']:
                return EmployeeId
            ScreenId = schemas.IntSchema
            CustomScreenTransactionId = schemas.IntSchema
        
            @staticmethod
            def CustomColumns() -> typing.Type['CustomColumnsForEmployeeCustomScreenObject']:
                return CustomColumnsForEmployeeCustomScreenObject
        
            @staticmethod
            def AddFiles() -> typing.Type['AddFilesForEmployeeCustomScreenObject']:
                return AddFilesForEmployeeCustomScreenObject
            __annotations__ = {
                "APIKey": APIKey,
                "Action": Action,
                "EmployeeId": EmployeeId,
                "ScreenId": ScreenId,
                "CustomScreenTransactionId": CustomScreenTransactionId,
    ...
    SignatureRequired: schemas.AnyTypeSchema
    CustomColumns: 'CustomColumnsForEmployeeCustomScreenObject'
    Description: schemas.AnyTypeSchema
    ScreenId: MetaOapg.properties.ScreenId
    EmployeeId: 'EmployeeId'
    AddFiles: 'AddFilesForEmployeeCustomScreenObject'
    DocumentCategory: schemas.AnyTypeSchema
    File: schemas.AnyTypeSchema
    CustomScreenTransactionId: MetaOapg.properties.CustomScreenTransactionId
    DocumentName: schemas.AnyTypeSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ScreenId"]) -> MetaOapg.properties.ScreenId: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["CustomScreenTransactionId"]) -> MetaOapg.properties.CustomScreenTransactionId: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["CustomColumns"]) -> 'CustomColumnsForEmployeeCustomScreenObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AddFiles"]) -> 'AddFilesForEmployeeCustomScreenObject': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "ScreenId", "CustomScreenTransactionId", "CustomColumns", "AddFiles", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ScreenId"]) -> MetaOapg.properties.ScreenId: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CustomScreenTransactionId"]) -> MetaOapg.properties.CustomScreenTransactionId: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CustomColumns"]) -> 'CustomColumnsForEmployeeCustomScreenObject': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AddFiles"]) -> 'AddFilesForEmployeeCustomScreenObject': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "ScreenId", "CustomScreenTransactionId", "CustomColumns", "AddFiles", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        SignatureRequired: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        CustomColumns: 'CustomColumnsForEmployeeCustomScreenObject',
        ...
        ScreenId: typing.Union[MetaOapg.properties.ScreenId, decimal.Decimal, int, ],
        EmployeeId: 'EmployeeId',
        AddFiles: 'AddFilesForEmployeeCustomScreenObject',
        DocumentCategory: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        File: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        CustomScreenTransactionId: typing.Union[MetaOapg.properties.CustomScreenTransactionId, decimal.Decimal, int, ],
        DocumentName: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
