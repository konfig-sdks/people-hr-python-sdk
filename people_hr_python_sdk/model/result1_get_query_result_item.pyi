...
class Result1GetQueryResultItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            holiday_start_date = schemas.DateSchema
            holiday_end_date = schemas.DateSchema
            holiday_type = schemas.StrSchema
            holiday_duration_type = schemas.StrSchema
            part_of_the_day = schemas.StrSchema
            holiday_duration__days = schemas.StrSchema
            holiday_duration__hrs = schemas.StrSchema
            holiday_comments = schemas.StrSchema
            holiday_status = schemas.StrSchema
            __annotations__ = {
                "Employee Id": employee_id,
                "First Name": first_name,
                "Last Name": last_name,
                "Holiday Start Date": holiday_start_date,
                "Holiday End Date": holiday_end_date,
                "Holiday Type": holiday_type,
                "Holiday Duration Type": holiday_duration_type,
                "Part of the Day": part_of_the_day,
                "Holiday Duration (Days)": holiday_duration__days,
                "Holiday Duration (Hrs)": holiday_duration__hrs,
                "Holiday Comments": holiday_comments,
                "Holiday Status": holiday_status,
            }
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Employee Id"]) -> MetaOapg.properties.employee_id: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["First Name"]) -> MetaOapg.properties.first_name: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Last Name"]) -> MetaOapg.properties.last_name: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Holiday Start Date"]) -> MetaOapg.properties.holiday_start_date: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Holiday End Date"]) -> MetaOapg.properties.holiday_end_date: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Holiday Type"]) -> MetaOapg.properties.holiday_type: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Holiday Duration Type"]) -> MetaOapg.properties.holiday_duration_type: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Part of the Day"]) -> MetaOapg.properties.part_of_the_day: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Holiday Duration (Days)"]) -> MetaOapg.properties.holiday_duration__days: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Holiday Duration (Hrs)"]) -> MetaOapg.properties.holiday_duration__hrs: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Holiday Comments"]) -> MetaOapg.properties.holiday_comments: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Holiday Status"]) -> MetaOapg.properties.holiday_status: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Employee Id", "First Name", "Last Name", "Holiday Start Date", "Holiday End Date", "Holiday Type", "Holiday Duration Type", "Part of the Day", "Holiday Duration (Days)", "Holiday Duration (Hrs)", "Holiday Comments", "Holiday Status", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Employee Id"]) -> typing.Union[MetaOapg.properties.employee_id, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["First Name"]) -> typing.Union[MetaOapg.properties.first_name, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Last Name"]) -> typing.Union[MetaOapg.properties.last_name, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Holiday Start Date"]) -> typing.Union[MetaOapg.properties.holiday_start_date, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Holiday End Date"]) -> typing.Union[MetaOapg.properties.holiday_end_date, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Holiday Type"]) -> typing.Union[MetaOapg.properties.holiday_type, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Holiday Duration Type"]) -> typing.Union[MetaOapg.properties.holiday_duration_type, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Part of the Day"]) -> typing.Union[MetaOapg.properties.part_of_the_day, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Holiday Duration (Days)"]) -> typing.Union[MetaOapg.properties.holiday_duration__days, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Holiday Duration (Hrs)"]) -> typing.Union[MetaOapg.properties.holiday_duration__hrs, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Holiday Comments"]) -> typing.Union[MetaOapg.properties.holiday_comments, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Holiday Status"]) -> typing.Union[MetaOapg.properties.holiday_status, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Employee Id", "First Name", "Last Name", "Holiday Start Date", "Holiday End Date", "Holiday Type", "Holiday Duration Type", "Part of the Day", "Holiday Duration (Days)", "Holiday Duration (Hrs)", "Holiday Comments", "Holiday Status", ], str]):
