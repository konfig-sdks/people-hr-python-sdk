...
class UpdateAppraisalParameter(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            def EmployeeId() -> typing.Type['EmployeeId']:
                return EmployeeId
            AppraisalReviewDate = schemas.DateSchema
            Reviewer = schemas.StrSchema
            Notes = schemas.StrSchema
            ActionPlan = schemas.StrSchema
            Objectives = schemas.StrSchema
        
            @staticmethod
            def CustomColumns() -> typing.Type['CustomColumnsArrayForUpdateAppraisal']:
                return CustomColumnsArrayForUpdateAppraisal
        
            @staticmethod
            def AddFiles() -> typing.Type['AddFilesArrayForUpdateAppraisal']:
                return AddFilesArrayForUpdateAppraisal
            __annotations__ = {
                "APIKey": APIKey,
                "Action": Action,
                "EmployeeId": EmployeeId,
                "AppraisalReviewDate": AppraisalReviewDate,
                "Reviewer": Reviewer,
                "Notes": Notes,
    ...
    CustomColumns: 'CustomColumnsArrayForUpdateAppraisal'
    AppraisalId: schemas.AnyTypeSchema
    AppraisalReviewDate: MetaOapg.properties.AppraisalReviewDate
    Objectives: MetaOapg.properties.Objectives
    EmployeeId: 'EmployeeId'
    AddFiles: 'AddFilesArrayForUpdateAppraisal'
    Reviewer: MetaOapg.properties.Reviewer
    ActionPlan: MetaOapg.properties.ActionPlan
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AppraisalReviewDate"]) -> MetaOapg.properties.AppraisalReviewDate: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ActionPlan"]) -> MetaOapg.properties.ActionPlan: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Objectives"]) -> MetaOapg.properties.Objectives: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["CustomColumns"]) -> 'CustomColumnsArrayForUpdateAppraisal': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AddFiles"]) -> 'AddFilesArrayForUpdateAppraisal': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "AppraisalReviewDate", "Reviewer", "Notes", "ActionPlan", "Objectives", "CustomColumns", "AddFiles", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AppraisalReviewDate"]) -> MetaOapg.properties.AppraisalReviewDate: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Reviewer"]) -> MetaOapg.properties.Reviewer: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Notes"]) -> MetaOapg.properties.Notes: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ActionPlan"]) -> MetaOapg.properties.ActionPlan: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Objectives"]) -> MetaOapg.properties.Objectives: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CustomColumns"]) -> 'CustomColumnsArrayForUpdateAppraisal': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AddFiles"]) -> 'AddFilesArrayForUpdateAppraisal': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "AppraisalReviewDate", "Reviewer", "Notes", "ActionPlan", "Objectives", "CustomColumns", "AddFiles", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        CustomColumns: 'CustomColumnsArrayForUpdateAppraisal',
        AppraisalId: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        AppraisalReviewDate: typing.Union[MetaOapg.properties.AppraisalReviewDate, str, date, ],
        Objectives: typing.Union[MetaOapg.properties.Objectives, str, ],
        EmployeeId: 'EmployeeId',
        AddFiles: 'AddFilesArrayForUpdateAppraisal',
        Reviewer: typing.Union[MetaOapg.properties.Reviewer, str, ],
        ActionPlan: typing.Union[MetaOapg.properties.ActionPlan, str, ],
