...
class AddFilesForGetEmployeeQualificationItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["DocumentName", "FileUrl", "Descriptions", "Category", "SignatureRequired", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["DocumentName", "FileUrl", "Descriptions", "Category", "SignatureRequired", ], str]):
    ...
    ) -> 'AddFilesForGetEmployeeQualificationItem':
