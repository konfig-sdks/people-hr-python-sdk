...
class EmploymentDetailObject(
    schemas.DictSchema
):
    """
    This class is auto generated by Konfig (https://konfigthis.com)

    Employment detail contain displayValue and FieldHistory array values
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def PayrollCompany() -> typing.Type['PayrollCompanyObject']:
                return PayrollCompanyObject
        
            @staticmethod
            def PayrollID() -> typing.Type['PayrollIDObject']:
                return PayrollIDObject
        
            @staticmethod
            def TimeAndAttendanceID() -> typing.Type['TimeAndAttendanceIDObject']:
                return TimeAndAttendanceIDObject
        
            @staticmethod
            def RotaID() -> typing.Type['RotaIDObject']:
                return RotaIDObject
        
            @staticmethod
            def CRMID() -> typing.Type['CRMIDObject']:
                return CRMIDObject
        
            @staticmethod
            def ATSID() -> typing.Type['ATSIDObject']:
                return ATSIDObject
        
            @staticmethod
            def PerformanceID() -> typing.Type['PerformanceIDObject']:
                return PerformanceIDObject
        
            @staticmethod
            def BenefitsID() -> typing.Type['BenefitsIDObject']:
                return BenefitsIDObject
        
            @staticmethod
            def System1ID() -> typing.Type['System1IDObject']:
                return System1IDObject
        
            @staticmethod
            def System2ID() -> typing.Type['System2IDObject']:
                return System2IDObject
        
            @staticmethod
            def System3ID() -> typing.Type['System3IDObject']:
                return System3IDObject
        
            @staticmethod
            def MethodOfRecruitment() -> typing.Type['MethodOfRecruitmentObject']:
                return MethodOfRecruitmentObject
            __annotations__ = {
                "PayrollCompany": PayrollCompany,
                "PayrollID": PayrollID,
                "TimeAndAttendanceID": TimeAndAttendanceID,
                "RotaID": RotaID,
                "CRMID": CRMID,
                "ATSID": ATSID,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["PayrollCompany"]) -> 'PayrollCompanyObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["PayrollID"]) -> 'PayrollIDObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["TimeAndAttendanceID"]) -> 'TimeAndAttendanceIDObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["RotaID"]) -> 'RotaIDObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["CRMID"]) -> 'CRMIDObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ATSID"]) -> 'ATSIDObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["PerformanceID"]) -> 'PerformanceIDObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["BenefitsID"]) -> 'BenefitsIDObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["System1ID"]) -> 'System1IDObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["System2ID"]) -> 'System2IDObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["System3ID"]) -> 'System3IDObject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["MethodOfRecruitment"]) -> 'MethodOfRecruitmentObject': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["PayrollCompany", "PayrollID", "TimeAndAttendanceID", "RotaID", "CRMID", "ATSID", "PerformanceID", "BenefitsID", "System1ID", "System2ID", "System3ID", "MethodOfRecruitment", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["PayrollCompany"]) -> typing.Union['PayrollCompanyObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["PayrollID"]) -> typing.Union['PayrollIDObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["TimeAndAttendanceID"]) -> typing.Union['TimeAndAttendanceIDObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["RotaID"]) -> typing.Union['RotaIDObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["CRMID"]) -> typing.Union['CRMIDObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ATSID"]) -> typing.Union['ATSIDObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["PerformanceID"]) -> typing.Union['PerformanceIDObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["BenefitsID"]) -> typing.Union['BenefitsIDObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["System1ID"]) -> typing.Union['System1IDObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["System2ID"]) -> typing.Union['System2IDObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["System3ID"]) -> typing.Union['System3IDObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["MethodOfRecruitment"]) -> typing.Union['MethodOfRecruitmentObject', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["PayrollCompany", "PayrollID", "TimeAndAttendanceID", "RotaID", "CRMID", "ATSID", "PerformanceID", "BenefitsID", "System1ID", "System2ID", "System3ID", "MethodOfRecruitment", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        PayrollCompany: typing.Union['PayrollCompanyObject', schemas.Unset] = schemas.unset,
        PayrollID: typing.Union['PayrollIDObject', schemas.Unset] = schemas.unset,
        TimeAndAttendanceID: typing.Union['TimeAndAttendanceIDObject', schemas.Unset] = schemas.unset,
        RotaID: typing.Union['RotaIDObject', schemas.Unset] = schemas.unset,
        CRMID: typing.Union['CRMIDObject', schemas.Unset] = schemas.unset,
        ATSID: typing.Union['ATSIDObject', schemas.Unset] = schemas.unset,
        PerformanceID: typing.Union['PerformanceIDObject', schemas.Unset] = schemas.unset,
        BenefitsID: typing.Union['BenefitsIDObject', schemas.Unset] = schemas.unset,
        System1ID: typing.Union['System1IDObject', schemas.Unset] = schemas.unset,
        System2ID: typing.Union['System2IDObject', schemas.Unset] = schemas.unset,
        System3ID: typing.Union['System3IDObject', schemas.Unset] = schemas.unset,
        MethodOfRecruitment: typing.Union['MethodOfRecruitmentObject', schemas.Unset] = schemas.unset,
