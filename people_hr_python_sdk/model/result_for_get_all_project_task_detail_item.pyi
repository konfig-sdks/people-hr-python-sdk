...
class ResultForGetAllProjectTaskDetailItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ProjectTaskDetailId = schemas.IntSchema
            ProjectTaskDetailName = schemas.StrSchema
            ...
            class Status(
                ...
                def TRUE(cls):
                    return cls("true")
            ProjectTaskName = schemas.StrSchema
            __annotations__ = {
                "ProjectTaskDetailId": ProjectTaskDetailId,
                "ProjectTaskDetailName": ProjectTaskDetailName,
                "Status": Status,
                "ProjectTaskName": ProjectTaskName,
            }
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ProjectTaskDetailId"]) -> MetaOapg.properties.ProjectTaskDetailId: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ProjectTaskDetailName"]) -> MetaOapg.properties.ProjectTaskDetailName: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Status"]) -> MetaOapg.properties.Status: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ProjectTaskName"]) -> MetaOapg.properties.ProjectTaskName: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["ProjectTaskDetailId", "ProjectTaskDetailName", "Status", "ProjectTaskName", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ProjectTaskDetailId"]) -> typing.Union[MetaOapg.properties.ProjectTaskDetailId, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ProjectTaskDetailName"]) -> typing.Union[MetaOapg.properties.ProjectTaskDetailName, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Status"]) -> typing.Union[MetaOapg.properties.Status, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ProjectTaskName"]) -> typing.Union[MetaOapg.properties.ProjectTaskName, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["ProjectTaskDetailId", "ProjectTaskDetailName", "Status", "ProjectTaskName", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ProjectTaskDetailId: typing.Union[MetaOapg.properties.ProjectTaskDetailId, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        ProjectTaskDetailName: typing.Union[MetaOapg.properties.ProjectTaskDetailName, str, schemas.Unset] = schemas.unset,
        Status: typing.Union[MetaOapg.properties.Status, str, schemas.Unset] = schemas.unset,
        ProjectTaskName: typing.Union[MetaOapg.properties.ProjectTaskName, str, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ResultForGetAllProjectTaskDetailItem':
