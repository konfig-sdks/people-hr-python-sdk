...
class AssignedToArrayForWorkPatternItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["EmployeeId", "FirstName", "LastName", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["EmployeeId", "FirstName", "LastName", ], str]):
    ...
    ) -> 'AssignedToArrayForWorkPatternItem':
