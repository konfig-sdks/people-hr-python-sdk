...
class Result1GetHistoryByEmployeeIdAndFieldNameItem(
    schemas.DictSchema
):
    """
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["JobRole"]) -> MetaOapg.properties.JobRole: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["JobRole", "EffectiveDate", "ReasonForChange", "ChangedOn", "CreatedBy", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["JobRole"]) -> typing.Union[MetaOapg.properties.JobRole, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["JobRole", "EffectiveDate", "ReasonForChange", "ChangedOn", "CreatedBy", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        JobRole: typing.Union[MetaOapg.properties.JobRole, str, schemas.Unset] = schemas.unset,
    ...
    ) -> 'Result1GetHistoryByEmployeeIdAndFieldNameItem':
