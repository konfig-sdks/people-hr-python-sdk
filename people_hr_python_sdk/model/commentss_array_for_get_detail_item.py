...
class CommentssArrayForGetDetailItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["CommentId", "Comments", "PostedBy", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["CommentId", "Comments", "PostedBy", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        CommentId: typing.Union[MetaOapg.properties.CommentId, decimal.Decimal, int, schemas.Unset] = schemas.unset,
    ...
    ) -> 'CommentssArrayForGetDetailItem':
