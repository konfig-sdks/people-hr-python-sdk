...
class UserPermissionsItem(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class resourceName(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "UpdateEmployeeId": "UPDATE_EMPLOYEE_ID",
                        "CheckAuthentication": "CHECK_AUTHENTICATION",
                        "api-keys": "APIKEYS",
                        "api-tracking": "APITRACKING",
                        "authentication-tokens": "AUTHENTICATIONTOKENS",
                        "bank-accounts": "BANKACCOUNTS",
                        "blacklists": "BLACKLISTS",
                        "checkout-pages": "CHECKOUTPAGES",
                        "contacts": "CONTACTS",
                        "coupons": "COUPONS",
                        "coupons-redemptions": "COUPONSREDEMPTIONS",
                        ...
                        "disputes": "DISPUTES",
                        "events": "EVENTS",
                        "gateway-accounts": "GATEWAYACCOUNTS",
                        "invoices": "INVOICES",
                        "layouts": "LAYOUTS",
                        ...
                        "password-tokens": "PASSWORDTOKENS",
                        "payments": "PAYMENTS",
                        "payment-cards": "PAYMENTCARDS",
                        "payment-cards-migrations": "PAYMENTCARDSMIGRATIONS",
                        "paypal-accounts": "PAYPALACCOUNTS",
                        "plans": "PLANS",
                        "reports": "REPORTS",
                        "reset-sandbox": "RESETSANDBOX",
                        "rulesets": "RULESETS",
                        "sessions": "SESSIONS",
                        "subscriptions": "SUBSCRIPTIONS",
                        "subscription-tracking": "SUBSCRIPTIONTRACKING",
                        "tokens": "TOKENS",
                        "transactions": "TRANSACTIONS",
                        "users": "USERS",
                        "webhook": "WEBHOOK",
                        "webhook-tracking": "WEBHOOKTRACKING",
                        "websites": "WEBSITES",
                    }
                
                @schemas.classproperty
                def UPDATE_EMPLOYEE_ID(cls):
                    return cls("UpdateEmployeeId")
                
                @schemas.classproperty
                def CHECK_AUTHENTICATION(cls):
                    return cls("CheckAuthentication")
                ...
                @schemas.classproperty
                def APITRACKING(cls):
                    return cls("api-tracking")
                
                @schemas.classproperty
                def AUTHENTICATIONTOKENS(cls):
                    return cls("authentication-tokens")
                ...
                @schemas.classproperty
                def BLACKLISTS(cls):
                    return cls("blacklists")
                
                @schemas.classproperty
                def CHECKOUTPAGES(cls):
                    return cls("checkout-pages")
                ...
                @schemas.classproperty
                def COUPONSREDEMPTIONS(cls):
                    return cls("coupons-redemptions")
                ...
                @schemas.classproperty
                def CUSTOMEVENTS(cls):
                    return cls("custom-events")
                
                @schemas.classproperty
                def CUSTOMFIELDS(cls):
                    return cls("custom-fields")
                ...
                @schemas.classproperty
                def GATEWAYACCOUNTS(cls):
                    return cls("gateway-accounts")
                ...
                @schemas.classproperty
                def MATCHEDRULES(cls):
                    return cls("matched-rules")
                ...
                @schemas.classproperty
                def PASSWORDTOKENS(cls):
                    return cls("password-tokens")
                ...
                @schemas.classproperty
                def PAYMENTCARDS(cls):
                    return cls("payment-cards")
                
                @schemas.classproperty
                def PAYMENTCARDSMIGRATIONS(cls):
                    return cls("payment-cards-migrations")
                
                @schemas.classproperty
                def PAYPALACCOUNTS(cls):
                    return cls("paypal-accounts")
                ...
                @schemas.classproperty
                def RESETSANDBOX(cls):
                    return cls("reset-sandbox")
                ...
                @schemas.classproperty
                def SUBSCRIPTIONTRACKING(cls):
                    return cls("subscription-tracking")
                ...
                @schemas.classproperty
                def WEBHOOKTRACKING(cls):
                    return cls("webhook-tracking")
            ...
            @staticmethod
            def methods() -> typing.Type['UserPermissionsItemMethods']:
                return UserPermissionsItemMethods
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["methods"]) -> 'UserPermissionsItemMethods': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["resourceIds"]) -> MetaOapg.properties.resourceIds: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["resourceName", "methods", "resourceIds", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["methods"]) -> typing.Union['UserPermissionsItemMethods', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["resourceIds"]) -> typing.Union[MetaOapg.properties.resourceIds, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["resourceName", "methods", "resourceIds", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        methods: typing.Union['UserPermissionsItemMethods', schemas.Unset] = schemas.unset,
        resourceIds: typing.Union[MetaOapg.properties.resourceIds, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
