...
class UpdateMaternityPaternityParameter(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def AddComments() -> typing.Type['AddCommentsArrayForMaternityPaternity']:
                return AddCommentsArrayForMaternityPaternity
        
            @staticmethod
            def AddFiles() -> typing.Type['AddFilesArrayForAddNewMaternityPaternity']:
                return AddFilesArrayForAddNewMaternityPaternity
            __annotations__ = {
                "APIKey": APIKey,
                "Action": Action,
    ...
    MaternityPaternityTxnId: MetaOapg.properties.MaternityPaternityTxnId
    APIKey: 'APIKey'
    ActualEndDate: MetaOapg.properties.ActualEndDate
    Action: MetaOapg.properties.Action
    AddComments: 'AddCommentsArrayForMaternityPaternity'
    ActualStartDate: MetaOapg.properties.ActualStartDate
    DueDate: MetaOapg.properties.DueDate
    EmployeeId: 'EmployeeId'
    AddFiles: 'AddFilesArrayForAddNewMaternityPaternity'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AddComments"]) -> 'AddCommentsArrayForMaternityPaternity': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AddFiles"]) -> 'AddFilesArrayForAddNewMaternityPaternity': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "MaternityPaternityTxnId", "DueDate", "ActualStartDate", "ActualEndDate", "AddComments", "AddFiles", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["MaternityPaternityTxnId"]) -> MetaOapg.properties.MaternityPaternityTxnId: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DueDate"]) -> MetaOapg.properties.DueDate: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ActualStartDate"]) -> MetaOapg.properties.ActualStartDate: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ActualEndDate"]) -> MetaOapg.properties.ActualEndDate: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AddComments"]) -> 'AddCommentsArrayForMaternityPaternity': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AddFiles"]) -> 'AddFilesArrayForAddNewMaternityPaternity': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "MaternityPaternityTxnId", "DueDate", "ActualStartDate", "ActualEndDate", "AddComments", "AddFiles", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        MaternityPaternityTxnId: typing.Union[MetaOapg.properties.MaternityPaternityTxnId, decimal.Decimal, int, ],
        APIKey: 'APIKey',
        ActualEndDate: typing.Union[MetaOapg.properties.ActualEndDate, str, date, ],
        Action: typing.Union[MetaOapg.properties.Action, str, ],
        AddComments: 'AddCommentsArrayForMaternityPaternity',
        ActualStartDate: typing.Union[MetaOapg.properties.ActualStartDate, str, date, ],
        DueDate: typing.Union[MetaOapg.properties.DueDate, str, date, ],
        EmployeeId: 'EmployeeId',
        AddFiles: 'AddFilesArrayForAddNewMaternityPaternity',
