...
class EmailInboxParameter(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def EmailFrom() -> typing.Type['EmailFrom']:
                return EmailFrom
        
            @staticmethod
            def EmailTo() -> typing.Type['Result1ForEmailToForEmailInbox']:
                return Result1ForEmailToForEmailInbox
        
            @staticmethod
            def EmailSubject() -> typing.Type['EmailSubject']:
                return EmailSubject
        
            @staticmethod
            def EmailCc() -> typing.Type['Result1ForEmailCcForEmailInbox']:
                return Result1ForEmailCcForEmailInbox
        
            @staticmethod
            def EmailBcc() -> typing.Type['Result1ForEmailBccForEmailInbox']:
                return Result1ForEmailBccForEmailInbox
        
            @staticmethod
            def Attachment() -> typing.Type['Result1ForAttachmentForEmailInbox']:
                return Result1ForAttachmentForEmailInbox
            __annotations__ = {
                "Action": Action,
                "EmailFrom": EmailFrom,
                "EmailTo": EmailTo,
    ...
    EmailTo: 'Result1ForEmailToForEmailInbox'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["EmailFrom"]) -> 'EmailFrom': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["EmailTo"]) -> 'Result1ForEmailToForEmailInbox': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["EmailSubject"]) -> 'EmailSubject': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["EmailCc"]) -> 'Result1ForEmailCcForEmailInbox': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["EmailBcc"]) -> 'Result1ForEmailBccForEmailInbox': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Attachment"]) -> 'Result1ForAttachmentForEmailInbox': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Action", "EmailFrom", "EmailTo", "EmailSubject", "EmailCc", "EmailBcc", "Attachment", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["EmailFrom"]) -> 'EmailFrom': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["EmailTo"]) -> 'Result1ForEmailToForEmailInbox': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["EmailSubject"]) -> 'EmailSubject': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["EmailCc"]) -> typing.Union['Result1ForEmailCcForEmailInbox', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["EmailBcc"]) -> typing.Union['Result1ForEmailBccForEmailInbox', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Attachment"]) -> typing.Union['Result1ForAttachmentForEmailInbox', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Action", "EmailFrom", "EmailTo", "EmailSubject", "EmailCc", "EmailBcc", "Attachment", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        EmailFrom: 'EmailFrom',
        EmailSubject: 'EmailSubject',
        EmailCc: typing.Union['Result1ForEmailCcForEmailInbox', schemas.Unset] = schemas.unset,
        EmailBcc: typing.Union['Result1ForEmailBccForEmailInbox', schemas.Unset] = schemas.unset,
        Attachment: typing.Union['Result1ForAttachmentForEmailInbox', schemas.Unset] = schemas.unset,
