...
class UpdateothereventleaveParameter(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            def EmployeeId() -> typing.Type['EmployeeId']:
                return EmployeeId
            OtherEventTxnId = schemas.IntSchema
        
            @staticmethod
            def DurationType() -> typing.Type['Byte']:
                return Byte
            other_event_reason = schemas.StrSchema
            ...
            @staticmethod
            def AddFiles() -> typing.Type['Result1Forupdateothereventleave']:
                return Result1Forupdateothereventleave
            __annotations__ = {
                "APIKey": APIKey,
                "Action": Action,
                "EmployeeId": EmployeeId,
                "OtherEventTxnId": OtherEventTxnId,
                "DurationType": DurationType,
                "Other Event Reason": other_event_reason,
                "StartDate": StartDate,
                "EndDate": EndDate,
    ...
    OtherEventTxnId: MetaOapg.properties.OtherEventTxnId
    EmployeeId: 'EmployeeId'
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["OtherEventTxnId"]) -> MetaOapg.properties.OtherEventTxnId: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["DurationType"]) -> 'Byte': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Other Event Reason"]) -> MetaOapg.properties.other_event_reason: ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AddFiles"]) -> 'Result1Forupdateothereventleave': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "OtherEventTxnId", "DurationType", "Other Event Reason", "StartDate", "EndDate", "DurationInDays", "StartTime", "EndTime", "Comments", "AddFiles", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["OtherEventTxnId"]) -> MetaOapg.properties.OtherEventTxnId: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["DurationType"]) -> 'Byte': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Other Event Reason"]) -> MetaOapg.properties.other_event_reason: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AddFiles"]) -> typing.Union['Result1Forupdateothereventleave', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "OtherEventTxnId", "DurationType", "Other Event Reason", "StartDate", "EndDate", "DurationInDays", "StartTime", "EndTime", "Comments", "AddFiles", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        OtherEventTxnId: typing.Union[MetaOapg.properties.OtherEventTxnId, decimal.Decimal, int, ],
        EmployeeId: 'EmployeeId',
        ...
        AddFiles: typing.Union['Result1Forupdateothereventleave', schemas.Unset] = schemas.unset,
