...
class AddNewDrivingLicenseParameter(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "LicenseNumber", "LicenseType", "ExpiryDate", "Comments", "CustomColumns", "AddFiles", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "EmployeeId", "LicenseNumber", "LicenseType", "ExpiryDate", "Comments", "CustomColumns", "AddFiles", ], str]):
