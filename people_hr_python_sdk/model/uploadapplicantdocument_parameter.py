...
class UploadapplicantdocumentParameter(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def ApplicantId() -> typing.Type['Bigint']:
                return Bigint
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["ApplicantId"]) -> 'Bigint': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "ApplicantId", "DocumentName", "File", "Description", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ApplicantId"]) -> 'Bigint': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["APIKey", "Action", "ApplicantId", "DocumentName", "File", "Description", ], str]):
...
from people_hr_python_sdk.model.bigint import Bigint
