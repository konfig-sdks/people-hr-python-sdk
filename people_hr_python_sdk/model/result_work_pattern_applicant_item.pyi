...
class ResultWorkPatternApplicantItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            WorkPatternId = schemas.IntSchema
            WorkPatternName = schemas.StrSchema
        
            @staticmethod
            def Week() -> typing.Type['WeekArrayForWorkPattern']:
                return WeekArrayForWorkPattern
        
            @staticmethod
            def AssignedTo() -> typing.Type['AssignedToArrayForWorkPattern']:
                return AssignedToArrayForWorkPattern
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["WorkPatternId"]) -> MetaOapg.properties.WorkPatternId: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["WorkPatternName"]) -> MetaOapg.properties.WorkPatternName: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["Week"]) -> 'WeekArrayForWorkPattern': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["AssignedTo"]) -> 'AssignedToArrayForWorkPattern': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["WorkPatternId", "WorkPatternName", "Week", "AssignedTo", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["WorkPatternId"]) -> typing.Union[MetaOapg.properties.WorkPatternId, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["WorkPatternName"]) -> typing.Union[MetaOapg.properties.WorkPatternName, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["Week"]) -> typing.Union['WeekArrayForWorkPattern', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["AssignedTo"]) -> typing.Union['AssignedToArrayForWorkPattern', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["WorkPatternId", "WorkPatternName", "Week", "AssignedTo", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        WorkPatternId: typing.Union[MetaOapg.properties.WorkPatternId, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        WorkPatternName: typing.Union[MetaOapg.properties.WorkPatternName, str, schemas.Unset] = schemas.unset,
        Week: typing.Union['WeekArrayForWorkPattern', schemas.Unset] = schemas.unset,
        AssignedTo: typing.Union['AssignedToArrayForWorkPattern', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'ResultWorkPatternApplicantItem':
